...
DO:
    ...
    DO: 
        RUN cls\kundeordre\asPostpakkeEtikettUtskrift.p ON hServer (cKOrdre_IdLst, OUTPUT ocReturn). 
        hServer:DISCONNECT().
        obOk = TRUE.
    END.
    ELSE DO: 
        RUN cls\kundeordre\asPostpakkeEtikettUtskrift.p (cKOrdre_IdLst, OUTPUT ocReturn). 
        obOk = FALSE.
    END.
