...
/*    cConnectionString = "-H " + cIpAdr + " -AppService asbroker1 -S 3090 -DirectConnect"*/
    cKOrdre_IdLst     = '1180000001,1180000002,1180000003,1180000004'
    bBrukAppServer    = TRUE
    .
...
DO:
    ...
    DO: 
        RUN cls\kundeordre\asSetStatusKundeOrdre.p ON hServer (cKOrdre_IdLst, 30, OUTPUT ocReturn). 
        hServer:DISCONNECT().
        obOk = TRUE.
    END.
    ELSE DO: 
        RUN cls\kundeordre\asSetStatusKundeOrdre.p (cKOrdre_IdLst, 30, OUTPUT ocReturn). 
        obOk = FALSE.
    END.
