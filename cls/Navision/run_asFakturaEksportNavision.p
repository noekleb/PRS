...
/*------------------------------------------------------------------------
    File        : run_asFakturaEksportNavision.p
    Purpose     : Kjører eksport av faktura via AppServer.
...
DO:
  ...
  rStandardFunksjoner:SkrivTilLogg(cLogg,
      '  Starter runFakturaEksportNavision.p.'
      ).
  cReturn-Value = ''.
  RUN cls\Navision\runFakturaEksportNavision.p ON SERVER hServer.
