...
/*------------------------------------------------------------------------
    File        : run_asOppdaterPkSdlHodeMedFakturaNr.p
    Purpose     : 
...
ASSIGN
    ...
    bTest       = TRUE 
    cLogg       = 'run_asOppdaterPkSdlHodeMedFakturaNr' + REPLACE(STRING(TODAY),'/','')
...
DO:
  ...
  RUN cls\Pakkseddel\OppdaterPkSdlHodeMedFakturaNr.p ON hServer.
