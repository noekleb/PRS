...
/*------------------------------------------------------------------------
    File        : run_run_aspksdlEDIWeb.p
    Purpose     : Kjører import av EDIWeb filer via AppSErver.
...
DO:
  rStandardFunksjoner:SkrivTilLogg(cLogg,
      'Kjører import av EDIWeb filer' 
      ).

  RUN cls\Pakkseddel\runksdlEDIWeb.p ON hServer.
