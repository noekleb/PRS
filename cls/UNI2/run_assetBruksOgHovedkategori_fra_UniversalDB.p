...
/*------------------------------------------------------------------------
    File        : run_assetBruksOgHovedkategori_fra_UniversalDB.p
    Purpose     : 
...
ASSIGN
    ...
    bTest        = TRUE 
    cLogg        = 'run_assetBruksOgHovedkategori_fra_UniversalDB' + REPLACE(STRING(TODAY),'/','')
...
DO:
  ...
  /* Leser inn bongene. */
  RUN cls\UNI2\setBruksOgHovedkategori_fra_UniversalDB.p ON SERVER hServer.
