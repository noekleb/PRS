/* Registrer overføring fra pakkseddel
...
DO ON ERROR UNDO, LEAVE:
  ...
  IF bHarGjortDet = FALSE THEN 
    DO:
        bHarGjortDet = TRUE.
        IF PkSdlHode.PkSdlOpphav = 6 THEN 
  ...
  ELSE IF NOT CAN-DO('5,6',STRING(PkSdlHode.PkSdlOpphav)) THEN 
      LEAVE KJOP.
  ...
  REPEAT WHILE NOT hQuery:QUERY-OFF-END:
    ...
    DO:
      ...
      ASSIGN
        ...
        BongLinje.TBId       = 2 /* Pakkseddel skal opprettes */ 
    ...
    DO TRANSACTION:
        ...
        DO:
            ...
            ASSIGN
                ...
                BongLinje.BongNr       = BongHode.BongNr   
                BongLinje.TTId         = 65 /* Kredit for Outlet skal faktureres. */
                BongLinje.TBId         = 1
