      ...
      DO:
        ...
        DO:
          ASSIGN
            ...
            ArtBas.EDato    = TODAY 
            ArtBas.ETid    = TIME
            ArtBas.PubliserINettbutikk = IF ArtBas.WebButikkArtikkel = FALSE THEN FALSE ELSE NOT ArtBas.PubliserINettbutikk  
            .
        ...
        ELSE DO:
          FOR EACH bArtBas EXCLUSIVE-LOCK WHERE bArtBas.ModellFarge = ArtBas.ModellFarge AND 
            ...
            ASSIGN
              ...
              bArtBas.EDato    = TODAY 
              bArtBas.ETid    = TIME
              bArtBas.PubliserINettbutikk = IF bArtBas.WebButikkArtikkel = FALSE THEN FALSE ELSE NOT bArtBas.PubliserINettbutikk  
              .
            CREATE ttArtikkel.
            ASSIGN 
