...
/*
TN 30/5-07 
Hvorfor får jeg her et gyldig buffer når jeg kjører på hk - peker på ttFunctionAccess, 
mens jeg ikke får det når jeg kører programmet på min maskin.
*/
...
DO:
  ...
  REPEAT WHILE NOT hQuery:QUERY-OFF-END TRANSACTION:
    ...
    IF AVAIL ArtBas THEN DO:
        IF ArtBas.StrTypeId > 1 THEN /* Kan ikke endre pakkevarer */
        DO:
            ArtBas.StrTypeId = int(entry(1,icParam)).
            /* TN 11/11-08 02 koder skal ikke slettes ved bytte av størrelsestype.
            FOR EACH StrekKode OF ArtBas WHERE StrekKode.Kode BEGINS "02" AND
