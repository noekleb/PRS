...
/*    FIND FIRST SIEEksport WHERE SIEEksport.SIEEksportNr = DEC(ihBuffer:BUFFER-FIELD('SIEEksportNr'):BUFFER-VALUE)
      ...
      FOR EACH SIEEksport EXCLUSIVE-LOCK:
    ...
    DO:
      ...
      FIND FIRST Butiker NO-LOCK WHERE 
        ...
        IF NOT AVAILABLE Butiker THEN
          ASSIGN iKstButik = SIETrans.ButikkNr.
        ELSE
          ASSIGN iKstButik = Butiker.SIEButikkNr.
...
/*           OR SIETrans.TTId = 78 */
    ...
    END.         
END. /* SIE_LOOP */
/*    MESSAGE "Diff-2" STRING(dDiffBel) STRING(dBelop) SKIP VIEW-AS ALERT-BOX.*/
