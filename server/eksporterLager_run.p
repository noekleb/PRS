...
/*ASSIGN lTid = TIME.                                                                                                                                                     */
/*RUN bibl_logg.p ('eksporter_lager', 'eksporterLager_run.p: WinCheduler Starter eksport av lager. ' + string(TIME,"HH:MM:SS")).                                          */
/*RUN eksportlager.p (?,?,YES,OUTPUT ocReturn).                                                                                                                           */
/*ASSIGN lTid = TIME - lTid.                                                                                                                                              */
/*RUN bibl_logg.p ('eksporter_lager', 'eksporterLager_run.p: WinCheduler Stoppet eksport av lager. ' + string(TIME,"HH:MM:SS") + ' Tidsbruk: ' + string(lTid,"HH:MM:SS")).*/


ASSIGN lTid = TIME.
RUN eksportKomplettlager.p (OUTPUT ocReturn).

ASSIGN lTid = TIME.
RUN eksporterkunder.p.

/*ASSIGN lTid = TIME.                                                                                                                 */
/*RUN eksportvaretelling.p.                                                                                                           */

/*ASSIGN lTid = TIME.                                                                                                                       */
/*RUN eksportpakksedler.p.                                                                                                                  */
