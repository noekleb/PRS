...
DEFINE VARIABLE cFirmanamn AS CHARACTER   NO-UNDO.
...
/*     cLastRowCol = "G" + STRING(iVecka + 4).             */
    ...
    EXPORT STREAM sExportFile DELIMITER ";"
       cFirmanamn + " " + STRING(dFirstday) + " - " + STRING(dLastday) SKIP.
    EXPORT STREAM sExportFile DELIMITER ";"
        /* A  */ "Style no"          
        /* B  */ "Quantity"              
        /* C  */ "Sold pair" 
...
/*         EXPORT STREAM sExportFile DELIMITER ";" " " " " " " " " " " " " " " SKIP. */
    iDag = 0.
    FOR EACH tt_RiekerMnd BY levartnr:
        IF utglager = 0 AND sold = 0 AND inglager = 0 THEN
            NEXT.
            EXPORT STREAM sExportFile DELIMITER ";"
/*                    INT(SUBSTR(vecka,5)) */
                ENTRY(1,levartnr," ")
    ...
    OUTPUT STREAM sExportFile CLOSE.
        ...
        chWorkSheets:Range("A2:D2"):Font:Bold = TRUE.
...
/*         chWorkSheets:Range("A:A"):NumberFormat = "#0". */
        ...
        chWorkSheets:Range("B:D"):NumberFormat = "# ##0".
        

/*         chWorkSheets:Range(cSumBold):Font:Bold = TRUE. */
        chWorkSheets:Columns("A:D"):AutoFit().
...
DEFINE VARIABLE dEfterTTId1    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId2    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId3    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId4    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId5    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId6    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId7    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId8    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId9    AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId10   AS INTE NO-UNDO.
DEFINE VARIABLE dEfterTTId11   AS INTE NO-UNDO.
...
/*              iLagantUtg = iLagantUtg + (getkoeff(1) * translogg.antall). */
             CASE translogg.ttid:
                 WHEN  1 THEN dEfterTTId1  = dEfterTTId1  + translogg.antall.
                 WHEN  2 THEN dEfterTTId2  = dEfterTTId2  + translogg.antall.
                 WHEN  3 THEN dEfterTTId3  = dEfterTTId3  + translogg.antall.
                 WHEN  4 THEN dEfterTTId4  = dEfterTTId4  + translogg.antall.
                 WHEN  5 THEN dEfterTTId5  = dEfterTTId5  + translogg.antall.
                 WHEN  6 THEN dEfterTTId6  = dEfterTTId6  + translogg.antall.
                 WHEN  7 THEN dEfterTTId7  = dEfterTTId7  + translogg.antall.
                 WHEN  8 THEN dEfterTTId8  = dEfterTTId8  + translogg.antall.
                 WHEN  9 THEN dEfterTTId9  = dEfterTTId9  + translogg.antall.
                 WHEN 10 THEN dEfterTTId10 = dEfterTTId10 + translogg.antall.
                 WHEN 11 THEN dEfterTTId11 = dEfterTTId11 + translogg.antall.
             END CASE.
        END.
...
/*                      iSalgAnt = iSalgAnt + translogg.antall.             */
        ...
        ASSIGN tt_RiekerMnd.artikkelnr = artbas.artikkelnr
               ...
               tt_RiekerMnd.utglager   = iLagantUtg + dEfterTTId1 + dEfterTTId4 - dEfterTTId5 + dEfterTTId7 - dEfterTTId9 + dEfterTTId10
               tt_RiekerMnd.sold       = dTTId1 + dTTId10 + dTTId3
/*                tt_RiekerMnd.sold       = iSalgAnt */
               tt_RiekerMnd.inglager   = tt_RiekerMnd.utglager + dTTId1 + dTTId4 - dTTId5 + dTTId7 - dTTId9 + dTTId10
