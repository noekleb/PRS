...
DEF VAR piOldLevNr     AS INT NO-UNDO.
...
/*             NEXT BYTTLEV.                                        */
/*         IF ArtBas.ModellFarge <> 0 THEN /* Inngår i modell */    */
/*             NEXT BYTTLEV.                                        */
        IF ArtBas.ArtikkelNr <> ArtBas.Vg THEN
        ASSIGN
            piOldLevNr   = ArtBas.LevNr
            ArtBas.LevNr = int(entry(1,icParam))
            .
