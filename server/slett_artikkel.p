/* Sletting av artikler 
   Parametere:  temp-tabell med feltet Artikkelnr 
              ...
              eller
                   ...
                   <"ARTNR">,<Artnr1,Artnr2..>
   Kommentar: Benytter eksisterende sletterutine, slettartbasbatch.w 
   
   Opprettet: 28.07.04 av BHa                  
-----------------------------------------------------------------------------------*/
...
REPEAT WHILE NOT hQuery:QUERY-OFF-END:
  RUN slettartbasbatch.w (DEC(ihBuffer:BUFFER-FIELD("Artikkelnr"):BUFFER-VALUE)).
  /*
