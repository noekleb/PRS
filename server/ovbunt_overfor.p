/* Mottar overføring og oppretter en overføringsbong.
   Parameter: 
-----------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION:
        ...
        DO:
            ...
            ASSIGN
                ...
                BongLinje.TransTid     = BongHode.Tid
                BongLinje.RefNr        = 1
                BongLinje.Reftekst     = 'Overførings BuntNr: ' + STRING(iBuntNr) + '.'
                .
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN 
      pcTxt = 'Overførings BuntNr: ' + STRING(ihBuffer:BUFFER-FIELD("BuntNr"):BUFFER-VALUE) + ' eTime:' + STRING(ETIME) + '.'.
  ...
  IF NOT CAN-FIND(Filer WHERE
                  ...
                  Filer.Katalog   = "Overføringsordre"
                 ) THEN
  DO TRANSACTION:
    /* Finner FilId */
