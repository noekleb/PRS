...
ASSIGN lTid = TIME.
RUN bibl_logg.p ('eksporter_strekkoder', 'eksporterStrekkoder_run.p: WinCheduler Starter eksport av strekkoder. ' + string(TIME,"HH:MM:SS")).

RUN eksportstrekkoder.p (OUTPUT ocReturn).

ASSIGN lTid = TIME - lTid.
RUN bibl_logg.p ('eksporter_strekkoder', 'eksporterStrekkoder_run.p: WinCheduler Stoppet eksport av strekkoder. ' + string(TIME,"HH:MM:SS") + ' Tidsbruk: ' + string(lTid,"HH:MM:SS")).
