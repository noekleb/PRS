...
DEF VAR piOldAnbefaltPris AS DEC    NO-UNDO.
...
DO:
  ...
  REPEAT WHILE NOT hQuery:QUERY-OFF-END TRANSACTION:
    ...
    IF AVAIL ArtBas THEN DO:
        ...
        IF ArtBas.ArtikkelNr = ArtBas.Vg THEN /* Plu artikkel */
            NEXT BYTTLEV.
        IF ArtBas.Opris = true THEN /* Plu artikkel */
            NEXT BYTTLEV.
        ASSIGN
            piOldAnbefaltPris   = ArtBas.AnbefaltPris
            ArtBas.AnbefaltPris = DEC(entry(1,icParam))
            .
