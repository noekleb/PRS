...
/*------------------------------------------------------------------------
    File        : excelrapport4_run.p 
    Purpose     : 
    Syntax      :
    Description : Starter analyse rapport
    Author(s)   : Curt O
    Notes       :
  ----------------------------------------------------------------------*/
...
ELSE RUN excelrapport4.p (INPUT '229|' + cRappNr,INPUT ttbh,INPUT ?, OUTPUT ocMelding,OUTPUT obOk) NO-ERROR.


RUN SendMail. 


/* --- -------------------- mail functions procedures ---------------*/
