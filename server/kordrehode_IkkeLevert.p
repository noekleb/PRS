...
DO:
    ...
    DO:
        obOk = FALSE.
        ocReturn = 'En eller flere av de valgte kundeordre er ikke bekreftet mottatt fra speditør.'.
        RETURN.    
    END.
END.
    ...
    DO TRANSACTION:
        ...
        DO:
            rKundeordreBehandling:setStatusKundeordre( INPUT STRING(KOrdreHode.KOrdre_Id),
                                                       INPUT IF (KOrdreHode.LevStatus < '50' AND iStatusLst = 15) THEN 55 ELSE INT(KOrdreHode.LevStatus)).  
        END. 
