...
IF cMKlubbId = "4" THEN 
  ...
  cMsgNyMedlem = 
     ...
     + '|;'
     + '|;Jag har tagit del av villkoren i infor-'
     + '|;mationsfoldern.'
     + '|;Undertecknat önskar bli medlem i Jedviks'
     + '|;Guldklubb för att kunna få attraktiva'
     + '|;medlemserbjudanden, information om nyheter'
     + '|;samt bonusmöjligheter vid köp hos JF'
     + '|;Johanssons och godtar att JF Johanssons'
     + '|;behandlar mina personuppgifter enligt'
     + '|;tillämplig dataskyddslagstiftning,'
     + '|;inklusive Europaparlamentets och rådets'
     + '|;förordning (EU) 2016/679 om skydd för'
     + '|;fysiska personer med avseende på behand-'
     + '|;ling av personuppgifter. Vill du se vilka'
     + '|;uppgifter som sparas och/eller träda ut'
     + '|;medlemsklubben och då få dina köp och med-'
     + '|;lemsuppgifter anonymiserade så vänder du'
     + '|;dig till bolagets huvudkontor.'
     + '|;Kontaktuppgifter finns på www.jedviks.se.'
...
ELSE 
  ...
  cMsgNyMedlem = 
     ...
     + '|;Jag har tagit del av villkoren i infor-'
     + '|;mationsfoldern.'
     + '|;Undertecknat önskar bli medlem i Club'
     + '|;Johanssons för att kunna få attraktiva'
      + '|;medlemserbjudanden, information om nyheter'
      + '|;samt bonusmöjligheter vid köp hos JF'
      + '|;Johanssons och godtar att JF Johanssons'
      + '|;behandlar mina personuppgifter enligt'
      ...
      + '|;medlemsklubben och då få dina köp och med-'
      + '|;lemsuppgifter anonymiserade så vänder du'
      + '|;dig till bolagets huvudkontor. Kontakt-'
      + '|;uppgifter finns på www.johanssons.se.'
/*      + '|;* Obligatoriska uppgifter för anslutning ' */
/*      + '|;* till Club Johanssons.                  ' */
/*      + '|;'                                          */
/*      + '|;    Jag har tagit del av villkoren i     ' */
...
RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Stepp 1: ' 
...
IF NOT CAN-DO(cLengdeLst,STRING(LENGTH(cOrgPersonNr))) THEN 
    DO:
        RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Ugyldig lengde på medlemsid: ' 
            + 'PersNr: '  + cOrgPersonNr + ' '
...
RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Stepp 2: ' 
    + 'MedemsId: '  + cOrgPersonNr + ' '
    + 'bOk: ' + STRING(bOk) + ' ' 
    + 'Status ' + cStatus + ' ' 
    + 'Melding ' + cMelding
...
RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Stepp 3: ' 
    + 'MedemsId: '  + cOrgPersonNr + ' '
    + 'bOk: ' + STRING(bOk) + ' ' 
    + 'Status ' + cStatus + ' ' 
    + 'Melding ' + cMelding
...
RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Stepp 4: ' 
    + 'MedemsId: '  + cOrgPersonNr + ' '
    + 'bOk: ' + STRING(bOk) + ' ' 
    + 'Status ' + cStatus + ' ' 
    + 'Melding ' + cMelding
...
SJEKKPersonNr:
DO: 
    IF LENGTH(cOrgPersonNr) < 10 OR  
        NOT CAN-DO(cLengdeLst,STRING(LENGTH(cOrgPersonNr))) THEN 
    DO:
        ASSIGN 
            bOK      = FALSE 
            cStatus  = "0"
            cMelding = "Okänt lokalt medlemsid. " + cOrgPersonNr + ".".
        RETURN.
    END.
END. /* SJEKKPersonNr */

RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Stepp 5: ' 
    + 'MedemsId: '  + cOrgPersonNr + ' '
    + 'bOk: ' + STRING(bOk) + ' ' 
    + 'Status ' + cStatus + ' ' 
    + 'Melding ' + cMelding
...
IF bOK = FALSE THEN DO:
    ASSIGN 
        bOK      = FALSE 
        cStatus  = "0".
    RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem_Spar3.p: Stepp 6: ' 
        + 'MedemsId: '  + cOrgPersonNr + ' '
        + 'bOk: ' + STRING(bOk) + ' ' 
        + 'Status ' + cStatus + ' ' 
        + 'Melding ' + cMelding
...
END.
DO:
    RUN sjekkOmFinnesSPAR NO-ERROR.
END.
/*RUN sjekkOmFinnesSPARTest.*/

RUN bibl_loggDbFri.p ('asMedlemLogg', 'asmedlem.p: Stepp 7: ' 
    + 'MedemsId: '  + cOrgPersonNr + ' '
    + 'bOk: ' + STRING(bOk) + ' ' 
    + 'Status ' + cStatus + ' ' 
    + 'Melding ' + cMelding
