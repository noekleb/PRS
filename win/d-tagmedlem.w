...
DEFINE TEMP-TABLE tMedlem NO-UNDO LIKE Medlem.
...
&scoped-define DB-BROWSER BROWSE-Medlem

&scoped-define br-tabell Medlem

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  MedlemsNr
...
&scoped-define index-col1  Medlem
...
&scoped-define sok-field2  EtterNavn
...
&scoped-define index-col2  EtterNavn
...
&scoped-define BUFFER-COPY-USING USING EtterNavn ForNavn
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tMedlem.MedlemsNr ~
tMedlem.EtterNavn tMedlem.ForNavn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tMedlem.MedlemsNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tMedlem
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tMedlem
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tMedlem NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tMedlem
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tMedlem


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Medlem}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Medlem BROWSE-Tag Btn_OK Btn_Cancel ~
...
DEFINE QUERY BROWSE-Medlem FOR 
      Medlem
    FIELDS(Medlem.MedlemsNr
      Medlem.EtterNavn
      Medlem.ForNavn) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tMedlem
    FIELDS(tMedlem.MedlemsNr
      tMedlem.EtterNavn
      tMedlem.ForNavn) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Medlem Dialog-Frame _STRUCTURED
  QUERY BROWSE-Medlem NO-LOCK DISPLAY
      ...
      Medlem.EtterNavn FORMAT "X(25)":U
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tMedlem.MedlemsNr FORMAT ">>>>>>>>>>>>9":U
      tMedlem.EtterNavn FORMAT "X(25)":U
      tMedlem.ForNavn FORMAT "X(20)":U
  ENABLE
      tMedlem.MedlemsNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-Medlem AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tMedlem T "?" NO-UNDO skotex Medlem
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Medlem 1 Dialog-Frame */
...
"MedlemsNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Medlem.EtterNavn
"EtterNavn" ? "X(25)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > SkoTex.Medlem.ForNavn
"ForNavn" ? "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tMedlem"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tMedlem.MedlemsNr
"MedlemsNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tMedlem.EtterNavn
"EtterNavn" ? "X(25)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > Temp-Tables.tMedlem.ForNavn
"ForNavn" ? "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg medlem */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Medlem Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Medlem IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Medlem BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
