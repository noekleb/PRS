...
DEFINE VARIABLE FI-Tittel AS CHARACTER FORMAT "X(256)":U INITIAL "      Import av varemerker" 
      VIEW-AS TEXT 
     SIZE 77 BY 1.38
...
DO:
  ...
  if B-Start:private-data = "OPPDAT" then
    do:
      ...
      run x-impflexvarum.w persistent set wProgram-Handle (this-procedure:handle).      
    end.
