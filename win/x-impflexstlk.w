...
put stream LoggData unformatted 
  " " skip
  " -----------------------------------------------------------------------" skip
  " Import av størrelsestyper fra eXcellenc PRO Innkjøpssystem startet         " skip
  ...
  repeat on error undo TRANSBLOKK, leave TRANSBLOKK:
    ...
    assign
      ...
      do:
        ...
        /* Størrelsesuavhengig er satt opp med "1". */
        /* Denne skal ikke tas med.                 */
        if trim(wFStlKod) = "1" then
          next IMPORT_AV_DATA.
          
        /* Leser inn størrelsene */
        do wLoop = 1 to 30:
        ...
        /* Oppretter StrTStr.                                          */
        /* Denne metoden forutsetter at størrelsestypene vedlikeholdes */
        /* i eXcellence PRO.                                           */
        /* Skjer vedlikeholdet i SkoTex, skal ikke import gjøres.      */
        /* NB: Sekvensnummer må tildeles i den ordning som størrelsene */
...
put stream LoggData unformatted 
  " " skip
  " -----------------------------------------------------------------------" skip
  " Antall størrelsestyper: " string(wAntBest,"zzzzzzz9") skip
