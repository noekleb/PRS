...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 BROWSE-LevBas BROWSE-Tag ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-LevBas Dialog-Frame _STRUCTURED
  QUERY BROWSE-LevBas NO-LOCK DISPLAY
      LevBas.levnr COLUMN-LABEL "LevNr" FORMAT "zzzzz9"
      LevBas.levnamn COLUMN-LABEL "Navn" FORMAT "x(30)"
  ENABLE
      LevBas.levnr
      LevBas.levnamn
/* _UIB-CODE-BLOCK-END */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tLevBas.levnr COLUMN-LABEL "LevNr" FORMAT "zzzzz9"
      tLevBas.levnamn COLUMN-LABEL "Navn" FORMAT "x(30)" WIDTH 29.8
  ENABLE
      tLevBas.levnr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"levnr" "LevNr" "zzzzz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > skotex.LevBas.levnamn
"levnamn" "Navn" "x(30)" "character" ? ? ? ? ? ? yes ? no no ?
     _Query            is OPENED
...
"levnamn" "Navn" "x(30)" "character" ? ? ? ? ? ? no ? no no "29.8"
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-4 RECT-5 BROWSE-LevBas BROWSE-Tag Btn_OK Btn_Cancel Btn_Help 
         BUTTON-Sok 
      WITH FRAME Dialog-Frame.
