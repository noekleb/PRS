...
&scope InitIdx     Notatkoder
&scope ip-felt     NotatKode
...
&scoped-define VedlikeholdsRutine d-vnotatkoder.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Notatkoder

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Notatkoder

/* Definitions for BROWSE BROWSE-Notatkoder                             */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Notatkoder Notatkoder.NotatKode ~
Notatkoder.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Notatkoder ~
Notatkoder.NotatKode Notatkoder.Beskrivelse 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Notatkoder Notatkoder
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Notatkoder Notatkoder
&Scoped-define OPEN-QUERY-BROWSE-Notatkoder OPEN QUERY BROWSE-Notatkoder FOR EACH Notatkoder NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Notatkoder Notatkoder
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Notatkoder Notatkoder
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Notatkoder Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Notatkoder FOR 
      Notatkoder SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Notatkoder
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Notatkoder Dialog-Frame _STRUCTURED
  QUERY BROWSE-Notatkoder NO-LOCK DISPLAY
      Notatkoder.NotatKode FORMAT ">9":U
      Notatkoder.Beskrivelse FORMAT "X(40)":U
  ENABLE
      Notatkoder.NotatKode
      Notatkoder.Beskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 51 BY 14.76 ROW-HEIGHT-CHARS .62.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Notatkoder AT ROW 2.91 COL 2
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Notatkoder BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Notatkoder:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Notatkoder
/* Query rebuild information for BROWSE BROWSE-Notatkoder
     _TblList          = "skotex.Notatkoder"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > skotex.Notatkoder.NotatKode
"Notatkoder.NotatKode" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Notatkoder.Beskrivelse
"Notatkoder.Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Notatkoder */
&ANALYZE-RESUME
...
&Scoped-define BROWSE-NAME BROWSE-Notatkoder
&Scoped-define SELF-NAME BROWSE-Notatkoder
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Notatkoder Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Notatkoder IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Notatkoder Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Notatkoder IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Notatkoder Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Notatkoder IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Notatkoder Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Notatkoder IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Notatkoder Dialog-Frame
ON HOME OF BROWSE-Notatkoder IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Notatkoder Dialog-Frame
ON START-SEARCH OF BROWSE-Notatkoder IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Notatkoder Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
