/************************************************************
    Program:  tvfolgeseddel.p
    Created:  TN    21/6-01
Description:  Skriver ut en følgeseddel for innleverte par sko.
...
DEF INPUT PARAMETER  wLeveringsNr   AS INT   NO-UNDO.
  ...
  do TRANSACTION:
    ...
    assign
      ...
      Lister.Merknad       = if wLAyout = 107
                             ...
                             else "Utskrift av innleveranserapport pr. butikk "
      ...
      */
      ...
      Lister.Kriterier[16] = STRING(wLeveringsNr)
