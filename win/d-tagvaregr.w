...
DEFINE TEMP-TABLE tVarGr NO-UNDO LIKE VarGr.
...
&scoped-define DB-BROWSER BROWSE-VarGr

&scoped-define br-tabell VarGr

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  Vg
...
&scoped-define index-col1  VarGrIn
...
/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field2  VgBeskr
...
&scoped-define index-col2  VgBeskr
...
&scoped-define BUFFER-COPY-USING USING VgBeskr
...
&Scoped-define INTERNAL-TABLES tVarGr VarGr

/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tVarGr.Vg tVarGr.VgBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tVarGr.Vg 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tVarGr
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tVarGr
&Scoped-define QUERY-STRING-BROWSE-Tag FOR EACH tVarGr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tVarGr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tVarGr
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tVarGr
...
&Scoped-define QUERY-STRING-BROWSE-VarGr FOR EACH VarGr ~
      WHERE VarGr.Vg > 0 NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-VarGr OPEN QUERY BROWSE-VarGr FOR EACH VarGr ~
      WHERE VarGr.Vg > 0 NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-VarGr VarGr
...
&Scoped-Define ENABLED-OBJECTS BROWSE-VarGr BROWSE-Tag Btn_OK Btn_Cancel ~
...
DEFINE QUERY BROWSE-Tag FOR 
      tVarGr
    FIELDS(tVarGr.Vg
      tVarGr.VgBeskr) SCROLLING.

DEFINE QUERY BROWSE-VarGr FOR 
      VarGr
    FIELDS(VarGr.Vg
      VarGr.VgBeskr) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tVarGr.Vg FORMAT "zzzzz9":U
      tVarGr.VgBeskr FORMAT "x(30)":U
  ENABLE
      tVarGr.Vg
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 39 BY 12.19 ROW-HEIGHT-CHARS .62.

DEFINE BROWSE BROWSE-VarGr
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-VarGr Dialog-Frame _STRUCTURED
  QUERY BROWSE-VarGr NO-LOCK DISPLAY
      VarGr.Vg COLUMN-LABEL "Vg *" FORMAT "zzzzz9":U
      VarGr.VgBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(30)":U
  ENABLE
      VarGr.Vg
      VarGr.VgBeskr
/* _UIB-CODE-BLOCK-END */
...
DEFINE FRAME Dialog-Frame
     BROWSE-VarGr AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tVarGr T "?" NO-UNDO skotex VarGr
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-VarGr 1 Dialog-Frame */
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tVarGr"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tVarGr.Vg
"Vg" ? "zzzzz9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tVarGr.VgBeskr
"VgBeskr" ? "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"Vg" "Vg *" "zzzzz9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.VarGr.VgBeskr
"VgBeskr" "Beskrivelse *" "x(30)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-VarGr */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg varegrupper */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VarGr Dialog-Frame
ON CURSOR-LEFT OF BROWSE-VarGr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VarGr Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-VarGr IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VarGr Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-VarGr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VarGr Dialog-Frame
ON START-SEARCH OF BROWSE-VarGr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VarGr Dialog-Frame
ON VALUE-CHANGED OF BROWSE-VarGr IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-VarGr BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
