...
tStLinje.Aar tStLinje.PerLinTxt tStLinje.KjopAnt tStLinje.KjopVerdi ~
tStLinje.AntSolgt tStLinje.VerdiSolgt tStLinje.VVarekost tStLinje.AntRabatt ~
tStLinje.VerdiRabatt tStLinje.DbKr tStLinje.Db% tStLinje.Utsolgt% ~
tStLinje.ReklAnt tStLinje.ReklVerdi tStLinje.ReklLAnt tStLinje.ReklLVerdi ~
tStLinje.LagerAnt tStLinje.LagerVerdi tStLinje.OvAnt tStLinje.OvVerdi ~
tStLinje.GjenkjopAnt tStLinje.GjenkjopVerdi tStLinje.MvaVerdi ~
tStLinje.BrekkAnt tStLinje.BrekkVerdi tStLinje.JustAnt tStLinje.DiverseAnt ~
tStLinje.JustVerdi tStLinje.SvinnAnt tStLinje.SvinnVerdi tStLinje.IntAnt ~
tStLinje.IntVerdi tStLinje.Diverseverdi tStLinje.NedAnt tStLinje.NedVerdi 
...
&Scoped-Define ENABLED-OBJECTS B-Excel COMBO-BOX-Periode B-Grafikk T-Tot ~
BROWSE-Statistikk B-Rapp B-Rapp-HtmEx BUTTON-SokDato FILL-IN-Tekst1 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Statistikk C-Win _STRUCTURED
  QUERY BROWSE-Statistikk NO-LOCK DISPLAY
      ...
      tStLinje.KjopAnt COLUMN-LABEL "Kjøpt" FORMAT "-zzz,zz9":U
            WIDTH 10.2
      tStLinje.KjopVerdi COLUMN-LABEL "V-Kjøpt" FORMAT "-zz,zzz,zz9":U
            WIDTH 13.6
      tStLinje.AntSolgt COLUMN-LABEL "Solgt" FORMAT "-zzz,zz9":U
            WIDTH 12
      tStLinje.VerdiSolgt COLUMN-LABEL "V-Solgt" FORMAT "-zz,zzz,zz9":U
            WIDTH 12.8
      tStLinje.VVarekost COLUMN-LABEL "Sv-Varekost" FORMAT "-z,zzz,zz9":U
            WIDTH 13
      tStLinje.AntRabatt COLUMN-LABEL "Rabatt" FORMAT "-zzz,zz9":U
            WIDTH 7.6
      tStLinje.VerdiRabatt COLUMN-LABEL "V-Rabatt" FORMAT "-zzz,zzz,zz9":U
      tStLinje.DbKr COLUMN-LABEL "DbKr" FORMAT "-zz,zzz,zz9":U
      tStLinje.Db% COLUMN-LABEL "DB%" FORMAT "-zzz,zz9.99":U WIDTH 10
      tStLinje.Utsolgt% COLUMN-LABEL "Utsolgt%" FORMAT "-zzzz9.9":U
      tStLinje.ReklAnt COLUMN-LABEL "Reklamert" FORMAT "-zzz,zz9":U
            WIDTH 12
      tStLinje.ReklVerdi COLUMN-LABEL "V-Reklamert" FORMAT "-zzz,zzz,zz9":U
      tStLinje.ReklLAnt COLUMN-LABEL "LReklamert" FORMAT "-zzz,zz9":U
      tStLinje.ReklLVerdi COLUMN-LABEL "V-LReklamert" FORMAT "-zzz,zzz,zz9":U
      tStLinje.LagerAnt COLUMN-LABEL "Lager" FORMAT "-zzz,zz9":U
            WIDTH 9
      tStLinje.LagerVerdi COLUMN-LABEL "V-Lager" FORMAT "-zzz,zzz,zz9":U
      tStLinje.OvAnt COLUMN-LABEL "Overført" FORMAT "-zzz,zz9":U
            WIDTH 10.2
      tStLinje.OvVerdi COLUMN-LABEL "V-Overført" FORMAT "-zzz,zzz,zz9":U
      tStLinje.GjenkjopAnt COLUMN-LABEL "Retur" FORMAT "-zzz,zz9":U
            WIDTH 12
      tStLinje.GjenkjopVerdi COLUMN-LABEL "V-Retur" FORMAT "-zzz,zzz,zz9":U
      tStLinje.MvaVerdi COLUMN-LABEL "V-Mva" FORMAT "-zz,zzz,zz9":U
            WIDTH 9.6
      tStLinje.BrekkAnt FORMAT "-zzz,zz9":U
      tStLinje.BrekkVerdi COLUMN-LABEL "V-Brekkasje" FORMAT "-zzz,zzz,zz9":U
      tStLinje.JustAnt COLUMN-LABEL "Justert" FORMAT "-zzz,zz9":U
      tStLinje.DiverseAnt FORMAT "-zzz,zzz,zz9":U
      tStLinje.JustVerdi COLUMN-LABEL "V-Justert" FORMAT "-zzz,zzz,zz9":U
      tStLinje.SvinnAnt COLUMN-LABEL "Svinn" FORMAT "-zz,zz9":U
      tStLinje.SvinnVerdi COLUMN-LABEL "V-Svinn" FORMAT "-zzz,zzz,zz9":U
      tStLinje.IntAnt FORMAT "-zzz,zz9":U
      tStLinje.IntVerdi COLUMN-LABEL "V-Internt forbruk" FORMAT "-zzz,zzz,zz9":U
      tStLinje.Diverseverdi COLUMN-LABEL "V-Diverse" FORMAT "-zzz,zzz,zz9":U
      tStLinje.NedAnt COLUMN-LABEL "Nedskrevet" FORMAT "-zz,zz9":U
      tStLinje.NedVerdi COLUMN-LABEL "V-Nedksrevet" FORMAT "-zzz,zzz,zz9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 198 BY 19.76 ROW-HEIGHT-CHARS .62 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME FRAME-Historikk
     B-Excel AT ROW 2.38 COL 106.2
     COMBO-BOX-Periode AT ROW 2.38 COL 19 COLON-ALIGNED NO-LABEL
     FI-Filter AT ROW 2.38 COL 57 COLON-ALIGNED
     B-Grafikk AT ROW 2.38 COL 141
     T-Tot AT ROW 2.57 COL 123
     BROWSE-Statistikk AT ROW 4.05 COL 1.6
     B-Rapp AT ROW 2.38 COL 111.2
     B-Rapp-HtmEx AT ROW 2.38 COL 116
     BUTTON-SokDato AT ROW 2.38 COL 100
     FILL-IN-Tekst1 AT ROW 2.52 COL 2 NO-LABEL
...
"tStLinje.VisBut" "But" "xxxxxxx" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tStLinje.Aar
"tStLinje.Aar" ? "zzz9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > "_<CALC>"
"tStLinje.PerLinTxt" "Periode" "xxxxxxxxxxxxxxxxxxxx" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.tStLinje.KjopAnt
"tStLinje.KjopAnt" "Kjøpt" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.tStLinje.KjopVerdi
"tStLinje.KjopVerdi" "V-Kjøpt" "-zz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "13.6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.tStLinje.AntSolgt
"tStLinje.AntSolgt" "Solgt" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tStLinje.VerdiSolgt
"tStLinje.VerdiSolgt" "V-Solgt" "-zz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "12.8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tStLinje.VVarekost
"tStLinje.VVarekost" "Sv-Varekost" "-z,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.tStLinje.AntRabatt
"tStLinje.AntRabatt" "Rabatt" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "7.6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.tStLinje.VerdiRabatt
"tStLinje.VerdiRabatt" "V-Rabatt" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"tStLinje.DbKr" "DbKr" "-zz,zzz,zz9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > "_<CALC>"
"tStLinje.Db%" "DB%" "-zzz,zz9.99" ? ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > "_<CALC>"
"tStLinje.Utsolgt%" "Utsolgt%" "-zzzz9.9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > Temp-Tables.tStLinje.ReklAnt
"tStLinje.ReklAnt" "Reklamert" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > Temp-Tables.tStLinje.ReklVerdi
"tStLinje.ReklVerdi" "V-Reklamert" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.tStLinje.ReklLAnt
"tStLinje.ReklLAnt" "LReklamert" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > Temp-Tables.tStLinje.ReklLVerdi
"tStLinje.ReklLVerdi" "V-LReklamert" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > "_<CALC>"
"tStLinje.LagerAnt" "Lager" "-zzz,zz9" ? ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > Temp-Tables.tStLinje.LagerVerdi
"tStLinje.LagerVerdi" "V-Lager" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > Temp-Tables.tStLinje.OvAnt
"tStLinje.OvAnt" "Overført" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > Temp-Tables.tStLinje.OvVerdi
"tStLinje.OvVerdi" "V-Overført" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[22]   > Temp-Tables.tStLinje.GjenkjopAnt
"tStLinje.GjenkjopAnt" "Retur" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[23]   > Temp-Tables.tStLinje.GjenkjopVerdi
"tStLinje.GjenkjopVerdi" "V-Retur" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[24]   > Temp-Tables.tStLinje.MvaVerdi
"tStLinje.MvaVerdi" "V-Mva" "-zz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no "9.6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[25]   > Temp-Tables.tStLinje.BrekkAnt
"tStLinje.BrekkAnt" ? "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[26]   > Temp-Tables.tStLinje.BrekkVerdi
"tStLinje.BrekkVerdi" "V-Brekkasje" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[27]   > Temp-Tables.tStLinje.JustAnt
"tStLinje.JustAnt" "Justert" "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[28]   > Temp-Tables.tStLinje.DiverseAnt
"tStLinje.DiverseAnt" ? "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[29]   > Temp-Tables.tStLinje.JustVerdi
"tStLinje.JustVerdi" "V-Justert" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[30]   > Temp-Tables.tStLinje.SvinnAnt
"tStLinje.SvinnAnt" "Svinn" "-zz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[31]   > Temp-Tables.tStLinje.SvinnVerdi
"tStLinje.SvinnVerdi" "V-Svinn" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[32]   > Temp-Tables.tStLinje.IntAnt
"tStLinje.IntAnt" ? "-zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[33]   > Temp-Tables.tStLinje.IntVerdi
"tStLinje.IntVerdi" "V-Internt forbruk" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[34]   > Temp-Tables.tStLinje.Diverseverdi
"tStLinje.Diverseverdi" "V-Diverse" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   > Temp-Tables.tStLinje.NedAnt
"tStLinje.NedAnt" "Nedskrevet" "-zz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[36]   > Temp-Tables.tStLinje.NedVerdi
"tStLinje.NedVerdi" "V-Nedksrevet" "-zzz,zzz,zz9" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
IF SOURCE-PROCEDURE:FILE-NAME BEGINS "w-vartkor." THEN
    ASSIGN FRAME Frame-Historikk:WIDTH = 207.8
           FRAME Frame-Historikk:HEIGHT = 23.1
           BROWSE BROWSE-Statistikk:WIDTH = 206.80.
    
  &SCOP PROCEDURE-TYPE FRAME 
  RUN enable_UI.
  {lng.i}
  ASSIGN
      COMBO-BOX-Periode:SCREEN-VALUE IN FRAME FRAME-Historikk = wPerId
      .
...
------------------------------------------------------------------------------*/
  DISPLAY COMBO-BOX-Periode FI-Filter T-Tot FILL-IN-Tekst1 
      WITH FRAME FRAME-Historikk.
  ENABLE B-Excel COMBO-BOX-Periode B-Grafikk T-Tot BROWSE-Statistikk B-Rapp 
         B-Rapp-HtmEx BUTTON-SokDato FILL-IN-Tekst1 
      WITH FRAME FRAME-Historikk.
  {&OPEN-BROWSERS-IN-QUERY-FRAME-Historikk}
  VIEW C-Win.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ASSIGN
      ...
      wDiverseVerdi = tStlinje.DiverseVerdi
  ...
  if tStLinje.PerLinNr > 999999 then
    assign
      ...
      tStLinje.DiverseAnt:bgcolor in browse BROWSE-Statistikk = if tStLinje.PerLinNr = 1000000 then 8 else 11
      tStLinje.DiverseVerdi:bgcolor in browse BROWSE-Statistikk = if tStLinje.PerLinNr = 1000000 then 8 else 11
      tStLinje.LagerVerdi:bgcolor in browse BROWSE-Statistikk = if tStLinje.PerLinNr = 1000000 then 8 else 11
  ...
  case wStTypeId:
    ...
    when "VAREGR" then
      do:
        ...
        /* Setter vindu, graf tittler og dataobjekt. */
        assign
          wDataObjekt   = string(VarGr.Vg,"999999")
      ...
      when "SELGER" then
        do:
          ...
          find Selger no-lock where 
            Recid(Selger) = wArtBasRecid no-error.
      ...
      when "AVDELING" then
        do:
          ...
          find Avdeling no-lock where 
            Recid(Avdeling) = wArtBasRecid no-error.
