...
------------------------------------------------------------------------------*/
    ...
    DO:
        ...
        FOR EACH KasValuta  NO-LOCK WHERE 
            ...
            ASSIGN cString = "KASVALUTA;" + 
                             "1;" +
                             STRING(KasValuta.ValNr) + ";" + 
                             REPLACE(REPLACE(KasValuta.ValNavn,";",""),'"'," ") + ";" + 
                             REPLACE(REPLACE(KasValuta.ValKod,";",""),'"'," ") + ";" + 
                             STRING(KasValuta.indeks) + ";" + 
                             STRING(IF KasValuta.ValAktiv THEN KasValuta.KasseValKurs ELSE 0) + ";" + 
                             STRING(KasValuta.retur) 
