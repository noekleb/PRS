...
DEFINE TEMP-TABLE tKundeType NO-UNDO LIKE KundeType.
...
&scoped-define DB-BROWSER BROWSE-KundeType

&scoped-define br-tabell KundeType
...
&scoped-define index-col1 KundeType
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-KundeType

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES KundeType tKundeType

/* Definitions for BROWSE BROWSE-KundeType                              */
&Scoped-define FIELDS-IN-QUERY-BROWSE-KundeType KundeType.TypeId ~
KundeType.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-KundeType KundeType.TypeId 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-KundeType KundeType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-KundeType KundeType
&Scoped-define OPEN-QUERY-BROWSE-KundeType OPEN QUERY BROWSE-KundeType FOR EACH KundeType NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-KundeType KundeType
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-KundeType KundeType


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tKundeType.TypeId ~
tKundeType.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tKundeType.TypeId 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tKundeType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tKundeType
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tKundeType NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tKundeType
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tKundeType


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-KundeType}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-KundeType BROWSE-Tag Btn_OK ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-KundeType FOR 
      KundeType
    FIELDS(KundeType.TypeId
      KundeType.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tKundeType
    FIELDS(tKundeType.TypeId
      tKundeType.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-KundeType
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-KundeType Dialog-Frame _STRUCTURED
  QUERY BROWSE-KundeType NO-LOCK DISPLAY
      KundeType.TypeId FORMAT "zzz9":U
      KundeType.Beskrivelse FORMAT "X(40)":U
  ENABLE
      KundeType.TypeId
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tKundeType.TypeId FORMAT "zzz9":U
      tKundeType.Beskrivelse FORMAT "X(40)":U
  ENABLE
      tKundeType.TypeId
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-KundeType AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tKundeType T "?" NO-UNDO skotex KundeType
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-KundeType 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-KundeType
/* Query rebuild information for BROWSE BROWSE-KundeType
     _TblList          = "skotex.KundeType"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.KundeType.TypeId
"TypeId" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = skotex.KundeType.Beskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-KundeType */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tKundeType"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tKundeType.TypeId
"TypeId" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tKundeType.Beskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg kundetyper */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-KundeType
&Scoped-define SELF-NAME BROWSE-KundeType
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeType Dialog-Frame
ON CURSOR-LEFT OF BROWSE-KundeType IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeType Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-KundeType IN FRAME Dialog-Frame /* ? */
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeType Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-KundeType IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeType Dialog-Frame
ON START-SEARCH OF BROWSE-KundeType IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeType Dialog-Frame
ON VALUE-CHANGED OF BROWSE-KundeType IN FRAME Dialog-Frame /* ? */
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-KundeType BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok 
         RECT-4 RECT-5 
      WITH FRAME Dialog-Frame.
