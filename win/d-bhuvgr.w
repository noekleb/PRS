...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wHg LIKE HuvGr.Hg NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wHg LIKE HuvGr.Hg NO-UNDO.
&ENDIF
...
&scoped-define ip-variabel wHg
&scoped-define return-ip   wHg = HuvGr.Hg.
&scoped-define assign-retur-verdi retur-verdi = string(Recid(HuvGr)).
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-HuvGr Btn_OK Btn_Cancel Btn_Help 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-HuvGr Dialog-Frame _STRUCTURED
  QUERY BROWSE-HuvGr NO-LOCK DISPLAY
      HuvGr.Hg COLUMN-LABEL "HG *" FORMAT ">>>>9":U
      HuvGr.HgBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(20)":U
  ENABLE
      HuvGr.Hg
      HuvGr.HgBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 43 BY 7.38 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-HuvGr AT ROW 2.91 COL 2
     Btn_OK AT ROW 10.81 COL 1.8
     Btn_Cancel AT ROW 10.81 COL 14.4
     Btn_Help AT ROW 10.81 COL 33
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste hovedgrupper"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-HuvGr BUTTON-Sok Dialog-Frame */
ASSIGN 
...
"Hg" "HG *" ">>>>9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.HuvGr.HgBeskr
"HgBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-HuvGr */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste hovedgrupper */
DO:
...
ON ANY-PRINTABLE OF BROWSE-HuvGr IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-HuvGr Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
