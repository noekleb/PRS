...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  ...
  assign
    wStrTypeId = 10.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wSoStorl   LIKE StrTStr.SoStorl   NO-UNDO.
  def    input        parameter wStrTypeId like STrTStr.StrTypeId no-undo.
&ENDIF
...
FILL-IN-SOK-CHAR BUTTON-Sok BROWSE-StrTStr Btn_Help Btn_OK Btn_Cancel 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 14 BY 7.38.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-DATE FILL-IN-SOK-INT FILL-IN-SOK-CHAR BUTTON-Sok 
         BROWSE-StrTStr Btn_Help Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
