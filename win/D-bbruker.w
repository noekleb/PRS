...
&scope InitIdx     Bruker
&scope ip-felt     Brukerid
...
&scoped-define KanSlettes 
 /*  ~
  if can-find(first Bruker where Bruker.BrGrp = Bruker.BrGrp) then ~
    do: ~
      message "Det finnes brukere med denne brukergruppen. Kan ikke slettes!" ~
      view-as alert-box title "Fel vid borttagning". ~
      return no-apply. ~
    end.
*/
&scoped-define VedlikeholdsRutine d-vbruker.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Bruker

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Bruker

/* Definitions for BROWSE BROWSE-Bruker                                 */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Bruker Bruker.BrukerID Bruker.Navn ~
Bruker.BrGrpNr Bruker.Lng Bruker.BrukerType Bruker.grad Bruker.ButikkNr ~
Bruker.EDato Bruker.RegistrertDato 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Bruker Bruker.BrukerID ~
Bruker.Navn Bruker.BrGrpNr Bruker.Lng Bruker.ButikkNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Bruker Bruker
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Bruker Bruker
&Scoped-define QUERY-STRING-BROWSE-Bruker FOR EACH Bruker NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Bruker OPEN QUERY BROWSE-Bruker FOR EACH Bruker NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Bruker Bruker
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Bruker Bruker
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Bruker Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Bruker FOR 
      Bruker SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Bruker
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Bruker Dialog-Frame _STRUCTURED
  QUERY BROWSE-Bruker NO-LOCK DISPLAY
      Bruker.BrukerID FORMAT "X(10)":U WIDTH 12.2
      Bruker.Navn FORMAT "X(40)":U WIDTH 39
      Bruker.BrGrpNr FORMAT "zz9":U
      Bruker.Lng FORMAT "X(3)":U
      Bruker.BrukerType FORMAT ">9":U
      Bruker.grad FORMAT ">9":U
      Bruker.ButikkNr FORMAT ">>>>>9":U
      Bruker.EDato FORMAT "99/99/9999":U
      Bruker.RegistrertDato FORMAT "99/99/9999":U WIDTH 17.4
  ENABLE
      Bruker.BrukerID
      Bruker.Navn
      Bruker.BrGrpNr
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 129 BY 18.81 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Bruker AT ROW 2.91 COL 2
     Btn_OK AT ROW 21.95 COL 2
     Btn_Cancel AT ROW 21.95 COL 15.2
     Btn_Help AT ROW 21.95 COL 132
     BUTTON-Ny AT ROW 2.91 COL 132
     BUTTON-Endre AT ROW 4.24 COL 132
     BUTTON-Slett AT ROW 5.57 COL 132
     SPACE(1.39) SKIP(16.47)
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Bruker BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Bruker:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Bruker
/* Query rebuild information for BROWSE BROWSE-Bruker
     _TblList          = "SkoTex.Bruker"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Bruker.BrukerID
"BrukerID" ? ? "character" ? ? ? ? ? ? yes ? no no "12.2" yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Bruker.Navn
"Navn" ? ? "character" ? ? ? ? ? ? yes ? no no "39" yes no no "U" "" ""
     _FldNameList[3]   > SkoTex.Bruker.BrGrpNr
"BrGrpNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > SkoTex.Bruker.Lng
"Lng" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[5]   = SkoTex.Bruker.BrukerType
     _FldNameList[6]   = SkoTex.Bruker.grad
     _FldNameList[7]   > SkoTex.Bruker.ButikkNr
"ButikkNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[8]   = SkoTex.Bruker.EDato
     _FldNameList[9]   > SkoTex.Bruker.RegistrertDato
"RegistrertDato" ? ? "date" ? ? ? ? ? ? no ? no no "17.4" yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Bruker */
&ANALYZE-RESUME
...
&Scoped-define BROWSE-NAME BROWSE-Bruker
&Scoped-define SELF-NAME BROWSE-Bruker
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bruker Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Bruker IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bruker Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Bruker IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bruker Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Bruker IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bruker Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Bruker IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bruker Dialog-Frame
ON HOME OF BROWSE-Bruker IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bruker Dialog-Frame
ON START-SEARCH OF BROWSE-Bruker IN FRAME Dialog-Frame
DO:
