...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wForsNr LIKE Forsalj.ForsNr NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wforsNr LIKE Forsalj.forsNr NO-UNDO.
&ENDIF
...
&scoped-define ip-variabel wForsNr
&scoped-define return-ip   wForsNr = if available {&br-tabell}  ~
...
FILL-IN-SOK-CHAR BUTTON-Sok BROWSE-Forsalj BUTTON-Ny BUTTON-Endre ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Forsalj Dialog-Frame _STRUCTURED
  QUERY BROWSE-Forsalj NO-LOCK DISPLAY
      Forsalj.ForsNr COLUMN-LABEL "Selger *" FORMAT ">>>>>9":U
      Forsalj.FoNamn COLUMN-LABEL "Navn *" FORMAT "x(30)":U
      Forsalj.FoTel FORMAT "x(15)":U
      Forsalj.FoAdr FORMAT "x(30)":U WIDTH 30.2
  ENABLE
      Forsalj.ForsNr
      Forsalj.FoNamn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 89 BY 13.1 ROW-HEIGHT-CHARS .62.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Forsalj AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 2.91 COL 92
     BUTTON-Endre AT ROW 4.24 COL 92
     BUTTON-Slett AT ROW 5.57 COL 92
     Btn_OK AT ROW 16.48 COL 2
     Btn_Cancel AT ROW 16.48 COL 15
     Btn_Help AT ROW 16.48 COL 92
     SPACE(0.39) SKIP(0.13)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste kasserere"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Forsalj BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Forsalj:NUM-LOCKED-COLUMNS IN FRAME Dialog-Frame     = 2.
...
"Forsalj.ForsNr" "Selger *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Forsalj.FoNamn
"Forsalj.FoNamn" "Navn *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   = skotex.Forsalj.FoTel
     _FldNameList[4]   > skotex.Forsalj.FoAdr
"Forsalj.FoAdr" ? ? "character" ? ? ? ? ? ? no ? no no "30.2" yes no no "U" "" ""
     _Query            is OPENED
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste kasserere */
DO:
...
ON ANY-PRINTABLE OF BROWSE-Forsalj IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-DATE FILL-IN-SOK-INT FILL-IN-SOK-CHAR BUTTON-Sok 
         BROWSE-Forsalj BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
