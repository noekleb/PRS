...
&scoped-define br-tabell TeamType
&scoped-define KeyFelt TeamTypeId
...
&scoped-define VisPoster {&br-tabell}.Beskrivelse when available {&br-tabell} ~
...
/* Ved sletting - Sjekker om posten kan opprettes */
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
          if {&br-tabell}.{&KeyFelt}:screen-value = "" then ~
            message "{&KeyFelt} må ikke være blank" ~
            view-as alert-box title "Lagringsfeil". ~
          else ~
            message "{&br-tabell} finnes allerede med id:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame TeamType.TeamTypeId ~
TeamType.Beskrivelse TeamType.Notat 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame TeamType.TeamTypeId ~
TeamType.Beskrivelse TeamType.Notat 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame TeamType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame TeamType
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH TeamType SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame TeamType
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame TeamType


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS TeamType.TeamTypeId TeamType.Beskrivelse ~
TeamType.Notat 
&Scoped-define ENABLED-TABLES TeamType
&Scoped-define FIRST-ENABLED-TABLE TeamType
&Scoped-define DISPLAYED-TABLES TeamType
&Scoped-define FIRST-DISPLAYED-TABLE TeamType
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help RECT-1 
&Scoped-Define DISPLAYED-FIELDS TeamType.TeamTypeId TeamType.Beskrivelse ~
TeamType.Notat 
...
DEFINE FRAME Dialog-Frame
     TeamType.TeamTypeId AT ROW 4.33 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     TeamType.Beskrivelse AT ROW 5.33 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
     TeamType.Notat AT ROW 6.33 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
...
------------------------------------------------------------------------------*/
  IF AVAILABLE TeamType THEN 
    DISPLAY TeamType.TeamTypeId TeamType.Beskrivelse TeamType.Notat 
      WITH FRAME Dialog-Frame.
  ENABLE TeamType.TeamTypeId TeamType.Beskrivelse TeamType.Notat Btn_OK 
