...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wAnv-Id LIKE Anv-Kod.anv-Id NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wAnv-Id LIKE Anv-Kod.Anv-Id NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   Anv-Kod

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  anv-Id
...
&scoped-define index-col1  Anv-Kod
...
&scoped-define sok-field2  AnvBeskr
...
&scoped-define index-col2  Anv-Beskr
...
&scoped-define ip-variabel wAnv-Id
&scoped-define return-ip   wAnv-Id = Anv-Kod.Anv-Id.
&scoped-define assign-retur-verdi retur-verdi = string(recid(Anv-Kod)).
...
&scoped-define KanSlettes ~
  if can-find(first ArtBas where ArtBas.Anv-Id = Anv-Kod.Anv-Id) then ~
    do: ~
...
&scoped-define VedlikeholdsRutine d-vanvkod.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Anv-Kod

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Anv-Kod

/* Definitions for BROWSE BROWSE-Anv-Kod                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Anv-Kod Anv-Kod.Anv-Id ~
Anv-Kod.AnvBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Anv-Kod Anv-Kod.Anv-Id ~
Anv-Kod.AnvBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Anv-Kod Anv-Kod
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Anv-Kod Anv-Kod
&Scoped-define QUERY-STRING-BROWSE-Anv-Kod FOR EACH Anv-Kod NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Anv-Kod OPEN QUERY BROWSE-Anv-Kod FOR EACH Anv-Kod NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Anv-Kod Anv-Kod
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Anv-Kod Anv-Kod


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Anv-Kod}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-INT FILL-IN-SOK-DATE ~
FILL-IN-SOK-CHAR BUTTON-Sok BROWSE-Anv-Kod BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Anv-Kod FOR 
      Anv-Kod SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Anv-Kod
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Anv-Kod Dialog-Frame _STRUCTURED
  QUERY BROWSE-Anv-Kod NO-LOCK DISPLAY
      Anv-Kod.Anv-Id COLUMN-LABEL "Anv.kode *" FORMAT "z9":U
      Anv-Kod.AnvBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(30)":U
  ENABLE
      Anv-Kod.Anv-Id
      Anv-Kod.AnvBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 45.6 BY 7.71.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Anv-Kod AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 3 COL 48.4
     BUTTON-Endre AT ROW 4.33 COL 48.4
     BUTTON-Slett AT ROW 5.67 COL 48.4
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     Btn_Help AT ROW 10.81 COL 48.4
     SPACE(0.39) SKIP(0.04)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste anvendelseskoder"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Anv-Kod BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Anv-Kod
/* Query rebuild information for BROWSE BROWSE-Anv-Kod
     _TblList          = "SkoTex.Anv-Kod"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Anv-Kod.Anv-Id
"Anv-Kod.Anv-Id" "Anv.kode *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Anv-Kod.AnvBeskr
"Anv-Kod.AnvBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Anv-Kod */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste anvendelseskoder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Anv-Kod
&Scoped-define SELF-NAME BROWSE-Anv-Kod
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Anv-Kod Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Anv-Kod IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Anv-Kod Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Anv-Kod IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Anv-Kod Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Anv-Kod IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Anv-Kod Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Anv-Kod IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Anv-Kod Dialog-Frame
ON START-SEARCH OF BROWSE-Anv-Kod IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
{syspara.i 16 23 2 iTilgang INT}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-INT FILL-IN-SOK-DATE FILL-IN-SOK-CHAR BUTTON-Sok 
         BROWSE-Anv-Kod BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
