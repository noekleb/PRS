...
DEFINE SHARED TEMP-TABLE tmpLevBas NO-UNDO LIKE LevBas.
DEFINE TEMP-TABLE ttmpLevBas NO-UNDO LIKE LevBas.
...
&scoped-define DB-BROWSER BROWSE-tmpLevBas

&scoped-define br-tabell tmpLevBas

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  LevNr                
...
&scoped-define index-col1 LevIn
...
&scoped-define sok-field2  LevNamn              
...
&scoped-define index-col2 LevNamn
...
&scoped-define BUFFER-COPY-USING USING LevNamn
...
&Scoped-define INTERNAL-TABLES ttmpLevBas tmpLevBas

/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag ttmpLevBas.levnr ~
ttmpLevBas.levnamn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag ttmpLevBas.levnr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag ttmpLevBas
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag ttmpLevBas
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH ttmpLevBas NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag ttmpLevBas
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag ttmpLevBas


/* Definitions for BROWSE BROWSE-tmpLevBas                              */
&Scoped-define FIELDS-IN-QUERY-BROWSE-tmpLevBas tmpLevBas.levnr ~
tmpLevBas.levnamn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-tmpLevBas tmpLevBas.levnr ~
tmpLevBas.levnamn 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-tmpLevBas tmpLevBas
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-tmpLevBas tmpLevBas
&Scoped-define OPEN-QUERY-BROWSE-tmpLevBas OPEN QUERY BROWSE-tmpLevBas FOR EACH tmpLevBas NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-tmpLevBas tmpLevBas
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-tmpLevBas tmpLevBas


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-tmpLevBas}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 BROWSE-tmpLevBas BROWSE-Tag ~
...
DEFINE QUERY BROWSE-Tag FOR 
      ttmpLevBas
    FIELDS(ttmpLevBas.levnr
      ttmpLevBas.levnamn) SCROLLING.

DEFINE QUERY BROWSE-tmpLevBas FOR 
      tmpLevBas
    FIELDS(tmpLevBas.levnr
      tmpLevBas.levnamn) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      ttmpLevBas.levnr COLUMN-LABEL "LevNr" FORMAT "zzzzz9"
      ttmpLevBas.levnamn COLUMN-LABEL "Navn" FORMAT "x(30)" WIDTH 31
  ENABLE
      ttmpLevBas.levnr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE BROWSE BROWSE-tmpLevBas
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-tmpLevBas Dialog-Frame _STRUCTURED
  QUERY BROWSE-tmpLevBas NO-LOCK DISPLAY
      tmpLevBas.levnr COLUMN-LABEL "LevNr *" FORMAT "zzzzz9"
      tmpLevBas.levnamn COLUMN-LABEL "Navn *" FORMAT "x(30)"
  ENABLE
      tmpLevBas.levnr
      tmpLevBas.levnamn
/* _UIB-CODE-BLOCK-END */
...
DEFINE FRAME Dialog-Frame
     BROWSE-tmpLevBas AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tmpLevBas T "SHARED" NO-UNDO skotex LevBas
      TABLE: ttmpLevBas T "?" NO-UNDO skotex LevBas
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-tmpLevBas 1 Dialog-Frame */
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.ttmpLevBas"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.ttmpLevBas.levnr
"ttmpLevBas.levnr" "LevNr" "zzzzz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.ttmpLevBas.levnamn
"ttmpLevBas.levnamn" "Navn" "x(30)" "character" ? ? ? ? ? ? no ? no no "31"
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Tag */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-tmpLevBas
/* Query rebuild information for BROWSE BROWSE-tmpLevBas
     _TblList          = "Temp-Tables.tmpLevBas"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tmpLevBas.levnr
"tmpLevBas.levnr" "LevNr *" "zzzzz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.tmpLevBas.levnamn
"tmpLevBas.levnamn" "Navn *" "x(30)" "character" ? ? ? ? ? ? yes ? no no ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-tmpLevBas */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg leverandører */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-tmpLevBas
&Scoped-define SELF-NAME BROWSE-tmpLevBas
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpLevBas Dialog-Frame
ON CURSOR-LEFT OF BROWSE-tmpLevBas IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpLevBas Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-tmpLevBas IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpLevBas Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-tmpLevBas IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpLevBas Dialog-Frame
ON START-SEARCH OF BROWSE-tmpLevBas IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpLevBas Dialog-Frame
ON VALUE-CHANGED OF BROWSE-tmpLevBas IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-4 RECT-5 BROWSE-tmpLevBas BROWSE-Tag Btn_OK Btn_Cancel Btn_Help 
         BUTTON-Sok 
      WITH FRAME Dialog-Frame.
