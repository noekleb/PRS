...
&scoped-define VisPoster ~
  SlitSula.Slit-Id when available SlitSula ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame SlitSula.Slit-Id ~
SlitSula.SlitBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame SlitSula.Slit-Id ~
SlitSula.SlitBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame SlitSula
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame SlitSula
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH SlitSula SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame SlitSula
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame SlitSula


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS SlitSula.Slit-Id SlitSula.SlitBeskr 
&Scoped-define ENABLED-TABLES SlitSula
&Scoped-define FIRST-ENABLED-TABLE SlitSula
&Scoped-define DISPLAYED-TABLES SlitSula
&Scoped-define FIRST-DISPLAYED-TABLE SlitSula
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS SlitSula.Slit-Id SlitSula.SlitBeskr 
...
DEFINE FRAME Dialog-Frame
     SlitSula.Slit-Id AT ROW 1.86 COL 10.8 COLON-ALIGNED
          LABEL "Slitesåle"
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     SlitSula.SlitBeskr AT ROW 1.86 COL 15.6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* SETTINGS FOR FILL-IN SlitSula.Slit-Id IN FRAME Dialog-Frame
   EXP-LABEL                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold overdel */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE SlitSula THEN 
    DISPLAY SlitSula.Slit-Id SlitSula.SlitBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 SlitSula.Slit-Id SlitSula.SlitBeskr Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
