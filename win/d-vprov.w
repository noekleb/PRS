...
&scoped-define VisPoster ~
  Prov.ProvKod when available Prov ~
  Prov.ProvProc when available Prov ~
  Prov.ProvBeskr when available Prov
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
            message "{&br-tabell} finnes allerede med provisjonskode:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Prov.ProvKod Prov.ProvProc ~
Prov.ProvBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Prov.ProvKod ~
Prov.ProvProc Prov.ProvBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Prov
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Prov
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Prov SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Prov
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Prov


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Prov.ProvKod Prov.ProvProc Prov.ProvBeskr 
&Scoped-define ENABLED-TABLES Prov
&Scoped-define FIRST-ENABLED-TABLE Prov
&Scoped-define DISPLAYED-TABLES Prov
&Scoped-define FIRST-DISPLAYED-TABLE Prov
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help RECT-1 
&Scoped-Define DISPLAYED-FIELDS Prov.ProvKod Prov.ProvProc Prov.ProvBeskr 
...
DEFINE FRAME Dialog-Frame
     Prov.ProvKod AT ROW 1.86 COL 11.8 COLON-ALIGNED
          LABEL "Provisjon"
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Prov.ProvProc AT ROW 1.86 COL 17 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     Prov.ProvBeskr AT ROW 1.86 COL 26.2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
/* SETTINGS FOR FILL-IN Prov.ProvKod IN FRAME Dialog-Frame
   EXP-LABEL                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold provisjon */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Prov THEN 
    DISPLAY Prov.ProvKod Prov.ProvProc Prov.ProvBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE Prov.ProvKod Prov.ProvProc Prov.ProvBeskr Btn_OK Btn_Cancel Btn_Help 
         RECT-1 
      WITH FRAME Dialog-Frame.
