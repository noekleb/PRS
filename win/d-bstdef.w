...
&scoped-define index-col1  StDef
...
&scoped-define return-ip   wStTypeId = if available StDef ~
                                          then StDef.StTypeId ~
                                          else "".
...
&scoped-define VedlikeholdsRutine d-vstdef.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-StDef

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES StDef

/* Definitions for BROWSE BROWSE-StDef                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-StDef StDef.StTypeId StDef.PerId ~
StDef.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-StDef 
&Scoped-define OPEN-QUERY-BROWSE-StDef OPEN QUERY BROWSE-StDef FOR EACH StDef NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-StDef StDef
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-StDef StDef


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-StDef}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-INT FILL-IN-SOK-CHAR ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-StDef BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-StDef FOR 
      StDef SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-StDef
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-StDef Dialog-Frame _STRUCTURED
  QUERY BROWSE-StDef NO-LOCK DISPLAY
      StDef.StTypeId COLUMN-LABEL "StTypeId *" WIDTH 14.2
      StDef.PerId WIDTH 13
      StDef.Beskrivelse WIDTH 38
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 72 BY 17.1 ROW-HEIGHT-CHARS .76.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-StDef AT ROW 2.71 COL 2
     BUTTON-Ny AT ROW 2.91 COL 75.2
     BUTTON-Endre AT ROW 4.24 COL 75.2
     BUTTON-Slett AT ROW 5.57 COL 75.2
     Btn_OK AT ROW 20.29 COL 2
     Btn_Cancel AT ROW 20.29 COL 14.4
     Btn_Help AT ROW 20.29 COL 75
     SPACE(0.39) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste statistikkdefinisjoner"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-StDef BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-StDef
/* Query rebuild information for BROWSE BROWSE-StDef
     _TblList          = "SkoTex.StDef"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.StDef.StTypeId
"StDef.StTypeId" "StTypeId *" ? "character" ? ? ? ? ? ? no ? no no "14.2"
     _FldNameList[2]   > SkoTex.StDef.PerId
"StDef.PerId" ? ? "character" ? ? ? ? ? ? no ? no no "13"
     _FldNameList[3]   > SkoTex.StDef.Beskrivelse
"StDef.Beskrivelse" ? ? "character" ? ? ? ? ? ? no ? no no "38"
     _Query            is OPENED
*/  /* BROWSE BROWSE-StDef */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste statistikkdefinisjoner */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-StDef
&Scoped-define SELF-NAME BROWSE-StDef
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StDef Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-StDef IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StDef Dialog-Frame
ON CURSOR-LEFT OF BROWSE-StDef IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StDef Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-StDef IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StDef Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-StDef IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StDef Dialog-Frame
ON START-SEARCH OF BROWSE-StDef IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-INT FILL-IN-SOK-CHAR FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-StDef BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
