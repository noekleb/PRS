...
DEFINE TEMP-TABLE tKommune NO-UNDO LIKE Kommune.
...
&scoped-define DB-BROWSER BROWSE-Kommune

&scoped-define br-tabell Kommune

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1 KommNr
...
&scoped-define index-col1 KommNr
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Kommune

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Kommune tKommune

/* Definitions for BROWSE BROWSE-Kommune                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Kommune Kommune.KommNr ~
Kommune.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Kommune Kommune.KommNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Kommune Kommune
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Kommune Kommune
&Scoped-define OPEN-QUERY-BROWSE-Kommune OPEN QUERY BROWSE-Kommune FOR EACH Kommune NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Kommune Kommune
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Kommune Kommune


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tKommune.KommNr ~
tKommune.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tKommune.KommNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tKommune
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tKommune
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tKommune NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tKommune
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tKommune


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Kommune}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Kommune BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Kommune FOR 
      Kommune
    FIELDS(Kommune.KommNr
      Kommune.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tKommune
    FIELDS(tKommune.KommNr
      tKommune.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Kommune
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Kommune Dialog-Frame _STRUCTURED
  QUERY BROWSE-Kommune NO-LOCK DISPLAY
      Kommune.KommNr FORMAT "X(8)":U
      Kommune.Beskrivelse FORMAT "X(30)":U
  ENABLE
      Kommune.KommNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tKommune.KommNr FORMAT "X(8)":U
      tKommune.Beskrivelse FORMAT "X(30)":U
  ENABLE
      tKommune.KommNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-Kommune AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tKommune T "?" NO-UNDO skotex Kommune
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Kommune 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Kommune
/* Query rebuild information for BROWSE BROWSE-Kommune
     _TblList          = "skotex.Kommune"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.Kommune.KommNr
"KommNr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = skotex.Kommune.Beskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-Kommune */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tKommune"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tKommune.KommNr
"KommNr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tKommune.Beskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg kommuner */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Kommune
&Scoped-define SELF-NAME BROWSE-Kommune
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kommune Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Kommune IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kommune Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Kommune IN FRAME Dialog-Frame /* ? */
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kommune Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Kommune IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kommune Dialog-Frame
ON START-SEARCH OF BROWSE-Kommune IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kommune Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Kommune IN FRAME Dialog-Frame /* ? */
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Kommune BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
