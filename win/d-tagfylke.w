...
DEFINE TEMP-TABLE tFylke NO-UNDO LIKE Fylke.
...
&scoped-define DB-BROWSER BROWSE-Fylke

&scoped-define br-tabell Fylke

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1 FylkesNr
...
&scoped-define index-col1 Fylke
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Fylke

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Fylke tFylke

/* Definitions for BROWSE BROWSE-Fylke                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Fylke Fylke.FylkesNr ~
Fylke.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Fylke Fylke.FylkesNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Fylke Fylke
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Fylke Fylke
&Scoped-define OPEN-QUERY-BROWSE-Fylke OPEN QUERY BROWSE-Fylke FOR EACH Fylke NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Fylke Fylke
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Fylke Fylke


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tFylke.FylkesNr ~
tFylke.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tFylke.FylkesNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tFylke
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tFylke
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tFylke NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tFylke
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tFylke


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Fylke}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Fylke BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Fylke FOR 
      Fylke
    FIELDS(Fylke.FylkesNr
      Fylke.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tFylke
    FIELDS(tFylke.FylkesNr
      tFylke.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Fylke
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Fylke Dialog-Frame _STRUCTURED
  QUERY BROWSE-Fylke NO-LOCK DISPLAY
      Fylke.FylkesNr FORMAT "X(8)":U
      Fylke.Beskrivelse FORMAT "X(30)":U
  ENABLE
      Fylke.FylkesNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tFylke.FylkesNr FORMAT "X(8)":U
      tFylke.Beskrivelse FORMAT "X(30)":U
  ENABLE
      tFylke.FylkesNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-Fylke AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tFylke T "?" NO-UNDO skotex Fylke
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Fylke 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Fylke
/* Query rebuild information for BROWSE BROWSE-Fylke
     _TblList          = "skotex.Fylke"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.Fylke.FylkesNr
"FylkesNr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = skotex.Fylke.Beskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-Fylke */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tFylke"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tFylke.FylkesNr
"FylkesNr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tFylke.Beskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg fylker */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Fylke
&Scoped-define SELF-NAME BROWSE-Fylke
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Fylke Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Fylke IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Fylke Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Fylke IN FRAME Dialog-Frame /* ? */
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Fylke Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Fylke IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Fylke Dialog-Frame
ON START-SEARCH OF BROWSE-Fylke IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Fylke Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Fylke IN FRAME Dialog-Frame /* ? */
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Fylke BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
