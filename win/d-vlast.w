...
&scoped-define VisPoster ~
  Last-Sko.Last-Id when available Last-Sko ~
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
            message "{&br-tabell} finnes allerede med lastnr:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Last-Sko.Last-Id ~
Last-Sko.LastBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Last-Sko.Last-Id ~
Last-Sko.LastBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Last-Sko
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Last-Sko
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Last-Sko SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Last-Sko
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Last-Sko


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Last-Sko.Last-Id Last-Sko.LastBeskr 
&Scoped-define ENABLED-TABLES Last-Sko
&Scoped-define FIRST-ENABLED-TABLE Last-Sko
&Scoped-define DISPLAYED-TABLES Last-Sko
&Scoped-define FIRST-DISPLAYED-TABLE Last-Sko
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS Last-Sko.Last-Id Last-Sko.LastBeskr 
...
DEFINE FRAME Dialog-Frame
     Last-Sko.Last-Id AT ROW 2.05 COL 9.6 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Last-Sko.LastBeskr AT ROW 2.05 COL 15 COLON-ALIGNED NO-LABEL FORMAT "x(200)"
          VIEW-AS FILL-IN 
          SIZE 36.2 BY 1
     Btn_OK AT ROW 4.05 COL 2.6
     Btn_Cancel AT ROW 4.05 COL 18.2
     Btn_Help AT ROW 4.05 COL 40.8
     RECT-1 AT ROW 1.38 COL 2
     SPACE(1.19) SKIP(1.70)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold anvendelseskoder"
...
/* SETTINGS FOR FILL-IN Last-Sko.LastBeskr IN FRAME Dialog-Frame
   EXP-FORMAT                                                           */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold anvendelseskoder */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Last-Sko THEN 
    DISPLAY Last-Sko.Last-Id Last-Sko.LastBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 Last-Sko.Last-Id Last-Sko.LastBeskr Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
