...
DEFINE TEMP-TABLE ttVaruomradeAlla NO-UNDO LIKE Regnskapsavdeling.
DEFINE TEMP-TABLE ttVaruomradeVald NO-UNDO LIKE Regnskapsavdeling.
...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR dArtikkelnr AS DECI  NO-UNDO.
&ELSE
  DEFINE INPUT PARAMETER dArtikkelnr AS DECI  NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define DB-BROWSER BROWSE-HuvGr

&scoped-define br-tabell ttVaruomradeAlla

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  RavdNr
...
&scoped-define index-col1  RAvdNr
...
/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field2  RAvdBeskrivelse
...
&scoped-define index-col2  RAvdBeskrivelse
...
&scoped-define BUFFER-COPY-USING USING HgBeskr
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-HuvGr

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES ttVaruomradeAlla ttVaruomradeVald

/* Definitions for BROWSE BROWSE-HuvGr                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-HuvGr ttVaruomradeAlla.RAvdNr ~
ttVaruomradeAlla.RAvdBeskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-HuvGr 
&Scoped-define QUERY-STRING-BROWSE-HuvGr FOR EACH ttVaruomradeAlla NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-HuvGr OPEN QUERY BROWSE-HuvGr FOR EACH ttVaruomradeAlla NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-HuvGr ttVaruomradeAlla
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-HuvGr ttVaruomradeAlla


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag ttVaruomradeVald.RAvdNr ~
ttVaruomradeVald.RAvdBeskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag 
&Scoped-define QUERY-STRING-BROWSE-Tag FOR EACH ttVaruomradeVald NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH ttVaruomradeVald NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag ttVaruomradeVald
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag ttVaruomradeVald


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-HuvGr}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-HuvGr BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-HuvGr FOR 
      ttVaruomradeAlla
    FIELDS(ttVaruomradeAlla.RAvdNr
      ttVaruomradeAlla.RAvdBeskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      ttVaruomradeVald
    FIELDS(ttVaruomradeVald.RAvdNr
      ttVaruomradeVald.RAvdBeskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-HuvGr
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-HuvGr Dialog-Frame _STRUCTURED
  QUERY BROWSE-HuvGr NO-LOCK DISPLAY
      ttVaruomradeAlla.RAvdNr FORMAT ">>9":U
      ttVaruomradeAlla.RAvdBeskrivelse FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      ttVaruomradeVald.RAvdNr FORMAT ">>9":U
      ttVaruomradeVald.RAvdBeskrivelse FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 39 BY 12.19 ROW-HEIGHT-CHARS .62 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-HuvGr AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: ttVaruomradeAlla T "?" NO-UNDO SkoTex Regnskapsavdeling
      TABLE: ttVaruomradeVald T "?" NO-UNDO SkoTex Regnskapsavdeling
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   FRAME-NAME Custom                                                    */
/* BROWSE-TAB BROWSE-HuvGr 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-HuvGr
/* Query rebuild information for BROWSE BROWSE-HuvGr
     _TblList          = "Temp-Tables.ttVaruomradeAlla"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   = Temp-Tables.ttVaruomradeAlla.RAvdNr
     _FldNameList[2]   = Temp-Tables.ttVaruomradeAlla.RAvdBeskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-HuvGr */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.ttVaruomradeVald"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   = Temp-Tables.ttVaruomradeVald.RAvdNr
     _FldNameList[2]   = Temp-Tables.ttVaruomradeVald.RAvdBeskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Välj varuområde */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-HuvGr
&Scoped-define SELF-NAME BROWSE-HuvGr
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-HuvGr Dialog-Frame
ON CURSOR-LEFT OF BROWSE-HuvGr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-HuvGr Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-HuvGr IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-HuvGr Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-HuvGr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-HuvGr Dialog-Frame
ON START-SEARCH OF BROWSE-HuvGr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-HuvGr Dialog-Frame
ON VALUE-CHANGED OF BROWSE-HuvGr IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-HuvGr BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
