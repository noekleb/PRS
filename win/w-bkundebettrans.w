...
/* Parameters Definitions ---                                           */
&scope br-tabell   KundeBetTrans
&scope Sorttype    ,,,,,,
&scope BrowseIdx   KundeBetTrans,DatoTid,Belop,ForsNr,KortNr,Medlems,BatchLogg
&scope Sokvillkor  >=,>=,>=,>=,>=,>=,>=
&scope InitIdx     DatoTid
&scope ip-felt     Dato
...
&scope QWhere ~
      'KundeBetTrans.KundeNr = ' + string(Kunde.KundeNr) + ' XWHERE '
...
DEF    VAR cInfo             AS CHAR  FORMAT "x(30)" NO-UNDO.
...
&Scoped-define BROWSE-NAME BROWSE-KundeBetTrans
&Scoped-define QUERY-NAME QUERY-Alle

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES KundeBetTrans bKundeBetTrans tmpKunde2

/* Definitions for BROWSE BROWSE-KundeBetTrans                          */
&Scoped-define FIELDS-IN-QUERY-BROWSE-KundeBetTrans KundeBetTrans.Butik ~
KundeBetTrans.TTId wTypeBeskr KundeBetTrans.Dato KundeBetTrans.MotPostert ~
KundeBetTrans.Belop KundeBetTrans.ForsNr KundeBetTrans.KortNr ~
KundeBetTrans.MedlemsNr KundeBetTrans.KundeNr cInfo KundeBetTrans.RefNr ~
KundeBetTrans.RefTekst KundeBetTrans.RegistrertDato ~
KundeBetTrans.RegistrertAv KundeBetTrans.BatchNr KundeBetTrans.TransNr cKl 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-KundeBetTrans ~
KundeBetTrans.Butik KundeBetTrans.Dato KundeBetTrans.Belop ~
KundeBetTrans.ForsNr KundeBetTrans.MedlemsNr KundeBetTrans.BatchNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-KundeBetTrans KundeBetTrans
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-KundeBetTrans KundeBetTrans
&Scoped-define QUERY-STRING-BROWSE-KundeBetTrans FOR EACH KundeBetTrans NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-KundeBetTrans OPEN QUERY BROWSE-KundeBetTrans FOR EACH KundeBetTrans NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-KundeBetTrans KundeBetTrans
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-KundeBetTrans KundeBetTrans
...
&Scoped-define QUERY-STRING-QUERY-Alle FOR EACH bKundeBetTrans NO-LOCK where   KundeBetTrans.KundeNr = Kunde.KundeNr BY KundeNr BY TransNr
&Scoped-define OPEN-QUERY-QUERY-Alle OPEN QUERY {&SELF-NAME} FOR EACH bKundeBetTrans NO-LOCK where   KundeBetTrans.KundeNr = Kunde.KundeNr BY KundeNr BY TransNr.
&Scoped-define TABLES-IN-QUERY-QUERY-Alle bKundeBetTrans
&Scoped-define FIRST-TABLE-IN-QUERY-QUERY-Alle bKundeBetTrans
...
&Scoped-Define ENABLED-OBJECTS RECT-51 RECT-52 B-Oppdater B-VisTrans ~
FILL-IN-SOK-DATE FILL-IN-SOK-DECI FILL-IN-SOK-CHAR FILL-IN-SOK-INTE CB-TTId ~
BUTTON-Sok BROWSE-KundeBetTrans B-Ny B-Endre B-Slett 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-SOK-DATE FILL-IN-SOK-DECI ~
FILL-IN-SOK-CHAR FILL-IN-SOK-INTE CB-TTId 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-KundeBetTrans FOR 
      KundeBetTrans SCROLLING.

DEFINE QUERY QUERY-Alle FOR 
      bKundeBetTrans SCROLLING.
...
/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-KundeBetTrans
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-KundeBetTrans C-Win _STRUCTURED
  QUERY BROWSE-KundeBetTrans NO-LOCK DISPLAY
      KundeBetTrans.Butik FORMAT ">>>>>9":U
      KundeBetTrans.TTId COLUMN-LABEL "TTId" FORMAT "zz9":U WIDTH 5
      wTypeBeskr COLUMN-LABEL "TransType" FORMAT "x(70)":U WIDTH 17
      KundeBetTrans.Dato FORMAT "99/99/9999":U
      KundeBetTrans.MotPostert FORMAT "*/":U
      KundeBetTrans.Belop FORMAT "-zz,zzz,zz9.99":U
      KundeBetTrans.ForsNr FORMAT ">>>>>9":U
      KundeBetTrans.KortNr FORMAT "X(22)":U
      KundeBetTrans.MedlemsNr FORMAT ">>>>>>>>>>>>9":U
      KundeBetTrans.KundeNr FORMAT ">>>>>>>>>>>>9":U
      cInfo COLUMN-LABEL "Referanse" WIDTH 30
      KundeBetTrans.RefNr FORMAT "->,>>>,>>9":U
      KundeBetTrans.RefTekst FORMAT "X(40)":U
      KundeBetTrans.RegistrertDato FORMAT "99/99/9999":U
      KundeBetTrans.RegistrertAv FORMAT "X(10)":U
      KundeBetTrans.BatchNr FORMAT "zzzzzzzz9":U
      KundeBetTrans.TransNr COLUMN-LABEL "TransNr" FORMAT "zz,zzz,zz9":U
            WIDTH 11
      cKl COLUMN-LABEL "Kl" WIDTH 9
  ENABLE
      KundeBetTrans.Butik
      KundeBetTrans.Dato
      KundeBetTrans.Belop
      ...
      KundeBetTrans.BatchNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-ROW-MARKERS SIZE 129 BY 15.48 ROW-HEIGHT-CHARS .67 EXPANDABLE.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     BROWSE-KundeBetTrans AT ROW 2.91 COL 1
     B-Ny AT ROW 3 COL 131
     B-Endre AT ROW 4.19 COL 131
     B-Slett AT ROW 5.38 COL 131
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
                                                                        */
/* BROWSE-TAB BROWSE-KundeBetTrans BUTTON-Sok DEFAULT-FRAME */
ASSIGN 
       FRAME DEFAULT-FRAME:HIDDEN           = TRUE.

ASSIGN 
       B-Endre:HIDDEN IN FRAME DEFAULT-FRAME           = TRUE.

ASSIGN 
       B-Slett:HIDDEN IN FRAME DEFAULT-FRAME           = TRUE.

ASSIGN 
       BROWSE-KundeBetTrans:NUM-LOCKED-COLUMNS IN FRAME DEFAULT-FRAME     = 3
       BROWSE-KundeBetTrans:MAX-DATA-GUESS IN FRAME DEFAULT-FRAME         = 481
       BROWSE-KundeBetTrans:COLUMN-RESIZABLE IN FRAME DEFAULT-FRAME       = TRUE.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-KundeBetTrans
/* Query rebuild information for BROWSE BROWSE-KundeBetTrans
     _TblList          = "SkoTex.KundeBetTrans"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.KundeBetTrans.Butik
"KundeBetTrans.Butik" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.KundeBetTrans.TTId
"KundeBetTrans.TTId" "TTId" ? "integer" ? ? ? ? ? ? no ? no no "5" yes no no "U" "" ""
     _FldNameList[3]   > "_<CALC>"
"wTypeBeskr" "TransType" "x(70)" ? ? ? ? ? ? ? no ? no no "17" yes no no "U" "" ""
     _FldNameList[4]   > SkoTex.KundeBetTrans.Dato
"KundeBetTrans.Dato" ? ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > SkoTex.KundeBetTrans.MotPostert
"KundeBetTrans.MotPostert" ? "*~~/" "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > SkoTex.KundeBetTrans.Belop
"KundeBetTrans.Belop" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[7]   > SkoTex.KundeBetTrans.ForsNr
"KundeBetTrans.ForsNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[8]   = SkoTex.KundeBetTrans.KortNr
     _FldNameList[9]   > SkoTex.KundeBetTrans.MedlemsNr
"KundeBetTrans.MedlemsNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[10]   = SkoTex.KundeBetTrans.KundeNr
     _FldNameList[11]   > "_<CALC>"
"cInfo" "Referanse" ? ? ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
     _FldNameList[12]   = SkoTex.KundeBetTrans.RefNr
     _FldNameList[13]   = SkoTex.KundeBetTrans.RefTekst
     _FldNameList[14]   = SkoTex.KundeBetTrans.RegistrertDato
     _FldNameList[15]   = SkoTex.KundeBetTrans.RegistrertAv
     _FldNameList[16]   > SkoTex.KundeBetTrans.BatchNr
"KundeBetTrans.BatchNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[17]   > SkoTex.KundeBetTrans.TransNr
"KundeBetTrans.TransNr" "TransNr" ? "integer" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" ""
     _FldNameList[18]   > "_<CALC>"
"cKl" "Kl" ? ? ? ? ? ? ? ? no ? no no "9" yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-KundeBetTrans */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK QUERY QUERY-Alle
/* Query rebuild information for QUERY QUERY-Alle
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH bKundeBetTrans NO-LOCK where
  KundeBetTrans.KundeNr = Kunde.KundeNr BY KundeNr BY TransNr.
     _END_FREEFORM
...
ON CHOOSE OF B-Endre IN FRAME DEFAULT-FRAME /* Endre... */
DO:
    IF NOT AVAILABLE {&br-tabell} THEN
        RETURN.
    assign
      wRecid = recid({&br-tabell}).
    run d-vkundebettrans.w (input-output wRecid,(IF AVAILABLE Kunde
                                                   THEN Kunde.KundeNr
                                                   ELSE ?), "ENDRE").
...
ON CHOOSE OF B-Ny IN FRAME DEFAULT-FRAME /* Ny betaling... */
DO:
  LOOPEN:
  DO WHILE TRUE:
    assign 
    ...
    FIND bKundeBetTrans NO-LOCK WHERE
        RECID(bKundeBetTrans) = wRecid NO-ERROR.
    wBlank = ?.
    RUN SD-Reposition.
    wBlank = false.
...
DO:
  if not available KundeBetTrans then
    return no-apply.
    
  /* Kall til rutine for visning av transaksjon. */
  RUN gviskvittokopi.w (KundeBetTrans.Butik,1,KundeBetTrans.KassaNr,KundeBetTrans.Dato,KundeBetTrans.BongId).
  RETURN NO-APPLY.
END.
...
&Scoped-define BROWSE-NAME BROWSE-KundeBetTrans
&Scoped-define SELF-NAME BROWSE-KundeBetTrans
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeBetTrans C-Win
ON ANY-PRINTABLE OF BROWSE-KundeBetTrans IN FRAME DEFAULT-FRAME
DO:
  if lastkey <> 32 then
    do:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeBetTrans C-Win
ON CURSOR-LEFT OF BROWSE-KundeBetTrans IN FRAME DEFAULT-FRAME
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeBetTrans C-Win
ON CURSOR-RIGHT OF BROWSE-KundeBetTrans IN FRAME DEFAULT-FRAME
DO:
  IF wAntSortCol < 2 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeBetTrans C-Win
ON HOME OF BROWSE-KundeBetTrans IN FRAME DEFAULT-FRAME
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeBetTrans C-Win
ON ROW-DISPLAY OF BROWSE-KundeBetTrans IN FRAME DEFAULT-FRAME
DO:
  IF AVAILABLE KundeBetTrans THEN
  DO:
    ASSIGN
        cKl   = STRING(KundeBetTrans.RegistrertTid,"HH:MM:SS")
        cInfo = IF (KundeBetTrans.TTId = 61 AND KundeBetTrans.TBId = 2)
                  THEN "áKontoinnbetaling"
                ELSE IF (KundeBetTrans.TTId = 61 AND KundeBetTrans.TBId = 3) 
                  THEN "Faktura: " + STRING(KundeBetTrans.FakturaNr)
                ELSE IF (KundeBetTrans.TTId = 61 AND KundeBetTrans.TBId = 4) 
                  THEN "Konto: " + STRING(KundeBetTrans.KontoNr)
                ELSE IF (KundeBetTrans.TTId = 61 AND KundeBetTrans.TBId = 5) 
                  THEN "Innb. på kvitt: " + STRING(KundeBetTrans.betButik) + "/" + 
                                            STRING(KundeBetTrans.betKassaNr) + "/" + 
                                            STRING(KundeBetTrans.betBongId)
                ELSE
                    "Kvittering: " + STRING(KundeBetTrans.betButik) + "/" + 
                                     STRING(KundeBetTrans.betKassaNr) + "/" + 
                                     STRING(KundeBetTrans.betBongId)
        .

    find TransType NO-LOCK WHERE
      TransType.TTId = KundeBetTrans.TTId NO-ERROR.
    IF AVAILABLE TransType THEN
      ASSIGN
        wTypeBeskr = TransType.Beskrivelse
        .
    ELSE
        ASSIGN
            wTypeBeskr = "* Ukjent *"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeBetTrans C-Win
ON START-SEARCH OF BROWSE-KundeBetTrans IN FRAME DEFAULT-FRAME
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-SOK-DATE FILL-IN-SOK-DECI FILL-IN-SOK-CHAR FILL-IN-SOK-INTE 
          CB-TTId 
      WITH FRAME DEFAULT-FRAME.
  ENABLE RECT-51 RECT-52 B-Oppdater B-VisTrans FILL-IN-SOK-DATE 
         FILL-IN-SOK-DECI FILL-IN-SOK-CHAR FILL-IN-SOK-INTE CB-TTId BUTTON-Sok 
         BROWSE-KundeBetTrans B-Ny B-Endre B-Slett 
      WITH FRAME DEFAULT-FRAME.
...
------------------------------------------------------------------------------*/
  ...
  assign
    wWhere = wWhere + (if input CB-TTId <> wAlle
               then (if "{&QWhere}" = "" then "" else " and ") + " KundeBetTrans.TTId = " + entry(1,CB-TTId:screen-value,":")
               else "")
    /*
    wWhere = wWhere + " " +
