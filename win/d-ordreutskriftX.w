...
/* Local Variable Definitions ---                                       */
    ...
    DEFINE VARIABLE cLogoCol      AS CHARACTER  NO-UNDO.
    DEFINE VARIABLE cMailAdress   AS CHARACTER  NO-UNDO.
...
/*    DEFINE FRAME PageHeader
       HEADER
          "<ALIGN=BASE><FArial><R4><P12><B><C6>" cLevNamn "<C33><P24>" TRIM(cOrdreLabel)
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Artikkler

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES TT_OrdreArtBas TT_OrdreHode TT_PrintOrdre

/* Definitions for BROWSE BROWSE-Artikkler                              */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Artikkler TT_OrdreArtBas.OrdreNr TT_OrdreArtBas.ArtikkelNr TT_OrdreArtBas.LevKod   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Artikkler   
&Scoped-define SELF-NAME BROWSE-Artikkler
&Scoped-define QUERY-STRING-BROWSE-Artikkler FOR EACH TT_OrdreArtBas     WHERE TT_OrdreArtBas.OrdreNr = TT_OrdreHode.OrdreNr.     {&OPEN-QUERY-BROWSE-PrintOrdre}
&Scoped-define OPEN-QUERY-BROWSE-Artikkler OPEN QUERY {&SELF-NAME} FOR EACH TT_OrdreArtBas     WHERE TT_OrdreArtBas.OrdreNr = TT_OrdreHode.OrdreNr.     {&OPEN-QUERY-BROWSE-PrintOrdre}.
&Scoped-define TABLES-IN-QUERY-BROWSE-Artikkler TT_OrdreArtBas
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Artikkler TT_OrdreArtBas


/* Definitions for BROWSE BROWSE-Ordre                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Ordre TT_OrdreHode.OrdreNr TT_OrdreHode.SendtDato /* TT_OrdreHode.BestHodeListe */ /* TT_OrdreHode.AvvikStatus */   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Ordre   
&Scoped-define SELF-NAME BROWSE-Ordre
&Scoped-define QUERY-STRING-BROWSE-Ordre FOR EACH TT_OrdreHode
&Scoped-define OPEN-QUERY-BROWSE-Ordre OPEN QUERY {&SELF-NAME} FOR EACH TT_OrdreHode.
&Scoped-define TABLES-IN-QUERY-BROWSE-Ordre TT_OrdreHode
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Ordre TT_OrdreHode


/* Definitions for BROWSE BROWSE-PrintOrdre                             */
&Scoped-define FIELDS-IN-QUERY-BROWSE-PrintOrdre TT_PrintOrdre.OrdreNr TT_PrintOrdre.BestNr TT_PrintOrdre.AntBestNrGrp TT_PrintOrdre.AntBestNrAv TT_PrintOrdre.ArtikkelSlut TT_PrintOrdre.ArtikkelNr TT_PrintOrdre.Direktelev TT_PrintOrdre.Butik TT_PrintOrdre.SortID TT_PrintOrdre.StrInterval TT_PrintOrdre.Storrelser TT_PrintOrdre.Fordeling TT_PrintOrdre.FriFordeling TT_PrintOrdre.AntSort TT_PrintOrdre.Rab1% TT_PrintOrdre.Antall TT_PrintOrdre.TotAntall TT_PrintOrdre.ValPris   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-PrintOrdre   
&Scoped-define SELF-NAME BROWSE-PrintOrdre
&Scoped-define QUERY-STRING-BROWSE-PrintOrdre FOR EACH TT_PrintOrdre WHERE TT_PrintOrdre.Ordrenr = TT_OrdreHode.Ordrenr AND                                  TT_PrintOrdre.ArtikkelNr = TT_OrdreArtBas.ArtikkelNr /*                                  BY TT_PrintOrdre.OrdreNr */                                  BY TT_PrintOrdre.ArtikkelNr BY SortButik                                  BY TT_PrintOrdre.BestNr BY Fri BY SortID
&Scoped-define OPEN-QUERY-BROWSE-PrintOrdre OPEN QUERY {&SELF-NAME} FOR EACH TT_PrintOrdre WHERE TT_PrintOrdre.Ordrenr = TT_OrdreHode.Ordrenr AND                                  TT_PrintOrdre.ArtikkelNr = TT_OrdreArtBas.ArtikkelNr /*                                  BY TT_PrintOrdre.OrdreNr */                                  BY TT_PrintOrdre.ArtikkelNr BY SortButik                                  BY TT_PrintOrdre.BestNr BY Fri BY SortID.
&Scoped-define TABLES-IN-QUERY-BROWSE-PrintOrdre TT_PrintOrdre
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-PrintOrdre TT_PrintOrdre


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Artikkler}~
    ~{&OPEN-QUERY-BROWSE-Ordre}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS Btn_OK BROWSE-Ordre BROWSE-Artikkler ~
BUTTON-Rapport Btn_Cancel Btn_Help BROWSE-PrintOrdre 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD bredd Dialog-Frame 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Artikkler FOR 
      TT_OrdreArtBas SCROLLING.

DEFINE QUERY BROWSE-Ordre FOR 
      TT_OrdreHode SCROLLING.

DEFINE QUERY BROWSE-PrintOrdre FOR 
      TT_PrintOrdre SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Artikkler
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Artikkler Dialog-Frame _FREEFORM
  QUERY BROWSE-Artikkler DISPLAY
      TT_OrdreArtBas.OrdreNr
 TT_OrdreArtBas.ArtikkelNr
  TT_OrdreArtBas.LevKod
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 66 BY 4.52 FIT-LAST-COLUMN.

DEFINE BROWSE BROWSE-Ordre
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Ordre Dialog-Frame _FREEFORM
  QUERY BROWSE-Ordre DISPLAY
      TT_OrdreHode.OrdreNr      
 TT_OrdreHode.SendtDato    
/*  TT_OrdreHode.BestHodeListe FORMAT "X(40)" */
/*  TT_OrdreHode.AvvikStatus                  */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 69 BY 4.52 ROW-HEIGHT-CHARS .52 FIT-LAST-COLUMN.

DEFINE BROWSE BROWSE-PrintOrdre
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-PrintOrdre Dialog-Frame _FREEFORM
  QUERY BROWSE-PrintOrdre DISPLAY
      TT_PrintOrdre.OrdreNr    
 TT_PrintOrdre.BestNr  
 TT_PrintOrdre.AntBestNrGrp
 TT_PrintOrdre.AntBestNrAv
 TT_PrintOrdre.ArtikkelSlut
 TT_PrintOrdre.ArtikkelNr 
 TT_PrintOrdre.Direktelev 
 TT_PrintOrdre.Butik      
 TT_PrintOrdre.SortID     
 TT_PrintOrdre.StrInterval FORMAT "x(15)"
 TT_PrintOrdre.Storrelser  FORMAT "x(45)"
 TT_PrintOrdre.Fordeling   FORMAT "x(30)"
 TT_PrintOrdre.FriFordeling  FORMAT "x(30)" LABEL "Frifordeling"
 TT_PrintOrdre.AntSort LABEL "Antsort"
 TT_PrintOrdre.Rab1%
 TT_PrintOrdre.Antall
 TT_PrintOrdre.TotAntall LABEL "Totant"
 TT_PrintOrdre.ValPris
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 196 BY 14.29 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     Btn_OK AT ROW 1.24 COL 175
     BROWSE-Ordre AT ROW 1.48 COL 4
     BROWSE-Artikkler AT ROW 1.48 COL 77
     BUTTON-Rapport AT ROW 2.43 COL 149
     Btn_Cancel AT ROW 2.48 COL 175
     Btn_Help AT ROW 4.48 COL 175
     BROWSE-PrintOrdre AT ROW 6.24 COL 3
     SPACE(1.59) SKIP(0.75)
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-Ordre Btn_OK Dialog-Frame */
/* BROWSE-TAB BROWSE-Artikkler BROWSE-Ordre Dialog-Frame */
/* BROWSE-TAB BROWSE-PrintOrdre Btn_Help Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Artikkler
/* Query rebuild information for BROWSE BROWSE-Artikkler
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH TT_OrdreArtBas
    WHERE TT_OrdreArtBas.OrdreNr = TT_OrdreHode.OrdreNr.
    {&OPEN-QUERY-BROWSE-PrintOrdre}
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-Artikkler */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Ordre
/* Query rebuild information for BROWSE BROWSE-Ordre
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH TT_OrdreHode.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-Ordre */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-PrintOrdre
/* Query rebuild information for BROWSE BROWSE-PrintOrdre
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH TT_PrintOrdre WHERE TT_PrintOrdre.Ordrenr = TT_OrdreHode.Ordrenr AND
                                 TT_PrintOrdre.ArtikkelNr = TT_OrdreArtBas.ArtikkelNr
/*                                  BY TT_PrintOrdre.OrdreNr */
                                 BY TT_PrintOrdre.ArtikkelNr BY SortButik
                                 BY TT_PrintOrdre.BestNr BY Fri BY SortID.
     _END_FREEFORM
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-PrintOrdre */
&ANALYZE-RESUME
...
&Scoped-define BROWSE-NAME BROWSE-Artikkler
&Scoped-define SELF-NAME BROWSE-Artikkler
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Artikkler Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Artikkler IN FRAME Dialog-Frame
DO:
    {&OPEN-QUERY-BROWSE-PrintOrdre}
...
&Scoped-define SELF-NAME BROWSE-Ordre
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Ordre Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Ordre IN FRAME Dialog-Frame
DO:
    {&OPEN-QUERY-BROWSE-Artikkler}
    {&OPEN-QUERY-BROWSE-PrintOrdre}
END.
...
{syspar2.i 5 4 30 cLogoCol}
IF INT(cLogoCol) < 55 OR INT(cLogoCol) > 70 THEN
    ASSIGN cLogoCol = "55".
...
------------------------------------------------------------------------------*/
  ENABLE Btn_OK BROWSE-Ordre BROWSE-Artikkler BUTTON-Rapport Btn_Cancel 
         Btn_Help BROWSE-PrintOrdre 
...
------------------------------------------------------------------------------*/
    ASSIGN cOrgLabels = FILL(CHR(1),29) + CHR(1) + "Rab2%". /* 30 entries */ 
    FOR EACH SysPara WHERE SysPara.SysHId = 6 AND SysPara.SysGr = 105 AND SysPara.ParaNr <= 30:
        ...
        IF SysPara.Paranr = 12 AND SysPara.Parameter2 <> "" THEN
            ENTRY(31,cOrgLabels,CHR(1)) = TRIM(SysPara.Parameter2).
    END.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFGetStorlek Dialog-Frame 
PROCEDURE PDFGetStorlek :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT-OUTPUT PARAMETER cStorlek AS CHARACTER NO-UNDO.
DEFINE INPUT-OUTPUT PARAMETER cFriFord AS CHARACTER NO-UNDO.
...
DEFINE VARIABLE cWrk3          AS CHARACTER         NO-UNDO.
DEFINE VARIABLE cFriFord2      AS CHARACTER         NO-UNDO.
DEFINE VARIABLE cStorlek2      AS CHARACTER         NO-UNDO.
DEFINE VARIABLE iStrl          AS INTEGER EXTENT 30 NO-UNDO.
DEFINE VARIABLE lFlag          AS LOGICAL           NO-UNDO.

ASSIGN cFriFord2 = cFriFord.
ASSIGN cStorlek2 = cStorlek.
FIND FIRST ArtBas WHERE ArtBas.ArtikkelNr = TT_OrdreArtBas.ArtikkelNr NO-LOCK.
  IF AVAILABLE ArtBas THEN
  DO:
    FIND FIRST StrType WHERE StrType.StrTypeID = ArtBas.StrTypeId.
      IF AVAILABLE StrType THEN
      DO:
/*         MESSAGE cStorlek SKIP StrType.AlfaFordeling SKIP TT_OrdreArtBas.ArtikkelNr
             VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
        ASSIGN ix3 = NUM-ENTRIES(cStorlek).
        ASSIGN cWrk = TRIM(ENTRY(1,cStorlek)).
        ASSIGN cWrk2 = TRIM(ENTRY(ix3,cStorlek)).
        ASSIGN cStorlek2 = "".
        DO ix2 = 1 TO NUM-ENTRIES(StrType.AlfaFordeling):
          IF TRIM(ENTRY(ix2,StrType.AlfaFordeling)) = cWrk THEN
          DO:
            ASSIGN cWrk3 = TRIM(ENTRY(ix2,StrType.AlfaFordeling)).
            ASSIGN ix4 = ix2.
          END.
        END.
        ASSIGN cStorlek2 = cWrk3 + ",".
/*         MESSAGE "cWrk: " cWrk SKIP "cWrk2: " cWrk2 SKIP "cWrk3: " cWrk3 ix4
          VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
        ASSIGN ix4 = ix4 + 1.
        IF NUM-ENTRIES(cStorlek) > 1 THEN
            ASSIGN lFlag = TRUE.
        ELSE 
            cStorlek2 = ENTRY(1,cStorlek2).
        DO ix2 = ix4 TO NUM-ENTRIES(StrType.AlfaFordeling):
          IF lFlag = TRUE THEN
          DO:
            ASSIGN cWrk3 = TRIM(ENTRY(ix2,StrType.AlfaFordeling)).
            IF cWrk3 = cWrk2 THEN
            DO:
              ASSIGN cStorlek2 = cStorlek2 + cWrk3.
              ASSIGN lFlag =FALSE.
            END.
            ELSE
             ASSIGN cStorlek2 = cStorlek2 + cWrk3 + ",".               
          END.
        END.
/*      MESSAGE cStorlek2 SKIP StrType.AlfaFordeling
          VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
        ASSIGN ix3 = 1.
        ASSIGN ix4 = 1.
        DO ix2 = 1 TO NUM-ENTRIES(cStorlek2):
/*         MESSAGE "entry 6" "fri" cFriFord "str" cStorlek "numE str 2" NUM-ENTRIES(cStorlek2,CHR(44)) ix2 ix3 ix4 */
/*             VIEW-AS ALERT-BOX INFO BUTTONS OK.                                                                  */
          IF ix4 <= NUM-ENTRIES(cStorlek) AND ENTRY(ix2,cStorlek2) = ENTRY(ix4,cStorlek) THEN
          DO:
            ASSIGN iStrl[ix3] = INTEGER(ENTRY(ix4,cFriFord)).
            ASSIGN ix3 = ix3 + 1.
            ASSIGN ix4 = ix4 + 1.
          END.
          ELSE
          ...
          END.
        END.
        ASSIGN cStorlek = cStorlek2.
        ASSIGN cFriFord2 = "".
        DO ix2 = 1 TO (ix3 - 1):
          IF ix2 = ix3 THEN
            ASSIGN cFriFord2 = cFriFord2 + STRING(iStrl[ix2]).
          ELSE
            ASSIGN cFriFord2 = cFriFord2 + STRING(iStrl[ix2]) + ",".
        END.
        ASSIGN cFriFord = cFriFord2.
    END.
  END.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFNysida Dialog-Frame 
PROCEDURE PDFNysida :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
DEFINE VARIABLE        iLM2 AS INTEGER     NO-UNDO.
  ...
  RUN pdf_text_xy_dec ("Spdf",cLevnamn,iLM,doRad).
...
/*  RUN pdf_text_xy_dec ("Spdf",cToday,iLM,doRad).*/
  ...
  RUN pdf_text_xy_dec ("Spdf","ORDER",iLM + 200,doRad).
  RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica-Bold",10).
  RUN pdf_text_xy_dec ("Spdf",cOrdreNr,iLM + 300,doRad).
  ASSIGN cSidTxt = STRING(pdf_page("Spdf")).
  RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM + 525,doRad).

  RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica",8).
  ASSIGN doRad = doRad - 2.
/*  RUN pdf_set_dash IN h_PDFinc ("Spdf",1,0).*/
  RUN pdf_line IN h_PDFinc  ("Spdf", pdf_LeftMargin ("Spdf"), doRad, pdf_PageWidth("Spdf") - pdf_LeftMargin ("Spdf") , doRad, 0.5).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFPageFooter Dialog-Frame 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivAdresseInfo Dialog-Frame 
PROCEDURE PDFSkrivAdresseInfo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
ASSIGN ioRad = ioRad - 20.

ASSIGN cSidTxt = TRIM(ENTRY(4,TT_OrdreHode.levlabels,CHR(1))).
RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica-Bold",10).
RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM,ioRad).
ASSIGN cUl = "".
DO ix = 1 TO LENGTH(cSidTxt):
  ASSIGN cUl = cUl + "_".
END.
RUN pdf_text_xy_dec ("Spdf",cUl,iLM,ioRad).


IF NUM-ENTRIES(TT_OrdreHode.levlabels,CHR(1)) > 29 THEN DO:
    ASSIGN cSidTxt = TRIM(ENTRY(30,TT_OrdreHode.levlabels,CHR(1))).
    RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM + 350,ioRad).
    ASSIGN cUl = "".
    DO ix = 1 TO LENGTH(cSidTxt):
      ASSIGN cUl = cUl + "_".
    END.
    RUN pdf_text_xy_dec ("Spdf",cUl,iLM + 350,ioRad).
END.


ASSIGN ioRad = ioRad - 13.
RUN pdf_text_xy_dec ("Spdf",TT_OrdreHode.LevNamn,iLm,ioRad).
RUN pdf_text_xy_dec ("Spdf",cFirmaNavn,iLm + 350,ioRad).

ASSIGN ioRad = ioRad - 13.
RUN pdf_text_xy_dec ("Spdf",TT_OrdreHode.Levadr,iLm,ioRad).
RUN pdf_text_xy_dec ("Spdf",CLButiker.BuAdr,iLm + 350,ioRad).

ASSIGN ioRad = ioRad - 13.
RUN pdf_text_xy_dec ("Spdf",TT_OrdreHode.Levponr + " " + TT_OrdreHode.Levpadr,iLm,ioRad).
IF getPostAdr(CLButiker.BuPonr) = "" THEN
  RUN pdf_text_xy_dec ("Spdf",CLButiker.BuPadr,iLm + 350,ioRad).
ELSE
  RUN pdf_text_xy_dec ("Spdf",CLButiker.BuPonr + " " + getPostAdr(CLButiker.BuPonr),iLm + 350,ioRad).
ASSIGN ioRad = ioRad - 13.
RUN pdf_text_xy_dec ("Spdf",TT_OrdreHode.Levland,iLm,ioRad).
RUN pdf_text_xy_dec ("Spdf",CLButiker.BuKon + "/" + CLButiker.BuTel,iLm + 350,ioRad).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivArtikkelInfo Dialog-Frame 
PROCEDURE PDFSkrivArtikkelInfo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE VARIABLE ioRad2 AS INTEGER     NO-UNDO.

ASSIGN cSidTxt = ENTRY(1,ENTRY(1,TT_OrdreArtBas.ArtInfo,CHR(1)),CHR(2)).
ASSIGN ioRad = ioRad - 20.
RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica-Bold",10).
RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM,ioRad).
RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica",10).
...
DO:
  ASSIGN ioRad = ioRad - 13.
  ASSIGN cSidTxt = ENTRY(2,ENTRY(1,TT_OrdreArtBas.ArtInfo,CHR(1)),CHR(2)).
  RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM,ioRad).
END.
ELSE
  ASSIGN ioRad = ioRad - 13.
DO iCount1 = 2 TO NUM-ENTRIES(TT_OrdreArtBas.ArtInfo,CHR(1)):
  ASSIGN ioRad = ioRad - 13.
  ASSIGN cSidTxt = ENTRY(1,ENTRY(iCount1,TT_OrdreArtBas.ArtInfo,CHR(1)),CHR(2)).
  RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM,ioRad).
  IF NUM-ENTRIES(ENTRY(iCount1,TT_OrdreArtBas.ArtInfo,CHR(1)),CHR(2)) = 2 THEN
  DO:
    ASSIGN ioRad = ioRad - 13.
    ASSIGN cSidTxt = ENTRY(2,ENTRY(iCount1,TT_OrdreArtBas.ArtInfo,CHR(1)),CHR(2)).
    RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM,ioRad).
  END.
END.

ASSIGN TT_OrdreArtBas.BildeFil = REPLACE(TT_OrdreArtBas.BildeFil,".bmp",".jpg").
IF TT_OrdreArtBas.BildeFil <> "" AND SEARCH(TT_OrdreArtBas.BildeFil) <> ? THEN
DO:
  ASSIGN cBildNamn = "mini" + STRING(TT_OrdreArtBas.ArtikkelNr).
  IF NOT CAN-FIND(FIRST TT_image WHERE TT_image.image_name = cBildNamn NO-LOCK) THEN
  DO:
    RUN pdf_load_image ("Spdf",cBildNamn,TT_OrdreArtBas.BildeFil).
    CREATE TT_image.
...
/*  MESSAGE "iImageHeight: " iImageHeight SKIP
          "iImageWidth: " iImageWidth SKIP
          TT_OrdreArtBas.ArtikkelNr
      VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
...
/*                iImageWidth = 50.                                          */
  ELSE
    ASSIGN iImageWidth = 50 * (iImageWidth / iImageHeight)   /* 60 */
         iImageHeight = 50.
/*ASSIGN ioRad = ioRad - 25
       dY = pdf_PageHeight ("Spdf") - doRad + 52. /* 55,50 */*/

/*  MESSAGE "PDFH: " (pdf_PageHeight ("Spdf") + 25) SKIP "ioRad: " ioRad
      VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
  ASSIGN ioRad2 = (pdf_PageHeight ("Spdf") + 25) - ioRad.
/*MESSAGE "ioRad2: " ioRad2 SKIP "ioRad: " ioRad SKIP pdf_PageHeight ("Spdf")
    VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
/*  IF ioRad > 500 THEN
    ASSIGN ioRad2 = ioRad - 470.
  ELSE
    ASSIGN ioRad2 = ioRad.*/
  RUN pdf_place_image ("Spdf",cBildNamn,iLM + 445,ioRad2,iImageWidth,iImageHeight).
END.
ioRad = ioRad - 13.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivDato Dialog-Frame 
PROCEDURE PDFSkrivDato :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEFINE INPUT        PARAMETER iLM   AS INTEGER NO-UNDO.
    ...
    RUN pdf_text_xy_dec ("Spdf",STRING(TODAY),iLM,ioRad).
/*    PUT UNFORMATTED "<FArial><C6><R" STRING(ioRad) ">" STRING(TODAY) + IF TT_OrdreHode.SendtDato <> ? THEN 
    ...
    IF TT_OrdreHode.SendtDato <> ? THEN 
      RUN pdf_text_xy_dec ("Spdf"," (Order sänd: " + STRING(TT_OrdreHode.SendtDato) + ")",iLM + 40,ioRad).

    IF TT_OrdreHode.Hasteordre = TRUE THEN
    DO:
      RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica-Bold",10).
      RUN pdf_text_xy_dec ("Spdf","SNABBORDER",iLM + 200,ioRad).
      RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica",10).
    END.
/*        PUT UNFORMATTED "<C33><R" STRING(ioRad) "><FGCOLOR=RED><B>HASTEORDRE<FGCOLOR=BLACK></B>".
...
/*             "<TRANSPARENT=false><R" STRING(ioRad + 6) ",25><C74><#3><R" STRING(ioRad - 3) ",25><C55,2><IMAGE#3=" */
            "<TRANSPARENT=false><R2,5><C" cLogoCol "><#3><R4,9><C75><IMAGE#3="
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivLeveransAdress Dialog-Frame 
PROCEDURE PDFSkrivLeveransAdress :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
         ...
         TT_OrdreHode.CLLevPostNr   <> CLButiker.BuPonr THEN
          ASSIGN cRad[2] = TT_OrdreHode.CLButNamn
                 ...
                 cRad[6] = (IF TT_OrdreHode.CLLevPostNr <> "" THEN TT_OrdreHode.CLLevPostNr + " "
                                ELSE "") + getPostAdr(TT_OrdreHode.CLLevPostNr).
  ...
  END.
  IF ipButik = iCentrallager THEN DO:
      RUN pdf_text_xy_dec ("Spdf",cRad[1],iLM + 350,ioRad).
      ASSIGN cUl = "".
      DO ix = 1 TO LENGTH(cRad[1]):
        ASSIGN cUl = cUl + "_".
      END.
      RUN pdf_text_xy_dec ("Spdf",cUl,iLM + 350,ioRad).
      ASSIGN ioRad = ioRad - 13.
/*      PUT UNFORMATTED "<FArial><R" STRING(ioRad) "><C60><B><U>" cRad[1] "</B></U>" SKIP.*/
      DO iCount = 2 TO 8:
          IF cRad[iCount] <> "" THEN DO:
              ASSIGN ioRad = ioRad - 13.
              RUN pdf_text_xy_dec ("Spdf",cRad[iCount],iLM + 350,ioRad).
...
/*       RUN SkrivUnderStrek(INPUT-OUTPUT ioRad,6,78). */
      RUN pdf_text_xy_dec ("Spdf",cRad[1],iLM,ioRad).
      ASSIGN cUl = "".
      DO ix = 1 TO LENGTH(cRad[1]):
        ASSIGN cUl = cUl + "_".
      END.
...
/*      PUT UNFORMATTED "<FArial><R" STRING(ioRad) "><C6><B><U>" cRad[1] "</B></U>" SKIP.*/
      DO iCount = 2 TO 8:
          IF cRad[iCount] <> "" THEN DO:
              ASSIGN ioRad = ioRad - 13.
              RUN pdf_text_xy_dec ("Spdf",cRad[iCount],iLM,ioRad).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivRapport Dialog-Frame 
...
DEFINE VARIABLE cSendtDato     AS CHARACTER          NO-UNDO.
DEFINE VARIABLE fArtTotalTmp   AS DECIMAL DECIMALS 2 NO-UNDO.
DEFINE VARIABLE fArtTotal      AS DECIMAL DECIMALS 2 NO-UNDO.
DEFINE VARIABLE cOrdreAntal    AS CHARACTER          NO-UNDO. /* for å samle ordreAntal,ulike valutaer ett entry för varje valuta */
DEFINE VARIABLE iOrdreAntal    AS INTEGER            NO-UNDO. /* for å summera entryna i ordreAntal ved ulike valutaer */
DEFINE VARIABLE cOrdreTotal    AS CHARACTER          NO-UNDO. /* for å samle ordretotal ved ulike valutaer */
DEFINE VARIABLE cArtikkelTotal AS CHARACTER          NO-UNDO. /* for å samle artikkeltotal ved ulike valutaer */
DEFINE VARIABLE iValutaIdx     AS INTEGER            NO-UNDO.
DEFINE VARIABLE iCount         AS INTEGER            NO-UNDO.
DEFINE VARIABLE dOrdreSent     AS DATE               NO-UNDO.
...
DEFINE VARIABLE cWrk           AS CHARACTER          NO-UNDO.
DEFINE VARIABLE cWrk2          AS CHARACTER          NO-UNDO.
DEFINE VARIABLE cFriFord       AS CHARACTER          NO-UNDO.
DEFINE VARIABLE cStorlek       AS CHARACTER          NO-UNDO.


  ASSIGN dOrdreSent = IF Ordre.SendtDato = ? THEN TODAY ELSE Ordre.SendtDato
         pcRappFil = SESSION:TEMP-DIRECTORY + SUBSTR(STRING(YEAR(dOrdreSent)) + STRING(MONTH(dOrdreSent),"99") + STRING(DAY(dOrdreSent),"99"),3)
                       + "-Order-" + STRING(TT_OrdreHode.OrdreNr) + ".pdf".
...
/*  RUN pdf_set_Orientation ("Spdf", "landscape").*/
  ...
  FOR EACH TT_OrdreHode BREAK BY TT_OrdreHode.OrdreNr:
    ...
    IF NOT FIRST(TT_OrdreHode.OrdreNr) THEN 
    DO:
    ...
    DO:
      RUN PDFNysida(INPUT-OUTPUT doRad,INPUT iLM).
    END.
    ASSIGN cOrdreTotal = FILL(CHR(1),NUM-ENTRIES(TT_OrdreHode.ValutaKod,CHR(1)) - 1)
           cOrdreAntal = cOrdreTotal.

    RUN PDFSkrivDato(INPUT-OUTPUT doRad,INPUT iLM).
        
    IF cTypeListe = "" THEN 
    DO:
      RUN PDFSkrivAdresseInfo(INPUT-OUTPUT doRad,INPUT iLM). /* iRad = 5 */
    END.
    FOR EACH TT_PrintOrdre WHERE TT_PrintOrdre.Ordrenr = TT_OrdreHode.Ordrenr 
                        BREAK /* BY TT_PrintOrdre.Ordrenr */
                               BY TT_PrintOrdre.SortButik
        ...
        IF FIRST-OF(SortButik) THEN 
        DO:
            IF cTypeListe = "" THEN
            DO:
              IF TT_PrintOrdre.Butik <> iCentrallager THEN
                RUN PDFSkrivLeveransAdress(INPUT-OUTPUT doRad,INPUT iLM,TT_PrintOrdre.Butik).
            END. 
          RUN PDFSkrivSpecHeader(INPUT-OUTPUT doRad,INPUT iLM).
        END.
        IF FIRST-OF(TT_PrintOrdre.ArtikkelNr) THEN 
        DO:
          IF doRad < 200 THEN 
          DO:
            RUN PDFNySida(INPUT-OUTPUT doRad,INPUT iLM).
          ...
          RUN PDFSkrivArtikkelInfo(INPUT-OUTPUT doRad,INPUT iLM).
          ASSIGN cArtikkelTotal = FILL(CHR(1),NUM-ENTRIES(TT_OrdreArtBas.ValutaKod,CHR(1)) - 1).
        END.
        IF FIRST-OF(TT_PrintOrdre.BestNr) THEN 
        DO:
          IF NOT FIRST(TT_PrintOrdre.BestNr) AND doRad < 60 AND TT_PrintOrdre.AntBestNrGrp > 4 THEN 
          DO:
            RUN PDFNySida(INPUT-OUTPUT doRad,INPUT iLM).
            RUN PDFSkrivSpecHeader(INPUT-OUTPUT doRad,INPUT iLM).
          END.
          RUN PDFSkrivRefnr(INPUT-OUTPUT doRad,INPUT iLM,"").
        END.

        IF doRad < 60 AND TT_PrintOrdre.AntBestNrGrp > 3 THEN 
        DO:
          RUN PDFNySida(INPUT-OUTPUT doRad,INPUT iLM).
          RUN PDFSkrivSpecHeader(INPUT-OUTPUT doRad,INPUT iLM).
          RUN PDFSkrivRefnr(INPUT-OUTPUT doRad,INPUT iLM,"()").
        END.
        IF TT_PrintOrdre.Fri = FALSE THEN 
        DO:
          ASSIGN doRad = doRad - 13.
          RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica",10).
          RUN pdf_text_xy_dec ("Spdf",SortId,iLM,doRad).
          ASSIGN cWrk = STRING(AntSort,"zz9").
          RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 90) - bredd(cWrk),doRad).
          RUN pdf_text_xy_dec ("Spdf","*",iLM + 100,doRad).
          ASSIGN cWrk = STRING(Antall,"zz9").
          RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 140) - bredd(cWrk),doRad).
          RUN pdf_text_xy_dec ("Spdf",StrInterval,iLM + 150,doRad).
          RUN pdf_text_xy_dec ("Spdf",Fordeling,iLM + 200,doRad).
          ASSIGN cWrk = STRING(TotAntal,"zzz9").
          RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 350) - bredd(cWrk),doRad).
          ASSIGN cWrk = STRING(ValPris,">>>,>>>,>>9.99").
          RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 535) - bredd(cWrk),doRad).
        END.
        ELSE 
        DO: /* TT_PrintOrdre.Fri = TRUE */ 
          RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica",10).
          ASSIGN doRad = doRad - 13.
          ASSIGN cStorlek = "".
          DO ix = 1 TO NUM-ENTRIES(Storrelser,CHR(32)):
            ASSIGN cWrk = ENTRY(ix,Storrelser,CHR(32)).
            IF cWrk <> CHR(32) THEN
              IF ix = NUM-ENTRIES(Storrelser,CHR(32)) THEN
                ASSIGN cStorlek = cStorlek + cWrk.
              ELSE
                ASSIGN cStorlek = cStorlek + cWrk + CHR(44).
          END.

          ASSIGN cFriFord = "".
          DO ix = 1 TO NUM-ENTRIES(FriFordeling,CHR(32)):
            ASSIGN cWrk = ENTRY(ix,FriFordeling,CHR(32)).
            IF cWrk <> CHR(32) THEN
              IF ix = NUM-ENTRIES(FriFordeling,CHR(32)) THEN
                ASSIGN cFriFord = cFriFord + cWrk.
              ELSE
                ASSIGN cFriFord = cFriFord + cWrk + CHR(44).
          END.

          RUN PDFGetStorlek(INPUT-OUTPUT cStorlek, INPUT-OUTPUT cFriFord). /*, INPUT-OUTPUT cFriFord).*/
/* start*/
          IF NUM-ENTRIES(cStorlek,CHR(44)) > 15 THEN
          DO:
            ASSIGN iLM2 = iLM.
            DO ix = 1 TO 15:
              RUN pdf_text_xy_dec ("Spdf",ENTRY(ix,cStorlek,CHR(44)),iLM2,doRad).
              ASSIGN iLM2 = iLM2 + 22.
            END.
/*            RUN pdf_text_xy_dec ("Spdf",STRING(TotAntal,"zzz9"),(iLM + 350) - bredd(STRING(TotAntal,"zzz9")),doRad).
            RUN pdf_text_xy_dec ("Spdf",STRING(ValPris,">>>,>>>,>>9.99"),(iLM + 535) - bredd(STRING(ValPris,">>>,>>>,>>9.99")),doRad).*/
            ASSIGN doRad = doRad - 13.
            ASSIGN iLM2 = iLM + 8.
            DO ix = 1 TO 15:
              ASSIGN cWrk = ENTRY(ix,cFriFord,CHR(44)).
              RUN pdf_text_xy_dec ("Spdf",cWrk,iLM2 - bredd(cWrk),doRad).
              ASSIGN iLM2 = iLM2 + 22.
            END.
            ASSIGN doRad = doRad - 13.
            ASSIGN iLM2 = iLM.
            DO ix = 16 TO NUM-ENTRIES(cStorlek,CHR(44)):
              RUN pdf_text_xy_dec ("Spdf",ENTRY(ix,cStorlek,CHR(44)),iLM2,doRad).
              ASSIGN iLM2 = iLM2 + 22.
            END.
            RUN pdf_text_xy_dec ("Spdf",STRING(TotAntal,"zzz9"),(iLM + 350) - bredd(STRING(TotAntal,"zzz9")),doRad).
            ...
            ASSIGN doRad = doRad - 13.
            ASSIGN iLM2 = iLM + 8.
            DO ix = 16 TO NUM-ENTRIES(cFriFord,CHR(44)):
              ASSIGN cWrk = ENTRY(ix,cFriFord,CHR(44)).
              RUN pdf_text_xy_dec ("Spdf",cWrk,iLM2 - bredd(cWrk),doRad).
              ASSIGN iLM2 = iLM2 + 22.
            END.
/*            ASSIGN doRad = doRad + 26.*/
          END.
          ELSE
          DO:
            ASSIGN iLM2 = iLM.
            DO ix = 1 TO NUM-ENTRIES(cStorlek,CHR(44)):
              RUN pdf_text_xy_dec ("Spdf",ENTRY(ix,cStorlek,CHR(44)),iLM2,doRad).
              ASSIGN iLM2 = iLM2 + 22.
            END.
            RUN pdf_text_xy_dec ("Spdf",STRING(TotAntal,"zzz9"),(iLM + 350) - bredd(STRING(TotAntal,"zzz9")),doRad).
            ...
            ASSIGN doRad = doRad - 13.
            ASSIGN iLM2 = iLM + 8.
            DO ix = 1 TO NUM-ENTRIES(cFriFord,CHR(44)):
              ASSIGN cWrk = ENTRY(ix,cFriFord,CHR(44)).
              RUN pdf_text_xy_dec ("Spdf",cWrk,iLM2 - bredd(cWrk),doRad).
              ASSIGN iLM2 = iLM2 + 22.
            END.
...
/* slut */
        ...
        END.
        IF LAST-OF(TT_PrintOrdre.BestNr) THEN 
        DO:
          ASSIGN doRad = doRad - 13.
          ASSIGN iRad = iRad - 1
                 fArtTotalTmp = (ACCUM TOTAL BY BestNr TotAntal) * ValPris * (1 - (Rab1% / 100)) * (1 - (Rab2% / 100))
          ...
          RUN pdf_line ("Spdf",iLM + 320,doRad + 11,iLM + 350,doRad + 11,0.5).
          ASSIGN cSidTxt = STRING(ACCUM TOTAL BY BestNr TotAntal,">,>>9").
          RUN pdf_text_xy_dec ("Spdf",cSidTxt,(iLM + 350) - bredd(cSidTxt),doRad).
          ASSIGN cSidTxt = STRING(TT_PrintOrdre.Rab1%,">>9.9").
          RUN pdf_text_xy_dec ("Spdf",cSidTxt,(iLM + 390) - bredd(cSidTxt),doRad).
          ASSIGN cSidTxt = STRING(TT_PrintOrdre.Rab2%,">>9.9").
          RUN pdf_text_xy_dec ("Spdf",cSidTxt,(iLM + 420) - bredd(cSidTxt),doRad).
          ASSIGN cSidTxt = "(" + TRIM(STRING(fArtTotalTmp,">>>,>>>,>>9.99")) + ")".
          RUN pdf_text_xy_dec ("Spdf",cSidTxt,(iLM + 535) - bredd(cSidTxt),doRad).
          ASSIGN iRad = iRad + 1 /* IF TT_PrintOrdre.Fri THEN 1 ELSE 0 */.
        END.
        IF LAST-OF(TT_PrintOrdre.ArtikkelNr) THEN 
        DO:
          ASSIGN doRad = doRad - 13.
          RUN pdf_line ("Spdf",iLM + 320,doRad,iLM + 535,doRad, 0.5).
          ASSIGN cWrk = STRING(ACCUM TOTAL BY TT_PrintOrdre.ArtikkelNr TotAntal,">>,>>9").
          ASSIGN doRad = doRad - 13.
          RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 350) - bredd(cWrk),doRad).
          ASSIGN cWrk = STRING(DECI(ENTRY(1,cArtikkelTotal,CHR(1))),">>>,>>>,>>9.99").
          RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 535) - bredd(cWrk),doRad).
          ASSIGN iRad      = iRad + 1
                 fArtTotal = 0.
          IF doRad < 60 THEN
          ...
          DO iCount = 2 TO NUM-ENTRIES(cArtikkelTotal,CHR(1)):
            ASSIGN doRad = doRad - 13.
            RUN pdf_text_xy_dec ("Spdf",ENTRY(iCount,TT_OrdreArtBas.ValutaKod,CHR(1)),iLM + 380,doRad).
            ASSIGN cWrk = STRING(DECI(ENTRY(iCount,cArtikkelTotal,CHR(1))),">>>,>>>,>>9.99").
            RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 535) - bredd(cWrk),doRad).
            ASSIGN iRad = iRad + 1.
          END.
        END.
        IF LAST(TT_PrintOrdre.SortButik) THEN /* skriv ut ordertotal */
        DO: 
          IF doRad < 80 THEN
          DO:
            RUN PDFNySida(INPUT-OUTPUT doRad,INPUT iLM).
          ...
          ASSIGN iRad = iRad + 2.
          RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica-Bold",20).
          RUN pdf_text_xy_dec ("Spdf",ENTRY(1,TT_OrdreHode.levlabels,CHR(1)),iLM + 410,doRad).
          RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica",10).
          ASSIGN doRad = doRad - 2.
          RUN pdf_line ("Spdf",iLM + 320,doRad,iLM + 535,doRad,0.5).
          ...
          DO iCount = 1 TO NUM-ENTRIES(cOrdreTotal,CHR(1)):
            ASSIGN doRad = doRad - 13.
            ASSIGN cWrk = STRING(INT(ENTRY(iCount,cOrdreAntal,CHR(1))),">>,>>9").
            RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 350) - bredd(cWrk),doRad).
            ASSIGN cWrk = STRING(DECI(ENTRY(iCount,cOrdreTotal,CHR(1))),">>>,>>>,>>9.99").
            RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 535) - bredd(cWrk),doRad).
            RUN pdf_text_xy_dec ("Spdf",ENTRY(iCount,TT_OrdreHode.ValutaKod,CHR(1)),iLM + 536,doRad).
            ASSIGN iRad = iRad + 1
                     iOrdreAntal = iOrdreAntal + INT(ENTRY(iCount,cOrdreAntal,CHR(1))).
          END.
          IF NUM-ENTRIES(cOrdreTotal,CHR(1)) > 1 THEN 
          DO:
            ASSIGN iRad = iRad - 1.
            ASSIGN doRad = doRad - 2.
            RUN pdf_line ("Spdf",iLM + 320,doRad,iLM + 535,doRad,0.5).
            ASSIGN doRad = doRad - 13.
            ASSIGN cWrk = STRING(iOrdreAntal,">>,>>9").
            RUN pdf_text_xy_dec ("Spdf",cWrk,(iLM + 350) - bredd(cWrk),doRad).
          END.
        END.
        IF LAST-OF(TT_PrintOrdre.SortButik) AND NOT LAST(TT_PrintOrdre.SortButik) THEN 
        DO:
          RUN PDFNySida(INPUT-OUTPUT doRad,INPUT iLM).
          IF NOT LAST(TT_PrintOrdre.SortButik) THEN 
          DO:
            RUN PDFSkrivDato(INPUT-OUTPUT doRad,INPUT iLM).
          END.
        END.
...
/*  IF cMailAdress <> "" THEN 
  DO:
    PUT UNFORMATTED "<MAILTO=TO:" + cMailAdress + ">" +
        "<MAILSUBJECT=" + "Ordre: " + CLButiker.Butnamn + ">".
  END.
  OUTPUT TO TERMINAL.*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivRefnr Dialog-Frame 
PROCEDURE PDFSkrivRefnr :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF cOpt = "()" THEN
   ASSIGN c1 = "(.."
          c2 = "..)".
ASSIGN ioRad = ioRad - 30.
RUN pdf_text_xy_dec ("Spdf",c1 + "RefNr " + STRING(TT_PrintOrdre.BestNr),iLM,ioRad).
IF TT_PrintOrdre.LevDato <> ? THEN
DO:
  ASSIGN cSidTxt = ENTRY(8,TT_OrdreHode.levlabels,CHR(1)) + STRING(TT_PrintOrdre.LevDato).
  RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM + 70,ioRad).
END.
RUN pdf_set_font IN h_PDFinc ("Spdf", "Helvetica-Bold",10).
ASSIGN cSidTxt = CAPS(TT_PrintOrdre.ValutaKod).
RUN pdf_text_xy_dec ("Spdf",cSidTxt,iLM + 505,ioRad).
ASSIGN cUl = "".
DO ix = 1 TO LENGTH(cSidTxt):
  ASSIGN cUl = cUl + "_".
END.
ASSIGN cUl = cUl + "_".
RUN pdf_text_xy_dec ("Spdf",cUl,iLM + 505,ioRad).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDFSkrivSpecHeader Dialog-Frame 
PROCEDURE PDFSkrivSpecHeader :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
ASSIGN ioRad = ioRad - 5.
RUN pdf_line IN h_PDFinc  ("Spdf", pdf_LeftMargin ("Spdf"), ioRad, pdf_PageWidth("Spdf") - pdf_LeftMargin ("Spdf") , ioRad, 0.5).
ASSIGN ioRad = ioRad - 13.
/*   5 7 6 9 10 13 11 12 17 */
RUN pdf_text_xy_dec ("Spdf",ENTRY(5,TT_OrdreHode.levlabels,CHR(1)),iLM,ioRad).      
RUN pdf_text_xy_dec ("Spdf",ENTRY(7,TT_OrdreHode.levlabels,CHR(1)),iLM + 80,ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(6,TT_OrdreHode.levlabels,CHR(1)),iLM + 120,ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(9,TT_OrdreHode.levlabels,CHR(1)),iLM + 150,ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(10,TT_OrdreHode.levlabels,CHR(1)),iLM + 200,ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(13,TT_OrdreHode.levlabels,CHR(1)),iLM + 320,ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(12,TT_OrdreHode.levlabels,CHR(1)),iLM + 390 - bredd(ENTRY(12,TT_OrdreHode.levlabels,CHR(1))),ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(31,TT_OrdreHode.levlabels,CHR(1)),iLM + 430 - bredd(ENTRY(31,TT_OrdreHode.levlabels,CHR(1))),ioRad).
RUN pdf_text_xy_dec ("Spdf",ENTRY(11,TT_OrdreHode.levlabels,CHR(1)),iLM + 505,ioRad).
...
------------------------------------------------------------------------------*/
  ...
  DO iAntOrdre = 1 TO NUM-ENTRIES(cOrdreListe):
    ...
    IF NOT AVAIL Ordre THEN
        NEXT.
    IF Ordre.CL <> 0 THEN DO:
        iCentralLager = Ordre.CL.
        FIND clButiker WHERE clButiker.Butik = iCentralLager NO-LOCK.
    END.
    FIND LevBas OF Ordre NO-LOCK NO-ERROR.
    IF NUM-ENTRIES(LevBas.E_MailLev,"@") = 2 THEN
        ASSIGN cMailAdress = LevBas.E_MailLev.
    ...
    ASSIGN TT_OrdreHode.OrdreNr       = Ordre.OrdreNr
           ...
           TT_OrdreHode.Hasteordre    = Ordre.HasteOrdre
           .
...
/*            BestHodeListe */
/*            AvvikStatus   */
    FOR EACH BestHode WHERE BestHode.OrdreNr = TT_OrdreHode.OrdreNr  NO-LOCK BY Besthode.artikkelnr.
        ii = ii + 1.
/*         IF besthode.artikkelnr <> 103419 THEN */
/*             NEXT.                             */
/*         IF ii > 26 THEN DO:                        */
/*             MESSAGE besthode.bestnr                */
/*                 VIEW-AS ALERT-BOX INFO BUTTONS OK. */
/*             NEXT.                                  */
/*         END.                                       */
...
/*               ELSE                                                                           */
              DO:
                ...
                ASSIGN TT_PrintOrdre.OrdreNr      = BestHode.OrdreNr
                       ...
                       TT_PrintOrdre.Rab2%        = BestPris.Rab2%
            ...
            FOR EACH BestKasse OF BestSort NO-LOCK:
                ...
                IF cTypeListe = "A" THEN 
                  FIND FIRST bTT_PrintOrdre WHERE
                       ...
                       bTT_PrintOrdre.Rab1%        = BestPris.Rab1%            AND
                       bTT_PrintOrdre.Rab2%        = BestPris.Rab2%            AND
            ...
            IF AVAIL BestSort THEN DO:
                FOR EACH Fributik OF BestHode NO-LOCK.
                    ...
                    DO iCount = 1 TO NUM-ENTRIES(BestSort.Storrelser," "):
                        IF iCount > 50 THEN NEXT. /* TN BugHider :) */
...
------------------------------------------------------------------------------*/
  ...
  DEF VAR dOrdreSent     AS DATE NO-UNDO.

  /*   ASSIGN pcRappFil = SESSION:TEMP-DIRECTORY + "Ordre.xpr" */

/*   IF VALID-HANDLE(wLibHandle) THEN                                         */
/*      RUN GetTempFileName IN wLibHandle ("Ordre", "xpr", OUTPUT pcRappFil). */
  ASSIGN dOrdreSent = IF Ordre.SendtDato = ? THEN TODAY ELSE Ordre.SendtDato
         pcRappFil = SESSION:TEMP-DIRECTORY + SUBSTR(STRING(YEAR(dOrdreSent)) + STRING(MONTH(dOrdreSent),"99") + string(DAY(dOrdreSent),"99"),3)
                       + "-Ordre-" + STRING(TT_OrdreHode.OrdreNr) + ".xpr".
...
/*   PUT CONTROL '<PREVIEW=PDF>'. */
  ...
  FOR EACH TT_OrdreHode BREAK BY TT_OrdreHode.OrdreNr:
    ...
    FOR EACH TT_PrintOrdre WHERE TT_PrintOrdre.Ordrenr = TT_OrdreHode.Ordrenr 
      ...
      IF FIRST-OF(TT_PrintOrdre.BestNr) THEN
      DO:
        IF NOT FIRST(TT_PrintOrdre.BestNr) AND iRad > 58 AND TT_PrintOrdre.AntBestNrGrp > 4 THEN
        DO:
          RUN NySide(INPUT-OUTPUT iRad).
          RUN SkrivSpecHeader(INPUT-OUTPUT iRad).
        END.
...
/*         IF iPageSize - iRad < TT_PrintOrdre.AntBestNrAv - TT_PrintOrdre.AntBestNrGrp THEN DO: */
      IF iRad > 59 AND TT_PrintOrdre.AntBestNrGrp > 3 THEN
      DO:
...
/*                 "><C" STRING(iColSortId)      ">" SortId */
      ...
      DO:
        ...
        END.
      END.
      IF LAST(TT_PrintOrdre.SortButik) THEN 
      DO: /* skriv ut ordertotal */
        IF iRad + 2 + NUM-ENTRIES(cOrdreTotal,CHR(1)) > iPageSize THEN
        DO:
          RUN NySide(INPUT-OUTPUT iRad).
        END.
        ASSIGN iRad = iRad + 2.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION bredd Dialog-Frame 
FUNCTION bredd RETURNS DECIMAL
...
------------------------------------------------------------------------------*/
  ...
  IF LevBas.Lng <> "DES" AND LevBas.Lng <> "" THEN DO:
      ...
      FOR EACH SysPara OF SysGruppe WHERE SysPara.ParaNr <= 30:
          IF SysPara.Parameter1 <> "" THEN
          ASSIGN ENTRY(SysPara.ParaNr,cReturLabels,CHR(1)) = SysPara.Parameter1.
          IF SysPara.ParaNr = 12 AND Syspara.parameter2 <> "" THEN
              ENTRY(31,cReturLabels,CHR(1)) = SysPara.Parameter2.
