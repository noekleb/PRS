...
&Scoped-define QUERY-STRING-BROWSE-Butiker FOR EACH Butiker ~
      WHERE Butiker.Sentrallager = true NO-LOCK ~
...
/* Query rebuild information for BROWSE BROWSE-Butiker
     ...
     _Where[1]         = "SkoTex.Butiker.Sentrallager = true"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste sentrallager */
DO:
