...
&scope QWhere      'TransLogg.Postert = false'
...
DEF VAR wTitle AS CHAR INITIAL "Feiltransaksjoner" NO-UNDO.
...
TransLogg.BatchNr TransLogg.TransNr wTransType TransLogg.Dato ~
...
TransLogg.RabKr (TransLogg.Pris - Translogg.RabKr) @ lNettoPris ~
TransLogg.Mva TransLogg.VVarekost TransLogg.Postert TransLogg.PostertDato ~
TransLogg.FeilKode TransLogg.OvButik TransLogg.TilStorl TransLogg.Plukket ~
TransLogg.KassaNr TransLogg.BongId TransLogg.BongLinjeNr cFeilmelding ~
TransLogg.BestNr TransLogg.SelgerNr TransLogg.ForsNr TransLogg.KundNr ~
...
FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE B-KorrTrans ~
BUTTON-Motposter Btn_Help Btn_OK BUTTON-Sok B-VisTrans-2 CB-TTId T-VisAlle ~
BROWSE-TransLogg 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-SOK-DECI FILL-IN-SOK-CHAR ~
FILL-IN-SOK-INTE FILL-IN-SOK-DATE CB-TTId T-VisAlle 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-TransLogg C-Win _STRUCTURED
  QUERY BROWSE-TransLogg NO-LOCK DISPLAY
      ...
      TransLogg.Storl COLUMN-LABEL "Str" FORMAT "x(4)":U
      ...
      TransLogg.TilStorl FORMAT "X(4)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN MULTIPLE SIZE 155 BY 22.14 ROW-HEIGHT-CHARS .63 EXPANDABLE.
...
"TransLogg.Butik" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = SkoTex.TransLogg.BatchNr
     _FldNameList[3]   > SkoTex.TransLogg.TransNr
"TransLogg.TransNr" "TransNr" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > "_<CALC>"
"wTransType" "TransType" "x(15)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > SkoTex.TransLogg.Dato
"TransLogg.Dato" "Dato" ? "date" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[6]   > SkoTex.TransLogg.ArtikkelNr
"TransLogg.ArtikkelNr" "Artikkelnr" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[7]   > SkoTex.TransLogg.Kode
"TransLogg.Kode" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[8]   > SkoTex.TransLogg.BongTekst
"TransLogg.BongTekst" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[9]   > SkoTex.TransLogg.Vg
"TransLogg.Vg" "Vg" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[10]   > SkoTex.TransLogg.LopNr
"TransLogg.LopNr" "LpNr" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[11]   > SkoTex.TransLogg.Storl
"TransLogg.Storl" "Str" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[12]   > SkoTex.TransLogg.Antall
"TransLogg.Antall" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[13]   > SkoTex.TransLogg.Pris
"TransLogg.Pris" "Brutto Pris" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[14]   = SkoTex.TransLogg.RabKr
     _FldNameList[15]   > "_<CALC>"
"(TransLogg.Pris - Translogg.RabKr) @ lNettoPris" "Pris" "-zz,zzz,zz9.99" ? ? ? ? ? ? ? no ? no no "14.4" yes no no "U" "" ""
     _FldNameList[16]   = SkoTex.TransLogg.Mva
     _FldNameList[17]   = SkoTex.TransLogg.VVarekost
     _FldNameList[18]   > SkoTex.TransLogg.Postert
"TransLogg.Postert" "Post" ? "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[19]   > SkoTex.TransLogg.PostertDato
"TransLogg.PostertDato" "PosttDato" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[20]   > SkoTex.TransLogg.FeilKode
"TransLogg.FeilKode" "Feil" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[21]   > SkoTex.TransLogg.OvButik
"TransLogg.OvButik" "TilBut" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[22]   = SkoTex.TransLogg.TilStorl
     _FldNameList[23]   = SkoTex.TransLogg.Plukket
     _FldNameList[24]   > SkoTex.TransLogg.KassaNr
"TransLogg.KassaNr" "Kasse" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[25]   = SkoTex.TransLogg.BongId
     _FldNameList[26]   = SkoTex.TransLogg.BongLinjeNr
     _FldNameList[27]   > "_<CALC>"
"cFeilmelding" ? "x(40)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[28]   = SkoTex.TransLogg.BestNr
     _FldNameList[29]   = SkoTex.TransLogg.SelgerNr
     _FldNameList[30]   = SkoTex.TransLogg.ForsNr
     _FldNameList[31]   = SkoTex.TransLogg.KundNr
     _FldNameList[32]   = SkoTex.TransLogg.MedlemsNr
     _FldNameList[33]   = SkoTex.TransLogg.KortType
     _FldNameList[34]   = SkoTex.TransLogg.KortNr
     _FldNameList[35]   > SkoTex.TransLogg.LevNr
"TransLogg.LevNr" "LevNr" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[36]   = SkoTex.TransLogg.OvTransNr
     _FldNameList[37]   = SkoTex.TransLogg.SattVVareKost
     _FldNameList[38]   = SkoTex.TransLogg.RefNr
     _FldNameList[39]   = SkoTex.TransLogg.RefTekst
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-SOK-DECI FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE 
          CB-TTId T-VisAlle 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE RECT-50 RECT-51 RECT-52 FILL-IN-SOK-DECI FILL-IN-SOK-CHAR 
         FILL-IN-SOK-INTE FILL-IN-SOK-DATE B-KorrTrans BUTTON-Motposter 
