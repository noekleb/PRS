...
&Scoped-Define ENABLED-OBJECTS RECT-55 FI-DATO FI-Tid FI-Pris Btn_OK ~
Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-OBJECTS FI-DATO FI-Tid FI-Pris 
...
DEFINE FRAME Dialog-Frame
     ...
     FI-Tid AT ROW 3.38 COL 22 COLON-ALIGNED
     FI-Pris AT ROW 4.52 COL 22 COLON-ALIGNED
     Btn_OK AT ROW 1.24 COL 49
     Btn_Cancel AT ROW 2.43 COL 49
     Btn_Help AT ROW 4.81 COL 49
...
ON LEAVE OF FI-Tid IN FRAME Dialog-Frame /* Tid */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  IF (iType = 3 OR iType = 6) THEN
      ASSIGN
        FI-Pris:SENSITIVE = FALSE
        .
...
------------------------------------------------------------------------------*/
  DISPLAY FI-DATO FI-Tid FI-Pris 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-55 FI-DATO FI-Tid FI-Pris Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
