...
&Scoped-define OPEN-QUERY-BROWSE-Medlem OPEN QUERY BROWSE-Medlem FOR EACH Medlem ~
      WHERE Medlem.HovedMedlemFlagg = true NO-LOCK ~
...
/* Query rebuild information for BROWSE BROWSE-Medlem
     ...
     _Where[1]         = "Medlem.HovedMedlemFlagg = true"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Hovedmedlemssøk */
DO:
