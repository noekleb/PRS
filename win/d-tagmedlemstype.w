...
DEFINE TEMP-TABLE tMedlemsType NO-UNDO LIKE MedlemsType.
...
&scoped-define DB-BROWSER BROWSE-MedlemsType

&scoped-define br-tabell MedlemsType

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  MedType
...
&scoped-define index-col1 MedlemsType
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-MedlemsType

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES MedlemsType tMedlemsType

/* Definitions for BROWSE BROWSE-MedlemsType                            */
&Scoped-define FIELDS-IN-QUERY-BROWSE-MedlemsType MedlemsType.MedType ~
MedlemsType.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-MedlemsType ~
MedlemsType.MedType 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-MedlemsType MedlemsType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-MedlemsType MedlemsType
&Scoped-define OPEN-QUERY-BROWSE-MedlemsType OPEN QUERY BROWSE-MedlemsType FOR EACH MedlemsType NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-MedlemsType MedlemsType
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-MedlemsType MedlemsType


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tMedlemsType.MedType ~
tMedlemsType.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tMedlemsType.MedType 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tMedlemsType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tMedlemsType
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tMedlemsType NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tMedlemsType
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tMedlemsType


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-MedlemsType}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-MedlemsType BROWSE-Tag Btn_OK ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-MedlemsType FOR 
      MedlemsType
    FIELDS(MedlemsType.MedType
      MedlemsType.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tMedlemsType
    FIELDS(tMedlemsType.MedType
      tMedlemsType.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-MedlemsType
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-MedlemsType Dialog-Frame _STRUCTURED
  QUERY BROWSE-MedlemsType NO-LOCK DISPLAY
      MedlemsType.MedType COLUMN-LABEL "MedType" FORMAT "zzz9":U
      MedlemsType.Beskrivelse FORMAT "X(40)":U
  ENABLE
      MedlemsType.MedType
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tMedlemsType.MedType COLUMN-LABEL "MedType" FORMAT "zzz9":U
      tMedlemsType.Beskrivelse FORMAT "X(40)":U
  ENABLE
      tMedlemsType.MedType
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-MedlemsType AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tMedlemsType T "?" NO-UNDO skotex MedlemsType
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-MedlemsType 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-MedlemsType
/* Query rebuild information for BROWSE BROWSE-MedlemsType
     _TblList          = "skotex.MedlemsType"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.MedlemsType.MedType
"MedType" "MedType" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = skotex.MedlemsType.Beskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-MedlemsType */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tMedlemsType"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tMedlemsType.MedType
"MedType" "MedType" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tMedlemsType.Beskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg medlemstype */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-MedlemsType
&Scoped-define SELF-NAME BROWSE-MedlemsType
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsType Dialog-Frame
ON CURSOR-LEFT OF BROWSE-MedlemsType IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsType Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-MedlemsType IN FRAME Dialog-Frame /* ? */
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsType Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-MedlemsType IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsType Dialog-Frame
ON START-SEARCH OF BROWSE-MedlemsType IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsType Dialog-Frame
ON VALUE-CHANGED OF BROWSE-MedlemsType IN FRAME Dialog-Frame /* ? */
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-MedlemsType BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok 
         RECT-4 RECT-5 
      WITH FRAME Dialog-Frame.
