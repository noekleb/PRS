...
DEFINE TEMP-TABLE tFarg NO-UNDO LIKE Farg.
...
&scoped-define DB-BROWSER BROWSE-Farg
...
&Scoped-define INTERNAL-TABLES Farg tFarg

/* Definitions for BROWSE BROWSE-Farg                                   */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Farg Farg.Farg Farg.FarBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Farg Farg.Farg 
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tFarg.Farg tFarg.FarBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tFarg.Farg 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tFarg
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tFarg
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tFarg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tFarg
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tFarg
...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 BROWSE-Farg BROWSE-Tag Btn_OK ~
Btn_Cancel Btn_Help BUTTON-Sok 
...
DEFINE QUERY BROWSE-Farg FOR 
      Farg
    FIELDS(Farg.Farg
      Farg.FarBeskr) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tFarg
    FIELDS(tFarg.Farg
      tFarg.FarBeskr) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Farg Dialog-Frame _STRUCTURED
  QUERY BROWSE-Farg NO-LOCK DISPLAY
      Farg.Farg FORMAT "zz9"
      Farg.FarBeskr WIDTH 33.8
  ENABLE
      Farg.Farg
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tFarg.Farg FORMAT "zz9"
      tFarg.FarBeskr WIDTH 33.8
  ENABLE
      tFarg.Farg
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tFarg T "?" NO-UNDO skotex Farg
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Farg 1 Dialog-Frame */
...
"Farg" ? "zz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > skotex.Farg.FarBeskr
"FarBeskr" ? ? "character" ? ? ? ? ? ? no ? no no "33.8"
     _Query            is OPENED
*/  /* BROWSE BROWSE-Farg */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tFarg"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tFarg.Farg
"Farg" ? "zz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.tFarg.FarBeskr
"FarBeskr" ? ? "character" ? ? ? ? ? ? no ? no no "33.8"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg farger */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-4 RECT-5 BROWSE-Farg BROWSE-Tag Btn_OK Btn_Cancel Btn_Help 
         BUTTON-Sok 
      WITH FRAME Dialog-Frame.
