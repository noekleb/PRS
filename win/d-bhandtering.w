...
&scope InitIdx     Handtering
&scope ip-felt     HandKode
...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vhandtering.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Handtering

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Handtering

/* Definitions for BROWSE BROWSE-Handtering                             */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Handtering Handtering.HandKode ~
Handtering.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Handtering ~
Handtering.HandKode Handtering.Beskrivelse 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Handtering Handtering
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Handtering Handtering
&Scoped-define OPEN-QUERY-BROWSE-Handtering OPEN QUERY BROWSE-Handtering FOR EACH Handtering NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Handtering Handtering
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Handtering Handtering
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Handtering Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Handtering FOR 
      Handtering SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Handtering
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Handtering Dialog-Frame _STRUCTURED
  QUERY BROWSE-Handtering NO-LOCK DISPLAY
      Handtering.HandKode FORMAT ">9":U
      Handtering.Beskrivelse FORMAT "X(40)":U
  ENABLE
      Handtering.HandKode
      Handtering.Beskrivelse
/* _UIB-CODE-BLOCK-END */
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Handtering AT ROW 2.91 COL 2
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Handtering BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Handtering:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Handtering
/* Query rebuild information for BROWSE BROWSE-Handtering
     _TblList          = "skotex.Handtering"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > skotex.Handtering.HandKode
"Handtering.HandKode" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Handtering.Beskrivelse
"Handtering.Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Handtering */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Håndteringskoder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Handtering
&Scoped-define SELF-NAME BROWSE-Handtering
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Handtering Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Handtering IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Handtering Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Handtering IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Handtering Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Handtering IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Handtering Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Handtering IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Handtering Dialog-Frame
ON HOME OF BROWSE-Handtering IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Handtering Dialog-Frame
ON START-SEARCH OF BROWSE-Handtering IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Handtering Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
