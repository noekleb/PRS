...
&scoped-define VisPoster ~
  StType.Beskrivelse when available StType ~
  StType.StTypeId when available StType
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame StType.StTypeId ~
StType.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame StType.Beskrivelse 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame StType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame StType
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH StType SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame StType
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame StType


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS StType.Beskrivelse 
&Scoped-define ENABLED-TABLES StType
&Scoped-define FIRST-ENABLED-TABLE StType
&Scoped-define DISPLAYED-TABLES StType
&Scoped-define FIRST-DISPLAYED-TABLE StType
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS StType.StTypeId StType.Beskrivelse 
...
DEFINE FRAME Dialog-Frame
     StType.StTypeId AT ROW 2 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     StType.Beskrivelse AT ROW 1.95 COL 36 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Vedlikehold statistikktyper"
...
/* SETTINGS FOR FILL-IN StType.StTypeId IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold statistikktyper */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE StType THEN 
    DISPLAY StType.StTypeId StType.Beskrivelse 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 StType.Beskrivelse Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
