...
&scoped-define br-tabell Handtering
...
&scoped-define VisPoster {&br-tabell}.HandKode when available {&br-tabell} ~
...
&scoped-define AssignFelter {&br-tabell}.HandKode ~
...
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Handtering
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Handtering


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Handtering.HandKode Handtering.Beskrivelse ~
Handtering.Notat 
&Scoped-define ENABLED-TABLES Handtering
&Scoped-define FIRST-ENABLED-TABLE Handtering
&Scoped-define DISPLAYED-TABLES Handtering
&Scoped-define FIRST-DISPLAYED-TABLE Handtering
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help RECT-1 
&Scoped-Define DISPLAYED-FIELDS Handtering.HandKode Handtering.Beskrivelse ~
Handtering.Notat 
...
DEFINE FRAME Dialog-Frame
     Handtering.HandKode AT ROW 1.95 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Handtering.Beskrivelse AT ROW 3.14 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
     Handtering.Notat AT ROW 4.33 COL 4 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 60 BY 4.05
     Btn_OK AT ROW 9.1 COL 2
     Btn_Cancel AT ROW 9.1 COL 18
     Btn_Help AT ROW 9.1 COL 51
     RECT-1 AT ROW 1.48 COL 2.4
...
ASSIGN 
       Handtering.Notat:RETURN-INSERTED IN FRAME Dialog-Frame  = TRUE.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Handtering THEN 
    DISPLAY Handtering.HandKode Handtering.Beskrivelse Handtering.Notat 
      WITH FRAME Dialog-Frame.
  ENABLE Handtering.HandKode Handtering.Beskrivelse Handtering.Notat Btn_OK 
