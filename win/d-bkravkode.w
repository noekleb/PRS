...
&scope InitIdx     Kravkode
&scope ip-felt     KravKode
...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vkravkode.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Kravkode

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Kravkode

/* Definitions for BROWSE BROWSE-Kravkode                               */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Kravkode Kravkode.KravKode ~
Kravkode.Beskrivelse Kravkode.TransKode 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Kravkode Kravkode.KravKode ~
Kravkode.Beskrivelse 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Kravkode Kravkode
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Kravkode Kravkode
&Scoped-define QUERY-STRING-BROWSE-Kravkode FOR EACH Kravkode NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Kravkode OPEN QUERY BROWSE-Kravkode FOR EACH Kravkode NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Kravkode Kravkode
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Kravkode Kravkode
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Kravkode Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Kravkode FOR 
      Kravkode SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Kravkode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Kravkode Dialog-Frame _STRUCTURED
  QUERY BROWSE-Kravkode NO-LOCK DISPLAY
      Kravkode.KravKode COLUMN-LABEL "Beh.kode" FORMAT ">9":U WIDTH 12
      Kravkode.Beskrivelse FORMAT "X(40)":U
      Kravkode.TransKode FORMAT ">9":U WIDTH 37.2
  ENABLE
      Kravkode.KravKode
      Kravkode.Beskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 68 BY 14.76 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Kravkode AT ROW 2.91 COL 2
     Btn_OK AT ROW 17.91 COL 2
     Btn_Cancel AT ROW 17.91 COL 15.2
     Btn_Help AT ROW 17.91 COL 71
     BUTTON-Ny AT ROW 2.91 COL 71
     BUTTON-Endre AT ROW 4.24 COL 71
     BUTTON-Slett AT ROW 5.57 COL 71
     SPACE(0.19) SKIP(12.33)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Behandlingskoder"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Kravkode BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Kravkode:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Kravkode
/* Query rebuild information for BROWSE BROWSE-Kravkode
     _TblList          = "skotex.Kravkode"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > skotex.Kravkode.KravKode
"KravKode" "Beh.kode" ? "integer" ? ? ? ? ? ? yes ? no no "12" yes no no "U" "" ""
     _FldNameList[2]   > skotex.Kravkode.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > skotex.Kravkode.TransKode
"TransKode" ? ? "integer" ? ? ? ? ? ? no ? no no "37.2" yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Kravkode */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Behandlingskoder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Kravkode
&Scoped-define SELF-NAME BROWSE-Kravkode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kravkode Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Kravkode IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kravkode Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Kravkode IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kravkode Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Kravkode IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kravkode Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Kravkode IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kravkode Dialog-Frame
ON HOME OF BROWSE-Kravkode IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kravkode Dialog-Frame
ON START-SEARCH OF BROWSE-Kravkode IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Kravkode Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
