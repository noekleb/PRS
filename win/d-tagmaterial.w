...
DEFINE TEMP-TABLE tMaterial NO-UNDO LIKE Material.
...
&scoped-define DB-BROWSER BROWSE-Material
...
&scoped-define BUFFER-COPY-USING USING MatBeskr
...
&Scoped-define INTERNAL-TABLES Material tMaterial
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tMaterial.MatKod ~
tMaterial.MatBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tMaterial.MatKod 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tMaterial
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tMaterial
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tMaterial NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tMaterial
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tMaterial
...
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 BROWSE-Material BROWSE-Tag ~
...
DEFINE QUERY BROWSE-Material FOR 
      Material
    FIELDS(Material.MatKod
      Material.MatBeskr) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tMaterial
    FIELDS(tMaterial.MatKod
      tMaterial.MatBeskr) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Material Dialog-Frame _STRUCTURED
  QUERY BROWSE-Material NO-LOCK DISPLAY
      Material.MatKod FORMAT "zz9"
      Material.MatBeskr FORMAT "x(30)" WIDTH 34
  ENABLE
      Material.MatKod
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tMaterial.MatKod FORMAT "zz9"
      tMaterial.MatBeskr FORMAT "x(30)" WIDTH 34
  ENABLE
      tMaterial.MatKod
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-Material AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tMaterial T "?" NO-UNDO skotex Material
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Material 1 Dialog-Frame */
...
"MatKod" ? "zz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > skotex.Material.MatBeskr
"MatBeskr" ? "x(30)" "character" ? ? ? ? ? ? no ? no no "34"
     _Query            is OPENED
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tMaterial"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tMaterial.MatKod
"MatKod" ? "zz9" "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.tMaterial.MatBeskr
"MatBeskr" ? "x(30)" "character" ? ? ? ? ? ? no ? no no "34"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg material */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Material Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Material IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-4 RECT-5 BROWSE-Material BROWSE-Tag Btn_OK Btn_Cancel Btn_Help 
         BUTTON-Sok 
      WITH FRAME Dialog-Frame.
