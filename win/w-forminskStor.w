...
OCXFile = SEARCH( "w-forminskStor.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "w-forminskStor.wrx":U SKIP(1)
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE KonverterLiten C-Win 
PROCEDURE KonverterLiten :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
