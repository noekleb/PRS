...
&scoped-define VisPoster ~
  Rabatt.RabKod when available Rabatt ~
  Rabatt.RabProc when available Rabatt ~
  Rabatt.RabBeskr when available Rabatt
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
            message "{&br-tabell} finnes allerede med rabattkode:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Rabatt.RabKod Rabatt.RabProc ~
Rabatt.RabBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Rabatt.RabKod ~
Rabatt.RabProc Rabatt.RabBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Rabatt
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Rabatt
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Rabatt SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Rabatt
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Rabatt


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Rabatt.RabKod Rabatt.RabProc Rabatt.RabBeskr 
&Scoped-define ENABLED-TABLES Rabatt
&Scoped-define FIRST-ENABLED-TABLE Rabatt
&Scoped-define DISPLAYED-TABLES Rabatt
&Scoped-define FIRST-DISPLAYED-TABLE Rabatt
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help RECT-1 
&Scoped-Define DISPLAYED-FIELDS Rabatt.RabKod Rabatt.RabProc ~
Rabatt.RabBeskr 
...
DEFINE FRAME Dialog-Frame
     Rabatt.RabKod AT ROW 1.95 COL 11.8 COLON-ALIGNED
          LABEL "Rabatt"
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Rabatt.RabProc AT ROW 1.95 COL 17 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     Rabatt.RabBeskr AT ROW 1.95 COL 26.4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     Btn_OK AT ROW 3.48 COL 2.4
     Btn_Cancel AT ROW 3.48 COL 18
     Btn_Help AT ROW 3.48 COL 47.6
     RECT-1 AT ROW 1.38 COL 2
     SPACE(0.79) SKIP(1.37)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold rabattkoder"
...
/* SETTINGS FOR FILL-IN Rabatt.RabKod IN FRAME Dialog-Frame
   EXP-LABEL                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold rabattkoder */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Rabatt THEN 
    DISPLAY Rabatt.RabKod Rabatt.RabProc Rabatt.RabBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE Rabatt.RabKod Rabatt.RabProc Rabatt.RabBeskr Btn_OK Btn_Cancel 
         Btn_Help RECT-1 
      WITH FRAME Dialog-Frame.
