...
DEFINE TEMP-TABLE tAvdeling NO-UNDO LIKE Avdeling.
...
&scoped-define DB-BROWSER BROWSE-Avdeling

&scoped-define br-tabell Avdeling

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  AvdelingNr
...
&scoped-define index-col1  Avdeling
...
/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field2  AvdelingNavn
...
&scoped-define index-col2  AvdelingsNavn
...
&scoped-define BUFFER-COPY-USING USING AvdelingNavn
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Avdeling

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Avdeling tAvdeling

/* Definitions for BROWSE BROWSE-Avdeling                               */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Avdeling Avdeling.AvdelingNr ~
Avdeling.AvdelingNavn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Avdeling Avdeling.AvdelingNr ~
Avdeling.AvdelingNavn 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Avdeling Avdeling
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Avdeling Avdeling
&Scoped-define QUERY-STRING-BROWSE-Avdeling FOR EACH Avdeling NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Avdeling OPEN QUERY BROWSE-Avdeling FOR EACH Avdeling NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Avdeling Avdeling
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Avdeling Avdeling


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tAvdeling.AvdelingNr ~
tAvdeling.AvdelingNavn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tAvdeling.AvdelingNr ~
tAvdeling.AvdelingNavn 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tAvdeling
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tAvdeling
&Scoped-define QUERY-STRING-BROWSE-Tag FOR EACH tAvdeling NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tAvdeling NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tAvdeling
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tAvdeling


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Avdeling}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Avdeling BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Avdeling FOR 
      Avdeling
    FIELDS(Avdeling.AvdelingNr
      Avdeling.AvdelingNavn) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tAvdeling
    FIELDS(tAvdeling.AvdelingNr
      tAvdeling.AvdelingNavn) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Avdeling
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Avdeling Dialog-Frame _STRUCTURED
  QUERY BROWSE-Avdeling NO-LOCK DISPLAY
      Avdeling.AvdelingNr FORMAT ">>>9":U
      Avdeling.AvdelingNavn FORMAT "x(30)":U
  ENABLE
      Avdeling.AvdelingNr
      Avdeling.AvdelingNavn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 39 BY 12.19.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tAvdeling.AvdelingNr FORMAT ">>9":U
      tAvdeling.AvdelingNavn FORMAT "x(30)":U
  ENABLE
      tAvdeling.AvdelingNr
      tAvdeling.AvdelingNavn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 39 BY 12.19 ROW-HEIGHT-CHARS .62 EXPANDABLE.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-Avdeling AT ROW 2.91 COL 3
     BUTTON-LeggTil AT ROW 6.71 COL 44
     BUTTON-TrekkFra AT ROW 7.91 COL 44
     BUTTON-AlleFra AT ROW 9.1 COL 44
     BROWSE-Tag AT ROW 2.91 COL 61
     Btn_OK AT ROW 15.52 COL 2
     Btn_Cancel AT ROW 15.52 COL 15
     Btn_Help AT ROW 15.52 COL 89
     ...
     RECT-5 AT ROW 2.67 COL 60
     SPACE(0.39) SKIP(1.37)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Velg avdelinger"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tAvdeling T "?" NO-UNDO SkoTex Avdeling
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Avdeling 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Avdeling
/* Query rebuild information for BROWSE BROWSE-Avdeling
     _TblList          = "skotex.Avdeling"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.Avdeling.AvdelingNr
"AvdelingNr" ? ">>>9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Avdeling.AvdelingNavn
"AvdelingNavn" ? "x(30)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Avdeling */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tAvdeling"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tAvdeling.AvdelingNr
"AvdelingNr" ? ">>9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tAvdeling.AvdelingNavn
"AvdelingNavn" ? "x(30)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg avdelinger */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Avdeling
&Scoped-define SELF-NAME BROWSE-Avdeling
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Avdeling Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Avdeling IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Avdeling Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Avdeling IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Avdeling Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Avdeling IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Avdeling Dialog-Frame
ON START-SEARCH OF BROWSE-Avdeling IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Avdeling Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Avdeling IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Avdeling BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok 
         RECT-4 RECT-5 
      WITH FRAME Dialog-Frame.
