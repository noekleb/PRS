...
DEFINE SHARED TEMP-TABLE tmpFarg NO-UNDO LIKE Farg.
DEFINE TEMP-TABLE ttmpFarg NO-UNDO LIKE Farg.
...
&scoped-define DB-BROWSER BROWSE-tmpFarg

&scoped-define br-tabell tmpFarg
...
&scoped-define BUFFER-COPY-USING USING FarBeskr
...
&Scoped-define INTERNAL-TABLES ttmpFarg tmpFarg

/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag ttmpFarg.Farg ttmpFarg.FarBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag ttmpFarg.Farg 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag ttmpFarg
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag ttmpFarg
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH ttmpFarg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag ttmpFarg
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag ttmpFarg


/* Definitions for BROWSE BROWSE-tmpFarg                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-tmpFarg tmpFarg.Farg tmpFarg.FarBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-tmpFarg tmpFarg.Farg 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-tmpFarg tmpFarg
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-tmpFarg tmpFarg
&Scoped-define OPEN-QUERY-BROWSE-tmpFarg OPEN QUERY BROWSE-tmpFarg FOR EACH tmpFarg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-tmpFarg tmpFarg
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-tmpFarg tmpFarg


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-tmpFarg}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 BROWSE-tmpFarg BROWSE-Tag ~
...
DEFINE QUERY BROWSE-Tag FOR 
      ttmpFarg
    FIELDS(ttmpFarg.Farg
      ttmpFarg.FarBeskr) SCROLLING.

DEFINE QUERY BROWSE-tmpFarg FOR 
      tmpFarg
    FIELDS(tmpFarg.Farg
      tmpFarg.FarBeskr) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      ttmpFarg.Farg COLUMN-LABEL "Status"
      ttmpFarg.FarBeskr WIDTH 31.8
  ENABLE
      ttmpFarg.Farg
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 45 BY 7.38 ROW-HEIGHT-CHARS .62.

DEFINE BROWSE BROWSE-tmpFarg
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-tmpFarg Dialog-Frame _STRUCTURED
  QUERY BROWSE-tmpFarg NO-LOCK DISPLAY
      tmpFarg.Farg COLUMN-LABEL "Status"
      tmpFarg.FarBeskr WIDTH 31.8
  ENABLE
      tmpFarg.Farg
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-tmpFarg AT ROW 2.91 COL 3
     BUTTON-LeggTil AT ROW 5.05 COL 50
     BUTTON-TrekkFra AT ROW 6.24 COL 50
     BUTTON-AlleFra AT ROW 7.43 COL 50
     BROWSE-Tag AT ROW 2.91 COL 67
     Btn_OK AT ROW 10.76 COL 2
     Btn_Cancel AT ROW 10.76 COL 15
     Btn_Help AT ROW 10.76 COL 101
     ...
     SPACE(0.59) SKIP(1.46)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Velg bestillingsstatus"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tmpFarg T "SHARED" NO-UNDO skotex Farg
      TABLE: ttmpFarg T "?" NO-UNDO skotex Farg
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-tmpFarg 1 Dialog-Frame */
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.ttmpFarg"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.ttmpFarg.Farg
"Farg" "Status" ? "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.ttmpFarg.FarBeskr
"FarBeskr" ? ? "character" ? ? ? ? ? ? no ? no no "31.8"
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Tag */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-tmpFarg
/* Query rebuild information for BROWSE BROWSE-tmpFarg
     _TblList          = "Temp-Tables.tmpFarg"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tmpFarg.Farg
"Farg" "Status" ? "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.tmpFarg.FarBeskr
"FarBeskr" ? ? "character" ? ? ? ? ? ? no ? no no "31.8"
     _Query            is OPENED
*/  /* BROWSE BROWSE-tmpFarg */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg bestillingsstatus */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-tmpFarg
&Scoped-define SELF-NAME BROWSE-tmpFarg
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpFarg Dialog-Frame
ON CURSOR-LEFT OF BROWSE-tmpFarg IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpFarg Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-tmpFarg IN FRAME Dialog-Frame /* ? */
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpFarg Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-tmpFarg IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpFarg Dialog-Frame
ON START-SEARCH OF BROWSE-tmpFarg IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-tmpFarg Dialog-Frame
ON VALUE-CHANGED OF BROWSE-tmpFarg IN FRAME Dialog-Frame /* ? */
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-4 RECT-5 BROWSE-tmpFarg BROWSE-Tag Btn_OK Btn_Cancel Btn_Help 
         BUTTON-Sok 
      WITH FRAME Dialog-Frame.
