...
DO:
    OUTPUT TO VALUE(SESSION:TEMP-DIR + "SL-Sum-Jan-Aug.skv").
  FOR EACH TT_RapHodePB:
      EXPORT DELIMITER ";" TT_RapHodePB.
  END.
  OUTPUT CLOSE.
  OUTPUT TO VALUE(SESSION:TEMP-DIR + "SL-Art-Jan-Aug.skv").
...
DO:
  ...
  DEFINE VARIABLE dTmpSum   AS DECIMAL    NO-UNDO.
    ...
    DEFINE VARIABLE iKassaLoop AS INTEGER    NO-UNDO.
