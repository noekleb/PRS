...
DEFINE TEMP-TABLE tStrTStr NO-UNDO LIKE SkoTex.StrTStr
       field SoAnt as int.
...
&scoped-define DB-BROWSER BROWSE-StrTStr

&scoped-define br-tabell StrTStr

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  SeqNr
...
&scoped-define index-col1  StrTStr
&scoped-define sok-phrase1 FIND FIRST b{&br-tabell} WHERE ~
                b{&br-tabell}.StrTypeId = wStrTypeId and ~
...
&scoped-define init-sel-phrase FIND b{&br-tabell} where ~
        b{&br-tabell}.StrTypeId = wStrTypeId and ~
        b{&br-tabell}.{&sok-field1} = INT(ENTRY(2,ENTRY(wAntEntries,IO-Liste),';')) no-lock no-error.

&scoped-define Assign-IO-Liste string(t{&br-tabell}.StrTypeId) + ";" + ~
                               string(t{&br-tabell}.{&sok-field1}) + ";" + ~
                               t{&br-tabell}.SoStorl + ";" + ~
                               string(t{&br-tabell}.SoAnt)
...
&scoped-define BUFFER-COPY-USING USING StrTStr.SoStorl
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-StrTStr

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES StrTStr tStrTStr

/* Definitions for BROWSE BROWSE-StrTStr                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-StrTStr StrTStr.SeqNr StrTStr.SoStorl 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-StrTStr StrTStr.SeqNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-StrTStr StrTStr
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-StrTStr StrTStr
&Scoped-define OPEN-QUERY-BROWSE-StrTStr OPEN QUERY BROWSE-StrTStr FOR EACH StrTStr ~
      WHERE StrTStr.StrTypeId = wStrTypeId NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-StrTStr StrTStr
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-StrTStr StrTStr


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tStrTStr.SeqNr tStrTStr.SoStorl 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tStrTStr.SeqNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tStrTStr
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tStrTStr
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tStrTStr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tStrTStr
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tStrTStr


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-StrTStr}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-4 RECT-5 BROWSE-StrTStr BROWSE-Tag ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-StrTStr FOR 
      StrTStr
    FIELDS(StrTStr.SeqNr
      StrTStr.SoStorl) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tStrTStr
    FIELDS(tStrTStr.SeqNr
      tStrTStr.SoStorl) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-StrTStr
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-StrTStr Dialog-Frame _STRUCTURED
  QUERY BROWSE-StrTStr NO-LOCK DISPLAY
      StrTStr.SeqNr COLUMN-LABEL "SeqNr *"
      StrTStr.SoStorl COLUMN-LABEL "Størrelse"
  ENABLE
      StrTStr.SeqNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 22.4 BY 12.19.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tStrTStr.SeqNr COLUMN-LABEL "SeqNr *"
      tStrTStr.SoStorl COLUMN-LABEL "Størrelse"
  ENABLE
      tStrTStr.SeqNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-StrTStr AT ROW 2.91 COL 3
     BUTTON-LeggTil AT ROW 7 COL 27
     BUTTON-TrekkFra AT ROW 8.19 COL 27
     BUTTON-AlleFra AT ROW 9.38 COL 27
     BROWSE-Tag AT ROW 2.95 COL 44
     Btn_OK AT ROW 15.52 COL 2
     Btn_Cancel AT ROW 15.52 COL 15
     Btn_Help AT ROW 15.57 COL 55.2
     ...
     RECT-5 AT ROW 2.71 COL 43
     SPACE(0.19) SKIP(1.34)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Velg størrelser fra"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-StrTStr 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-StrTStr
/* Query rebuild information for BROWSE BROWSE-StrTStr
     _TblList          = "SkoTex.StrTStr"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _Where[1]         = "StrTStr.StrTypeId = wStrTypeId"
     _FldNameList[1]   > SkoTex.StrTStr.SeqNr
"StrTStr.SeqNr" "SeqNr *" ? "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > SkoTex.StrTStr.SoStorl
"StrTStr.SoStorl" "Størrelse" ? "character" ? ? ? ? ? ? no ? no no ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-StrTStr */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-Tag
     ...
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tStrTStr.SeqNr
"SeqNr" "SeqNr *" ? "integer" ? ? ? ? ? ? yes ? no no ?
     _FldNameList[2]   > Temp-Tables.tStrTStr.SoStorl
"SoStorl" "Størrelse" ? "character" ? ? ? ? ? ? no ? no no ?
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg størrelser fra */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-StrTStr
&Scoped-define SELF-NAME BROWSE-StrTStr
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StrTStr Dialog-Frame
ON CURSOR-LEFT OF BROWSE-StrTStr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StrTStr Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-StrTStr IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StrTStr Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-StrTStr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StrTStr Dialog-Frame
ON START-SEARCH OF BROWSE-StrTStr IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-StrTStr Dialog-Frame
ON VALUE-CHANGED OF BROWSE-StrTStr IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
    assign
      ...
      string(StrType.StrTypeId) + " " + StrType.KortNavn + " " + StrType.Beskrivelse.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-4 RECT-5 BROWSE-StrTStr BROWSE-Tag Btn_OK Btn_Cancel Btn_Help 
         BUTTON-Sok 
      WITH FRAME Dialog-Frame.
...
------------------------------------------------------------------------------*/
  def var wTekst as char no-undo.
    ...
    DO wAntEntries = 1 TO NUM-ENTRIES(IO-Liste,"!") WITH FRAME {&FRAME-NAME}:
        assign
          wTekst = entry(wAntEntries,IO-Liste,"!").
          
        FIND first b{&br-tabell} where 
          b{&br-tabell}.StrTypeId = wStrTypeId and 
          b{&br-tabell}.SoStorl   = ENTRY(4,wTekst,';') no-lock no-error.
        
        IF AVAIL b{&br-tabell} THEN DO:
            CREATE t{&br-tabell}.
            assign
              wAntValgt               = wAntValgt + 1            
              t{&br-tabell}.SeqNr     = b{&br-tabell}.SeqNr
              t{&br-tabell}.SoStorl   = b{&br-tabell}.SoStorl
              t{&br-tabell}.SoAnt     = int(entry(5,wTekst, ';')).
        END.
    END.
    assign
      IO-Liste = "".
