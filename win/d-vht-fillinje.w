...
&scoped-define br-tabell HT-FilLinje
&scoped-define KeyFelt LinjeId
...
&scoped-define VisPoster HT-FilLinje.LinjeId when available HT-FilLinje ~
                         HT-FilLinje.LinjeData when available HT-FilLinje
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
          if int({&br-tabell}.{&KeyFelt}:screen-value) = 0 then ~
            ...
            message "{&br-tabell} finnes allerede med LinjeId:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame HT-FilLinje.LinjeId ~
HT-FilLinje.LinjeData 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame HT-FilLinje.LinjeData 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame HT-FilLinje
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame HT-FilLinje
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH HT-FilLinje SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame HT-FilLinje
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame HT-FilLinje


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS HT-FilLinje.LinjeData 
&Scoped-define ENABLED-TABLES HT-FilLinje
&Scoped-define FIRST-ENABLED-TABLE HT-FilLinje
&Scoped-define DISPLAYED-TABLES HT-FilLinje
&Scoped-define FIRST-DISPLAYED-TABLE HT-FilLinje
&Scoped-Define ENABLED-OBJECTS RECT-55 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS HT-FilLinje.LinjeId HT-FilLinje.LinjeData 
...
DEFINE FRAME Dialog-Frame
     HT-FilLinje.LinjeId AT ROW 1.95 COL 14 COLON-ALIGNED
          LABEL "Linje"
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     HT-FilLinje.LinjeData AT ROW 1.95 COL 28 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 52 BY 1
     Btn_OK AT ROW 4.33 COL 3
     Btn_Cancel AT ROW 4.33 COL 19
     Btn_Help AT ROW 4.33 COL 70
     RECT-55 AT ROW 1.24 COL 3
     SPACE(1.39) SKIP(1.80)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold linjedata"
...
/* SETTINGS FOR FILL-IN HT-FilLinje.LinjeId IN FRAME Dialog-Frame
   NO-ENABLE EXP-LABEL                                                  */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold linjedata */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE HT-FilLinje THEN 
    DISPLAY HT-FilLinje.LinjeId HT-FilLinje.LinjeData 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-55 HT-FilLinje.LinjeData Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
