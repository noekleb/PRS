...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wRegKode LIKE Region.RegKode INIT 31 NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wRegKode LIKE Region.RegKode NO-UNDO.
&ENDIF
...
&scoped-define ip-variabel wRegKode
&scoped-define return-ip   wRegKode = Region.RegKode.
&scoped-define assign-retur-verdi retur-verdi = string(recid(Region)).
...
&scoped-define KanSlettes ~
  if can-find(first Medlem where Medlem.RegKode = Region.RegKode) then ~
    do: ~
      message "Det finns medlemmer med denne Region" ~
      view-as alert-box title "Feil ved sletting av Regionkunde". ~
      return no-apply. ~
    end.

&scoped-define VedlikeholdsRutine d-vregion.w
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Region BUTTON-Ny BUTTON-Endre ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 47 BY 7.38 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Region AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 2.91 COL 50
     BUTTON-Endre AT ROW 4.24 COL 50
     BUTTON-Slett AT ROW 5.57 COL 50
     Btn_Help AT ROW 10.76 COL 34
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     SPACE(44.19) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste regioner"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Region BUTTON-Sok Dialog-Frame */
ASSIGN 
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste regioner */
DO:
...
ON ANY-PRINTABLE OF BROWSE-Region IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Region BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_Help Btn_OK 
         Btn_Cancel 
      WITH FRAME Dialog-Frame.
