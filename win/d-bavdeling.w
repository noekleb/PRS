...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wAvdelingNr LIKE Avdeling.AvdelingNr NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wAvdelingNr LIKE Avdeling.AvdelingNr NO-UNDO.
&ENDIF
...
&scoped-define ip-variabel wAvdelingNr
&scoped-define return-ip   wAvdelingNr = Avdeling.AvdelingNr.
&scoped-define assign-retur-verdi retur-verdi = string(Recid(Avdeling)).
...
&Scoped-define INTERNAL-TABLES Avdeling
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Avdeling Btn_Help Btn_OK Btn_Cancel 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Avdeling Dialog-Frame _STRUCTURED
  QUERY BROWSE-Avdeling NO-LOCK DISPLAY
      Avdeling.AvdelingNr COLUMN-LABEL "AvdelingNr *" FORMAT ">>>9":U
      Avdeling.AvdelingNavn COLUMN-LABEL "Navn *" FORMAT "X(30)":U
            WIDTH 33
  ENABLE
      Avdeling.AvdelingNr
      Avdeling.AvdelingNavn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 50 BY 7.38 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Avdeling AT ROW 2.91 COL 2
     Btn_Help AT ROW 10.76 COL 40
     Btn_OK AT ROW 10.81 COL 1.8
     Btn_Cancel AT ROW 10.81 COL 14.4
     SPACE(25.79) SKIP(0.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste avdelinger"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Avdeling BUTTON-Sok Dialog-Frame */
ASSIGN 
...
"AvdelingNr" "AvdelingNr *" ">>>9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Avdeling.AvdelingNavn
"AvdelingNavn" "Navn *" ? "character" ? ? ? ? ? ? yes ? no no "33" yes no no "U" "" ""
     _Query            is OPENED
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste avdelinger */
DO:
...
ON ANY-PRINTABLE OF BROWSE-Avdeling IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Avdeling Btn_Help Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
