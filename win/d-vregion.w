...
&scoped-define VisPoster ~
  Region.RegKode      when available Region ~
  Region.Navn when available Region
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Region.RegKode Region.Navn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Region.RegKode ~
Region.Navn 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Region
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Region
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Region SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Region
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Region


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Region.RegKode Region.Navn 
&Scoped-define ENABLED-TABLES Region
&Scoped-define FIRST-ENABLED-TABLE Region
&Scoped-define DISPLAYED-TABLES Region
&Scoped-define FIRST-DISPLAYED-TABLE Region
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help RECT-1 
&Scoped-Define DISPLAYED-FIELDS Region.RegKode Region.Navn 
...
DEFINE FRAME Dialog-Frame
     Region.RegKode AT ROW 1.95 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     Region.Navn AT ROW 1.95 COL 33 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     Btn_OK AT ROW 3.95 COL 2
     Btn_Cancel AT ROW 3.95 COL 17.6
     Btn_Help AT ROW 3.95 COL 58
     RECT-1 AT ROW 1.38 COL 2
     SPACE(0.99) SKIP(1.56)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold regioner"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold regioner */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Region THEN 
    DISPLAY Region.RegKode Region.Navn 
      WITH FRAME Dialog-Frame.
  ENABLE Region.RegKode Region.Navn Btn_OK Btn_Cancel Btn_Help RECT-1 
      WITH FRAME Dialog-Frame.
