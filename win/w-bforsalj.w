...
&scope br-tabell   Forsalj
&scope Sorttype    ,,
&scope BrowseIdx   ,,
&scope Sokvillkor  >=,>=,>=
&scope InitIdx     ForsalIn  
&scope ip-felt     
...
{runlib.i}
DEFINE TEMP-TABLE tmpForsalj LIKE Forsalj
...
&Scoped-define BROWSE-NAME BROWSE-Forsalj
&Scoped-define QUERY-NAME QUERY-Alle

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Forsalj bForsalj tmpForsalj

/* Definitions for BROWSE BROWSE-Forsalj                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Forsalj Forsalj.ForsNr Forsalj.FoNamn ~
Forsalj.ButikkNr Forsalj.navnikasse Forsalj.FoAnstNr Forsalj.FoPersNr ~
Forsalj.FoAdr Forsalj.FoPoNr Forsalj.FoPadr Forsalj.FoTel 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Forsalj Forsalj.ForsNr ~
Forsalj.FoNamn Forsalj.navnikasse 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Forsalj Forsalj
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Forsalj Forsalj
&Scoped-define QUERY-STRING-BROWSE-Forsalj FOR EACH Forsalj NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Forsalj OPEN QUERY BROWSE-Forsalj FOR EACH Forsalj NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Forsalj Forsalj
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Forsalj Forsalj
...
&Scoped-define QUERY-STRING-QUERY-Alle FOR EACH bForsalj NO-LOCK BY ForsNr
&Scoped-define OPEN-QUERY-QUERY-Alle OPEN QUERY {&SELF-NAME} FOR EACH bForsalj NO-LOCK BY ForsNr.
&Scoped-define TABLES-IN-QUERY-QUERY-Alle bForsalj
&Scoped-define FIRST-TABLE-IN-QUERY-QUERY-Alle bForsalj


/* Definitions for QUERY QUERY-tmp                                      */
&Scoped-define SELF-NAME QUERY-tmp
&Scoped-define QUERY-STRING-QUERY-tmp FOR EACH tmpForsalj NO-LOCK BY tmpForsalj.Ordning
&Scoped-define OPEN-QUERY-QUERY-tmp OPEN QUERY {&SELF-NAME} FOR EACH tmpForsalj NO-LOCK BY tmpForsalj.Ordning.
&Scoped-define TABLES-IN-QUERY-QUERY-tmp tmpForsalj
&Scoped-define FIRST-TABLE-IN-QUERY-QUERY-tmp tmpForsalj
...
DEFINE BUTTON BUTTON-Endre 
     ...
     LABEL "&Endre.." 
     SIZE 4.6 BY 1.1 TOOLTIP "Endre varegruppe (Alt-E)".

DEFINE BUTTON BUTTON-Ny 
     IMAGE-UP FILE "icon/e-ny":U
     LABEL "&Ny.." 
     SIZE 4.6 BY 1.1 TOOLTIP "Opprette ny varegruppe (Alt-N)".

DEFINE BUTTON BUTTON-Slett 
     IMAGE-UP FILE "icon/e-del":U
     LABEL "&Slette" 
     SIZE 4.6 BY 1.1 TOOLTIP "Ta bort varegruppe (Alt-D)".
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Forsalj FOR 
      Forsalj SCROLLING.
...
DEFINE QUERY QUERY-tmp FOR 
      tmpForsalj SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Forsalj
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Forsalj C-Win _STRUCTURED
  QUERY BROWSE-Forsalj NO-LOCK DISPLAY
      Forsalj.ForsNr FORMAT "zzzzz9":U WIDTH 10.2
      Forsalj.FoNamn FORMAT "x(30)":U
      Forsalj.ButikkNr FORMAT ">>>>>9":U
      Forsalj.navnikasse FORMAT "X(15)":U
      Forsalj.FoAnstNr FORMAT "999999":U
      Forsalj.FoPersNr FORMAT "zzzzzzzzzz9":U
      Forsalj.FoAdr FORMAT "x(30)":U
      Forsalj.FoPoNr FORMAT "x(6)":U
      Forsalj.FoPadr COLUMN-LABEL "Postadresse" FORMAT "x(30)":U
      Forsalj.FoTel FORMAT "x(15)":U
  ENABLE
      Forsalj.ForsNr
      Forsalj.FoNamn
      Forsalj.navnikasse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN MULTIPLE SIZE 155 BY 17.86 ROW-HEIGHT-CHARS .62.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     BROWSE-Forsalj AT ROW 6.95 COL 2
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-Forsalj BUTTON-Sok DEFAULT-FRAME */
ASSIGN 
...
/* SETTINGS FOR BUTTON B-Print IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
ASSIGN 
       BROWSE-Forsalj:NUM-LOCKED-COLUMNS IN FRAME DEFAULT-FRAME     = 2
       BROWSE-Forsalj:MAX-DATA-GUESS IN FRAME DEFAULT-FRAME         = 481
       BROWSE-Forsalj:COLUMN-RESIZABLE IN FRAME DEFAULT-FRAME       = TRUE.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Forsalj
/* Query rebuild information for BROWSE BROWSE-Forsalj
     _TblList          = "SkoTex.Forsalj"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Forsalj.ForsNr
"Forsalj.ForsNr" ? "zzzzz9" "integer" ? ? ? ? ? ? yes ? no no "10.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > SkoTex.Forsalj.FoNamn
"Forsalj.FoNamn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = SkoTex.Forsalj.ButikkNr
     _FldNameList[4]   > SkoTex.Forsalj.navnikasse
"Forsalj.navnikasse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = SkoTex.Forsalj.FoAnstNr
     _FldNameList[6]   = SkoTex.Forsalj.FoPersNr
     _FldNameList[7]   = SkoTex.Forsalj.FoAdr
     _FldNameList[8]   = SkoTex.Forsalj.FoPoNr
     _FldNameList[9]   > SkoTex.Forsalj.FoPadr
"Forsalj.FoPadr" "Postadresse" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = SkoTex.Forsalj.FoTel
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Forsalj */
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY QUERY-Alle
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH bForsalj NO-LOCK BY ForsNr.
     _END_FREEFORM
...
/* Query rebuild information for QUERY QUERY-tmp
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tmpForsalj NO-LOCK BY tmpForsalj.Ordning.
     _END_FREEFORM
...
ON END-ERROR OF C-Win /* Søkeliste kasserer */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Søkeliste kasserer */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Søkeliste kasserer */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Forsalj
&Scoped-define SELF-NAME BROWSE-Forsalj
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj C-Win
ON ANY-PRINTABLE OF BROWSE-Forsalj IN FRAME DEFAULT-FRAME
DO:
  if lastkey <> 32 then
    do:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj C-Win
ON CURSOR-LEFT OF BROWSE-Forsalj IN FRAME DEFAULT-FRAME
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj C-Win
ON CURSOR-RIGHT OF BROWSE-Forsalj IN FRAME DEFAULT-FRAME
DO:
  IF wAntSortCol < 2 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj C-Win
ON DEFAULT-ACTION OF BROWSE-Forsalj IN FRAME DEFAULT-FRAME
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj C-Win
ON HOME OF BROWSE-Forsalj IN FRAME DEFAULT-FRAME
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj C-Win
ON START-SEARCH OF BROWSE-Forsalj IN FRAME DEFAULT-FRAME
DO:
...
DO:
  ...
  run w-vForsalj PERSISTENT SET wTmpChild (recid({&br-tabell}),"ENDRE").
  CREATE tmpChild.
...
DO:
  DEF VAR wTmpChild AS HANDLE NO-UNDO.
  run w-vForsalj PERSISTENT SET wTmpChild (?,"NY").
  CREATE tmpChild.
  ASSIGN tmpChild.wChild = wTmpChild.
  RELEASE tmpChild.
  RETURN NO-APPLY.  
...
/*
  ...
  */
  ...
  run w-vForsalj (recid({&br-tabell}),"SLETT").
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-50 RECT-51 RECT-52 FILL-IN-SOK-DECI FILL-IN-SOK-INTE 
         ...
         B-Excel B-Rapp B-Oppdater Btn_Help Btn_OK BUTTON-Sok BROWSE-Forsalj 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VAR hForsalj     AS HANDLE NO-UNDO.
 ...
 DO WITH FRAME {&FRAME-NAME}:
  ...
  IF RETURN-VALUE = "TMP" THEN DO:
     ...
     OPEN QUERY QUERY-tmp FOR EACH tmpForsalj NO-LOCK BY tmpForsalj.Ordning.
  END.
  ELSE DO:
      ASSIGN hQuery = QUERY QUERY-Alle:HANDLE
             hForsalj = {&BROWSE-NAME}:QUERY.
      hQuery:QUERY-PREPARE(REPLACE(hForsalj:PREPARE-STRING,"Forsalj","bForsalj")).
      hQuery:QUERY-OPEN().
  END.
  DO:
...
------------------------------------------------------------------------------*/
  ...
  IF iBrukerType = 2 THEN
      wWhere = 'NO-LOCK where Forsalj.ButikkNr = ' + STRING(iButikkNr) + ' '.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE SkapaTmpForsalj C-Win 
PROCEDURE SkapaTmpForsalj :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  def var wSvar as log no-undo.
  def var wLoop as int no-undo.
    EMPTY TEMP-TABLE tmpForsalj. /* [ NO-ERROR ] */
    wSvar = false.
    if BROWSE BROWSE-Forsalj:NUM-SELECTED-ROWS > 1 then do:  
      message "Skal rapport startes for de merkede selgerne?"
              view-as alert-box question buttons yes-no title "Bekreft utskrift"
              update wSvar.
      IF wSvar = TRUE THEN DO:
          do wLoop = 1 to BROWSE BROWSE-Forsalj:NUM-SELECTED-ROWS:
              IF BROWSE BROWSE-Forsalj:FETCH-SELECTED-ROW(wLoop) THEN DO:
                  create tmpForsalj.
                  ASSIGN tmpForsalj.ForsNr   = Forsalj.ForsNr
                         tmpForsalj.Ordning = wLoop.
                  RELEASE tmpForsalj.
              END.
          end.
          RETURN "TMP".
      ...
      ELSE
        ...
        message "Skal utskrift startes for ALLE selgere?"
              view-as alert-box question buttons yes-no title "Bekreft utskrift"
              update wSvar.
