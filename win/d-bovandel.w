...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wOv-Id LIKE Ovandel.Ov-Id NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wOv-Id LIKE Ovandel.Ov-Id NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   Ovandel

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  Ov-Id
...
&scoped-define index-col1  Ovandel
...
&scoped-define sok-field2  OvBeskr
...
&scoped-define index-col2  Ov-Txt
...
&scoped-define ip-variabel wOv-Id
&scoped-define return-ip   wOv-Id = Ovandel.Ov-Id.
&scoped-define assign-retur-verdi retur-verdi = string(recid(Ovandel)).
...
&scoped-define KanSlettes ~
  if can-find(first ArtBas where ArtBas.Ov-Id = Ovandel.Ov-Id) then ~
    do: ~
...
&scoped-define VedlikeholdsRutine d-vovandel.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Ovandel

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Ovandel

/* Definitions for BROWSE BROWSE-Ovandel                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Ovandel Ovandel.Ov-Id Ovandel.OvBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Ovandel Ovandel.Ov-Id ~
Ovandel.OvBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Ovandel Ovandel
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Ovandel Ovandel
&Scoped-define QUERY-STRING-BROWSE-Ovandel FOR EACH Ovandel NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Ovandel OPEN QUERY BROWSE-Ovandel FOR EACH Ovandel NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Ovandel Ovandel
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Ovandel Ovandel


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Ovandel}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-DATE FILL-IN-SOK-CHAR ~
FILL-IN-SOK-INT BUTTON-Sok BROWSE-Ovandel BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Ovandel FOR 
      Ovandel SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Ovandel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Ovandel Dialog-Frame _STRUCTURED
  QUERY BROWSE-Ovandel NO-LOCK DISPLAY
      Ovandel.Ov-Id COLUMN-LABEL "Fo *" FORMAT "z9":U
      Ovandel.OvBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(30)":U
  ENABLE
      Ovandel.Ov-Id
      Ovandel.OvBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 39.8 BY 7.71.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Ovandel AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 3 COL 43
     BUTTON-Endre AT ROW 4.33 COL 43
     BUTTON-Slett AT ROW 5.67 COL 43
     Btn_OK AT ROW 10.81 COL 1.6
     Btn_Cancel AT ROW 10.81 COL 14
     Btn_Help AT ROW 10.81 COL 43
     SPACE(0.39) SKIP(0.04)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste koder foder"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Ovandel BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Ovandel
/* Query rebuild information for BROWSE BROWSE-Ovandel
     _TblList          = "SkoTex.Ovandel"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Ovandel.Ov-Id
"Ovandel.Ov-Id" "Fo *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Ovandel.OvBeskr
"Ovandel.OvBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Ovandel */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste koder foder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Ovandel
&Scoped-define SELF-NAME BROWSE-Ovandel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Ovandel Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Ovandel IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Ovandel Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Ovandel IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Ovandel Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Ovandel IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Ovandel Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Ovandel IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Ovandel Dialog-Frame
ON START-SEARCH OF BROWSE-Ovandel IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
{syspara.i 16 20 2 iTilgang INT}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-DATE FILL-IN-SOK-CHAR FILL-IN-SOK-INT BUTTON-Sok 
         BROWSE-Ovandel BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
