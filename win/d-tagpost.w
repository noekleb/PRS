...
DEFINE TEMP-TABLE tPost NO-UNDO LIKE Post.
...
&scoped-define DB-BROWSER BROWSE-Post
...
&Scoped-define INTERNAL-TABLES Post tPost
...
&Scoped-define OPEN-QUERY-BROWSE-Post OPEN QUERY BROWSE-Post FOR EACH Post NO-LOCK ~
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tPost.PostNr tPost.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tPost.PostNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tPost
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tPost
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tPost NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tPost
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tPost
...
&Scoped-Define ENABLED-OBJECTS BROWSE-Post BROWSE-Tag Btn_OK Btn_Cancel ~
...
DEFINE QUERY BROWSE-Post FOR 
      Post
    FIELDS(Post.PostNr
      Post.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tPost
    FIELDS(tPost.PostNr
      tPost.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Post
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Post Dialog-Frame _STRUCTURED
  QUERY BROWSE-Post NO-LOCK DISPLAY
      Post.PostNr FORMAT "X(10)":U
      Post.Beskrivelse COLUMN-LABEL "Beskrivelse" FORMAT "X(30)":U
  ENABLE
      Post.PostNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tPost.PostNr FORMAT "X(10)":U
      tPost.Beskrivelse COLUMN-LABEL "Beskrivelse" FORMAT "X(30)":U
  ENABLE
      tPost.PostNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tPost T "?" NO-UNDO skotex Post
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Post 1 Dialog-Frame */
...
"PostNr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tPost"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tPost.PostNr
"PostNr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tPost.Beskrivelse
"Beskrivelse" "Beskrivelse" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg postnummer */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Post Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Post IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Post Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Post IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Post Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Post IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Post Dialog-Frame
ON START-SEARCH OF BROWSE-Post IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Post Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Post IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Post BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
