...
DEFINE TEMP-TABLE tForsalj NO-UNDO LIKE Forsalj.
...
&scoped-define DB-BROWSER BROWSE-Forsalj

&scoped-define br-tabell Forsalj

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  ForsNr
...
&scoped-define index-col1  Forsalin
...
/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field2  FoNamn
...
&scoped-define index-col2  FoNamn
...
&scoped-define BUFFER-COPY-USING USING FoNamn
...
&Scoped-define INTERNAL-TABLES Forsalj tForsalj
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tForsalj.ForsNr tForsalj.FoNamn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tForsalj.ForsNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tForsalj
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tForsalj
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tForsalj NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tForsalj
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tForsalj


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Forsalj}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Forsalj BROWSE-Tag Btn_OK Btn_Cancel ~
...
DEFINE QUERY BROWSE-Forsalj FOR 
      Forsalj
    FIELDS(Forsalj.ForsNr
      Forsalj.FoNamn
      Forsalj.ForsaljAktiv) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tForsalj
    FIELDS(tForsalj.ForsNr
      tForsalj.FoNamn) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Forsalj
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Forsalj Dialog-Frame _STRUCTURED
  QUERY BROWSE-Forsalj NO-LOCK DISPLAY
      Forsalj.ForsNr COLUMN-LABEL "Kasserer" FORMAT "zzz9":U
      Forsalj.FoNamn FORMAT "x(30)":U
      Forsalj.ForsaljAktiv FORMAT "*/":U COLUMN-FONT 8
  ENABLE
      Forsalj.ForsNr HELP "Kasserers nummer"
      Forsalj.FoNamn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 51.2 BY 12.19.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tForsalj.ForsNr COLUMN-LABEL "Kasserer" FORMAT "zzz9":U
      tForsalj.FoNamn FORMAT "x(30)":U
  ENABLE
      tForsalj.ForsNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 46 BY 12.19 ROW-HEIGHT-CHARS .62.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-Forsalj AT ROW 2.91 COL 2.8
     BUTTON-LeggTil AT ROW 6.71 COL 56
     BUTTON-TrekkFra AT ROW 7.91 COL 56
     BUTTON-AlleFra AT ROW 9.1 COL 56
     BROWSE-Tag AT ROW 2.81 COL 73
     Btn_OK AT ROW 15.52 COL 2
     Btn_Cancel AT ROW 15.52 COL 15
     Btn_Help AT ROW 15.52 COL 108
     ...
     RECT-5 AT ROW 2.57 COL 72
     SPACE(1.39) SKIP(1.38)
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tForsalj T "?" NO-UNDO SkoTex Forsalj
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Forsalj 1 Dialog-Frame */
...
"ForsNr" "Kasserer" "zzz9" "integer" ? ? ? ? ? ? yes "Kasserers nummer" no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Forsalj.FoNamn
"FoNamn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > skotex.Forsalj.ForsaljAktiv
"ForsaljAktiv" ? "*~~/" "logical" ? ? 8 ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tForsalj"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tForsalj.ForsNr
"tForsalj.ForsNr" "Kasserer" "zzz9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tForsalj.FoNamn
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg selgere */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Forsalj IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Forsalj IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Forsalj IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj Dialog-Frame
ON START-SEARCH OF BROWSE-Forsalj IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Forsalj Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Forsalj IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Forsalj BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
    ...
    CASE wType:
        WHEN "Til" THEN DO:
            DO wAntSel = 1 TO BROWSE {&DB-BROWSER}:NUM-SELECTED-ROWS:
                ...
                IF {&br-tabell}.ForsaljAktiv = FALSE THEN
                    NEXT.
