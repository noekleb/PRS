...
&scoped-define VisPoster ~
  Ovandel.Ov-Id when available Ovandel ~
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
            message "{&br-tabell} finnes allerede med ovandelnr:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Ovandel.Ov-Id Ovandel.OvBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Ovandel.Ov-Id ~
Ovandel.OvBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Ovandel
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Ovandel
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Ovandel SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Ovandel
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Ovandel


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Ovandel.Ov-Id Ovandel.OvBeskr 
&Scoped-define ENABLED-TABLES Ovandel
&Scoped-define FIRST-ENABLED-TABLE Ovandel
&Scoped-define DISPLAYED-TABLES Ovandel
&Scoped-define FIRST-DISPLAYED-TABLE Ovandel
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS Ovandel.Ov-Id Ovandel.OvBeskr 
...
DEFINE FRAME Dialog-Frame
     Ovandel.Ov-Id AT ROW 1.86 COL 12.8 COLON-ALIGNED
          LABEL "Foder"
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Ovandel.OvBeskr AT ROW 1.86 COL 17.6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     Btn_OK AT ROW 3.48 COL 2.4
     Btn_Cancel AT ROW 3.48 COL 18
     Btn_Help AT ROW 3.48 COL 38.6
     RECT-1 AT ROW 1.38 COL 2
     SPACE(0.39) SKIP(1.46)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold foder"
...
/* SETTINGS FOR FILL-IN Ovandel.Ov-Id IN FRAME Dialog-Frame
   EXP-LABEL                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold foder */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Ovandel THEN 
    DISPLAY Ovandel.Ov-Id Ovandel.OvBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 Ovandel.Ov-Id Ovandel.OvBeskr Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
