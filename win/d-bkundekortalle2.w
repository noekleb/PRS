...
&scope QWhere ~
  'KundeKort.KundeNr = ' + STRING(lKundeNr)
...
&Scoped-define OPEN-QUERY-BROWSE-Kundekort OPEN QUERY BROWSE-Kundekort FOR EACH KundeKort ~
      WHERE KundeKort.KundeNr = lKundeNr NO-LOCK ~
...
/* Query rebuild information for BROWSE BROWSE-Kundekort
     ...
     _Where[1]         = "KundeKort.KundeNr = lKundeNr"
...
"KundeKort.Innehaver" ? ? "character" ? ? ? ? ? ? no ? no no "22.4" yes no no "U" "" ""
     _Query            is OPENED
