...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wInnkjKode LIKE Innkjopsgrupper.InnkjKode INIT 31 NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wInnkjKode LIKE Innkjopsgrupper.InnkjKode NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   Innkjopsgrupper

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  InnkjKode
...
&scoped-define index-col1  InnkjKode
...
&scoped-define sok-field2  InnkjBeskr
...
&scoped-define index-col2  InnkjBeskr
...
&scoped-define ip-variabel wInnkjKode

&scoped-define return-ip   wInnkjKode = Innkjopsgrupper.InnkjKode.
&scoped-define assign-retur-verdi retur-verdi = string(recid(Innkjopsgrupper)).
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Innkjop

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Innkjopsgrupper

/* Definitions for BROWSE BROWSE-Innkjop                                */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Innkjop Innkjopsgrupper.InnkjKode ~
Innkjopsgrupper.InnkjBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Innkjop ~
Innkjopsgrupper.InnkjKode Innkjopsgrupper.InnkjBeskr 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-Innkjop~
 ~{&FP1}InnkjKode ~{&FP2}InnkjKode ~{&FP3}~
 ~{&FP1}InnkjBeskr ~{&FP2}InnkjBeskr ~{&FP3}
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Innkjop Innkjopsgrupper
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Innkjop Innkjopsgrupper
&Scoped-define OPEN-QUERY-BROWSE-Innkjop OPEN QUERY BROWSE-Innkjop FOR EACH Innkjopsgrupper NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Innkjop Innkjopsgrupper
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Innkjop Innkjopsgrupper


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Innkjop}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INT ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Innkjop Btn_OK Btn_Cancel Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Innkjop FOR 
      Innkjopsgrupper SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Innkjop
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Innkjop Dialog-Frame _STRUCTURED
  QUERY BROWSE-Innkjop NO-LOCK DISPLAY
      Innkjopsgrupper.InnkjKode COLUMN-LABEL "IGrp *"
      Innkjopsgrupper.InnkjBeskr COLUMN-LABEL "Beskrivelse *"
  ENABLE
      Innkjopsgrupper.InnkjKode
      Innkjopsgrupper.InnkjBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 40.6 BY 7.38.
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Innkjop BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Innkjop
/* Query rebuild information for BROWSE BROWSE-Innkjop
     _TblList          = "SkoTex.Innkjopsgrupper"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Innkjopsgrupper.InnkjKode
"InnkjKode" "IGrp *" ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > SkoTex.Innkjopsgrupper.InnkjBeskr
"InnkjBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-Innkjop */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste innkjøpsgrupper */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Innkjop
&Scoped-define SELF-NAME BROWSE-Innkjop
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innkjop Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Innkjop IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innkjop Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Innkjop IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innkjop Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Innkjop IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innkjop Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Innkjop IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innkjop Dialog-Frame
ON START-SEARCH OF BROWSE-Innkjop IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Innkjop Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
