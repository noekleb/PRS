...
&scoped-define VisPoster ~
  TransType.TTId when available TransType ~
  TransType.Beskrivelse when available TransType ~
  TransType.Notat when available TransType ~
  TransType.Aktiv WHEN AVAILABLE TransType
...
/* Ved sletting - Sjekker om finnes fra før */
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
          if int({&br-tabell}.{&KeyFelt}:screen-value) = 0 then ~
            ...
            message "{&br-tabell} finnes allerede med transtype:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame TransType.TTId ~
TransType.Beskrivelse TransType.Aktiv TransType.Notat 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame TransType.Beskrivelse ~
TransType.Aktiv TransType.Notat 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame TransType
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame TransType
&Scoped-define QUERY-STRING-Dialog-Frame FOR EACH TransType SHARE-LOCK
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH TransType SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame TransType
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame TransType


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS TransType.Beskrivelse TransType.Aktiv ~
TransType.Notat 
&Scoped-define ENABLED-TABLES TransType
&Scoped-define FIRST-ENABLED-TABLE TransType
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS TransType.TTId TransType.Beskrivelse ~
TransType.Aktiv TransType.Notat 
&Scoped-define DISPLAYED-TABLES TransType
&Scoped-define FIRST-DISPLAYED-TABLE TransType
...
DEFINE FRAME Dialog-Frame
     TransType.TTId AT ROW 1.95 COL 14 COLON-ALIGNED
          LABEL "TransType"
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     TransType.Beskrivelse AT ROW 1.95 COL 21 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     TransType.Aktiv AT ROW 3.14 COL 16
          VIEW-AS TOGGLE-BOX
          SIZE 25 BY .81
     TransType.Notat AT ROW 4.1 COL 4 NO-LABEL
          VIEW-AS EDITOR NO-WORD-WRAP SCROLLBAR-HORIZONTAL SCROLLBAR-VERTICAL
          SIZE 51 BY 4
     Btn_OK AT ROW 8.62 COL 2
     Btn_Cancel AT ROW 8.62 COL 17.6
     Btn_Help AT ROW 8.62 COL 42
     RECT-1 AT ROW 1.38 COL 2
     SPACE(0.19) SKIP(1.66)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold transaksjonstyper"
...
ASSIGN 
       TransType.Notat:RETURN-INSERTED IN FRAME Dialog-Frame  = TRUE.

/* SETTINGS FOR FILL-IN TransType.TTId IN FRAME Dialog-Frame
   NO-ENABLE EXP-LABEL                                                  */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold transaksjonstyper */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE TransType THEN 
    DISPLAY TransType.TTId TransType.Beskrivelse TransType.Aktiv TransType.Notat 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 TransType.Beskrivelse TransType.Aktiv TransType.Notat Btn_OK 
         Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
