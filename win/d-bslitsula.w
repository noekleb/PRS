...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wSlit-Id LIKE SlitSula.Slit-Id INIT 31 NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wSlit-Id LIKE Slitsula.Slit-Id NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   SlitSula

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  Slit-Id
...
&scoped-define index-col1  SlitSula
...
&scoped-define sok-field2  SlitBeskr
...
&scoped-define index-col2  Slit-Beskr
...
&scoped-define ip-variabel wSlit-Id
&scoped-define return-ip   wSlit-Id = SlitSula.Slit-Id.
&scoped-define assign-retur-verdi retur-verdi = string(recid(SlitSula)).
...
&scoped-define KanSlettes ~
  if can-find(first ArtBas where ArtBas.Slit-Id = SlitSula.Slit-Id) then ~
    do: ~
...
&scoped-define VedlikeholdsRutine d-vslitsula.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-SlitSula

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES SlitSula

/* Definitions for BROWSE BROWSE-SlitSula                               */
&Scoped-define FIELDS-IN-QUERY-BROWSE-SlitSula SlitSula.Slit-Id ~
SlitSula.SlitBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-SlitSula SlitSula.Slit-Id ~
SlitSula.SlitBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-SlitSula SlitSula
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-SlitSula SlitSula
&Scoped-define QUERY-STRING-BROWSE-SlitSula FOR EACH SlitSula NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-SlitSula OPEN QUERY BROWSE-SlitSula FOR EACH SlitSula NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-SlitSula SlitSula
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-SlitSula SlitSula


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-SlitSula}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INT ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-SlitSula BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-SlitSula FOR 
      SlitSula SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-SlitSula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-SlitSula Dialog-Frame _STRUCTURED
  QUERY BROWSE-SlitSula NO-LOCK DISPLAY
      SlitSula.Slit-Id COLUMN-LABEL "Slitesåle *" FORMAT "z9":U
      SlitSula.SlitBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(30)":U
  ENABLE
      SlitSula.Slit-Id
      SlitSula.SlitBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 44 BY 7.38.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-SlitSula AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 3 COL 46.8
     BUTTON-Endre AT ROW 4.33 COL 46.8
     BUTTON-Slett AT ROW 5.67 COL 46.8
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     Btn_Help AT ROW 10.81 COL 46.8
     SPACE(0.19) SKIP(0.04)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkelister for kode slitesåle"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-SlitSula BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-SlitSula
/* Query rebuild information for BROWSE BROWSE-SlitSula
     _TblList          = "SkoTex.SlitSula"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.SlitSula.Slit-Id
"SlitSula.Slit-Id" "Slitesåle *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.SlitSula.SlitBeskr
"SlitSula.SlitBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-SlitSula */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkelister for kode slitesåle */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-SlitSula
&Scoped-define SELF-NAME BROWSE-SlitSula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-SlitSula Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-SlitSula IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-SlitSula Dialog-Frame
ON CURSOR-LEFT OF BROWSE-SlitSula IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-SlitSula Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-SlitSula IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-SlitSula Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-SlitSula IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-SlitSula Dialog-Frame
ON START-SEARCH OF BROWSE-SlitSula IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
{syspara.i 16 21 2 iTilgang INT}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-SlitSula BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
