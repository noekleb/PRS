...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 C-Sasong _STRUCTURED
  QUERY BROWSE-3 DISPLAY
      Sasong.Sasong COLUMN-LABEL "SäsongKod"
      Sasong.SasBeskr COLUMN-LABEL "Säsong"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Sasong" "SäsongKod" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[2]   > SkoTex.Sasong.SasBeskr
"SasBeskr" "Säsong" ? "character" ? ? ? ? ? ? no ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
...
ON END-ERROR OF C-Sasong /* Sök i säsongsregistret */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Sasong C-Sasong
ON WINDOW-CLOSE OF C-Sasong /* Sök i säsongsregistret */
DO:
