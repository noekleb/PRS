...
"Butiker.Butik" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > skotex.Butiker.ButNamn
"Butiker.ButNamn" ? "x(30)" "character" ? ? ? ? ? ? no ? no no "30.8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
...
"tButiker.Butik" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tButiker.ButNamn
"tButiker.ButNamn" ? "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
    DO wAntEntries = 1 TO NUM-ENTRIES(IO-Liste) WITH FRAME {&FRAME-NAME}:
        ...
        IF AVAIL b{&br-tabell} THEN 
        DO:
            IF NOT CAN-FIND(t{&br-tabell} where 
              t{&br-tabell}.{&sok-field1} = int(ENTRY(wAntEntries,IO-Liste))) THEN 
            DO:
                CREATE t{&br-tabell}.
                assign
