...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vimporthode.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-ImportHode

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES ImportHode

/* Definitions for BROWSE BROWSE-ImportHode                             */
&Scoped-define FIELDS-IN-QUERY-BROWSE-ImportHode ImportHode.BatchNr ~
ImportHode.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-ImportHode ImportHode.BatchNr ~
ImportHode.Beskrivelse 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-ImportHode ImportHode
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-ImportHode ImportHode
&Scoped-define OPEN-QUERY-BROWSE-ImportHode OPEN QUERY BROWSE-ImportHode FOR EACH ImportHode NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-ImportHode ImportHode
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-ImportHode ImportHode
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-ImportHode Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-ImportHode FOR 
      ImportHode SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-ImportHode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-ImportHode Dialog-Frame _STRUCTURED
  QUERY BROWSE-ImportHode NO-LOCK DISPLAY
      ImportHode.BatchNr FORMAT "->,>>>,>>9":U
      ImportHode.Beskrivelse FORMAT "X(40)":U
  ENABLE
      ImportHode.BatchNr
      ImportHode.Beskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 63 BY 14.76 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-ImportHode AT ROW 2.91 COL 2
     Btn_OK AT ROW 17.91 COL 2
     Btn_Cancel AT ROW 17.91 COL 15.2
     Btn_Help AT ROW 17.91 COL 53
     BUTTON-Ny AT ROW 2.91 COL 66
     BUTTON-Endre AT ROW 4.24 COL 66
     BUTTON-Slett AT ROW 5.57 COL 66
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-ImportHode BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-ImportHode:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-ImportHode
/* Query rebuild information for BROWSE BROWSE-ImportHode
     _TblList          = "WR.ImportHode"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > WR.ImportHode.BatchNr
"BatchNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > WR.ImportHode.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-ImportHode */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Importbuffer */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-ImportHode
&Scoped-define SELF-NAME BROWSE-ImportHode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-ImportHode Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-ImportHode IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-ImportHode Dialog-Frame
ON CURSOR-LEFT OF BROWSE-ImportHode IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-ImportHode Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-ImportHode IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-ImportHode Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-ImportHode IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-ImportHode Dialog-Frame
ON HOME OF BROWSE-ImportHode IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-ImportHode Dialog-Frame
ON START-SEARCH OF BROWSE-ImportHode IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-ImportHode Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
