...
&scope InitIdx     FeilKode
&scope ip-felt     FeilKode
...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vfeilkode.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Feilkode

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Feilkode

/* Definitions for BROWSE BROWSE-Feilkode                               */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Feilkode Feilkode.FeilKode ~
Feilkode.Beskrivelse Feilkode.Belastes Feilkode.TransKode 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Feilkode Feilkode.FeilKode ~
Feilkode.Beskrivelse 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Feilkode Feilkode
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Feilkode Feilkode
&Scoped-define QUERY-STRING-BROWSE-Feilkode FOR EACH Feilkode NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Feilkode OPEN QUERY BROWSE-Feilkode FOR EACH Feilkode NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Feilkode Feilkode
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Feilkode Feilkode
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Feilkode Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Feilkode FOR 
      Feilkode SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Feilkode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Feilkode Dialog-Frame _STRUCTURED
  QUERY BROWSE-Feilkode NO-LOCK DISPLAY
      Feilkode.FeilKode FORMAT ">9":U
      Feilkode.Beskrivelse FORMAT "X(40)":U
      Feilkode.Belastes FORMAT "9":U WIDTH 10.6
      Feilkode.TransKode FORMAT ">9":U WIDTH 16.6
  ENABLE
      Feilkode.FeilKode
      Feilkode.Beskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 82 BY 14.76 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Feilkode AT ROW 2.91 COL 2
     Btn_OK AT ROW 17.91 COL 2
     Btn_Cancel AT ROW 17.91 COL 15.2
     Btn_Help AT ROW 17.91 COL 85.6
     BUTTON-Ny AT ROW 2.91 COL 86
     BUTTON-Endre AT ROW 4.24 COL 86
     BUTTON-Slett AT ROW 5.57 COL 86
     SPACE(0.00) SKIP(12.33)
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Feilkode BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Feilkode:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Feilkode
/* Query rebuild information for BROWSE BROWSE-Feilkode
     _TblList          = "skotex.Feilkode"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > skotex.Feilkode.FeilKode
"FeilKode" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Feilkode.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > skotex.Feilkode.Belastes
"Belastes" ? ? "integer" ? ? ? ? ? ? no ? no no "10.6" yes no no "U" "" ""
     _FldNameList[4]   > skotex.Feilkode.TransKode
"TransKode" ? ? "integer" ? ? ? ? ? ? no ? no no "16.6" yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE BROWSE-Feilkode */
&ANALYZE-RESUME
...
&Scoped-define BROWSE-NAME BROWSE-Feilkode
&Scoped-define SELF-NAME BROWSE-Feilkode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Feilkode Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Feilkode IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Feilkode Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Feilkode IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Feilkode Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Feilkode IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Feilkode Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Feilkode IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Feilkode Dialog-Frame
ON HOME OF BROWSE-Feilkode IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Feilkode Dialog-Frame
ON START-SEARCH OF BROWSE-Feilkode IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Feilkode Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
