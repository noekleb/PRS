...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wVg LIKE ArtBas.Vg NO-UNDO.
  assign wVg = 1.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wVg LIKE ArtBas.Vg NO-UNDO.
&ENDIF

def var wVgKat like VgKat.VgKat no-undo.

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell VgKat
&scoped-define OptWhere VgKat.Vg = wVg and

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  VgKat
...
&scoped-define index-col1  VgKat
...
&scoped-define ip-variabel wVgKat
&scoped-define return-ip   wVgKat = if available {&br-tabell}  ~
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-VgKat

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES VgKat

/* Definitions for BROWSE BROWSE-VgKat                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-VgKat VgKat.VgKat ~
Beskrivelse() @ wBeskrivelse VgKat.KatNr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-VgKat 
&Scoped-define QUERY-STRING-BROWSE-VgKat FOR EACH VgKat ~
      WHERE VgKat.Vg = wVg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-VgKat OPEN QUERY BROWSE-VgKat FOR EACH VgKat ~
      WHERE VgKat.Vg = wVg NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-VgKat VgKat
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-VgKat VgKat


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-VgKat}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-INT FILL-IN-SOK-DATE ~
FILL-IN-SOK-CHAR BUTTON-Sok BROWSE-VgKat Btn_Help Btn_OK Btn_Cancel 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-VgKat FOR 
      VgKat SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-VgKat
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-VgKat Dialog-Frame _STRUCTURED
  QUERY BROWSE-VgKat NO-LOCK DISPLAY
      VgKat.VgKat FORMAT "z9":U
      Beskrivelse() @ wBeskrivelse COLUMN-LABEL "Beskrivelse" FORMAT "x(30)":U
      VgKat.KatNr FORMAT "z9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 49.8 BY 7.38.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-VgKat AT ROW 2.91 COL 2
     Btn_Help AT ROW 10.71 COL 46.6
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     SPACE(35.39) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste VgKat"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-VgKat BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-VgKat:NUM-LOCKED-COLUMNS IN FRAME Dialog-Frame     = 1.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-VgKat
/* Query rebuild information for BROWSE BROWSE-VgKat
     _TblList          = "SkoTex.VgKat"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _Where[1]         = "VgKat.Vg = wVg"
     _FldNameList[1]   = SkoTex.VgKat.VgKat
     _FldNameList[2]   > "_<CALC>"
"Beskrivelse() @ wBeskrivelse" "Beskrivelse" "x(30)" ? ? ? ? ? ? ? no "Beskrivelse" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = SkoTex.VgKat.KatNr
     _Query            is OPENED
*/  /* BROWSE BROWSE-VgKat */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste VgKat */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-VgKat
&Scoped-define SELF-NAME BROWSE-VgKat
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VgKat Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-VgKat IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VgKat Dialog-Frame
ON CURSOR-LEFT OF BROWSE-VgKat IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VgKat Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-VgKat IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VgKat Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-VgKat IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-VgKat Dialog-Frame
ON START-SEARCH OF BROWSE-VgKat IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-INT FILL-IN-SOK-DATE FILL-IN-SOK-CHAR BUTTON-Sok 
         BROWSE-VgKat Btn_Help Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
