...
&scope InitIdx     MedlemsSaldo
&scope ip-felt     ButikkNr
...
&scope QWhere ~
      'MedlemSaldo.MedlemsNr = ' +  string(wMedlemsNr)
...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vmedlemsaldo.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-MedlemSaldo

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES MedlemSaldo

/* Definitions for BROWSE BROWSE-MedlemSaldo                            */
&Scoped-define FIELDS-IN-QUERY-BROWSE-MedlemSaldo MedlemSaldo.ButikkNr ~
MedlemSaldo.ForsteDato MedlemSaldo.DatoSiste MedlemSaldo.TotaltKjop 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-MedlemSaldo ~
MedlemSaldo.ButikkNr MedlemSaldo.ForsteDato MedlemSaldo.DatoSiste 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-MedlemSaldo MedlemSaldo
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-MedlemSaldo MedlemSaldo
&Scoped-define OPEN-QUERY-BROWSE-MedlemSaldo OPEN QUERY BROWSE-MedlemSaldo FOR EACH MedlemSaldo ~
      WHERE MedlemSaldo.MedlemsNr = wMedlemsNr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-MedlemSaldo MedlemSaldo
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-MedlemSaldo MedlemSaldo


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-MedlemSaldo}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INTE ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-MedlemSaldo Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-MedlemSaldo FOR 
      MedlemSaldo SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-MedlemSaldo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-MedlemSaldo Dialog-Frame _STRUCTURED
  QUERY BROWSE-MedlemSaldo NO-LOCK DISPLAY
      MedlemSaldo.ButikkNr FORMAT ">>>>>9":U
      MedlemSaldo.ForsteDato FORMAT "99/99/99":U
      MedlemSaldo.DatoSiste FORMAT "99/99/99":U
      MedlemSaldo.TotaltKjop FORMAT "->>>,>>>,>>9.99":U WIDTH 17.6
  ENABLE
      MedlemSaldo.ButikkNr
      MedlemSaldo.ForsteDato
      MedlemSaldo.DatoSiste
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 51 BY 14.76 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-MedlemSaldo AT ROW 2.91 COL 2
     Btn_OK AT ROW 17.91 COL 2
     Btn_Cancel AT ROW 17.91 COL 15.2
     Btn_Help AT ROW 17.91 COL 41
     BUTTON-Ny AT ROW 2.91 COL 54
     BUTTON-Endre AT ROW 4.24 COL 54
     BUTTON-Slett AT ROW 5.57 COL 54
     SPACE(0.39) SKIP(12.33)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Medlemssaldo pr. butikk"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-MedlemSaldo BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-MedlemSaldo:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-MedlemSaldo
/* Query rebuild information for BROWSE BROWSE-MedlemSaldo
     _TblList          = "skotex.MedlemSaldo"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _Where[1]         = "MedlemSaldo.MedlemsNr = wMedlemsNr"
     _FldNameList[1]   > skotex.MedlemSaldo.ButikkNr
"MedlemSaldo.ButikkNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.MedlemSaldo.ForsteDato
"MedlemSaldo.ForsteDato" ? ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > skotex.MedlemSaldo.DatoSiste
"MedlemSaldo.DatoSiste" ? ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > skotex.MedlemSaldo.TotaltKjop
"MedlemSaldo.TotaltKjop" ? ? "decimal" ? ? ? ? ? ? no ? no no "17.6" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-MedlemSaldo */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Medlemssaldo pr. butikk */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-MedlemSaldo
&Scoped-define SELF-NAME BROWSE-MedlemSaldo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemSaldo Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-MedlemSaldo IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemSaldo Dialog-Frame
ON CURSOR-LEFT OF BROWSE-MedlemSaldo IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemSaldo Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-MedlemSaldo IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemSaldo Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-MedlemSaldo IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemSaldo Dialog-Frame
ON HOME OF BROWSE-MedlemSaldo IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemSaldo Dialog-Frame
ON START-SEARCH OF BROWSE-MedlemSaldo IN FRAME Dialog-Frame
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-MedlemSaldo Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
