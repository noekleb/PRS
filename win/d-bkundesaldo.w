...
&scope QWhere ~
      'KundeSaldo.KundeNr = ' +  string(wKundeNr)
...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vkundesaldo.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-KundeSaldo

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES KundeSaldo

/* Definitions for BROWSE BROWSE-KundeSaldo                             */
&Scoped-define FIELDS-IN-QUERY-BROWSE-KundeSaldo KundeSaldo.ButikkNr ~
KundeSaldo.ForsteDato KundeSaldo.DatoSiste KundeSaldo.Saldo ~
KundeSaldo.TotaltKjop 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-KundeSaldo ~
KundeSaldo.ButikkNr KundeSaldo.ForsteDato KundeSaldo.DatoSiste 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-KundeSaldo KundeSaldo
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-KundeSaldo KundeSaldo
&Scoped-define OPEN-QUERY-BROWSE-KundeSaldo OPEN QUERY BROWSE-KundeSaldo FOR EACH KundeSaldo ~
      WHERE KundeSaldo.KundeNr = wKundeNr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-KundeSaldo KundeSaldo
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-KundeSaldo KundeSaldo


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-KundeSaldo}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INTE ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-KundeSaldo Btn_OK Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-KundeSaldo FOR 
      KundeSaldo SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-KundeSaldo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-KundeSaldo Dialog-Frame _STRUCTURED
  QUERY BROWSE-KundeSaldo NO-LOCK DISPLAY
      KundeSaldo.ButikkNr FORMAT ">>>>>9":U
      KundeSaldo.ForsteDato FORMAT "99/99/99":U
      KundeSaldo.DatoSiste FORMAT "99/99/99":U
      KundeSaldo.Saldo FORMAT "->>>,>>>,>>9.99":U
      KundeSaldo.TotaltKjop FORMAT "->>>,>>>,>>9.99":U
  ENABLE
      KundeSaldo.ButikkNr
      KundeSaldo.ForsteDato
      KundeSaldo.DatoSiste
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 67 BY 14.76 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-KundeSaldo AT ROW 2.91 COL 2
     Btn_OK AT ROW 17.91 COL 2
     Btn_Cancel AT ROW 17.91 COL 15.2
     Btn_Help AT ROW 17.91 COL 57
     BUTTON-Ny AT ROW 2.91 COL 70
     BUTTON-Endre AT ROW 4.24 COL 70
     BUTTON-Slett AT ROW 5.57 COL 70
     SPACE(0.79) SKIP(12.33)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Kundesaldo pr. butikk"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-KundeSaldo BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-KundeSaldo:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-KundeSaldo
/* Query rebuild information for BROWSE BROWSE-KundeSaldo
     _TblList          = "skotex.KundeSaldo"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _Where[1]         = "KundeSaldo.KundeNr = wKundeNr"
     _FldNameList[1]   > skotex.KundeSaldo.ButikkNr
"KundeSaldo.ButikkNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.KundeSaldo.ForsteDato
"KundeSaldo.ForsteDato" ? ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > skotex.KundeSaldo.DatoSiste
"KundeSaldo.DatoSiste" ? ? "date" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   = skotex.KundeSaldo.Saldo
     _FldNameList[5]   = skotex.KundeSaldo.TotaltKjop
     _Query            is OPENED
*/  /* BROWSE BROWSE-KundeSaldo */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Kundesaldo pr. butikk */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-KundeSaldo
&Scoped-define SELF-NAME BROWSE-KundeSaldo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeSaldo Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-KundeSaldo IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeSaldo Dialog-Frame
ON CURSOR-LEFT OF BROWSE-KundeSaldo IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeSaldo Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-KundeSaldo IN FRAME Dialog-Frame
DO:
  IF wAntSortCol > 1 THEN
      RUN SD-CURSOR ("RIGHT").
  RETURN NO-APPLY.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeSaldo Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-KundeSaldo IN FRAME Dialog-Frame
DO:
  IF wType = "V" THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeSaldo Dialog-Frame
ON HOME OF BROWSE-KundeSaldo IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeSaldo Dialog-Frame
ON START-SEARCH OF BROWSE-KundeSaldo IN FRAME Dialog-Frame
DO:
...
DO:
  ...
  run {&VedlikeholdsRutine} (input-output wRecid,"Endre",wKundeNr).
...
DO:
  assign 
    wRecid = ?.
  run {&VedlikeholdsRutine} (input-output wRecid,"Ny",wKundeNr).
  if return-value = "AVBRYT" then
    return no-apply.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INTE FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-KundeSaldo Btn_OK Btn_Help 
      WITH FRAME Dialog-Frame.
