...
&scoped-define KanSlettes 
   ...
   */
&scoped-define VedlikeholdsRutine d-vkunde.w
...
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Kunde Btn_OK Btn_Help 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Kunde Dialog-Frame _STRUCTURED
  QUERY BROWSE-Kunde NO-LOCK DISPLAY
      ...
      Kunde.Navn FORMAT "X(40)":U WIDTH 42.4
  ENABLE
      Kunde.KundeNr
      Kunde.Navn
/* _UIB-CODE-BLOCK-END */
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Kunde AT ROW 2.91 COL 2
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Kunde BUTTON-Sok Dialog-Frame */
ASSIGN 
       FRAME Dialog-Frame:SCROLLABLE       = FALSE
       FRAME Dialog-Frame:HIDDEN           = TRUE.

ASSIGN 
       BROWSE-Kunde:MAX-DATA-GUESS IN FRAME Dialog-Frame         = 481.
...
"Kunde.Navn" ? ? "character" ? ? ? ? ? ? yes ? no no "42.4" yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Kunder */
DO:
...
ON ANY-PRINTABLE OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kunde Dialog-Frame
ON HOME OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
  APPLY "ENTRY" TO SELF.
END.
