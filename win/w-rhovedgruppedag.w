...
DEFINE VARIABLE FI-Butik2 AS INTEGER FORMAT ">>9":U INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.
...
assign
  ...
  wRB-REPORT-NAME      = if RS-Akkumulering = 1
                           then "HovedgruppeDag"               
                           else "HovedgruppeMnd"
...
{sww.i}
IF cTyp = "excel" THEN
  RUN skrivhgrapexcel.p (TRIM(ENTRY(2,wKunde,"=")),
