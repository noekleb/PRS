...
&scoped-define VisPoster ~
  Innersula.Inner-Id when available Innersula ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame InnerSula.Inner-Id ~
InnerSula.InnerBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame InnerSula.Inner-Id ~
InnerSula.InnerBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame InnerSula
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame InnerSula
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH InnerSula SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame InnerSula
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame InnerSula


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS InnerSula.Inner-Id InnerSula.InnerBeskr 
&Scoped-define ENABLED-TABLES InnerSula
&Scoped-define FIRST-ENABLED-TABLE InnerSula
&Scoped-define DISPLAYED-TABLES InnerSula
&Scoped-define FIRST-DISPLAYED-TABLE InnerSula
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS InnerSula.Inner-Id InnerSula.InnerBeskr 
...
DEFINE FRAME Dialog-Frame
     InnerSula.Inner-Id AT ROW 1.95 COL 11.6 COLON-ALIGNED
          LABEL "Innersåle"
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     InnerSula.InnerBeskr AT ROW 1.95 COL 16.6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     Btn_OK AT ROW 3.67 COL 2.6
     Btn_Cancel AT ROW 3.67 COL 18
     Btn_Help AT ROW 3.76 COL 38.6
     RECT-1 AT ROW 1.38 COL 2
     SPACE(0.19) SKIP(1.42)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold innersåle"
...
/* SETTINGS FOR FILL-IN InnerSula.Inner-Id IN FRAME Dialog-Frame
   EXP-LABEL                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold innersåle */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE InnerSula THEN 
    DISPLAY InnerSula.Inner-Id InnerSula.InnerBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 InnerSula.Inner-Id InnerSula.InnerBeskr Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
