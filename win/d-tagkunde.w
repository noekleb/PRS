...
DEFINE TEMP-TABLE tKunde NO-UNDO LIKE Kunde.
...
&scoped-define DB-BROWSER BROWSE-Kunde

&scoped-define br-tabell Kunde

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  KundeNr
...
&scoped-define index-col1  Kunde
...
&scoped-define init-datatype   dec /* CHAR, INT, DATE, DEC */
...
&Scoped-define INTERNAL-TABLES Kunde tKunde

/* Definitions for BROWSE BROWSE-Kunde                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Kunde Kunde.KundeNr Kunde.Navn 
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tKunde.KundeNr tKunde.Navn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tKunde.KundeNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tKunde
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tKunde
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tKunde NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tKunde
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tKunde


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Kunde}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Kunde BROWSE-Tag Btn_OK Btn_Cancel ~
Btn_Help BUTTON-Sok RECT-4 RECT-5 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-SOK-DEC FILL-IN-SOK-INT ~
...
DEFINE VARIABLE FILL-IN-SOK-DEC AS DECIMAL FORMAT "->>>>>>>>>>>>>":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 19 BY 1 NO-UNDO.
...
DEFINE QUERY BROWSE-Kunde FOR 
      Kunde
    FIELDS(Kunde.KundeNr
      Kunde.Navn) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tKunde
    FIELDS(tKunde.KundeNr
      tKunde.Navn) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Kunde
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Kunde Dialog-Frame _STRUCTURED
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 63 BY 18.1.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tKunde.KundeNr FORMAT ">>>>>>>>>>>>9":U
      tKunde.Navn FORMAT "X(40)":U
  ENABLE
      tKunde.KundeNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 63 BY 18.1 ROW-HEIGHT-CHARS .62.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     FILL-IN-SOK-DEC AT ROW 1.48 COL 2 NO-LABEL
     BROWSE-Kunde AT ROW 2.91 COL 3
     BUTTON-LeggTil AT ROW 6.71 COL 68
     BUTTON-TrekkFra AT ROW 7.91 COL 68
     BUTTON-AlleFra AT ROW 9.1 COL 68
     BROWSE-Tag AT ROW 2.91 COL 85
     Btn_OK AT ROW 21.48 COL 2
     Btn_Cancel AT ROW 21.48 COL 15
     Btn_Help AT ROW 21.48 COL 137
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tKunde T "?" NO-UNDO skotex Kunde
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Kunde 1 Dialog-Frame */
...
/* SETTINGS FOR FILL-IN FILL-IN-SOK-DATE IN FRAME Dialog-Frame
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN FILL-IN-SOK-DEC IN FRAME Dialog-Frame
   NO-ENABLE ALIGN-L                                                    */
...
"KundeNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Kunde.Navn
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tKunde"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tKunde.KundeNr
"KundeNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tKunde.Navn
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kunde Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kunde Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kunde Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kunde Dialog-Frame
ON START-SEARCH OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Kunde Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Kunde IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-SOK-DEC FILL-IN-SOK-INT FILL-IN-SOK-CHAR FILL-IN-SOK-DATE 
      WITH FRAME Dialog-Frame.
  ENABLE BROWSE-Kunde BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
