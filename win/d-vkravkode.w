...
&scoped-define br-tabell Kravkode
...
&scoped-define VisPoster {&br-tabell}.KravKode when available {&br-tabell} ~
...
&scoped-define AssignFelter {&br-tabell}.KravKode ~
...
&Scoped-define INTERNAL-TABLES Handtering Feilkode Notatkoder Kravkode
...
&Scoped-define QUERY-STRING-Dialog-Frame FOR EACH MS.Handtering SHARE-LOCK, ~
      ...
      EACH MS.Kravkode WHERE TRUE /* Join to MS.Handtering incomplete */ SHARE-LOCK
...
&Scoped-define FOURTH-TABLE-IN-QUERY-Dialog-Frame Kravkode


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Kravkode.KravKode Kravkode.Beskrivelse ~
Kravkode.Notat Kravkode.TransKode 
&Scoped-define ENABLED-TABLES Kravkode
&Scoped-define FIRST-ENABLED-TABLE Kravkode
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help RECT-1 
&Scoped-Define DISPLAYED-FIELDS Kravkode.KravKode Kravkode.Beskrivelse ~
Kravkode.Notat Kravkode.TransKode 
&Scoped-define DISPLAYED-TABLES Kravkode
&Scoped-define FIRST-DISPLAYED-TABLE Kravkode
...
DEFINE FRAME Dialog-Frame
     Kravkode.KravKode AT ROW 2.19 COL 20 COLON-ALIGNED
          LABEL "Behandlingskode"
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Kravkode.Beskrivelse AT ROW 3.19 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 42 BY 1
     Kravkode.Notat AT ROW 5.29 COL 4 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 60 BY 6.91
     Btn_OK AT ROW 12.91 COL 2
     Btn_Cancel AT ROW 12.91 COL 17
     Btn_Help AT ROW 12.91 COL 51
     Kravkode.TransKode AT ROW 4.33 COL 22 NO-LABEL
...
"Reklamasjon":U, 1
     ...
     SPACE(0.79) SKIP(1.46)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Behandlingskode"
...
/* SETTINGS FOR FILL-IN Kravkode.KravKode IN FRAME Dialog-Frame
   EXP-LABEL                                                            */
ASSIGN 
       Kravkode.Notat:RETURN-INSERTED IN FRAME Dialog-Frame  = TRUE.
...
/* Query rebuild information for DIALOG-BOX Dialog-Frame
     _TblList          = "MS.Handtering,MS.Feilkode WHERE MS.Handtering ...,MS.Notatkoder WHERE MS.Handtering ...,MS.Kravkode WHERE MS.Handtering ..."
     _Options          = "SHARE-LOCK"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Behandlingskode */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Kravkode THEN 
    DISPLAY Kravkode.KravKode Kravkode.Beskrivelse Kravkode.Notat 
          Kravkode.TransKode 
      WITH FRAME Dialog-Frame.
  ENABLE Kravkode.KravKode Kravkode.Beskrivelse Kravkode.Notat Btn_OK 
         Btn_Cancel Btn_Help Kravkode.TransKode RECT-1 
      WITH FRAME Dialog-Frame.
