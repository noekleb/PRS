...
&scoped-define VisPoster ~
  Material.MatKod when available Material ~
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
            message "{&br-tabell} finnes allerede med materialkode:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Material.MatKod ~
Material.MatBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Material.MatKod ~
Material.MatBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Material
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Material
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Material SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Material
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Material


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Material.MatKod Material.MatBeskr 
&Scoped-define ENABLED-TABLES Material
&Scoped-define FIRST-ENABLED-TABLE Material
&Scoped-define DISPLAYED-TABLES Material
&Scoped-define FIRST-DISPLAYED-TABLE Material
&Scoped-Define ENABLED-OBJECTS Btn_Help Btn_OK Btn_Cancel RECT-1 
&Scoped-Define DISPLAYED-FIELDS Material.MatKod Material.MatBeskr 
...
DEFINE FRAME Dialog-Frame
     Material.MatKod AT ROW 1.81 COL 12 COLON-ALIGNED
          LABEL "Material" FORMAT "zz9"
          VIEW-AS FILL-IN 
          SIZE 7 BY 1
     Material.MatBeskr AT ROW 1.81 COL 19 COLON-ALIGNED NO-LABEL FORMAT "x(200)"
          VIEW-AS FILL-IN 
          SIZE 34.6 BY 1
     Btn_Help AT ROW 3.38 COL 43
     Btn_OK AT ROW 3.48 COL 2.4
     Btn_Cancel AT ROW 3.48 COL 18
     RECT-1 AT ROW 1.38 COL 2
     SPACE(1.19) SKIP(1.37)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold materialkoder"
...
/* SETTINGS FOR FILL-IN Material.MatBeskr IN FRAME Dialog-Frame
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Material.MatKod IN FRAME Dialog-Frame
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold materialkoder */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Material THEN 
    DISPLAY Material.MatKod Material.MatBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE Material.MatKod Material.MatBeskr Btn_Help Btn_OK Btn_Cancel RECT-1 
      WITH FRAME Dialog-Frame.
