...
DEFINE TEMP-TABLE tLevBas NO-UNDO LIKE LevBas.
...
&scoped-define DB-BROWSER BROWSE-LevBas
...
&Scoped-define INTERNAL-TABLES LevBas tLevBas
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tLevBas.levnr tLevBas.levnamn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tLevBas.levnr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tLevBas
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tLevBas
&Scoped-define QUERY-STRING-BROWSE-Tag FOR EACH tLevBas NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tLevBas NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tLevBas
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tLevBas
...
&Scoped-Define ENABLED-OBJECTS BROWSE-LevBas BROWSE-Tag Btn_OK Btn_Cancel ~
...
DEFINE QUERY BROWSE-LevBas FOR 
      LevBas
    FIELDS(LevBas.levnr
      LevBas.levnamn) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tLevBas
    FIELDS(tLevBas.levnr
      tLevBas.levnamn) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-LevBas Dialog-Frame _STRUCTURED
  QUERY BROWSE-LevBas NO-LOCK DISPLAY
      LevBas.levnr COLUMN-LABEL "Levnr" FORMAT "zzzzz9":U
      LevBas.levnamn COLUMN-LABEL "Levnavn" FORMAT "x(20)":U
  ENABLE
      LevBas.levnr
      LevBas.levnamn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 45 BY 12.19 EXPANDABLE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tLevBas.levnr COLUMN-LABEL "Levnr" FORMAT "zzzzz9":U
      tLevBas.levnamn COLUMN-LABEL "Levnavn" FORMAT "x(20)":U
  ENABLE
      tLevBas.levnr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-LevBas AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tLevBas T "?" NO-UNDO skotex LevBas
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-LevBas 1 Dialog-Frame */
...
"levnr" "Levnr" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.LevBas.levnamn
"levnamn" "Levnavn" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tLevBas"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tLevBas.levnr
"levnr" "Levnr" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tLevBas.levnamn
"levnamn" "Levnavn" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-LevBas Dialog-Frame
ON VALUE-CHANGED OF BROWSE-LevBas IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-LevBas BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
