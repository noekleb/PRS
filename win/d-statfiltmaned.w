...
&Scoped-Define ENABLED-OBJECTS B-AlleBut B-SokButikk FI-Aar FI-Mnd FI-Aar2 ~
  ...
  if (input FI-Aar > input FI-Aar2) then
    ...
    do:
      if (input FI-Mnd > input FI-Mnd2) then
        do:
          message "Ugyldig månedsangivelse!" 
            view-as alert-box message title "Melding".
          return no-apply.
        end.  
    end.
...
------------------------------------------------------------------------------*/
  DISPLAY FI-Aar FI-Mnd FI-Aar2 FI-Mnd2 FI-Butikk FILL-IN-3 FI-FraTxt FI-TilTxt 
      WITH FRAME Dialog-Frame.
  ENABLE B-AlleBut B-SokButikk FI-Aar FI-Mnd FI-Aar2 FI-Mnd2 Btn_OK Btn_Cancel 
         Btn_Help RECT-49 
      WITH FRAME Dialog-Frame.
