...
&scoped-define VisPoster ~
  PerLin.PerLinNr when available PerLin ~
  PerLin.FraDato when available PerLin ~
  PerLin.TilDato when available PerLin
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame PerLin.PerLinNr PerLin.FraDato ~
PerLin.TilDato 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame PerLin.FraDato ~
PerLin.TilDato 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame PerLin
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame PerLin
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH PerLin SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame PerLin
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame PerLin


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS PerLin.FraDato PerLin.TilDato 
&Scoped-define ENABLED-TABLES PerLin
&Scoped-define FIRST-ENABLED-TABLE PerLin
&Scoped-define DISPLAYED-TABLES PerLin
&Scoped-define FIRST-DISPLAYED-TABLE PerLin
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS PerLin.PerLinNr PerLin.FraDato ~
PerLin.TilDato 
...
DEFINE FRAME Dialog-Frame
     PerLin.PerLinNr AT ROW 1.95 COL 18 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     PerLin.FraDato AT ROW 1.95 COL 35 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     PerLin.TilDato AT ROW 1.95 COL 53 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     Btn_OK AT ROW 4.05 COL 2.6
     Btn_Cancel AT ROW 4.05 COL 18.2
     Btn_Help AT ROW 4.1 COL 57
     RECT-1 AT ROW 1.48 COL 4
     SPACE(0.00) SKIP(1.75)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Vedlikehold periodelinjer"
...
/* SETTINGS FOR FILL-IN PerLin.PerLinNr IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vedlikehold periodelinjer */
DO:
...
------------------------------------------------------------------------------*/
  IF AVAILABLE PerLin THEN 
    DISPLAY PerLin.PerLinNr PerLin.FraDato PerLin.TilDato 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 PerLin.FraDato PerLin.TilDato Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
