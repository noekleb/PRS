...
&scope QWhere ~
      'Medlem.KundeNr = ' + STRING(wKundeNr)
...
&Scoped-define OPEN-QUERY-BROWSE-Medlem OPEN QUERY BROWSE-Medlem FOR EACH Medlem ~
      WHERE Medlem.KundeNr = wKundeNr NO-LOCK ~
...
/* Query rebuild information for BROWSE BROWSE-Medlem
     ...
     _Where[1]         = "Medlem.KundeNr = wKundeNr"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Medlemmer til kunde */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
    ...
    ASSIGN
        FRAME dialog-frame:TITLE = "Medlemmer til kunde " + 
