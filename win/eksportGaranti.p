...
DEFINE VARIABLE cExportFil      AS CHARACTER INIT "Garanti."                NO-UNDO.
...
IF cLanButiker <> "" THEN DO:
  DO iCount = 1 TO NUM-ENTRIES(cLanButiker):
      RUN ExportGaranti IN THIS-PROCEDURE (INT(ENTRY(iCount,cLanButiker)),"txt"). /* parameter = den loopade butiken */
  END.
END.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH TT_Garanti WHERE 
        ...
        EXPORT iButik
               TT_Garanti.Garantikl 
               TT_Garanti.aksjon    
               TT_Garanti.mndant     
               TT_Garanti.bonga5     
               TT_Garanti.radnr      
               TT_Garanti.fritekst[1]
               TT_Garanti.fritekst[2]
               TT_Garanti.fritekst[3]
               TT_Garanti.fritekst[4]
               TT_Garanti.fritekst[5]
               .
