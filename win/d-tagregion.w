...
DEFINE TEMP-TABLE tRegion NO-UNDO LIKE Region.
...
&scoped-define DB-BROWSER BROWSE-Region

&scoped-define br-tabell Region

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1 RegKode
...
&scoped-define index-col1 Region
...
&scoped-define sok-phrase2 FIND FIRST b{&br-tabell} WHERE b{&br-tabell}.{&sok-field2} >= ~
                INPUT FILL-IN-SOK-{&sok-field2-def} USE-INDEX {&index-col1} NO-LOCK NO-ERROR.
...
&scoped-define BUFFER-COPY-USING USING Navn
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Region

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Region tRegion

/* Definitions for BROWSE BROWSE-Region                                 */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Region Region.RegKode Region.Navn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Region Region.RegKode ~
Region.Navn 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Region Region
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Region Region
&Scoped-define OPEN-QUERY-BROWSE-Region OPEN QUERY BROWSE-Region FOR EACH Region NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Region Region
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Region Region


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tRegion.RegKode tRegion.Navn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tRegion.RegKode 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tRegion
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tRegion
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tRegion NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tRegion
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tRegion


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Region}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Region BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Region FOR 
      Region
    FIELDS(Region.RegKode
      Region.Navn) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tRegion
    FIELDS(tRegion.RegKode
      tRegion.Navn) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Region
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Region Dialog-Frame _STRUCTURED
  QUERY BROWSE-Region NO-LOCK DISPLAY
      Region.RegKode FORMAT "X(10)":U
      Region.Navn FORMAT "X(30)":U
  ENABLE
      Region.RegKode
      Region.Navn
/* _UIB-CODE-BLOCK-END */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tRegion.RegKode FORMAT "X(10)":U
      tRegion.Navn FORMAT "X(30)":U
  ENABLE
      tRegion.RegKode
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
     BROWSE-Region AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tRegion T "?" NO-UNDO skotex Region
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Region 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Region
/* Query rebuild information for BROWSE BROWSE-Region
     _TblList          = "skotex.Region"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.Region.RegKode
"RegKode" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.Region.Navn
"Navn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tRegion"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tRegion.RegKode
"RegKode" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tRegion.Navn
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg region */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Region
&Scoped-define SELF-NAME BROWSE-Region
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Region Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Region IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Region Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Region IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Region Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Region IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Region Dialog-Frame
ON START-SEARCH OF BROWSE-Region IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Region Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Region IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Region BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
