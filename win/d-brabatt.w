...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wRabKod LIKE Rabatt.RabKod NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wRabKod LIKE Rabatt.RabKod NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   Rabatt

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  RabKod
...
&scoped-define index-col1  RabattIn
...
&scoped-define sok-field2  RabBeskr
...
&scoped-define index-col2  RabBeskr
...
&scoped-define ip-variabel wRabKod
&scoped-define return-ip   wRabKod = Rabatt.RabKod.
&scoped-define assign-retur-verdi retur-verdi = string(recid(Rabatt)).
...
&scoped-define KanSlettes ~
  if can-find(first ArtBas where ArtBas.RabKod = Rabatt.RabKod) then ~
    do: ~
      message "Det finns artiklar med denna rabattkoden" ~
      view-as alert-box title "Fel vid borttagning". ~
      return no-apply. ~
    end.

&scoped-define VedlikeholdsRutine d-vrabatt.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Rabatt

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Rabatt

/* Definitions for BROWSE BROWSE-Rabatt                                 */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Rabatt Rabatt.RabKod Rabatt.RabBeskr ~
Rabatt.RabProc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Rabatt Rabatt.RabKod ~
Rabatt.RabBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Rabatt Rabatt
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Rabatt Rabatt
&Scoped-define QUERY-STRING-BROWSE-Rabatt FOR EACH Rabatt NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Rabatt OPEN QUERY BROWSE-Rabatt FOR EACH Rabatt NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Rabatt Rabatt
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Rabatt Rabatt


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Rabatt}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INT ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Rabatt BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Rabatt FOR 
      Rabatt SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Rabatt
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Rabatt Dialog-Frame _STRUCTURED
  QUERY BROWSE-Rabatt NO-LOCK DISPLAY
      Rabatt.RabKod COLUMN-LABEL "Rabattkode *" FORMAT "z9":U
      Rabatt.RabBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "X(30)":U
      Rabatt.RabProc FORMAT "z9.99":U
  ENABLE
      Rabatt.RabKod
      Rabatt.RabBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 55.6 BY 7.38.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Rabatt AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 3 COL 59
     BUTTON-Endre AT ROW 4.33 COL 59
     BUTTON-Slett AT ROW 5.67 COL 59
     Btn_Help AT ROW 10.71 COL 59
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     SPACE(48.19) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste rabattkoder"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Rabatt BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Rabatt
/* Query rebuild information for BROWSE BROWSE-Rabatt
     _TblList          = "SkoTex.Rabatt"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Rabatt.RabKod
"Rabatt.RabKod" "Rabattkode *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Rabatt.RabBeskr
"Rabatt.RabBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   = SkoTex.Rabatt.RabProc
     _Query            is OPENED
*/  /* BROWSE BROWSE-Rabatt */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste rabattkoder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Rabatt
&Scoped-define SELF-NAME BROWSE-Rabatt
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Rabatt Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Rabatt IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Rabatt Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Rabatt IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Rabatt Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Rabatt IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Rabatt Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Rabatt IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Rabatt Dialog-Frame
ON START-SEARCH OF BROWSE-Rabatt IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
{syspara.i 16 18 2 iTilgang INT}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Rabatt BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_Help Btn_OK 
         Btn_Cancel 
      WITH FRAME Dialog-Frame.
