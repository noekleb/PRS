...
DEFINE TEMP-TABLE tSelger NO-UNDO LIKE Selger.
...
&scoped-define DB-BROWSER BROWSE-Selger

&scoped-define br-tabell Selger

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  SelgerNr
...
&scoped-define index-col1  Selger
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Selger

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Selger tSelger

/* Definitions for BROWSE BROWSE-Selger                                 */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Selger Selger.SelgerNr Selger.Navn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Selger Selger.SelgerNr ~
Selger.Navn 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Selger Selger
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Selger Selger
&Scoped-define OPEN-QUERY-BROWSE-Selger OPEN QUERY BROWSE-Selger FOR EACH Selger NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Selger Selger
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Selger Selger


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tSelger.SelgerNr tSelger.Navn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tSelger.SelgerNr ~
tSelger.Navn 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tSelger
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tSelger
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tSelger NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tSelger
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tSelger


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Selger}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Selger BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Selger FOR 
      Selger
    FIELDS(Selger.SelgerNr
      Selger.Navn) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tSelger
    FIELDS(tSelger.SelgerNr
      tSelger.Navn) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Selger
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Selger Dialog-Frame _STRUCTURED
  QUERY BROWSE-Selger NO-LOCK DISPLAY
      Selger.SelgerNr FORMAT ">>>>>>>>>>>>9":U
      Selger.Navn FORMAT "X(30)":U WIDTH 30.8
  ENABLE
      Selger.SelgerNr
      Selger.Navn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 54 BY 12.19.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tSelger.SelgerNr FORMAT ">>>>>>>>>>>>9":U
      tSelger.Navn FORMAT "X(30)":U WIDTH 31.2
  ENABLE
      tSelger.SelgerNr
      tSelger.Navn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 54 BY 12.19 ROW-HEIGHT-CHARS .62 EXPANDABLE.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-Selger AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tSelger T "?" NO-UNDO SkoTex Selger
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Selger 1 Dialog-Frame */
...
ASSIGN 
       Selger.SelgerNr:COLUMN-READ-ONLY IN BROWSE BROWSE-Selger = TRUE
       Selger.Navn:COLUMN-READ-ONLY IN BROWSE BROWSE-Selger = TRUE.

ASSIGN 
       tSelger.SelgerNr:COLUMN-READ-ONLY IN BROWSE BROWSE-Tag = TRUE
       tSelger.Navn:COLUMN-READ-ONLY IN BROWSE BROWSE-Tag = TRUE.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Selger
/* Query rebuild information for BROWSE BROWSE-Selger
     _TblList          = "skotex.Selger"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.Selger.SelgerNr
"SelgerNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > skotex.Selger.Navn
"Navn" ? ? "character" ? ? ? ? ? ? yes ? no no "30.8" yes no yes "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Selger */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tSelger"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tSelger.SelgerNr
"SelgerNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > Temp-Tables.tSelger.Navn
"Navn" ? ? "character" ? ? ? ? ? ? yes ? no no "31.2" yes no yes "U" "" ""
...
&Scoped-define BROWSE-NAME BROWSE-Selger
&Scoped-define SELF-NAME BROWSE-Selger
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Selger Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Selger IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Selger Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Selger IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Selger Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Selger IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Selger Dialog-Frame
ON START-SEARCH OF BROWSE-Selger IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Selger Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Selger IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Selger BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
