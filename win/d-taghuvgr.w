...
DEFINE TEMP-TABLE tHuvGr NO-UNDO LIKE HuvGr.
...
&scoped-define index-col1  HuvGrIn
...
/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field2  HgBeskr
...
&scoped-define index-col2  HgBeskr
...
&Scoped-define INTERNAL-TABLES HuvGr tHuvGr

/* Definitions for BROWSE BROWSE-HuvGr                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-HuvGr HuvGr.Hg HuvGr.HgBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-HuvGr HuvGr.Hg HuvGr.HgBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-HuvGr HuvGr
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-HuvGr HuvGr
&Scoped-define QUERY-STRING-BROWSE-HuvGr FOR EACH HuvGr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-HuvGr OPEN QUERY BROWSE-HuvGr FOR EACH HuvGr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-HuvGr HuvGr
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-HuvGr HuvGr


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tHuvGr.Hg tHuvGr.HgBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tHuvGr.Hg tHuvGr.HgBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tHuvGr
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tHuvGr
&Scoped-define QUERY-STRING-BROWSE-Tag FOR EACH tHuvGr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tHuvGr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tHuvGr
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tHuvGr
...
DEFINE QUERY BROWSE-HuvGr FOR 
      HuvGr
    FIELDS(HuvGr.Hg
      HuvGr.HgBeskr) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tHuvGr
    FIELDS(tHuvGr.Hg
      tHuvGr.HgBeskr) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tHuvGr.Hg FORMAT ">>>>>9":U
      tHuvGr.HgBeskr FORMAT "x(30)":U
  ENABLE
      tHuvGr.Hg
      tHuvGr.HgBeskr
/* _UIB-CODE-BLOCK-END */
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tHuvGr T "?" NO-UNDO SkoTex HuvGr
   END-TABLES.
 */
...
"Hg" ? ">>>>>9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > skotex.HuvGr.HgBeskr
"HgBeskr" ? "x(30)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-HuvGr */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tHuvGr"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tHuvGr.Hg
"Hg" ? ">>>>>9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tHuvGr.HgBeskr
"HgBeskr" ? "x(30)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg hovedgrupper */
DO:
