...
DEFINE TEMP-TABLE tKundeGruppe NO-UNDO LIKE KundeGruppe.
...
&ELSE
  ...
  def    input        parameter wVgNr    as int   no-undo.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define DB-BROWSER BROWSE-KundeGruppe

&scoped-define br-tabell KundeGruppe

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  GruppeId
...
&scoped-define index-col1  KundeGruppe
...
&scoped-define init-sel-phrase FIND b{&br-tabell} where b{&br-tabell}.{&sok-field1} = INT(ENTRY(wAntEntries,IO-Liste)) no-lock no-error.
...
&scoped-define BUFFER-COPY-USING USING 
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-KundeGruppe

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES KundeGruppe tKundeGruppe

/* Definitions for BROWSE BROWSE-KundeGruppe                            */
&Scoped-define FIELDS-IN-QUERY-BROWSE-KundeGruppe KundeGruppe.GruppeId ~
KundeGruppe.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-KundeGruppe ~
KundeGruppe.GruppeId 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-KundeGruppe KundeGruppe
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-KundeGruppe KundeGruppe
&Scoped-define OPEN-QUERY-BROWSE-KundeGruppe OPEN QUERY BROWSE-KundeGruppe FOR EACH KundeGruppe NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-KundeGruppe KundeGruppe
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-KundeGruppe KundeGruppe


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tKundeGruppe.GruppeId ~
tKundeGruppe.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tKundeGruppe.GruppeId 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tKundeGruppe
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tKundeGruppe
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tKundeGruppe NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tKundeGruppe
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tKundeGruppe


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-KundeGruppe}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-KundeGruppe BROWSE-Tag Btn_OK ~
Btn_Cancel Btn_Help BUTTON-Sok RECT-4 RECT-5 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-KundeGruppe FOR 
      KundeGruppe
    FIELDS(KundeGruppe.GruppeId
      KundeGruppe.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tKundeGruppe
    FIELDS(tKundeGruppe.GruppeId
      tKundeGruppe.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-KundeGruppe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-KundeGruppe Dialog-Frame _STRUCTURED
  QUERY BROWSE-KundeGruppe NO-LOCK DISPLAY
      KundeGruppe.GruppeId FORMAT "zzz9":U
      KundeGruppe.Beskrivelse FORMAT "X(40)":U
  ENABLE
      KundeGruppe.GruppeId
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 45.2 BY 12.19.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tKundeGruppe.GruppeId FORMAT "zzz9":U
      tKundeGruppe.Beskrivelse FORMAT "X(40)":U
  ENABLE
      tKundeGruppe.GruppeId
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 51.6 BY 12.19.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-KundeGruppe AT ROW 2.91 COL 3
     BUTTON-LeggTil AT ROW 6.76 COL 49.6
     BUTTON-TrekkFra AT ROW 7.95 COL 49.6
     BUTTON-AlleFra AT ROW 9.14 COL 49.6
     BROWSE-Tag AT ROW 2.95 COL 66
     Btn_OK AT ROW 15.52 COL 2
     Btn_Cancel AT ROW 15.52 COL 15
     Btn_Help AT ROW 15.57 COL 105.6
     ...
     RECT-5 AT ROW 2.71 COL 65
     SPACE(0.59) SKIP(1.34)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Velg kundegrupper"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tKundeGruppe T "?" NO-UNDO SkoTex KundeGruppe
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-KundeGruppe 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-KundeGruppe
/* Query rebuild information for BROWSE BROWSE-KundeGruppe
     _TblList          = "SkoTex.KundeGruppe"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > SkoTex.KundeGruppe.GruppeId
"KundeGruppe.GruppeId" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = SkoTex.KundeGruppe.Beskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-KundeGruppe */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tKundeGruppe"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tKundeGruppe.GruppeId
"tKundeGruppe.GruppeId" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tKundeGruppe.Beskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg kundegrupper */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-KundeGruppe
&Scoped-define SELF-NAME BROWSE-KundeGruppe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeGruppe Dialog-Frame
ON CURSOR-LEFT OF BROWSE-KundeGruppe IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeGruppe Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-KundeGruppe IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeGruppe Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-KundeGruppe IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeGruppe Dialog-Frame
ON START-SEARCH OF BROWSE-KundeGruppe IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-KundeGruppe Dialog-Frame
ON VALUE-CHANGED OF BROWSE-KundeGruppe IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Tag Dialog-Frame
ON ROW-DISPLAY OF BROWSE-Tag IN FRAME Dialog-Frame
DO:
  find KundeGruppe no-lock where
    KundeGruppe.GruppeId = tKundeGruppe.GruppeId no-error.
  if available KundeGruppe then
    assign
      wBeskrivelse = if available KundeGruppe
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-KundeGruppe BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok 
         RECT-4 RECT-5 
      WITH FRAME Dialog-Frame.
        ...
        */
        ...
        IF AVAIL b{&br-tabell} THEN DO:
            ...
            assign
              ...
              t{&br-tabell}.GruppeId    = b{&br-tabell}.GruppeId
              t{&br-tabell}.Beskrivelse = b{&br-tabell}.Beskrivelse
              .
            /*
...
------------------------------------------------------------------------------*/
    ...
    def buffer bufVgKundeGrpRabatt for VgKundeGrpRabatt.
        ...
        WHEN "Til" THEN DO:
            DO wAntSel = 1 TO BROWSE {&DB-BROWSER}:NUM-SELECTED-ROWS:
                ...
                IF NOT AVAIL t{&br-tabell} THEN DO:
                   LOOPEN:
                   do wLoop = 1 to 99:
                     find t{&br-tabell} no-lock where
                       t{&br-tabell}.GruppeId = wLoop no-error.
                     if not available t{&br-tabell} then
                       leave LOOPEN.
                   end. /* LOOPEN */
                   ...
                   assign
                     wAntValgt                 = wAntValgt + 1
                     t{&br-tabell}.GruppeId    = {&br-tabell}.GruppeId
                     t{&br-tabell}.Beskrivelse = {&br-tabell}.Beskrivelse
                     .                        
                   /*
            ...
            IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 1 THEN DO:
                ...
                DO wAntSel = 1 TO BROWSE BROWSE-Tag:NUM-SELECTED-ROWS:
                    IF BROWSE BROWSE-Tag:FETCH-SELECTED-ROW (wAntSel) THEN
                      do:
                        do transaction:
                          find bufVgKundeGrpRabatt exclusive-lock where
                            bufVgKundeGrpRabatt.Vg    = VarGr.Vg and
                            bufVgKundeGrpRabatt.GruppeId = t{&br-tabell}.GruppeId no-error.
                          if available bufVgKundeGrpRabatt then
                            delete bufVgKundeGrpRabatt.
                          DELETE t{&br-tabell}.
                          assign
                            wAntValgt = wAntValgt - 1.
                        end. /* TRANSACTION */
...
------------------------------------------------------------------------------*/
  find KundeGruppe no-lock where
    KundeGruppe.GruppeId = KundeGruppe.GruppeId no-error.
  if available KundeGruppe 
    then wBeskrivelse = KundeGruppe.Beskrivelse.
    else wBeskrivelse = "".
