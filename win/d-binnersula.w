...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wInner-Id LIKE InnerSula.Inner-Id NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wInner-Id LIKE InnerSula.Inner-Id NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   InnerSula

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  Inner-Id
...
&scoped-define index-col1  Innersula
...
&scoped-define sok-field2  InnerBeskr
...
&scoped-define index-col2  Inners-Beskr
...
&scoped-define ip-variabel wInner-Id
&scoped-define return-ip   wInner-Id = InnerSula.Inner-Id.
&scoped-define assign-retur-verdi retur-verdi = string(recid(InnerSula)).
...
&scoped-define KanSlettes ~
  if can-find(first ArtBas where ArtBas.Inner-Id = InnerSula.Inner-Id) then ~
    do: ~
...
&scoped-define VedlikeholdsRutine d-vinnersula.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Innersula

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES InnerSula

/* Definitions for BROWSE BROWSE-Innersula                              */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Innersula InnerSula.Inner-Id ~
InnerSula.InnerBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Innersula InnerSula.Inner-Id ~
InnerSula.InnerBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Innersula InnerSula
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Innersula InnerSula
&Scoped-define QUERY-STRING-BROWSE-Innersula FOR EACH InnerSula NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Innersula OPEN QUERY BROWSE-Innersula FOR EACH InnerSula NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Innersula InnerSula
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Innersula InnerSula


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Innersula}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INT ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Innersula BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Innersula FOR 
      InnerSula SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Innersula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Innersula Dialog-Frame _STRUCTURED
  QUERY BROWSE-Innersula NO-LOCK DISPLAY
      InnerSula.Inner-Id COLUMN-LABEL "Innersåle *" FORMAT "z9":U
      InnerSula.InnerBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(30)":U
  ENABLE
      InnerSula.Inner-Id
      InnerSula.InnerBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 45 BY 7.38.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Innersula AT ROW 2.91 COL 2
     BUTTON-Ny AT ROW 3 COL 47.8
     BUTTON-Endre AT ROW 4.33 COL 47.8
     BUTTON-Slett AT ROW 5.67 COL 47.8
     Btn_Help AT ROW 10.71 COL 47.8
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     SPACE(36.79) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste for innersåle"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Innersula BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Innersula
/* Query rebuild information for BROWSE BROWSE-Innersula
     _TblList          = "SkoTex.InnerSula"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.InnerSula.Inner-Id
"InnerSula.Inner-Id" "Innersåle *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.InnerSula.InnerBeskr
"InnerSula.InnerBeskr" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Innersula */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste for innersåle */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Innersula
&Scoped-define SELF-NAME BROWSE-Innersula
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innersula Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Innersula IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innersula Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Innersula IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innersula Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Innersula IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innersula Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Innersula IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Innersula Dialog-Frame
ON START-SEARCH OF BROWSE-Innersula IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
{syspara.i 16 19 2 iTilgang INT}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Innersula BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_Help Btn_OK 
         Btn_Cancel 
      WITH FRAME Dialog-Frame.
