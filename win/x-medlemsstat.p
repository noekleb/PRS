/************************************************************
    Program:  x-medlemsstat.p
    Created:  TN   3 Jan 01
Description:  Bygger jobblinje for medlemstatistikk.
...
DEF VAR wStTypeId    as CHAR INITIAL "MEDLEM" NO-UNDO.
...
PROCEDURE OpprettJobbLinje:
  ...
  */
  ...
  assign
    ...
    JobbLinje.DivX[ 3] = Medlem.ForNavn + " " + Medlem.EtterNavn /*ArtBas.LevKod*/
    JobbLinje.DivX[ 4] = " " /*ArtBas.LevFargKod*/
    JobbLinje.DivX[ 6] = " " /*wFilNavn*/
    JobbLinje.DivX[ 7] = STRING(Medlem.MedlemsNr)
    ...
    JobbLinje.DivX[26] = (if AVAILABLE MedlemsGruppe
                            THEN STRING(MedlemsGruppe.MedGruppe) + " " + MedlemsGruppe.Beskrivelse
                            else STRING(Medlem.MedGruppe))
    ...
    if AVAILABLE tStLinje then
      DO:
        ...
        ASSIGN
          ...
          JobbLinje.DecX[36] = Medlem.MedGruppe /*ArtBas.BildNr*/
    ...
    CASE wSortering:
      WHEN 1 THEN assign
        ...
        JobbLinje.DivX[11] = STRING(Medlem.MedlemsNr,"9999999999999")
      ...
      WHEN 3 THEN assign
        JobbLinje.DivX[10] = JobbLinje.Char1
        JobbLinje.DivX[11] = STRING(Medlem.MedlemsNr,"9999999999999")
        JobbLinje.DivX[12] = STRING(Medlem.MedlemsNr,"9999999999999")
        ...
        JobbLinje.DivX[17] = if INT(ENTRY(2,ListeLinje.DataObjekt,",")) = 0
                               THEN "Alle butikker"
                                           ...
                                           then STRING(bufButiker.Butik,"zzzzz9") + " " + bufButiker.ButNamn
                                           ELSE "")
        JobbLinje.DivX[18] = STRING(Medlem.MedlemsNr) + " " +
                              (if AVAILABLE MedlemsGruppe
                                THEN MedlemsGruppe.Beskrivelse
                                ELSE "")
        JobbLinje.DivX[19] = ""
        JobbLinje.DivX[20] = ""
        JobbLinje.DivX[21] = "".
      WHEN 4 THEN assign
        JobbLinje.DivX[10] = JobbLinje.Char1
        JobbLinje.DivX[11] = STRING(Medlem.MedGruppe,"9999")
        JobbLinje.DivX[12] = Medlem.ForNavn + " " + MEdlem.EtterNavn
        JobbLinje.DivX[13] = STRING(tStLinje.Aar,"9999") + STRING(tStLinje.PerLinNr,"999999999")
        JobbLinje.DivX[14] = ""
        /* Brytgruppetekster */
        JobbLinje.DivX[17] = if INT(ENTRY(2,ListeLinje.DataObjekt,",")) = 0
                               THEN "Alle butikker"
                                           ...
                                           then STRING(bufButiker.Butik,"zzzzz9") + " " + bufButiker.ButNamn
                                           ELSE "")
        JobbLinje.DivX[18] = STRING(Medlem.MedGruppe) + " " +
                              (if AVAILABLE MedlemsGruppe
                                THEN MedlemsGruppe.Beskrivelse
                                ELSE "")
        JobbLinje.DivX[19] = ""
