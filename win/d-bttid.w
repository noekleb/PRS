...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wTTId LIKE TransType.TTId INIT 31 NO-UNDO.
&ELSE
...
&scoped-define return-ip   wTTId = if available {&br-tabell}  ~
...
define var wTransListe       as char        no-undo.
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-TransTyper

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES TransType

/* Definitions for BROWSE BROWSE-TransTyper                             */
&Scoped-define FIELDS-IN-QUERY-BROWSE-TransTyper TransType.TTId ~
TransType.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-TransTyper 
&Scoped-define OPEN-QUERY-BROWSE-TransTyper OPEN QUERY BROWSE-TransTyper FOR EACH TransType ~
      WHERE can-do(wTransListe,string(TransType.TTId)) NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-TransTyper TransType
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-TransTyper TransType


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-TransTyper}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-DATE ~
FILL-IN-SOK-INT BUTTON-Sok BROWSE-TransTyper Btn_OK Btn_Cancel Btn_Help 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-TransTyper FOR 
      TransType SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-TransTyper
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-TransTyper Dialog-Frame _STRUCTURED
  QUERY BROWSE-TransTyper NO-LOCK DISPLAY
      TransType.TTId COLUMN-LABEL "TTId" FORMAT "zz9":U WIDTH 8.2
      TransType.Beskrivelse FORMAT "X(30)":U WIDTH 35
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 49 BY 8.1 ROW-HEIGHT-CHARS .63.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-TransTyper AT ROW 2.91 COL 2
     Btn_OK AT ROW 11.48 COL 2
     Btn_Cancel AT ROW 11.48 COL 15
     Btn_Help AT ROW 11.48 COL 36
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-TransTyper BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-TransTyper
/* Query rebuild information for BROWSE BROWSE-TransTyper
     _TblList          = "skotex.TransType"
     _Options          = "NO-LOCK"
     _Where[1]         = "can-do(wTransListe,string(TransType.TTId))"
     _FldNameList[1]   > skotex.TransType.TTId
"TransType.TTId" "TTId" ? "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
     _FldNameList[2]   > skotex.TransType.Beskrivelse
"TransType.Beskrivelse" ? ? "character" ? ? ? ? ? ? no ? no no "35" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-TransTyper */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Transaksjonstyper */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-TransTyper
&Scoped-define SELF-NAME BROWSE-TransTyper
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-TransTyper Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-TransTyper IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-TransTyper Dialog-Frame
ON CURSOR-LEFT OF BROWSE-TransTyper IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-TransTyper Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-TransTyper IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-TransTyper Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-TransTyper IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-TransTyper Dialog-Frame
ON START-SEARCH OF BROWSE-TransTyper IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-DATE FILL-IN-SOK-INT BUTTON-Sok 
         BROWSE-TransTyper Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
