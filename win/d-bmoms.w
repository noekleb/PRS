...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wMomsKod LIKE Moms.MomsKod NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wMomsKod LIKE Moms.MomsKod NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   Moms

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  MomsKod
...
&scoped-define index-col1  MomsIn
...
&scoped-define ip-variabel wMomsKod
&scoped-define return-ip   wMomsKod = if available Moms ~
                                        then Moms.MomsKod ~
                                        else 0.
&scoped-define assign-retur-verdi retur-verdi = if available Moms ~
                                                  then string(recid(Moms)) ~
                                                  else "".
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Moms

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Moms

/* Definitions for BROWSE BROWSE-Moms                                   */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Moms Moms.MomsKod Moms.MomsProc ~
Moms.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Moms Moms.MomsKod ~
Moms.Beskrivelse 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-Moms~
 ~{&FP1}MomsKod ~{&FP2}MomsKod ~{&FP3}~
 ~{&FP1}Beskrivelse ~{&FP2}Beskrivelse ~{&FP3}
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Moms Moms
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Moms Moms
&Scoped-define OPEN-QUERY-BROWSE-Moms OPEN QUERY BROWSE-Moms FOR EACH Moms NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Moms Moms
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Moms Moms


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Moms}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INT ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Moms Btn_Help Btn_OK Btn_Cancel 
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Moms FOR 
      Moms SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Moms
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Moms Dialog-Frame _STRUCTURED
  QUERY BROWSE-Moms NO-LOCK DISPLAY
      Moms.MomsKod COLUMN-LABEL "Mva *"
      Moms.MomsProc
      Moms.Beskrivelse COLUMN-LABEL "Beskrivelse *"
  ENABLE
      Moms.MomsKod
      Moms.Beskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 48.6 BY 7.38.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Moms AT ROW 2.91 COL 2
     Btn_Help AT ROW 10.71 COL 35.6
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     SPACE(24.19) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste mva koder"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Moms BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Moms
/* Query rebuild information for BROWSE BROWSE-Moms
     _TblList          = "SkoTex.Moms"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Moms.MomsKod
"MomsKod" "Mva *" ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[2]   = SkoTex.Moms.MomsProc
     _FldNameList[3]   > SkoTex.Moms.Beskrivelse
"Beskrivelse" "Beskrivelse *" ? "character" ? ? ? ? ? ? yes ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-Moms */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste mva koder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Moms
&Scoped-define SELF-NAME BROWSE-Moms
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Moms Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Moms IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Moms Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Moms IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Moms Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Moms IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Moms Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Moms IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Moms Dialog-Frame
ON START-SEARCH OF BROWSE-Moms IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Moms Btn_Help Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
