...
/* ***************************  Main Block  *************************** */
IF NOT CAN-FIND(Butiker WHERE Butiker.Butik = dButikkNr) THEN DO:
    RUN ButikFraKjedens.
        ...
        CASE iModellNr:
            WHEN 20 THEN DO:
                ...
                ASSIGN Kasse.ButikkNr              = KjedensButikker.ButikkNr
                       ...
                       Kasse.ElJournalId           = STRING(KjedensButikker.ButikkNr)
                       Kasse.KvitteringId          = "*"
                       ...
                       Kasse.ElJournalKatalog      = ".\kom\in\" + STRING(KjedensButikker.ButikkNr)
            ...
            WHEN 30 THEN DO:
                ...
                ASSIGN Kasse.ButikkNr              = KjedensButikker.ButikkNr
                       ...
                       Kasse.KvitteringId          = '"' + STRING(KjedensButikker.ButikkNr) + '"'          
                       Kasse.UtskriftsKopiId       = "*"                  
                       Kasse.KassererOppgjId       = "*"                  
                       Kasse.DagsOppgj             = "*"                  
                       ...
                       Kasse.KassererOppgjAktiv    = no                   
                       Kasse.DagsOppgjAktiv        = no                   
                       Kasse.KvitteringKatalog     = ".\kom\in\" + STRING(KjedensButikker.ButikkNr)
