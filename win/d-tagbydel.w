...
DEFINE SHARED TEMP-TABLE Bydel NO-UNDO LIKE Post.
DEFINE TEMP-TABLE tBydel NO-UNDO LIKE Post.
...
&scoped-define DB-BROWSER BROWSE-Bydel

&scoped-define br-tabell Bydel
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Bydel

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Bydel tBydel

/* Definitions for BROWSE BROWSE-Bydel                                  */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Bydel Bydel.PostNr Bydel.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Bydel Bydel.PostNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Bydel Bydel
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Bydel Bydel
&Scoped-define OPEN-QUERY-BROWSE-Bydel OPEN QUERY BROWSE-Bydel FOR EACH Bydel NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Bydel Bydel
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Bydel Bydel


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tBydel.PostNr tBydel.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tBydel.PostNr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tBydel
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tBydel
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tBydel NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tBydel
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tBydel


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Bydel}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-Bydel BROWSE-Tag Btn_OK Btn_Cancel ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Bydel FOR 
      Bydel
    FIELDS(Bydel.PostNr
      Bydel.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tBydel
    FIELDS(tBydel.PostNr
      tBydel.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Bydel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Bydel Dialog-Frame _STRUCTURED
  QUERY BROWSE-Bydel NO-LOCK DISPLAY
      Bydel.PostNr COLUMN-LABEL "Bydel" FORMAT "X(10)":U
      Bydel.Beskrivelse COLUMN-LABEL "Beskrivelse" FORMAT "X(30)":U
  ENABLE
      Bydel.PostNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 54 BY 14.29 EXPANDABLE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tBydel.PostNr COLUMN-LABEL "Bydel" FORMAT "X(10)":U
      tBydel.Beskrivelse COLUMN-LABEL "Beskrivelse" FORMAT "X(30)":U
  ENABLE
      tBydel.PostNr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 54 BY 14.29 ROW-HEIGHT-CHARS .62 EXPANDABLE.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-Bydel AT ROW 2.91 COL 3
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: Bydel T "SHARED" NO-UNDO skotex Post
      TABLE: tBydel T "?" NO-UNDO skotex Post
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-Bydel 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Bydel
/* Query rebuild information for BROWSE BROWSE-Bydel
     _TblList          = "Temp-Tables.Bydel"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.Bydel.PostNr
"PostNr" "Bydel" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.Bydel.Beskrivelse
"Beskrivelse" "Beskrivelse" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Bydel */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tBydel"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tBydel.PostNr
"PostNr" "Bydel" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.tBydel.Beskrivelse
"Beskrivelse" "Beskrivelse" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg bydelsnummer */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Bydel
&Scoped-define SELF-NAME BROWSE-Bydel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bydel Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Bydel IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bydel Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Bydel IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bydel Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Bydel IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bydel Dialog-Frame
ON START-SEARCH OF BROWSE-Bydel IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Bydel Dialog-Frame
ON VALUE-CHANGED OF BROWSE-Bydel IN FRAME Dialog-Frame
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-Bydel BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok RECT-4 
         RECT-5 
      WITH FRAME Dialog-Frame.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEF VAR wBlank AS CHAR NO-UNDO.
...
------------------------------------------------------------------------------*/
    DO wAntEntries = 1 TO NUM-ENTRIES(IO-Liste) WITH FRAME {&FRAME-NAME}:
        ...
        IF entry(wAntEntries,io-Liste) = "BLANK" then
            ENTRY (wAntEntries,IO-Liste) = " ".

        FIND b{&br-tabell} where 
          b{&br-tabell}.{&sok-field1} = string(ENTRY(wAntEntries,IO-Liste)) no-lock no-error.
        
        IF AVAIL b{&br-tabell} THEN DO:
            CREATE t{&br-tabell}.
            assign
              wAntValgt                   = wAntValgt + 1            
              t{&br-tabell}.{&sok-field1} = string(entry(wAntEntries,IO-Liste)).
