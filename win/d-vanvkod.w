...
&scoped-define VisPoster ~
  Anv-Kod.Anv-Id when available Anv-Kod ~
...
&scoped-define SjekkOmPostFinnes if can-find({&br-tabell} where ~
        ...
        do: ~
            message "{&br-tabell} finnes allerede med anvkodnr:" ~
...
&Scoped-define FIELDS-IN-QUERY-Dialog-Frame Anv-Kod.Anv-Id Anv-Kod.AnvBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Dialog-Frame Anv-Kod.Anv-Id ~
Anv-Kod.AnvBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-Dialog-Frame Anv-Kod
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Dialog-Frame Anv-Kod
&Scoped-define OPEN-QUERY-Dialog-Frame OPEN QUERY Dialog-Frame FOR EACH Anv-Kod SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-Dialog-Frame Anv-Kod
&Scoped-define FIRST-TABLE-IN-QUERY-Dialog-Frame Anv-Kod


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Anv-Kod.Anv-Id Anv-Kod.AnvBeskr 
&Scoped-define ENABLED-TABLES Anv-Kod
&Scoped-define FIRST-ENABLED-TABLE Anv-Kod
&Scoped-define DISPLAYED-TABLES Anv-Kod
&Scoped-define FIRST-DISPLAYED-TABLE Anv-Kod
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel Btn_Help 
&Scoped-Define DISPLAYED-FIELDS Anv-Kod.Anv-Id Anv-Kod.AnvBeskr 
...
DEFINE FRAME Dialog-Frame
     Anv-Kod.Anv-Id AT ROW 2.05 COL 13.8 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     Anv-Kod.AnvBeskr AT ROW 2.05 COL 19.4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
...
------------------------------------------------------------------------------*/
  IF AVAILABLE Anv-Kod THEN 
    DISPLAY Anv-Kod.Anv-Id Anv-Kod.AnvBeskr 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 Anv-Kod.Anv-Id Anv-Kod.AnvBeskr Btn_OK Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
