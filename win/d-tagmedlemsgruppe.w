...
DEFINE TEMP-TABLE tMedlemsGruppe NO-UNDO LIKE MedlemsGruppe.
...
&scoped-define DB-BROWSER BROWSE-MedlemsGruppe

&scoped-define br-tabell MedlemsGruppe

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  MedGruppe
...
&scoped-define index-col1 MedlemsGruppe
...
&scoped-define BUFFER-COPY-USING USING Beskrivelse
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-MedlemsGruppe

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES MedlemsGruppe tMedlemsGruppe

/* Definitions for BROWSE BROWSE-MedlemsGruppe                          */
&Scoped-define FIELDS-IN-QUERY-BROWSE-MedlemsGruppe MedlemsGruppe.MedGruppe ~
MedlemsGruppe.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-MedlemsGruppe ~
MedlemsGruppe.MedGruppe 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-MedlemsGruppe MedlemsGruppe
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-MedlemsGruppe MedlemsGruppe
&Scoped-define OPEN-QUERY-BROWSE-MedlemsGruppe OPEN QUERY BROWSE-MedlemsGruppe FOR EACH MedlemsGruppe NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-MedlemsGruppe MedlemsGruppe
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-MedlemsGruppe MedlemsGruppe


/* Definitions for BROWSE BROWSE-Tag                                    */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Tag tMedlemsGruppe.MedGruppe ~
tMedlemsGruppe.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Tag tMedlemsGruppe.MedGruppe 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Tag tMedlemsGruppe
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Tag tMedlemsGruppe
&Scoped-define OPEN-QUERY-BROWSE-Tag OPEN QUERY BROWSE-Tag FOR EACH tMedlemsGruppe NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Tag tMedlemsGruppe
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Tag tMedlemsGruppe


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-MedlemsGruppe}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS BROWSE-MedlemsGruppe BROWSE-Tag Btn_OK ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-MedlemsGruppe FOR 
      MedlemsGruppe
    FIELDS(MedlemsGruppe.MedGruppe
      MedlemsGruppe.Beskrivelse) SCROLLING.

DEFINE QUERY BROWSE-Tag FOR 
      tMedlemsGruppe
    FIELDS(tMedlemsGruppe.MedGruppe
      tMedlemsGruppe.Beskrivelse) SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-MedlemsGruppe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-MedlemsGruppe Dialog-Frame _STRUCTURED
  QUERY BROWSE-MedlemsGruppe NO-LOCK DISPLAY
      MedlemsGruppe.MedGruppe COLUMN-LABEL "MedGrp" FORMAT "zzz9":U
      MedlemsGruppe.Beskrivelse FORMAT "X(40)":U
  ENABLE
      MedlemsGruppe.MedGruppe
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 54 BY 14.29.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Tag Dialog-Frame _STRUCTURED
  QUERY BROWSE-Tag NO-LOCK DISPLAY
      tMedlemsGruppe.MedGruppe COLUMN-LABEL "MedGrp" FORMAT "zzz9":U
      tMedlemsGruppe.Beskrivelse FORMAT "X(40)":U
  ENABLE
      tMedlemsGruppe.MedGruppe
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS MULTIPLE SIZE 54 BY 14.29 ROW-HEIGHT-CHARS .62.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     BROWSE-MedlemsGruppe AT ROW 2.91 COL 3
     BUTTON-LeggTil AT ROW 6.71 COL 59
     BUTTON-TrekkFra AT ROW 7.91 COL 59
     BUTTON-AlleFra AT ROW 9.1 COL 59
     BROWSE-Tag AT ROW 2.91 COL 76
     Btn_OK AT ROW 17.67 COL 2
     Btn_Cancel AT ROW 17.67 COL 15
     Btn_Help AT ROW 17.67 COL 119
     ...
     RECT-5 AT ROW 2.67 COL 75
     SPACE(0.19) SKIP(1.34)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Velg medlemsgrupper"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tMedlemsGruppe T "?" NO-UNDO skotex MedlemsGruppe
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
   Custom                                                               */
/* BROWSE-TAB BROWSE-MedlemsGruppe 1 Dialog-Frame */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-MedlemsGruppe
/* Query rebuild information for BROWSE BROWSE-MedlemsGruppe
     _TblList          = "skotex.MedlemsGruppe"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > skotex.MedlemsGruppe.MedGruppe
"MedGruppe" "MedGrp" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = skotex.MedlemsGruppe.Beskrivelse
     _Query            is OPENED
*/  /* BROWSE BROWSE-MedlemsGruppe */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Tag
/* Query rebuild information for BROWSE BROWSE-Tag
     _TblList          = "Temp-Tables.tMedlemsGruppe"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > Temp-Tables.tMedlemsGruppe.MedGruppe
"MedGruppe" "MedGrp" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = Temp-Tables.tMedlemsGruppe.Beskrivelse
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Velg medlemsgrupper */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-MedlemsGruppe
&Scoped-define SELF-NAME BROWSE-MedlemsGruppe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsGruppe Dialog-Frame
ON CURSOR-LEFT OF BROWSE-MedlemsGruppe IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsGruppe Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-MedlemsGruppe IN FRAME Dialog-Frame /* ? */
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsGruppe Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-MedlemsGruppe IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsGruppe Dialog-Frame
ON START-SEARCH OF BROWSE-MedlemsGruppe IN FRAME Dialog-Frame /* ? */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-MedlemsGruppe Dialog-Frame
ON VALUE-CHANGED OF BROWSE-MedlemsGruppe IN FRAME Dialog-Frame /* ? */
DO:
    IF BROWSE BROWSE-Tag:NUM-SELECTED-ROWS > 0 THEN DO:
        IF BROWSE BROWSE-Tag:DESELECT-ROWS() THEN.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-MedlemsGruppe BROWSE-Tag Btn_OK Btn_Cancel Btn_Help BUTTON-Sok 
         RECT-4 RECT-5 
      WITH FRAME Dialog-Frame.
