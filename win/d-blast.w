...
&IF DEFINED(UIB_IS_RUNNING) <> 0 &THEN          
  DEFINE VAR wLast-Id LIKE Last-Sko.Last-Id NO-UNDO.
&ELSE
  DEFINE INPUT-OUTPUT PARAMETER wLast-Id LIKE Last-Sko.Last-Id NO-UNDO.
&ENDIF

/* Preprossessor direktiver ---                                         */
&scoped-define br-tabell   Last-Sko

/* Kolonne 1 som det kan sorteres på */
&scoped-define sok-field1  Last-Id
...
&scoped-define index-col1  Last-Sko
...
&scoped-define sok-field2  LastBeskr
...
&scoped-define index-col2  Last-Txt
...
&scoped-define ip-variabel wLast-Id
&scoped-define return-ip   wLast-Id = Last-Sko.Last-Id.
&scoped-define assign-retur-verdi retur-verdi = string(recid(Last-Sko)).
...
&scoped-define KanSlettes ~
  if can-find(first ArtBas where ArtBas.Last-Id = Last-Sko.Last-Id) then ~
    do: ~
...
&scoped-define VedlikeholdsRutine d-vlast.w
...
&Scoped-define FRAME-NAME Dialog-Frame
&Scoped-define BROWSE-NAME BROWSE-Last-Sko

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Last-Sko

/* Definitions for BROWSE BROWSE-Last-Sko                               */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Last-Sko Last-Sko.Last-Id ~
Last-Sko.LastBeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Last-Sko Last-Sko.Last-Id ~
Last-Sko.LastBeskr 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-Last-Sko Last-Sko
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-Last-Sko Last-Sko
&Scoped-define QUERY-STRING-BROWSE-Last-Sko FOR EACH Last-Sko NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-Last-Sko OPEN QUERY BROWSE-Last-Sko FOR EACH Last-Sko NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-Last-Sko Last-Sko
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Last-Sko Last-Sko


/* Definitions for DIALOG-BOX Dialog-Frame                              */
&Scoped-define OPEN-BROWSERS-IN-QUERY-Dialog-Frame ~
    ~{&OPEN-QUERY-BROWSE-Last-Sko}

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS FILL-IN-SOK-CHAR FILL-IN-SOK-INT ~
FILL-IN-SOK-DATE BUTTON-Sok BROWSE-Last-Sko BUTTON-Ny BUTTON-Endre ~
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Last-Sko FOR 
      Last-Sko SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Last-Sko
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Last-Sko Dialog-Frame _STRUCTURED
  QUERY BROWSE-Last-Sko NO-LOCK DISPLAY
      Last-Sko.Last-Id COLUMN-LABEL "Læst *" FORMAT "z9":U
      Last-Sko.LastBeskr COLUMN-LABEL "Beskrivelse *" FORMAT "x(30)":U
  ENABLE
      Last-Sko.Last-Id
      Last-Sko.LastBeskr
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 41.2 BY 7.38.
...
DEFINE FRAME Dialog-Frame
     ...
     BROWSE-Last-Sko AT ROW 2.71 COL 2
     BUTTON-Ny AT ROW 2.71 COL 44
     BUTTON-Endre AT ROW 4.05 COL 44
     BUTTON-Slett AT ROW 5.38 COL 44
     Btn_OK AT ROW 10.81 COL 2.2
     Btn_Cancel AT ROW 10.81 COL 14.6
     Btn_Help AT ROW 10.81 COL 44
     SPACE(0.19) SKIP(0.18)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste læstkoder"
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-Last-Sko BUTTON-Sok Dialog-Frame */
ASSIGN 
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Last-Sko
/* Query rebuild information for BROWSE BROWSE-Last-Sko
     _TblList          = "SkoTex.Last-Sko"
     _Options          = "NO-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _FldNameList[1]   > SkoTex.Last-Sko.Last-Id
"Last-Sko.Last-Id" "Læst *" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > SkoTex.Last-Sko.LastBeskr
"Last-Sko.LastBeskr" "Beskrivelse *" "x(30)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-Last-Sko */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Søkeliste læstkoder */
DO:
...
&Scoped-define BROWSE-NAME BROWSE-Last-Sko
&Scoped-define SELF-NAME BROWSE-Last-Sko
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Last-Sko Dialog-Frame
ON ANY-PRINTABLE OF BROWSE-Last-Sko IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Last-Sko Dialog-Frame
ON CURSOR-LEFT OF BROWSE-Last-Sko IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Last-Sko Dialog-Frame
ON CURSOR-RIGHT OF BROWSE-Last-Sko IN FRAME Dialog-Frame
DO:
  IF {&ant-sok-field} = 1 THEN
    RETURN NO-APPLY.
  RUN SD-CURSOR ("RIGHT").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Last-Sko Dialog-Frame
ON DEFAULT-ACTION OF BROWSE-Last-Sko IN FRAME Dialog-Frame
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-Last-Sko Dialog-Frame
ON START-SEARCH OF BROWSE-Last-Sko IN FRAME Dialog-Frame
DO:
  RUN SD-START-SEARCH.
  RETURN NO-APPLY.
END.
...
{syspara.i 16 22 2 iTilgang INT}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE FILL-IN-SOK-CHAR FILL-IN-SOK-INT FILL-IN-SOK-DATE BUTTON-Sok 
         BROWSE-Last-Sko BUTTON-Ny BUTTON-Endre BUTTON-Slett Btn_OK Btn_Cancel 
         Btn_Help 
      WITH FRAME Dialog-Frame.
