...
DEFINE VARIABLE FI-Tittel AS CHARACTER FORMAT "X(256)":U INITIAL "      Import av leverandører" 
      VIEW-AS TEXT 
     SIZE 77 BY 1.38
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Import av leverandører fra eXcellenc PRO"
         HEIGHT             = 16.19
         WIDTH              = 80
         MAX-HEIGHT         = 16.19
         MAX-WIDTH          = 80
...
ON END-ERROR OF C-Win /* Import av leverandører fra eXcellenc PRO */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Import av leverandører fra eXcellenc PRO */
DO:
...
DO:
  ...
  if B-Start:private-data = "OPPDAT" then
    do:
      ...
      run x-impflexlevreg.w persistent set wProgram-Handle (this-procedure:handle).      
    end.
