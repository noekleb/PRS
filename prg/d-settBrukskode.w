...
&Scoped-Define ENABLED-OBJECTS rsAlle B-SokAnv-Id fiAnv-Id Btn_OK ~
Btn_Cancel fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiAnv-Id fi-cMessage fi-cNumTotal ~
fi-cNumSelected 
...
DEFINE VARIABLE fiAnv-Id AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "Brukskode" 
     VIEW-AS FILL-IN 
     SIZE 12.6 BY 1.
...
DEFINE FRAME Dialog-Frame
     ...
     B-SokAnv-Id AT ROW 3.81 COL 81.6 WIDGET-ID 2
     fiAnv-Id AT ROW 3.86 COL 67 COLON-ALIGNED HELP
          "Kjøkkenskriver"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Endre brukskode */
DO:
...
&Scoped-define SELF-NAME B-SokAnv-Id
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL B-SokAnv-Id {&FRAME-NAME}
ON CHOOSE OF B-SokAnv-Id IN FRAME {&FRAME-NAME} /* ... */
OR "MOUSE-SELECT-DBLCLICK":U OF B-SokAnv-Id
OR "F10" OF B-SokAnv-Id
DO:
  DEF VAR cLookupValue AS CHAR NO-UNDO.

  cLookupValue = "AnvBeskr,Anv-Id".

  RUN JBoxDLookup.w ("Anv-Kod;AnvBeskr;Anv-Id", "where true", INPUT-OUTPUT cLookupValue).

  IF cLookupValue NE "" THEN DO:
    fiAnv-Id:SCREEN-VALUE = ENTRY(2,cLookupValue,'|').
    APPLY "return" TO fiAnv-Id.
  END.
END.
...
DO:
  ASSIGN fiAnv-Id rsAlle.
  ASSIGN cValues = STRING(fiAnv-Id)
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiAnv-Id fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle B-SokAnv-Id fiAnv-Id Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
