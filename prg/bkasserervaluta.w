...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.ValKod ~
rowObject.KasseValKurs rowObject.Valuta rowObject.Belop 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.Valuta 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.ValKod FORMAT "x(3)":U
      rowObject.KasseValKurs FORMAT "zz9.999999":U
      rowObject.Valuta FORMAT "->>>>>>9.99":U
      rowObject.Belop FORMAT "->>>>>>9.99":U WIDTH 12.6
  ENABLE
      rowObject.Valuta
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 61 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.ValKod
     _FldNameList[2]   = _<SDO>.rowObject.KasseValKurs
     _FldNameList[3]   > _<SDO>.rowObject.Valuta
"rowObject.Valuta" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.Belop
"rowObject.Belop" ? ? "decimal" ? ? ? ? ? ? no ? no no "12.6" yes no no "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE updateRecord bTableWin 
...
------------------------------------------------------------------------------*/
  ...
  DO:
      ASSIGN
          RowObject.Belop:SCREEN-VALUE IN BROWSE br_Table =  STRING(DEC(RowObject.KasseValKurs:SCREEN-VALUE IN BROWSE br_Table)  *
                                                             DEC(RowObject.Valuta:SCREEN-VALUE IN BROWSE br_Table))
          RowObject.Belop:MODIFIED IN BROWSE br_Table     = TRUE
          .
  END.
  RUN SUPER.
