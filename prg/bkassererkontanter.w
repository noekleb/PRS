...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.ButikkNr rowObject.Dato ~
rowObject.KassererNr rowObject.z_nummer 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      KassererNr FORMAT ">>>>>9":U
      z_nummer FORMAT ">>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 42 BY 6.67 EXPANDABLE.
