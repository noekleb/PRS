...
/*------------------------------------------------------------------------
    File        : xGS1v3_4_Til_PRSPricat.p
    Purpose     :

    Syntax      :

    Description : Leser inn vpi GS1 v3.4 filen og omformer den til en PRS pricat fil.
...
ASSIGN 
    bTest = TRUE 
    cLogg = 'xGS1v3_4_Til_PRSPricat' + REPLACE(STRING(TODAY),'/','')
    .

IF bTest THEN 
    RUN bibl_loggDbFri.p (cLogg,
        'Start xGS1v3_4_Til_PRSPricat.p'
        ).
...
IF bTest THEN 
    RUN bibl_loggDbFri.p (cLogg,
        'Ferdig xGS1v3_4_Til_PRSPricat.p'
        ).
...
PROCEDURE lesInnPricat:
    ...
    REPEAT:
        ...
        lDec = DEC(TRIM(ENTRY( 5,pcLinje,";"),'"')) NO-ERROR.
        ...
        ASSIGN
            ...
            /* nArtno        */ 
            ttPriKat.LevModellNr     = TRIM(ENTRY( 7,pcLinje,";"),'"')                  
            /* cEANCode      */ 
            ttPriKat.EANnr           = TRIM(ENTRY( 5,pcLinje,";"),'"')
            /* rArtName      */ 
            ttPriKat.VareTekst       = REPLACE(REPLACE(TRIM(ENTRY( 9,pcLinje,";"),'"'),CHR(10),''),CHR(13),'')
            ttPriKat.VareTekst       = REPLACE(ttPriKat.VareTekst,';',',')
            /* NColCode      */ 
            ttPriKat.FargeKode       = TRIM(ENTRY(11,pcLinje,";"),'"')
            /* cColName      */ 
            ttPriKat.FargeTekst      = TRIM(ENTRY(12,pcLinje,";"),'"')
            ttPriKat.FargeTekst      = REPLACE(ttPriKat.FargeTekst,';',',')
            /* cCode1        */ 
            ttPriKat.Str             = TRIM(ENTRY(13,pcLinje,";"),'"')
            /* nOrder        */ 
            ttPriKat.SeqNrStr        = 0 
            /* nSeason(3) + nSizeCode(3) */
            ttPriKat.StrTab          = TRIM(ENTRY(14,pcLinje,";"),'"')
            /* nMainGroup    */ 
            ttPriKat.Varemerke       = TRIM(ENTRY( 3,pcLinje,";"),'"')
            /*               */ 
            ttPriKat.Enh             = TRIM(ENTRY(18,pcLinje,";"),'"')
            /*               */ 
            ttPriKat.AntIEnh         = TRIM(ENTRY(19,pcLinje,";"),'"')

            /* NWholeSaleNet */ 
            ttPriKat.LevPrisEngros   = REPLACE(TRIM(TRIM(ENTRY(29,pcLinje,";"),'"'),"%"),' ','')
            /*               */ 
            ttPriKat.ValKod          = TRIM(ENTRY(30,pcLinje,";"),'"')
            /*               */ 
            ttPriKat.forhRab%        = REPLACE(TRIM(TRIM(ENTRY(33,pcLinje,";"),'"'),"%"),' ','')
            /*               */ 
            ttPriKat.suppRab%        = REPLACE(TRIM(TRIM(ENTRY(37,pcLinje,";"),'"'),"%"),' ','')
            /* nRetailPrice  */ 
            ttPriKat.VeilPris        = TRIM(ENTRY(39,pcLinje,";"),'"')
            /*               */ 
            ttPriKat.PAKstru         = ""
            /* nArtgroup + nSubGroup */
            ttPriKat.VareGruppe      = ENTRY(4,pcLinje,";") 
            /*               */ 
            ttPriKat.LevNavn         = ""
            /* nArtno        */ 
            ...
            /* nSeason       */ 
            ttPriKat.Sesong          = "1"
            ttPriKat.VPIBildeKode    = TRIM(ENTRY(98,pcLinje,";"),'"')
            /*               */ 
            ttPriKat.Merknad         = ""
            ttPriKat.ERPNr           = TRIM(ENTRY( 8,pcLinje,";"),'"')
            ttPriKat.EkstStrTypeNavn = TRIM(ENTRY(14,pcLinje,";"),'"')
            ttPriKat.AntIEnh         = TRIM(ENTRY(19,pcLinje,";"),'"')
            ttPriKat.LevUke1         = TRIM(ENTRY(56,pcLinje,";"),'"')
            ttPriKat.LevUke2         = TRIM(ENTRY(57,pcLinje,";"),'"')
            /*
            ttPriKat.LevUke3         = TRIM(ENTRY(65,pcLinje,";"),'"')
            ttPriKat.LevUke4         = TRIM(ENTRY(66,pcLinje,";"),'"')
            */
            .      
