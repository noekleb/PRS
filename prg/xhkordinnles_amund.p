...
------------------------------------------------------------------------------*/
    ...
    FOR EACH TT_ArtBas:
        FIND ArtBas WHERE ArtBas.ArtikkelNr = TT_ArtBas.ArtikkelNr NO-ERROR.
        IF NOT AVAIL ArtBas THEN DO:
            CREATE ArtBas.
            BUFFER-COPY TT_ArtBas EXCEPT Lopnr TO ArtBas
                ASSIGN ArtBas.ManRabIKas = TRUE  NO-ERROR.
            IF ERROR-STATUS:ERROR THEN DO:
                DELETE ArtBas.
                NEXT.
            END.
            ASSIGN ArtBas.Notat     = REPLACE(REPLACE(ArtBas.Notat,CHR(1),CHR(10)),CHR(2),CHR(13))
                   ArtBas.Varefakta = REPLACE(REPLACE(ArtBas.Varefakta,CHR(1),CHR(10)),CHR(2),CHR(13)) NO-ERROR.
        ...
        ELSE DO:
            IF Artbas.vg <> TT_Artbas.vg THEN
                ASSIGN Artbas.lopnr = ?.
            BUFFER-COPY TT_ArtBas EXCEPT Lopnr IKasse TO ArtBas.
      ...
      FOR EACH TT_PkSdlPris OF TT_PkSdlHode:
          ...
          IF NOT AVAIL PkSdlPris THEN DO:
              ...
              IF ERROR-STATUS:ERROR THEN DO:
                  ...
                  NEXT.
              END.
              /* Overstyrer pakkseddelpris Pris til kunde, med den lokalt satte prisen. */
              ...
              DO:
                  IF lokArtPris.Pris[1] <> PkSdlPris.NyPris THEN
                  /* Setter lokal pris. */
                  ASSIGN
                      PkSdlPris.OverstyrPris = true
