...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.MomsKod ~
rowObject.MomsProc rowObject.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.MomsKod ~
rowObject.MomsProc rowObject.Beskrivelse 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.MomsKod FORMAT "z9":U WIDTH 5.2
      rowObject.MomsProc FORMAT "z9.99":U WIDTH 7.2
      rowObject.Beskrivelse FORMAT "X(30)":U WIDTH 47.6
  ENABLE
      rowObject.MomsKod HELP "?"
      rowObject.MomsProc HELP "?"
...
ASSIGN 
       ...
       rowObject.MomsProc:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.MomsKod
"rowObject.MomsKod" ? ? "integer" ? ? ? ? ? ? yes "?" no no "5.2" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.MomsProc
"rowObject.MomsProc" ? ? "decimal" ? ? ? ? ? ? yes "?" no no "7.2" yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Beskrivelse
"rowObject.Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no "47.6" yes no yes "U" "" ""
