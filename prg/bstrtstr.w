...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.SoStorl 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.SoStorl 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      SoStorl FORMAT "x(4)":U WIDTH 9.6
  ENABLE
      SoStorl
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 14 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.SoStorl:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.SoStorl
"SoStorl" ? ? "character" ? ? ? ? ? ? yes ? no no "9.6" yes no yes "U" "" ""
