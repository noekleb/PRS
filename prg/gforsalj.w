...
DEFINE VARIABLE h_bforsalj AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dforsalj AS HANDLE NO-UNDO.
...
DEFINE FRAME gDialog
     ...
     Btn_Cancel AT ROW 14.57 COL 53
     SPACE(0.19) SKIP(0.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste kassererregister"
...
ON WINDOW-CLOSE OF FRAME gDialog /* Søkeliste kassererregister */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'sdo/dforsalj.wDB-AWARE':U ,
             INPUT  FRAME gDialog:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedforsaljUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_dforsalj ).
       RUN repositionObject IN h_dforsalj ( 13.14 , 17.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'prg/bforsalj.w':U ,
             INPUT  FRAME gDialog:HANDLE ,
             INPUT  'ScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesDataSourceNamesUpdateTargetNamesLogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_bforsalj ).
       RUN repositionObject IN h_bforsalj ( 2.91 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_bforsalj ( 11.43 , 65.00 ) NO-ERROR.
       ...
       /* Links to SmartDataBrowser h_bforsalj. */
       RUN addLink ( h_dforsalj , 'Data':U , h_bforsalj ).
       RUN addLink ( h_bforsalj , 'Update':U , h_dforsalj ).

       /* Links to SmartObject h_sortsok. */
       RUN addLink ( h_bforsalj , 'Sortera':U , h_sortsok ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_bforsalj ,
...
------------------------------------------------------------------------------*/
  ...
  IF cReturn-Value <> "AVBRYT" THEN  
    ASSIGN
      cColValues = DYNAMIC-FUNCTION('colValues':U IN h_dforsalj,
                     INPUT "ForsNr,FoNamn" /* CHARACTER */).  
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNCTION('findRowWhere':U IN h_dforsalj,
     INPUT cFelt     + (IF cFelt     = "" THEN "" ELSE ",")    + "RowObject.ForsNr",
  ...
  RUN dataAvailable IN h_dforsalj
    ( INPUT "SAME" /* CHARACTER */).
  PUBLISH "Sortera" FROM h_bforsalj.
