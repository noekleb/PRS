...
&Scoped-define FIELDS-IN-QUERY-br_table Beskrivelse ProdNr Kontakt Telefon ~
RegistrertDato EDato 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table Beskrivelse ProdNr Kontakt ~
Telefon 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ProdNr FORMAT "zzzzz9":U WIDTH 11.2
      Kontakt FORMAT "X(30)":U
      Telefon FORMAT "X(15)":U
...
ASSIGN 
       ...
       rowObject.ProdNr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Kontakt:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Telefon:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.ProdNr
"ProdNr" ? ? "integer" ? ? ? ? ? ? yes ? no no "11.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.Kontakt
"Kontakt" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.Telefon
"Telefon" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = _<SDO>.rowObject.RegistrertDato
     _FldNameList[6]   = _<SDO>.rowObject.EDato
