...
&Scoped-Define ENABLED-OBJECTS rsAlle fiVButikkNr B-SokVmId1 Btn_OK ~
Btn_Cancel fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiVButikkNr fi-cMessage ~
...
DEFINE VARIABLE fiVButikkNr AS INTEGER FORMAT ">>>>>9" INITIAL 0 
     LABEL "Butikk" 
     VIEW-AS FILL-IN 
     SIZE 11.6 BY 1.
...
DEFINE FRAME Dialog-Frame
     ...
     fiVButikkNr AT ROW 3.86 COL 68 COLON-ALIGNED HELP
          "Butikknummer."
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Kopier til butikk */
DO:
...
DO:
  ...
  IF cLookupValue NE "" THEN DO: 
    fiVButikkNr:SCREEN-VALUE = cLookupValue.
    APPLY "return" TO fiVButikkNr.
  END.
END.
...
DO:
  ASSIGN fiVButikkNr rsAlle.
  ASSIGN cValues = (IF fiVButikkNr <> ?
                      THEN STRING(fiVButikkNr)
                      ELSE "?")
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiVButikkNr fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fiVButikkNr B-SokVmId1 Btn_OK Btn_Cancel fi-cMessage 
         fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
