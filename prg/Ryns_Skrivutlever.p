...
/*                                   cKundRad_4 = "".                                                                       */
DO:
    cLevRad_1  = "Ryns Skovaruhus AB".
    cLevRad_2  = "Sturegatan 9".
    cLevRad_3  = "722 13 Västerås".
    cLevRad_4  = "".
    ...
    cRightFtxt3 = "Ryns Skovaruhus AB, Sturegatan 9, 722 13 Västerås - Org.nr: 556062-9254".
END.
...
/*                                      pdf_ImageDim ("Spdf","HEADERLOGO","HEIGHT") * .20). */
    ...
    RUN pdf_set_font ("Spdf", "GantModern-Bold",8).
    RUN pdf_text_xy_dec ("Spdf","Rynsskor",iLMp2 + dDim + 165,69).
