...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.ArtikkelNr ~
rowObject.AnalyseId rowObject.Aktiv rowObject.AktivertDato ~
rowObject.StartDato rowObject.SluttDato 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      AnalyseId FORMAT ">>>>>9":U
      Aktiv FORMAT "yes/no":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.ArtikkelNr
     _FldNameList[2]   = _<SDO>.rowObject.AnalyseId
     _FldNameList[3]   = _<SDO>.rowObject.Aktiv
     _FldNameList[4]   = _<SDO>.rowObject.AktivertDato
     _FldNameList[5]   = _<SDO>.rowObject.StartDato
     _FldNameList[6]   = _<SDO>.rowObject.SluttDato
