...
&Scoped-define DATA-FIELD-DEFS "sdo/dvargr.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table VgBeskr Vg "" @ hgbeskr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table VgBeskr Vg 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VgBeskr FORMAT "x(40)":U WIDTH 50
      Vg FORMAT "zzzzz9":U WIDTH 10
      "" @ hgbeskr COLUMN-LABEL "." WIDTH 1
  ENABLE
      VgBeskr
      Vg
/* _UIB-CODE-BLOCK-END */
...
"VgBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "50" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Vg
"Vg" ? ? "integer" ? ? ? ? ? ? yes ? no no "10" yes no yes "U" "" ""
     _FldNameList[3]   > "_<CALC>"
""""" @ hgbeskr" "." ? ? ? ? ? ? ? ? no ? no no "1" yes no no "U" "" ""
