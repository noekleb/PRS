...
&Scoped-Define ENABLED-OBJECTS rsAlle fiRAvdNr B-SokRAvdNr Btn_OK ~
Btn_Cancel fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiRAvdNr fi-cMessage fi-cNumTotal ~
fi-cNumSelected 
...
DO:
  ASSIGN fiRAvdNr rsAlle.
  ASSIGN cValues = (IF fiRAvdNr <> ?
                      THEN STRING(fiRAvdNr)
                      ELSE "?")
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiRAvdNr fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fiRAvdNr B-SokRAvdNr Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
