...
DEFINE FRAME F-Main
     RowObject.EkstVPILevNr AT ROW 1.24 COL 21 COLON-ALIGNED
          LABEL "Eksternt EDB system"
          VIEW-AS FILL-IN 
          SIZE 12 BY 1
     RowObject.KortNavn AT ROW 1.24 COL 33 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 15.6 BY 1
     RowObject.Navn AT ROW 1.24 COL 49 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 29.4 BY 1
