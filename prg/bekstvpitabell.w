...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.TabellNr ~
rowObject.TabellNavn 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.TabellNr
     _FldNameList[2]   = _<SDO>.rowObject.TabellNavn
