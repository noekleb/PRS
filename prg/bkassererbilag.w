...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.BilagsNr rowObject.Meknad ~
rowObject.Belop rowObject.EDato rowObject.BrukerID rowObject.RegistrertDato ~
rowObject.RegistrertAv 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.Meknad ~
rowObject.Belop 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.BilagsNr
     _FldNameList[2]   > _<SDO>.rowObject.Meknad
"Meknad" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Belop
"Belop" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   = _<SDO>.rowObject.EDato
     _FldNameList[5]   = _<SDO>.rowObject.BrukerID
