...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.StTypeId ~
rowObject.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.StTypeId ~
rowObject.Beskrivelse 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      StTypeId FORMAT "X(10)":U
      Beskrivelse FORMAT "X(30)":U WIDTH 31.8
  ENABLE
      StTypeId
      Beskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 47 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.StTypeId:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.StTypeId
"StTypeId" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no "31.8" yes no yes "U" "" ""
