...
------------------------------------------------------------------------------*/
  ...
  REPEAT:
    ...
    IF ENTRY(1,cLinje,";") <> "99" THEN DO:
        ...
        /* TN 29/11-13 Har nettop oppdaget at det i pakkseddelfilen kan komme ut BLANK størrelse */
        /* Dette har som konsekvens at jeg mapper om blank størelse til størrelse 1.             */
        /* I det siste har dette forekommet så mye at vi er nødt til å prøve å finne den         */
        /* riktige størrelsen å legge på.                                                        */
        IF cStorl = '' THEN 
        DO:
        ...
        DO:
            ...
            /* Legger endret artikkelNr inn på linjen. */ 
          ...
          IF AVAILABLE Strekkode THEN 
            DO:
              IF NOT cTekst BEGINS STRING(Strekkode.ArtikkelNr) THEN 
                RUN bibl_logg.p ('PKSDLImport', 'xvgordinnles.p: Pakkseddelimport - Endret artikkelnr på ordrelinje Art.nr: ' + 
    ...
    ELSE DO:
        ...
        DO TRANSACTION:
          ...
          */
          RUN bibl_logg.p ('PKSDLImport', 'xvgordinnles.p: Pakkseddelimport - Endret strkode på strekkoden Art.nr: ' + 
    ...
    DO:
      ...
      DO piLoop = 1 TO ERROR-STATUS:NUM-MESSAGES:
          ...
          ASSIGN
            ...
            .
          RUN bibl_logg.p ('PKSDLImport', 'xvgordinnles.p: Pakkseddelimport FEIL i assign ' + "** (1 LesInnFil)Feil på linje " + STRING(iAntLinjer) + " " + ERROR-STATUS:GET-MESSAGE(piLoop) + ' ' + string(TIME,"HH:MM:SS")).          
      END.
      IF NOT lpkSdl THEN DO:
          RUN bibl_logg.p ('PKSDLImport', 'xvgordinnles.p: Pakkseddelimport FEIL i assign ' + "** (1 LesInnFil)Feil på linje " + STRING(iAntLinjer) + " Ikke pakkseddel" + ' ' + string(TIME,"HH:MM:SS")).          
          NEXT LESERLINJER.
      END.
    END.
    ...
    DO:
        RUN bibl_logg.p ('PKSDLImport', 'xvgordinnles.p: Pakkseddelimport FEIL Artikkelnr < 1000 på linje ' + STRING(iAntLinjer) + ' ' + string(TIME,"HH:MM:SS")).          
        NEXT LESERLINJER.
    END.
    ...
    /* TN 9/11-10 Åpner for opprettelse av pakkseddellinjer med 0 i antall
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH tt_Ordre WHERE
    ...
    */
    ...
    /* TN 20/10-11 Det kan ikke gjøres delleveranser på en pakkseddel. Derfor kobles dette ut.  
    RESTBEREGNIN:
    DO:
      ASSIGN
          fAntLevert = 0
