...
DEF VAR cBekreftet AS CHAR FORMAT "x" NO-UNDO.
...
&Scoped-define FIELDS-IN-QUERY-br_table BestStat ~
getBekreftet(BekreftetDato) @ cBekreftet LevDato TotAntPar TotInnkjVerdi ~
BestillingsDato BestNr 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      LevDato COLUMN-LABEL "Levdato" FORMAT "99/99/99":U
      TotAntPar COLUMN-LABEL "Antall" FORMAT "->>,>>9":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.BestStat
...
"getBekreftet(BekreftetDato) @ cBekreftet" "B" ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.LevDato
"LevDato" "Levdato" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.TotAntPar
"TotAntPar" "Antall" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = _<SDO>.rowObject.TotInnkjVerdi
     _FldNameList[6]   = _<SDO>.rowObject.BestillingsDato
     _FldNameList[7]   = _<SDO>.rowObject.BestNr
...
------------------------------------------------------------------------------*/
  ...
  PUBLISH "SetKnapperad" (INPUT pcState).
