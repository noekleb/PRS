...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.ProgNavn ~
rowObject.Programbeskrivelse rowObject.fuGradering 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.ProgNavn ~
rowObject.Programbeskrivelse 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.ProgNavn FORMAT "X(30)":U
      rowObject.Programbeskrivelse FORMAT "X(40)":U
      rowObject.fuGradering FORMAT "x(20)":U
  ENABLE
      rowObject.ProgNavn
      rowObject.Programbeskrivelse
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       rowObject.ProgNavn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Programbeskrivelse:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.ProgNavn
"rowObject.ProgNavn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Programbeskrivelse
"rowObject.Programbeskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.fuGradering
