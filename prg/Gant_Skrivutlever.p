...
{syspara.i 14 1  7 cMKlubbId} /* f�r Mayflower */
...
cRightFtxt1 = "Dersom du �nsker � bytte eller returnere varer p� din ordre".
cRightFtxt2 = "river du av og fyller ut 'Bytte- og Returskjema' p� siste side.".
...
DEFINE VARIABLE cTxt        AS CHARACTER   NO-UNDO.
  ...
  ASSIGN cOrsaksKod[1] = "10,20,30,40"
         ...
         cOrsaksKod[4] = "13,,,43"
         cOrsaksKod[5] = ",,,44".
  ASSIGN cOrsaksTxt[1] = "For liten,Feil vare levert,Feil p� varen,Farge ikke som forventet"
         cOrsaksTxt[2] = "For stor,Feil st�rrelse levert,Avvik fra beskrivelse,Stoffet var ikke som forventet"
...
/*  iPageHeight = 612. 
  ...
  DO:
    RUN pdf_set_font ("Spdf", "GantModern-Bold",7).
    d2 = 167.
    RUN pdf_text_xy_dec ("Spdf","V�r oppmerksom:",iLeftmargin,d2).
    RUN pdf_set_font ("Spdf", "GantModern-Regular",8).
    ...
    RUN pdf_set_font ("Spdf", "GantModern-Bold",8).
    d2 = 100.
    RUN pdf_text_xy_dec ("Spdf","�RSAKSNUMMER",iLeftmargin,d2).
    RUN pdf_set_font ("Spdf", "GantModern-Regular",8).
    RUN pdf_text_xy_dec ("Spdf","ST�RRELSE",iLeftmargin + iColPos[1],d2 - 13).
...
/*         cTxt = "Dersom du �nsker � bytte eller returnere varer p� din ordre".                  */
/*         RUN pdf_text_xy_dec ("Spdf",cTxt,iLMp2 - iLeftMargin + iMittenR - bredd(cTxt) / 2,50). */
/*         cTxt = "river du av og fyller ut 'Bytte- og Returskjema' p� siste side.".              */
...
/*       RUN  pdf_text_xy ("Spdf",cBarcode,iRMarginPos - 420 - bredd(cBarCode), dY - 40). */
    ...
    RUN pdf_set_font ("Spdf", "GantModern-Bold",9).
    RUN pdf_text_xy_dec ("Spdf","Jeg �nsker � bytte eller returnere f�lgende",iLeftmargin,dY - 93).
    RUN pdf_set_font ("Spdf", "GantModern-Regular",9).
...
/*   RUN pdf_text_align ("Spdf","Reservasjon nettbutikk","CENTER", iLeftMargin, iRMarginPos). */
  ...
  DO:
    ...
    DO:
        ...
        cTxt = "river du av og fyller ut 'Bytte- og Returskjema' p� siste side.".
        RUN pdf_text_xy_dec ("Spdf",cTxt,iLMp2 - iLeftMargin + iMittenR - bredd(cTxt) / 2,37).
/*         "river du av og fyller ut "Bytte- og Returskjema" p� siste side." */
/*                                                                           */
...
/*     END.                                                                                */
  ...
  RUN pdf_set_font ("Spdf", "GantModern-Bold",8).
  RUN pdf_text_xy_dec ("Spdf","HAR DU SP�RSM�L?",680,dY - 35).
  RUN pdf_text_xy_dec ("Spdf","GANT Kundeservice",680,dY - 45).
  
  RUN pdf_set_font ("Spdf", "GantModern-Medium",7).
  
  RUN pdf_text_xy_dec ("Spdf","�pningstider",680,dY - 55).
...
Font      Storlek Sidlayout F�rsta TO_V�nsterjusterat Sista_TO Sista_AT
...
/*            iTblCols[2] = 44 */
           ...
           cTblColLabels [4] = "Str"
           cTblColLabels [5] = "Retur/Bytte (Kryss av �n)"
           cTblColLabels [6] = "�rsaknr".
