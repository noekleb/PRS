...
RS-Type CB-Butik B-Artikkelkort B-Excel BUTTON-1 B-Oppdater BUTTON-Ok 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE Btn_Help RECT-3 RECT-1 RECT-2 B-Chart RS-Type CB-Butik B-Artikkelkort 
         B-Excel BUTTON-1 B-Oppdater BUTTON-Ok 
      WITH FRAME fMain IN WINDOW wWin.
