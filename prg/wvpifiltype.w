...
DEFINE VARIABLE h_bvpifiltype AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dvpifiltype AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_folder AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vvpifiltype AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vvpifiltype2 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Vedlikehold av import filtyper"
         HEIGHT             = 17
         WIDTH              = 80
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Vedlikehold av import filtyper */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Vedlikehold av import filtyper */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'sdo/dvpifiltype.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedvpifiltypeUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_dvpifiltype ).
       RUN repositionObject IN h_dvpifiltype ( 1.00 , 61.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'FolderLabels':U + 'Liste|Detalj' + 'FolderTabWidth0FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
       RUN repositionObject IN h_folder ( 2.43 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_folder ( 15.48 , 80.00 ) NO-ERROR.

       /* Links to SmartDataObject h_dvpifiltype. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dvpifiltype ).
    ...
    WHEN 1 THEN DO:
       RUN constructObject (
             INPUT  'prg/bvpifiltype.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'ScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesDataSourceNamesUpdateTargetNamesLogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_bvpifiltype ).
       RUN repositionObject IN h_bvpifiltype ( 3.86 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_bvpifiltype ( 13.81 , 58.00 ) NO-ERROR.

       /* Links to SmartDataBrowser h_bvpifiltype. */
       RUN addLink ( h_dvpifiltype , 'Data':U , h_bvpifiltype ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN constructObject (
             INPUT  'prg/vvpifiltype.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vvpifiltype ).
       RUN repositionObject IN h_vvpifiltype ( 3.86 , 2.00 ) NO-ERROR.
       /* Size in AB:  ( 3.57 , 51.00 ) */

       RUN constructObject (
             INPUT  'prg/vvpifiltype2.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vvpifiltype2 ).
       RUN repositionObject IN h_vvpifiltype2 ( 16.71 , 2.00 ) NO-ERROR.
       /* Size in AB:  ( 0.81 , 68.00 ) */

       /* Links to SmartDataViewer h_vvpifiltype. */
       RUN addLink ( h_dvpifiltype , 'Data':U , h_vvpifiltype ).
       RUN addLink ( h_vvpifiltype , 'Update':U , h_dvpifiltype ).
       RUN addLink ( h_dyntoolbar , 'TableIO':U , h_vvpifiltype ).

       /* Links to SmartDataViewer h_vvpifiltype2. */
       RUN addLink ( h_dvpifiltype , 'Data':U , h_vvpifiltype2 ).
...
------------------------------------------------------------------------------*/
  ...
  IF valid-handle(h_vvpifiltype) THEN
  DO:
      ASSIGN
          pbDataModified = 
              DYNAMIC-FUNCTION('getDataModified':U IN h_vvpifiltype)
          .
