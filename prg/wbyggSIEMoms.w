...
DEFINE VARIABLE FI-Tekst AS CHARACTER FORMAT "X(256)":U INITIAL "Oppdaterer SIE mva grupper" 
      VIEW-AS TEXT 
     SIZE 78 BY .62
     FONT 6 NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Oppdateterer SIE mva grupper"
         HEIGHT             = 15.62
         WIDTH              = 80.4
         MAX-HEIGHT         = 25.33
         MAX-WIDTH          = 116.4
...
ON END-ERROR OF C-Win /* Oppdateterer SIE mva grupper */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Oppdateterer SIE mva grupper */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ASSIGN
      E-Tekst = 'Leser alle mva grupper og kopierer inn disse i SIE mvagruppe oppsett for standardbutikken ' 
      .
  DISPLAY 
      E-Tekst 
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME DEFAULT-FRAME:
    ...
    bOk = FALSE.
    MESSAGE 'Bekreft at oppdatering av SIE mva grupper skal starte.'
  ...
  RUN generersiemvagrupper.p (INPUT-OUTPUT iAntLest,
  ...
  IF cMsgS <> '' THEN
  DO:
      MESSAGE 'Generering av SIE mva grupper er avbrudt med følgende melding:' SKIP(1)
              cMsgs
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
  END.
  ELSE MESSAGE 'Generering av SIE mva grupper ferdig.' SKIP(1)
