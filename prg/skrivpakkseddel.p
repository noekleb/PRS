...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE cLevLbl AS CHARACTER INIT "Levmelding"  NO-UNDO. /* om melding g�r �ver flera rader och ingen levmelding s� blir denna blank. */
...
------------------------------------------------------------------------------*/
   ...
   DEFINE VARIABLE iExtraRad AS INTEGER    NO-UNDO. /* Om vi har iFormatKod = 2 skall vi l�gga till vid summarad */
   ...
   DEFINE VARIABLE cHlblX1 AS CHARACTER  NO-UNDO. /* substitute tar bara 9 parametrar och vi har 11, vi g�r en replace mha denna */
   DEFINE VARIABLE cHlblX2 AS CHARACTER  NO-UNDO. /* substitute tar bara 9 parametrar och vi har 11, vi g�r en replace mha denna */
   DEFINE VARIABLE cHlblX3 AS CHARACTER  NO-UNDO. /* substitute tar bara 9 parametrar och vi har 11, vi g�r en replace mha denna */
...
/*    iFormatkod = 2. */
   /* Hantering av rader f�r olika layouter */
...
/*                    PUT UNFORMATTED "<B><R" STRING(iRadNr) SUBSTITUTE(cDetaljRad,"Prodnr","Beskr","Levert","Str","Antall","Enhetspris","Rabatt","Mva","Sum") "</B>" SKIP. */
               ...
               qL:GET-NEXT().
           END.
           /* H�r skrives postgiroblankett ut */
   ...
   /* Sender pdf. filen p� eMail hvis det er satt for det. TN 25/2-19 Gj�res i trigger w_pksdlhode.p */
