...
DEFINE VARIABLE h_bbeliggenhet AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dbeliggenhet AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dyntoolbar AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vbeliggenhet AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Beliggenhet */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Beliggenhet */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dbeliggenhet ( 1.48 , 54.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'prg/vbeliggenhet.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             ...
             OUTPUT h_vbeliggenhet ).
       RUN repositionObject IN h_vbeliggenhet ( 2.43 , 2.00 ) NO-ERROR.
       /* Size in AB:  ( 7.38 , 72.00 ) */

       RUN constructObject (
             INPUT  'prg/bbeliggenhet.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'ScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesDataSourceNamesUpdateTargetNamesLogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_bbeliggenhet ).
       RUN repositionObject IN h_bbeliggenhet ( 10.05 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_bbeliggenhet ( 6.67 , 71.00 ) NO-ERROR.
       ...
       RUN resizeObject IN h_dyntoolbar ( 1.24 , 51.60 ) NO-ERROR.

       /* Links to SmartDataObject h_dbeliggenhet. */
       RUN addLink ( h_dyntoolbar , 'Navigation':U , h_dbeliggenhet ).

       /* Links to SmartDataViewer h_vbeliggenhet. */
       RUN addLink ( h_dbeliggenhet , 'Data':U , h_vbeliggenhet ).
       RUN addLink ( h_vbeliggenhet , 'Update':U , h_dbeliggenhet ).
       RUN addLink ( h_dyntoolbar , 'TableIO':U , h_vbeliggenhet ).

       /* Links to SmartDataBrowser h_bbeliggenhet. */
       RUN addLink ( h_dbeliggenhet , 'Data':U , h_bbeliggenhet ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vbeliggenhet ,
             h_dyntoolbar , 'AFTER':U ).
       RUN adjustTabOrder ( h_bbeliggenhet ,
             h_vbeliggenhet , 'AFTER':U ).
    END. /* Page 0 */
