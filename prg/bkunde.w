...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.KundeNr rowObject.Navn ~
rowObject.Telefon rowObject.Telefaks 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.KundeNr ~
rowObject.Navn 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.Navn FORMAT "X(40)":U
      rowObject.Telefon FORMAT "X(15)":U
      rowObject.Telefaks FORMAT "X(15)":U
  ENABLE
      rowObject.KundeNr
      rowObject.Navn
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       rowObject.KundeNr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.KundeNr
"rowObject.KundeNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Navn
"rowObject.Navn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.Telefon
     _FldNameList[4]   = _<SDO>.rowObject.Telefaks
