...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.DistriktNr ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.DistriktNr FORMAT ">>9":U
      rowObject.DistriktKNavn FORMAT "X(8)":U
      rowObject.DistriktNavn FORMAT "X(30)":U
      rowObject.Kontaktperson FORMAT "X(30)":U
      rowObject.Mombil FORMAT "X(8)":U
      rowObject.Telefon FORMAT "X(20)":U
      rowObject.EMail FORMAT "X(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.DistriktNr
     _FldNameList[2]   = _<SDO>.rowObject.DistriktKNavn
     _FldNameList[3]   = _<SDO>.rowObject.DistriktNavn
     _FldNameList[4]   = _<SDO>.rowObject.Kontaktperson
     _FldNameList[5]   = _<SDO>.rowObject.Mombil
     _FldNameList[6]   = _<SDO>.rowObject.Telefon
     _FldNameList[7]   = _<SDO>.rowObject.EMail
