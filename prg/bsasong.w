...
&Scoped-define DATA-FIELD-DEFS "dsasong.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.SasBeskr rowObject.Sasong ~
"" @ cDummy 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.SasBeskr ~
rowObject.Sasong 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      SasBeskr FORMAT "x(40)":U WIDTH 39.2
      Sasong FORMAT "zz9":U WIDTH 9.2
      "" @ cDummy COLUMN-LABEL "." WIDTH 10.6
  ENABLE
      SasBeskr
      Sasong
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 65 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.SasBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.SasBeskr
"SasBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "39.2" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Sasong
"Sasong" ? ? "integer" ? ? ? ? ? ? yes ? no no "9.2" yes no yes "U" "" ""
     _FldNameList[3]   > "_<CALC>"
""""" @ cDummy" "." ? ? ? ? ? ? ? ? no ? no no "10.6" yes no no "U" "" ""
