...
&Scoped-define FIELDS-IN-QUERY-br_table KortNavn Beskrivelse VMId 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table KortNavn Beskrivelse VMId 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      KortNavn FORMAT "X(10)":U WIDTH 21.2
      Beskrivelse FORMAT "X(30)":U WIDTH 26.6
      VMId FORMAT "zzz9":U WIDTH 12.2
  ENABLE
      KortNavn
      Beskrivelse
      VMId
...
ASSIGN 
       ...
       rowObject.VMId:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.KortNavn
"KortNavn" ? ? "character" ? ? ? ? ? ? yes ? no no "21.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no "26.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.VMId
"VMId" ? ? "integer" ? ? ? ? ? ? yes ? no no "12.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
