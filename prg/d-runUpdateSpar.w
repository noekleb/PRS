...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Bekräfta uppdatering */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
    EDITOR-1 = "Det är valt " + STRING(NUM-ENTRIES(cData)) + " medlemmar för adressuppdatering mot SPAR. Kontrollera ditt urval och tryck 'OK' för uppdatering." +
