...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Parameter1 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Parameter1 FORMAT "X(50)":U WIDTH 50.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Parameter1
"Parameter1" ? ? "character" ? ? ? ? ? ? no "Eksternt EDB-System navn" no no "50.2" yes no no "U" "" ""
