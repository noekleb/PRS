...
DEF VAR cDummy AS CHAR FORMAT "x(10)" NO-UNDO.
...
&Scoped-define DATA-FIELD-DEFS "sdo/dlevbas.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table levnamn levnr KjedeAvtale ~
"" @ cDummy 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table levnamn levnr KjedeAvtale 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      levnamn COLUMN-LABEL "Levnavn" FORMAT "x(30)":U WIDTH 34.2
      levnr COLUMN-LABEL "Levnr" FORMAT ">>>>>9":U
      KjedeAvtale FORMAT "yes/no":U
      "" @ cDummy COLUMN-LABEL "."
  ENABLE
      levnamn HELP "?"
      levnr HELP "?"
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 53 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.levnamn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.levnr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.KjedeAvtale:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.levnamn
"levnamn" "Levnavn" ? "character" ? ? ? ? ? ? yes "?" no no "34.2" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.levnr
"levnr" "Levnr" ? "integer" ? ? ? ? ? ? yes "?" no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.KjedeAvtale
"KjedeAvtale" ? ? "logical" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
