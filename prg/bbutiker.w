...
&Scoped-define DATA-FIELD-DEFS "dbutiker.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Butik rowObject.KortNavn ~
rowObject.ButNamn 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.Butik ~
rowObject.KortNavn rowObject.ButNamn 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Butik FORMAT ">>>>>9":U
      KortNavn FORMAT "X(8)":U
      ButNamn FORMAT "x(20)":U WIDTH 25
  ENABLE
      Butik
      KortNavn
      ButNamn
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 46 BY 12.38 EXPANDABLE.
...
ASSIGN 
       rowObject.Butik:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.KortNavn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.ButNamn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Butik
"Butik" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.KortNavn
"KortNavn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.ButNamn
"ButNamn" ? ? "character" ? ? ? ? ? ? yes ? no no "25" yes no yes "U" "" ""
