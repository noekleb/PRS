...
&Scoped-Define ENABLED-OBJECTS rsAlle fcKampanjeKode Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fcKampanjeKode fi-cMessage ~
...
DEFINE VARIABLE fcKampanjeKode AS CHARACTER FORMAT "X(20)" INITIAL "?" 
     LABEL "Kampanjekode" 
     VIEW-AS FILL-IN 
     SIZE 12.6 BY 1.
...
DEFINE FRAME Dialog-Frame
     ...
     fcKampanjeKode AT ROW 3.86 COL 67 COLON-ALIGNED HELP
          "Kampanjekode"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Endre kampanjekode */
DO:
...
DO:
  ASSIGN fcKampanjeKode rsAlle.
  ASSIGN cValues = (IF fcKampanjeKode <> ?
                      THEN STRING(fcKampanjeKode)
                      ELSE "?")
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fcKampanjeKode fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fcKampanjeKode Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
