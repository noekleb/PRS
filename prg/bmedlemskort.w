...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.KortNr ~
rowObject.MedlemsNr rowObject.Innehaver rowObject.UtgarDato ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      MedlemsNr FORMAT ">>>>>>>>>>>>9":U
      Innehaver FORMAT "X(30)":U
      UtgarDato FORMAT "99/99/99":U
      AktivertDato FORMAT "99/99/99":U
      Sperret FORMAT "yes/no":U WIDTH 6.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 102 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.MedlemsNr
     _FldNameList[3]   = _<SDO>.rowObject.Innehaver
     _FldNameList[4]   = _<SDO>.rowObject.UtgarDato
     _FldNameList[5]   = _<SDO>.rowObject.AktivertDato
     _FldNameList[6]   > _<SDO>.rowObject.Sperret
"Sperret" ? ? "logical" ? ? ? ? ? ? no ? no no "6.6" yes no no "U" "" ""
