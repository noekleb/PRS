...
rowObject.fuKortNavn rowObject.GruppeNr rowObject.KasseNr rowObject.Navn ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ButikkNr FORMAT ">>>>>9":U
      fuKortNavn FORMAT "x(8)":U
      GruppeNr FORMAT ">9":U
      KasseNr FORMAT ">>9":U
      Navn FORMAT "X(30)":U
      fuModellNavn FORMAT "x(20)":U
      Aktiv FORMAT "*/":U
      ElJournalAktiv FORMAT "*/":U
      KvitteringAktiv FORMAT "*/":U
      UtskriftskopiAktiv FORMAT "*/":U
      DagsOppgjAktiv FORMAT "*/":U
      KassererOppgjAktiv FORMAT "*/":U WIDTH 11.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 149 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.fuKortNavn
     _FldNameList[3]   = _<SDO>.rowObject.GruppeNr
     _FldNameList[4]   = _<SDO>.rowObject.KasseNr
     _FldNameList[5]   = _<SDO>.rowObject.Navn
     _FldNameList[6]   = _<SDO>.rowObject.fuModellNavn
     _FldNameList[7]   = _<SDO>.rowObject.Aktiv
     _FldNameList[8]   = _<SDO>.rowObject.ElJournalAktiv
     _FldNameList[9]   = _<SDO>.rowObject.KvitteringAktiv
     _FldNameList[10]   = _<SDO>.rowObject.UtskriftskopiAktiv
     _FldNameList[11]   = _<SDO>.rowObject.DagsOppgjAktiv
     _FldNameList[12]   > _<SDO>.rowObject.KassererOppgjAktiv
"KassererOppgjAktiv" ? ? "logical" ? ? ? ? ? ? no ? no no "14" yes no no "U" "" ""
