...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.RegionNr ~
rowObject.RegionKNavn rowObject.RegionNavn rowObject.Kontaktperson ~
rowObject.Mombil rowObject.Telefon 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.RegionNr FORMAT ">9":U
      rowObject.RegionKNavn FORMAT "X(8)":U
      rowObject.RegionNavn FORMAT "X(30)":U
      rowObject.Kontaktperson FORMAT "X(30)":U
      rowObject.Mombil FORMAT "X(8)":U
      rowObject.Telefon FORMAT "X(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.RegionNr
     _FldNameList[2]   = _<SDO>.rowObject.RegionKNavn
     _FldNameList[3]   = _<SDO>.rowObject.RegionNavn
     _FldNameList[4]   = _<SDO>.rowObject.Kontaktperson
     _FldNameList[5]   = _<SDO>.rowObject.Mombil
     _FldNameList[6]   = _<SDO>.rowObject.Telefon
