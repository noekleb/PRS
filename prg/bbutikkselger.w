...
rowObject.fuButikkNavn rowObject.SelgerId rowObject.SelgerNr 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.fuButikkNavn FORMAT "x(30)":U
      rowObject.SelgerId FORMAT ">>>9":U WIDTH 8
      rowObject.SelgerNr FORMAT ">>>>>>>>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS NO-COLUMN-SCROLLING SEPARATORS SIZE 50 BY 6.67 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.fuButikkNavn
     _FldNameList[3]   > _<SDO>.rowObject.SelgerId
"rowObject.SelgerId" ? ? "integer" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = _<SDO>.rowObject.SelgerNr
