...
&Scoped-define FIELDS-IN-QUERY-br_table SlitBeskr Slit-Id 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table SlitBeskr Slit-Id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      SlitBeskr FORMAT "x(40)":U WIDTH 40.6
      Slit-Id FORMAT "zz9":U WIDTH 9.2
  ENABLE
      SlitBeskr
      Slit-Id
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 55 BY 6.67 FIT-LAST-COLUMN.
...
ASSIGN 
       rowObject.SlitBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Slit-Id:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.SlitBeskr
"SlitBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "40.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Slit-Id
"Slit-Id" ? ? "integer" ? ? ? ? ? ? yes ? no no "9.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
