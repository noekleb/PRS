...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.FeilKode ~
rowObject.Beskrivelse rowObject.Belastes rowObject.Notat 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.FeilKode ~
rowObject.Beskrivelse rowObject.Belastes 
...
ASSIGN 
       rowObject.FeilKode:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Beskrivelse:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Belastes:AUTO-RESIZE IN BROWSE br_table = TRUE
       rowObject.Belastes:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.FeilKode
"FeilKode" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Belastes
"Belastes" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes yes yes "U" "" ""
     _FldNameList[4]   = _<SDO>.rowObject.Notat
