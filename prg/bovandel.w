...
&Scoped-define FIELDS-IN-QUERY-br_table OvBeskr Ov-Id 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table OvBeskr Ov-Id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      OvBeskr FORMAT "x(40)":U WIDTH 40.6
      Ov-Id FORMAT "zz9":U WIDTH 5.2
  ENABLE
      OvBeskr
      Ov-Id
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 51 BY 6.67 FIT-LAST-COLUMN.
...
ASSIGN 
       rowObject.OvBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Ov-Id:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.OvBeskr
"OvBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "40.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Ov-Id
"Ov-Id" ? ? "integer" ? ? ? ? ? ? yes ? no no "5.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
