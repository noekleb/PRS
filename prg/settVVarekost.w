...
DEFINE VARIABLE FITekst3 AS CHARACTER FORMAT "X(256)":U INITIAL "  Viktig at eventuell feil vektet varekost er korrigert før det motposteres." 
      VIEW-AS TEXT 
     SIZE 84 BY 1.05
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Endring av varekost på salgstransaksjon"
         HEIGHT             = 10.29
         WIDTH              = 90
         MAX-HEIGHT         = 16
         MAX-WIDTH          = 95.2
...
ON END-ERROR OF C-Win /* Endring av varekost på salgstransaksjon */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Endring av varekost på salgstransaksjon */
DO:
