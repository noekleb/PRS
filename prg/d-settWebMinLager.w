...
&Scoped-Define ENABLED-OBJECTS rsAlle fiWebMinLager Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiWebMinLager fi-cMessage ~
...
DEFINE VARIABLE fiWebMinLager AS DECIMAL FORMAT "->>,>>9.999":U INITIAL 0 
     LABEL "Min.lager i nettbutikk" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME Dialog-Frame
     ...
     fiWebMinLager AT ROW 3.86 COL 76 COLON-ALIGNED 
...
DO:
  ASSIGN fiWebMinLager rsAlle.
  ASSIGN cValues = fiWebMinLager:SCREEN-VALUE
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiWebMinLager fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fiWebMinLager Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
