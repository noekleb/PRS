...
&Scoped-define DATA-FIELD-DEFS "dstrtype.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.StrTypeID ~
rowObject.KortNavn rowObject.Beskrivelse rowObject.Intervall ~
rowObject.AlfaFordeling 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.StrTypeID ~
rowObject.KortNavn rowObject.Beskrivelse rowObject.Intervall ~
rowObject.AlfaFordeling 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.StrTypeID FORMAT "zzzzzz9":U
      rowObject.KortNavn FORMAT "X(8)":U
      rowObject.Beskrivelse FORMAT "X(30)":U
      rowObject.Intervall FORMAT "x(12)":U
      rowObject.AlfaFordeling FORMAT "X(130)":U WIDTH 146.2
  ENABLE
      rowObject.StrTypeID
      rowObject.KortNavn
      rowObject.Beskrivelse
      rowObject.Intervall HELP "?"
      rowObject.AlfaFordeling
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 212 BY 6.67 EXPANDABLE.
...
ASSIGN 
       ...
       rowObject.KortNavn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Beskrivelse:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Intervall:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.AlfaFordeling:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.StrTypeID
"rowObject.StrTypeID" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.KortNavn
"rowObject.KortNavn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Beskrivelse
"rowObject.Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.Intervall
"rowObject.Intervall" ? ? "character" ? ? ? ? ? ? yes "?" no no ? yes no yes "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.AlfaFordeling
"rowObject.AlfaFordeling" ? ? "character" ? ? ? ? ? ? yes ? no no "146.2" yes no yes "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setEntry bTableWin 
PROCEDURE setEntry :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
