...
&Scoped-define FIELDS-IN-QUERY-br_table EkstVPILevNr VareNr Kode StrKode ~
EkstStorl Bestillingsnummer HovedNr KodeType VareId 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      VareNr FORMAT "X(20)":U
      Kode FORMAT "X(20)":U
      StrKode FORMAT ">>9":U
      EkstStorl FORMAT "X(15)":U
      Bestillingsnummer FORMAT "X(25)":U
      HovedNr FORMAT "yes/no":U
      KodeType FORMAT ">9":U
      VareId FORMAT ">>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.VareNr
     _FldNameList[3]   = _<SDO>.rowObject.Kode
     _FldNameList[4]   = _<SDO>.rowObject.StrKode
     _FldNameList[5]   = _<SDO>.rowObject.EkstStorl
     _FldNameList[6]   = _<SDO>.rowObject.Bestillingsnummer
     _FldNameList[7]   = _<SDO>.rowObject.HovedNr
     _FldNameList[8]   = _<SDO>.rowObject.KodeType
     _FldNameList[9]   = _<SDO>.rowObject.VareId
