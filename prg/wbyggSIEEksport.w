...
DEFINE VARIABLE FI-Tekst AS CHARACTER FORMAT "X(256)":U INITIAL "Generering av SIE eksport i angitt periode" 
      VIEW-AS TEXT 
     SIZE 78 BY .62
     FONT 6 NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Generering av SIE eksport"
         HEIGHT             = 15.62
         WIDTH              = 80.4
         MAX-HEIGHT         = 25.33
         MAX-WIDTH          = 116.4
...
ON END-ERROR OF C-Win /* Generering av SIE eksport */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Generering av SIE eksport */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ASSIGN
      ...
      E-Tekst = 'Leser alle bongdata innenfor gitte kriterier ' +
                'og genererer SIE eksport på grunnlag av dette.' + CHR(10) +  CHR(10) +
                'Eventuelle tidligere genererte dataeksportsett innefor angitt periode, vil IKKE bli'  + CHR(10) +
                'generert pånytt. Ønsker man å genere dataeksportsett på nytt, ta bort de gamle datasettene før generering startes.' + CHR(10) +
                'Bonger som ikke er postert i eksportdatasettet fra før, vil bli postert.'
      .
  DISPLAY 
      E-Tekst 
...
------------------------------------------------------------------------------*/
  ...
  RUN generersieeksport.p (DATE(FraDato:SCREEN-VALUE),
  ...
  DO:
      MESSAGE 'Generering av eksportdatasett er avbrudt med følgende melding:' SKIP(1)
          ...
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
  END.
  ELSE MESSAGE 'Generering av eksportdatasett til SIE format ferdig.' SKIP(1)
