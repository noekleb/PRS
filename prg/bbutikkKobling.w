...
&Scoped-define DATA-FIELD-DEFS "sdo/dbutikkkobling.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Butik ~
rowObject.fButikkNavn 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Butik FORMAT ">>>>>9":U
      fButikkNavn FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 66 BY 6.67 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "sdo/dbutikkkobling.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.fButikkNavn
