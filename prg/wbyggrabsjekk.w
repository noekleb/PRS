...
&Scoped-Define ENABLED-OBJECTS B-sokMedlem1 RECT-1 FraDato TilDato ~
FraMedlemNr TilMedlemNr E-Tekst BtnDone-2 BtnDone btnCalFraDato ~
btnCalFraDato-2 B-sokMedlem2 FI-Tekst 
...
DEFINE VARIABLE FI-Tekst AS CHARACTER FORMAT "X(256)":U INITIAL "Generering av rabattsjekker basert på medlemskjøp i periode" 
      VIEW-AS TEXT 
     SIZE 78 BY .62
     FONT 6 NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE B-sokMedlem1 RECT-1 FraDato TilDato FraMedlemNr TilMedlemNr E-Tekst 
         BtnDone-2 BtnDone btnCalFraDato btnCalFraDato-2 B-sokMedlem2 FI-Tekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME DEFAULT-FRAME:
    ...
    bOk = FALSE.
    MESSAGE 'Bekreft at beregning av rabattsjekker skal starte.'
  ...
  ELSE MESSAGE 'Generering av rabattsjekker ferdig.' SKIP(1)
          'Antall leste medlemskjøp:' iAntLest SKIP
