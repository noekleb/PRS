...
&Scoped-Define ENABLED-OBJECTS fi-cPassord Btn_OK Btn_Cancel Tekst1 Tekst2 
&Scoped-Define DISPLAYED-OBJECTS fi-iCount fi-cPassord Tekst1 Tekst2 
...
DEFINE VARIABLE Tekst1 AS CHARACTER FORMAT "X(256)":U INITIAL "Artikler m/lagerbevelgelser de siste to år slettes ikke." 
      VIEW-AS TEXT 
     SIZE 61 BY .62 NO-UNDO.

DEFINE VARIABLE Tekst2 AS CHARACTER FORMAT "X(256)":U INITIAL "Slike artikler deaktiveres ved at Aktiv og IKasse flaggene slås av." 
      VIEW-AS TEXT 
     SIZE 61 BY .62 NO-UNDO.
...
DEFINE FRAME Dialog-Frame
     fi-iCount AT ROW 4.24 COL 20.6 COLON-ALIGNED NO-LABEL
     fi-cPassord AT ROW 7.67 COL 20 COLON-ALIGNED
     Btn_OK AT ROW 11.95 COL 34
     Btn_Cancel AT ROW 11.95 COL 50
     Tekst1 AT ROW 9.1 COL 3 NO-LABEL
     Tekst2 AT ROW 9.81 COL 1 COLON-ALIGNED NO-LABEL
     "Du har valgt å slette" VIEW-AS TEXT
          SIZE 44 BY 1.19 AT ROW 2.43 COL 11
          FONT 8
     "artikler permanent fra databasen.." VIEW-AS TEXT
          SIZE 41 BY .95 AT ROW 6.1 COL 14
          FONT 6
     SPACE(10.19) SKIP(6.23)
...
/* SETTINGS FOR FILL-IN fi-iCount IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN Tekst1 IN FRAME Dialog-Frame
   ALIGN-L                                                              */
ASSIGN 
       Tekst1:READ-ONLY IN FRAME Dialog-Frame        = TRUE.

ASSIGN 
       Tekst2:READ-ONLY IN FRAME Dialog-Frame        = TRUE.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-iCount fi-cPassord Tekst1 Tekst2 
      WITH FRAME Dialog-Frame.
  ENABLE fi-cPassord Btn_OK Btn_Cancel Tekst1 Tekst2 
      WITH FRAME Dialog-Frame.
