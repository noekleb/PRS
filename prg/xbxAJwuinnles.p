...
Eks:  11 entries. Ingen transaksjonskode.    
;825840789768;1;'2014-12-16 11:50:16.234';3;;System;0;1;3;7
;198057/43;1;'2014-12-16 11:50:20.864';3;;System;0;1;3;7
 1
 2 Produktnr
 3 Antal
 4 Datum-Tid
...
------------------------------------------------------------------------------*/
  ...
  REPEAT:
    ...
    IF NUM-ENTRIES(cProduktNr,"/") = 2 THEN DO:
        ...
        cVg = SUBSTR(e1,1,LENGTH(e1) - 4).
        cVg = FILL("0",3 - LENGTH(cVg)) + cVg.
        cLopNr = SUBSTR(e1,LENGTH(e1) - 3).
    ...
    END.
    ELSE IF LENGTH(cProduktNr) = 12 THEN DO:
        IF LENGTH(cProduktNr) = 12 THEN
    ...
    ASSIGN
        ...
        tmpPDA.Brukerid     = REPLACE(ENTRY(7,pcLinje,";"),' ','_')
  ...
  FOR EACH tmpPDA WHERE tmpPDA.EAN > 0
      ...
      DO TRANSACTION:
        ...
        ASSIGN 
          ...
          TelleHode.TBId        = 1
          TelleHode.Notat       = 'Auto innlest ' + STRING(TODAY) + ' ' + STRING(TIME,"HH:MM:SS") + '.'
