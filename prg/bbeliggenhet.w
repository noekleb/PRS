...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.BeliggenhetId ~
rowObject.BeliggenhetNavn 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      BeliggenhetId FORMAT ">>9":U
      BeliggenhetNavn FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.BeliggenhetId
     _FldNameList[2]   = _<SDO>.rowObject.BeliggenhetNavn
