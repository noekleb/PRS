...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.KampanjeId ~
rowObject.Beskrivelse rowObject.StartDato rowObject.SluttDato ~
rowObject.Aktivert rowObject.RegistrertDato rowObject.RegistrertAv ~
rowObject.EDato rowObject.BrukerID 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.KampanjeId 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.KampanjeId FORMAT "->,>>>,>>9":U
      rowObject.Beskrivelse FORMAT "X(40)":U
      rowObject.StartDato FORMAT "99/99/99":U
      rowObject.SluttDato FORMAT "99/99/99":U
      rowObject.Aktivert FORMAT "yes/no":U
      rowObject.RegistrertDato FORMAT "99/99/9999":U
      rowObject.RegistrertAv FORMAT "X(10)":U
      rowObject.EDato FORMAT "99/99/99":U
      rowObject.BrukerID FORMAT "X(10)":U WIDTH 19.2
  ENABLE
      rowObject.KampanjeId HELP "?"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 133 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.KampanjeId:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
"rowObject.KampanjeId" ? ? "integer" ? ? ? ? ? ? yes "?" no no ? yes no yes "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.Beskrivelse
     _FldNameList[3]   = _<SDO>.rowObject.StartDato
     _FldNameList[4]   = _<SDO>.rowObject.SluttDato
     _FldNameList[5]   = _<SDO>.rowObject.Aktivert
     _FldNameList[6]   = _<SDO>.rowObject.RegistrertDato
     _FldNameList[7]   = _<SDO>.rowObject.RegistrertAv
     _FldNameList[8]   = _<SDO>.rowObject.EDato
     _FldNameList[9]   > _<SDO>.rowObject.BrukerID
"rowObject.BrukerID" ? ? "character" ? ? ? ? ? ? no ? no no "19.2" yes no no "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE displayLinks bTableWin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE exitObject bTableWin 
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
  ASSIGN rowObject.KampanjeId:READ-ONLY IN BROWSE {&BROWSE-NAME} = TRUE.
  MESSAGE "INIFORE"
      VIEW-AS ALERT-BOX INFO BUTTONS OK.
  RUN SUPER.
  MESSAGE "INIeftEr"
