...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.RabKod rowObject.RabBeskr ~
rowObject.RabProc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.RabKod ~
rowObject.RabBeskr rowObject.RabProc 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      RabKod FORMAT "zz9":U WIDTH 13.2
      RabBeskr FORMAT "X(30)":U WIDTH 34.2
      RabProc FORMAT "z9.99":U WIDTH 12.6
  ENABLE
      RabKod
      RabBeskr
      RabProc
...
ASSIGN 
       rowObject.RabKod:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.RabBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.RabProc:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.RabKod
"RabKod" ? ? "integer" ? ? ? ? ? ? yes ? no no "13.2" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.RabBeskr
"RabBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "34.2" yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.RabProc
"RabProc" ? ? "decimal" ? ? ? ? ? ? yes ? no no "12.6" yes no yes "U" "" ""
