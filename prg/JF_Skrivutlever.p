...
IF KOrdrehode.butikknr = 24 THEN DO:
    ...
    cRightFtxt3 = "JF Johanssons AB, Hulda Mellgrens Gata 5, 421 32 Västra Frölunda - Org.nr: 556027-7963".
END.
...
------------------------------------------------------------------------------*/
    ...
    cKO_LFtxt[2] = "Returrätt inom 14 dagar från mottagningsdatum.".
    cKO_LFtxt[3] = "".
...
IF cInstagram <> "" THEN DO:
    ...
    IF KOrdreHode.butikknr = 24 THEN
        RUN pdf_text_xy_dec ("Spdf","@JOHANSSONSSKOR",iLMp2 + 112,70).
    ELSE
...
/*   RUN pdf_text_xy_dec ("Spdf","Mån-fre, 10:00-16:00",740,dY - 55). */
  IF KOrdreHode.butikknr = 24 THEN
      RUN pdf_text_xy_dec ("Spdf","kundtjanst@johanssons.se",iRMarginPos - bredd("kundtjanst@johanssons.se"),dY - 45).
  ELSE
