...
DEF VAR cDummy AS CHAR NO-UNDO FORMAT "x(4)".
...
&Scoped-define DATA-FIELD-DEFS "dvargr.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.VgBeskr rowObject.Vg ~
rowObject.Hg rowObject.HgBeskr rowObject.Kost_Proc rowObject.MomsKod ~
"" @ cDummy 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.VgBeskr ~
rowObject.Vg rowObject.Hg rowObject.HgBeskr rowObject.Kost_Proc ~
rowObject.MomsKod 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      VgBeskr FORMAT "x(40)":U WIDTH 41.8
      Vg FORMAT "zzzzz9":U
      Hg COLUMN-LABEL "Hg" FORMAT ">>>9":U WIDTH 6
      HgBeskr FORMAT "x(20)":U
      Kost_Proc COLUMN-LABEL "Kost.proc" FORMAT "zz9.9":U WIDTH 12
      MomsKod COLUMN-LABEL "Mva.kode" FORMAT "z9":U WIDTH 10
      "" @ cDummy COLUMN-LABEL "                                   ."
  ENABLE
      VgBeskr
      Vg
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 50 BY 13.1 EXPANDABLE.
...
ASSIGN 
       rowObject.VgBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Vg:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Hg:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.HgBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Kost_Proc:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.MomsKod:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.VgBeskr
"VgBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "41.8" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Vg
"Vg" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Hg
"Hg" "Hg" ? "integer" ? ? ? ? ? ? yes ? no no "6" yes no yes "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.HgBeskr
"HgBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[5]   > _<SDO>.rowObject.Kost_Proc
"Kost_Proc" "Kost.proc" ? "decimal" ? ? ? ? ? ? yes ? no no "12" yes no yes "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.MomsKod
"MomsKod" "Mva.kode" ? "integer" ? ? ? ? ? ? yes ? no no "10" yes no yes "U" "" ""
     _FldNameList[7]   > "_<CALC>"
""""" @ cDummy" "                                   ." ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
