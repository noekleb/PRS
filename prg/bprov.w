...
&Scoped-define DATA-FIELD-DEFS "dprov.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.ProvKod ~
rowObject.ProvBeskr rowObject.ProvProc 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.ProvKod ~
rowObject.ProvBeskr rowObject.ProvProc 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ProvKod FORMAT "zz9":U WIDTH 4.2
      ProvBeskr FORMAT "X(30)":U
      ProvProc FORMAT "z9.99":U WIDTH 10.8
  ENABLE
      ProvKod
      ProvBeskr
      ProvProc
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 51 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.ProvKod:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.ProvBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.ProvProc:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.ProvKod
"ProvKod" ? ? "integer" ? ? ? ? ? ? yes ? no no "4.2" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.ProvBeskr
"ProvBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.ProvProc
"ProvProc" ? ? "decimal" ? ? ? ? ? ? yes ? no no "10.8" yes no yes "U" "" ""
