...
&Scoped-Define ENABLED-OBJECTS rsAlle fiKjokkenskriver Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiKjokkenskriver fi-cMessage ~
...
DEFINE VARIABLE fiKjokkenskriver AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "Kjøkkenskriver" 
     VIEW-AS FILL-IN 
     SIZE 12.6 BY 1.
...
DEFINE FRAME Dialog-Frame
     ...
     fiKjokkenskriver AT ROW 3.86 COL 67 COLON-ALIGNED HELP
          "Kjøkkenskriver"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Endre lokasjon */
DO:
...
DO:
  ASSIGN fiKjokkenskriver rsAlle.
  ASSIGN cValues = STRING(fiKjokkenskriver)
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiKjokkenskriver fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fiKjokkenskriver Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
