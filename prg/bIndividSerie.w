...
&Scoped-define FIELDS-IN-QUERY-br_table butnr ArtikkelNr Beskr fFarbeskr ~
individnr serienr Garantinummer 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table serienr Garantinummer 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Beskr FORMAT "x(20)":U
      fFarbeskr FORMAT "x(8)":U
      individnr FORMAT ">>>>>>>>>>>9":U
      serienr FORMAT "X(20)":U
      Garantinummer FORMAT "X(25)":U
  ENABLE
      serienr HELP "?"
      Garantinummer
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS NO-COLUMN-SCROLLING SEPARATORS SIZE 66 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.butnr
     _FldNameList[2]   = _<SDO>.rowObject.ArtikkelNr
     _FldNameList[3]   = _<SDO>.rowObject.Beskr
     _FldNameList[4]   = _<SDO>.rowObject.fFarbeskr
     _FldNameList[5]   = _<SDO>.rowObject.individnr
     _FldNameList[6]   > _<SDO>.rowObject.serienr
"serienr" ? ? "character" ? ? ? ? ? ? yes "?" no no ? yes no no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.Garantinummer
"Garantinummer" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
