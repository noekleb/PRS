...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.VPIFilNr ~
rowObject.VPIFilTypeNr rowObject.VPIFilNavn rowObject.VPIEkst 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.VPIFilNr COLUMN-LABEL "FilNr" FORMAT ">9":U
      rowObject.VPIFilTypeNr COLUMN-LABEL "FT" FORMAT ">9":U WIDTH 3
      rowObject.VPIFilNavn FORMAT "X(30)":U WIDTH 23.6
      rowObject.VPIEkst FORMAT "X(8)":U WIDTH 8.6
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 48 BY 6.67 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.VPIFilNr
"rowObject.VPIFilNr" "FilNr" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.VPIFilTypeNr
"rowObject.VPIFilTypeNr" "FT" ? "integer" ? ? ? ? ? ? no ? no no "3" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.VPIFilNavn
"rowObject.VPIFilNavn" ? ? "character" ? ? ? ? ? ? no ? no no "23.6" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.VPIEkst
"rowObject.VPIEkst" ? ? "character" ? ? ? ? ? ? no ? no no "8.6" yes no no "U" "" ""
