...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.garantikl ~
rowObject.garantitekst rowObject.mndant 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      garantikl FORMAT ">9":U
      garantitekst FORMAT "x(30)":U
      mndant FORMAT ">9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.garantikl
     _FldNameList[2]   = _<SDO>.rowObject.garantitekst
     _FldNameList[3]   = _<SDO>.rowObject.mndant
