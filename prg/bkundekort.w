...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.KortNr rowObject.KundeNr ~
rowObject.fuKundeNavn rowObject.Innehaver rowObject.UtgarDato ~
rowObject.AktivertDato rowObject.Sperret 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      KortNr FORMAT "X(22)":U
      KundeNr FORMAT ">>>>>>>>>>>>9":U
      fuKundeNavn FORMAT "x(30)":U
      Innehaver FORMAT "X(30)":U
      UtgarDato FORMAT "99/99/99":U WIDTH 10.4
      AktivertDato FORMAT "99/99/99":U
      Sperret FORMAT "yes/no":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 113 BY 18.1 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.KortNr
     _FldNameList[2]   = _<SDO>.rowObject.KundeNr
     _FldNameList[3]   = _<SDO>.rowObject.fuKundeNavn
     _FldNameList[4]   = _<SDO>.rowObject.Innehaver
     _FldNameList[5]   > _<SDO>.rowObject.UtgarDato
"UtgarDato" ? ? "date" ? ? ? ? ? ? no ? no no "10.4" yes no no "U" "" ""
     _FldNameList[6]   = _<SDO>.rowObject.AktivertDato
     _FldNameList[7]   = _<SDO>.rowObject.Sperret
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL F-Main bTableWin
