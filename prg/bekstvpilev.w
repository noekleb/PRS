...
&Scoped-define FIELDS-IN-QUERY-br_table EkstVPILevNr LevNr KortNavn Navn ~
AktivLev PrioNr EDB-System 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table EkstVPILevNr KortNavn Navn ~
AktivLev PrioNr 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      EkstVPILevNr FORMAT ">>>>>>9":U
      LevNr FORMAT "zzzzz9":U
      KortNavn FORMAT "X(15)":U
      Navn FORMAT "X(30)":U WIDTH 30.8
      AktivLev FORMAT "yes/no":U
      PrioNr COLUMN-LABEL "Pri" FORMAT ">>9":U WIDTH 4.6
      EDB-System COLUMN-LABEL "Mapping" FORMAT "X(12)":U
  ENABLE
      EkstVPILevNr
      KortNavn
      Navn
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 64 BY 6.67 FIT-LAST-COLUMN.
...
ASSIGN 
       ...
       rowObject.AktivLev:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.PrioNr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
"EkstVPILevNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.LevNr
     _FldNameList[3]   > _<SDO>.rowObject.KortNavn
"KortNavn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.Navn
"Navn" ? ? "character" ? ? ? ? ? ? yes ? no no "30.8" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.AktivLev
"AktivLev" ? ? "logical" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > _<SDO>.rowObject.PrioNr
"PrioNr" "Pri" ? "integer" ? ? ? ? ? ? yes ? no no "4.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > _<SDO>.rowObject.EDB-System
"EDB-System" "Mapping" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
