...
DEFINE FRAME Dialog-Frame
     ...
     SPACE(64.39) SKIP(6.99)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Endre hoved og underkategori"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Endre hoved og underkategori */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-SokHovedKategori Dialog-Frame
ON CHOOSE OF BUTTON-SokHovedKategori IN FRAME Dialog-Frame /* ... */
OR F10 OF fiHovedKAtNr 
DO:
  ...
  DO WITH FRAME Dialog-Frame:
      ...
      DO:
          ...
          ASSIGN
            fiHovedKAtNr:SCREEN-VALUE   = cTekst
            .
      END.
      ELSE DO:
          /* Legger opp verdier I de aktuelle feltene */
          ASSIGN
            fiHovedKAtNr:SCREEN-VALUE    = ''
            .
      END.
      RETURN NO-APPLY.
  END.
