...
&Scoped-Define ENABLED-OBJECTS rsAlle fcLokasjon Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fcLokasjon fi-cMessage fi-cNumTotal ~
fi-cNumSelected 
...
DEFINE VARIABLE fcLokasjon AS CHARACTER FORMAT "X(20)" INITIAL "?" 
     LABEL "Lokasjon" 
     VIEW-AS FILL-IN 
     SIZE 12.6 BY 1.
...
DEFINE FRAME Dialog-Frame
     ...
     fcLokasjon AT ROW 3.86 COL 67 COLON-ALIGNED HELP
          "Størrelsestype"
...
DO:
  ASSIGN fcLokasjon rsAlle.
  ASSIGN cValues = (IF fcLokasjon <> ?
                      THEN STRING(fcLokasjon)
                      ELSE "?")
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fcLokasjon fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fcLokasjon Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
