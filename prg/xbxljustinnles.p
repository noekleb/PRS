...
END.
ASSIGN
    cErrFil  = OS-GETENV('TMP') + '\' + "Errxbxljustinnles.txt"
...
------------------------------------------------------------------------------*/
  ...
  REPEAT:
    ...
    DO:
        ...
        ASSIGN
          tt_Error.LinjeNr = piAntFeil
          tt_Error.Tekst   = "** Feil på linje " + STRING(iAntLinjer) + " ** Feil transaksjonstype (Skal være 6) " + cTTID.
      ...
      DO TRANSACTION:  
        ...
        DO:
            ...
            ASSIGN
              ...
              TelleLinje.Kode       = Strekkode.Kode
