...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.MatBeskr rowObject.MatKod ~
"" @ cTekst 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.MatBeskr ~
rowObject.MatKod 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      MatBeskr FORMAT "x(40)":U WIDTH 55.6
      MatKod FORMAT "zz9":U WIDTH 5.2
      "" @ cTekst COLUMN-LABEL "."
  ENABLE
      MatBeskr
      MatKod
...
ASSIGN 
       rowObject.MatBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.MatBeskr
"MatBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "55.6" yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.MatKod
"MatKod" ? ? "integer" ? ? ? ? ? ? yes ? no no "5.2" yes no yes "U" "" ""
     _FldNameList[3]   > "_<CALC>"
""""" @ cTekst" "." ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
