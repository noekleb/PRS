...
&Scoped-Define ENABLED-OBJECTS rsAlle rsIKasse Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle rsIKasse fi-cMessage fi-cNumTotal ~
fi-cNumSelected 
...
DEFINE VARIABLE rsAlle AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Alle", 1,
"Valgte poster", 2
     SIZE 21 BY 1.81 NO-UNDO.

DEFINE VARIABLE rsIKasse AS LOGICAL 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "I kasse", yes,
"Ikke i kasse", no
     SIZE 35 BY 1.43 NO-UNDO.
...
DEFINE FRAME Dialog-Frame
     ...
     rsIKasse AT ROW 4.1 COL 60 NO-LABEL
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Vare i kasse */
DO:
...
DO:
  ASSIGN rsIKasse rsAlle.
  ASSIGN obOk = rsIKasse
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle rsIKasse fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle rsIKasse Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
