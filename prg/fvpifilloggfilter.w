...
&Scoped-Define ENABLED-OBJECTS FI-Tekst BUTTON-1 RECT-1 
...
DEFINE FRAME fMain
     FI-Tekst AT ROW 1.38 COL 7 COLON-ALIGNED
     BUTTON-1 AT ROW 1.38 COL 55.2
...
ON CHOOSE OF BUTTON-1 IN FRAME fMain /* <Blank> */
DO:
  ASSIGN
...
------------------------------------------------------------------------------*/
  DISPLAY FI-Tekst 
      WITH FRAME fMain.
  ENABLE FI-Tekst BUTTON-1 RECT-1 
      WITH FRAME fMain.
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    ASSIGN /* PerId */
        ...
        pcOperator = pcOperator + (IF pcOperator = "" 
                       THEN "" 
                       ELSE ",") + 
                     (IF FI-Tekst:SCREEN-VALUE BEGINS "*"
                        THEN "MATCHES"
                        ELSE "BEGINS")
        .
  END.
