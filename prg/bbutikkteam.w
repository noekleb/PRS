...
&Scoped-define DATA-FIELD-DEFS "sdo/dbutikkteam.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.TeamNr ~
rowObject.Beskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.TeamNr ~
rowObject.Beskrivelse 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      TeamNr FORMAT "zzz9":U
      Beskrivelse FORMAT "X(40)":U WIDTH 34
  ENABLE
      TeamNr
      Beskrivelse
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       rowObject.TeamNr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.TeamNr
"TeamNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Beskrivelse
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no "34" yes no yes "U" "" ""
