...
&Scoped-Define ENABLED-OBJECTS rsAlle cbSalgsenhet Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle cbSalgsenhet fi-cMessage ~
...
DEFINE VARIABLE cbSalgsenhet AS CHARACTER FORMAT "X(256)":U 
     LABEL "Salgsenhet" 
     VIEW-AS COMBO-BOX INNER-LINES 25
     LIST-ITEMS "Item 1" 
     DROP-DOWN-LIST
     SIZE 31.2 BY 1 TOOLTIP "Artikkelens salgsenhet" NO-UNDO.
...
DEFINE FRAME Dialog-Frame
     ...
     cbSalgsenhet AT ROW 4.1 COL 61.8 COLON-ALIGNED HELP
          "Artikkelens salgsenhet" 
     Btn_OK AT ROW 5.86 COL 64
     Btn_Cancel AT ROW 5.86 COL 80
...
DO:
  ASSIGN cbSalgsenhet rsAlle.
  
  ASSIGN cValues = cbSalgsenhet:SCREEN-VALUE
         oiReturn = rsAlle
         .
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
    ...
    IF pcTekst <> "" THEN
        ASSIGN
        cbSalgsEnhet:LIST-ITEMS = pcTekst
        cbSalgsEnhet:SCREEN-VALUE    = entry(2,pcTekst).   
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle cbSalgsenhet fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle cbSalgsenhet Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
