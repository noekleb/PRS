...
&Scoped-define FIELDS-IN-QUERY-br_table InnerBeskr Inner-Id 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table InnerBeskr Inner-Id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      InnerBeskr FORMAT "x(40)":U WIDTH 40.6
      Inner-Id FORMAT "zz9":U WIDTH 10.2
  ENABLE
      InnerBeskr
      Inner-Id
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 56 BY 6.67 FIT-LAST-COLUMN.
...
ASSIGN 
       rowObject.InnerBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Inner-Id:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.InnerBeskr
"InnerBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "40.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Inner-Id
"Inner-Id" ? ? "integer" ? ? ? ? ? ? yes ? no no "10.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
