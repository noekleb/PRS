...
DEFINE VARIABLE h_bkundekort AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dkundekort AS HANDLE NO-UNDO.
...
DEFINE FRAME gDialog
     Btn_OK AT ROW 19.33 COL 1
     Btn_Cancel AT ROW 19.33 COL 16
     Btn_Help AT ROW 19.33 COL 99
     SPACE(0.19) SKIP(0.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Søkeliste kundekort"
...
ON WINDOW-CLOSE OF FRAME gDialog /* Søkeliste kundekort */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'sdo/dkundekort.wDB-AWARE':U ,
             INPUT  FRAME gDialog:HANDLE ,
             INPUT  'AppServiceASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamedkundekortUpdateFromSourceno':U ,
             OUTPUT h_dkundekort ).
       RUN repositionObject IN h_dkundekort ( 18.62 , 32.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 10.80 ) */

       RUN constructObject (
             INPUT  'prg/bkundekort.w':U ,
             INPUT  FRAME gDialog:HANDLE ,
             INPUT  'ScrollRemotenoDataSourceNamesUpdateTargetNamesHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_bkundekort ).
       RUN repositionObject IN h_bkundekort ( 1.00 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_bkundekort ( 18.10 , 113.00 ) NO-ERROR.

       /* Links to SmartDataBrowser h_bkundekort. */
       RUN addLink ( h_dkundekort , 'Data':U , h_bkundekort ).
       RUN addLink ( h_bkundekort , 'Update':U , h_dkundekort ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_bkundekort ,
...
------------------------------------------------------------------------------*/
  ...
  IF cReturn-Value <> "AVBRYT" THEN  
    ASSIGN
      cColValues = DYNAMIC-FUNCTION('colValues':U IN h_dkundekort,
                     INPUT "KortNr,fuKundeNavn" /* CHARACTER */).  
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNCTION('findRowWhere':U IN h_dkundekort,
     INPUT cFelt     + (IF cFelt     = "" THEN "" ELSE ",")    + "RowObject.KortNr",
  ...
  RUN dataAvailable IN h_dkundekort
