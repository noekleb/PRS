...
&Scoped-Define ENABLED-OBJECTS rsAlle fiWebLeveringstid Btn_OK Btn_Cancel ~
fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiWebLeveringstid fi-cMessage ~
...
DEFINE VARIABLE fiWebLeveringstid AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "Leveringstid fra nettbutikk" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME Dialog-Frame
     ...
     fiWebLeveringstid AT ROW 3.86 COL 76 COLON-ALIGNED 
...
DO:
  ASSIGN fiWebLeveringstid rsAlle.
  ASSIGN cValues = fiWebLeveringstid:SCREEN-VALUE
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiWebLeveringstid fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fiWebLeveringstid Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal 
         fi-cNumSelected 
      WITH FRAME Dialog-Frame.
