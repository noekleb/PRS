...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.SelgerNr rowObject.Navn ~
rowObject.NavnIKasse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.SelgerNr ~
rowObject.Navn rowObject.NavnIKasse 
...
ASSIGN 
       rowObject.SelgerNr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Navn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.NavnIKasse:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.SelgerNr
"SelgerNr" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Navn
"Navn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.NavnIKasse
"NavnIKasse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
