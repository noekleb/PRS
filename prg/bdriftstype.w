...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.DriftsTypeId ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.DriftsTypeId
     _FldNameList[2]   = _<SDO>.rowObject.DriftsTypeNavn
