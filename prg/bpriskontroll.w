...
rowObject.GruppeNr rowObject.KasseNr rowObject.ArtikkelNr ~
rowObject.BongTekst rowObject.Strekkode rowObject.Feilkode rowObject.SEPris ~
rowObject.BongPris rowObject.Antall rowObject.SEVarekost ~
rowObject.KasseVarekost rowObject.b_id rowObject.Dato 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      GruppeNr FORMAT ">9":U
      KasseNr FORMAT ">>9":U
      ArtikkelNr FORMAT ">>>>>>>>>>>>9":U
      BongTekst FORMAT "X(20)":U WIDTH 25
      Strekkode COLUMN-LABEL "EAN" FORMAT "X(20)":U WIDTH 17
      Feilkode FORMAT ">9":U
      SEPris FORMAT "->>,>>>,>>9.99":U WIDTH 10
      BongPris FORMAT "->>,>>>,>>9.99":U WIDTH 10
      Antall FORMAT "->>>,>>9.999":U WIDTH 8
      SEVarekost FORMAT "->,>>>,>>9.99":U WIDTH 12.6
      KasseVarekost FORMAT "->,>>>,>>9.99":U
      b_id FORMAT ">>>>>>>>>>>9":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.GruppeNr
     _FldNameList[3]   = _<SDO>.rowObject.KasseNr
     _FldNameList[4]   = _<SDO>.rowObject.ArtikkelNr
     _FldNameList[5]   > _<SDO>.rowObject.BongTekst
"BongTekst" ? ? "character" ? ? ? ? ? ? no "?" no no "25" yes no no "U" "" ""
     _FldNameList[6]   > _<SDO>.rowObject.Strekkode
"Strekkode" "EAN" ? "character" ? ? ? ? ? ? no ? no no "17" yes no no "U" "" ""
     _FldNameList[7]   > _<SDO>.rowObject.Feilkode
"Feilkode" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" ""
     _FldNameList[8]   > _<SDO>.rowObject.SEPris
"SEPris" ? ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" ""
     _FldNameList[9]   > _<SDO>.rowObject.BongPris
"BongPris" ? ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" ""
     _FldNameList[10]   > _<SDO>.rowObject.Antall
"Antall" ? ? "decimal" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" ""
     _FldNameList[11]   > _<SDO>.rowObject.SEVarekost
"SEVarekost" ? ? "decimal" ? ? ? ? ? ? no ? no no "12.6" yes no no "U" "" ""
     _FldNameList[12]   = _<SDO>.rowObject.KasseVarekost
     _FldNameList[13]   = _<SDO>.rowObject.b_id
     _FldNameList[14]   = _<SDO>.rowObject.Dato
