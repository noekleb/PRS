...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Butik FORMAT ">>>>>9":U
      KortNavn FORMAT "X(8)":U WIDTH 9.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 20 BY 6.67 EXPANDABLE.
...
"KortNavn" ? ? "character" ? ? ? ? ? ? no ? no no "9.4" yes no no "U" "" ""
