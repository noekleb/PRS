...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.AnalyseId ~
rowObject.AnalyseType rowObject.Navn rowObject.KNavn rowObject.Aktiv ~
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.AnalyseId
     _FldNameList[2]   = _<SDO>.rowObject.AnalyseType
     _FldNameList[3]   = _<SDO>.rowObject.Navn
     _FldNameList[4]   = _<SDO>.rowObject.KNavn
     _FldNameList[5]   = _<SDO>.rowObject.Aktiv
     _FldNameList[6]   = _<SDO>.rowObject.AktivertDato
     _FldNameList[7]   = _<SDO>.rowObject.StartDato
     _FldNameList[8]   = _<SDO>.rowObject.SluttDato
