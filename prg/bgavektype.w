...
&Scoped-define FIELDS-IN-QUERY-br_table IdentType GKTBeskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table IdentType GKTBeskrivelse 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      IdentType FORMAT ">9":U
      GKTBeskrivelse FORMAT "X(30)":U
  ENABLE
      IdentType HELP "?"
      GKTBeskrivelse
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       rowObject.IdentType:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.GKTBeskrivelse:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.IdentType
"IdentType" ? ? "integer" ? ? ? ? ? ? yes "?" no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.GKTBeskrivelse
"GKTBeskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
