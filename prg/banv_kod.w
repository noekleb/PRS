...
&Scoped-define FIELDS-IN-QUERY-br_table AnvBeskr Anv-Id 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table AnvBeskr Anv-Id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      AnvBeskr FORMAT "x(30)":U WIDTH 54.6
      Anv-Id FORMAT "z9":U WIDTH 6.2
  ENABLE
      AnvBeskr HELP "?"
      Anv-Id
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       rowObject.AnvBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Anv-Id:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.AnvBeskr
"AnvBeskr" ? ? "character" ? ? ? ? ? ? yes "?" no no "54.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Anv-Id
"Anv-Id" ? ? "integer" ? ? ? ? ? ? yes ? no no "6.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
