  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dbutiker ).
       RUN repositionObject IN h_dbutiker ( 14.57 , 22.00 ) NO-ERROR.
       ...
       RUN addLink ( h_dbutiker , 'Data':U , h_bbutiker ).
       RUN addLink ( h_bbutiker , 'Update':U , h_dbutiker ).
...
------------------------------------------------------------------------------*/
  ...
  IF cFelt <> "" THEN
  DO:
    DYNAMIC-FUNCTION('assignQuerySelection':U IN h_dbutiker,
...
------------------------------------------------------------------------------*/
  ...
  IF cReturn-Value <> "AVBRYT" THEN  
    ASSIGN
      cColValues    = DYNAMIC-FUNCTION('colValues':U IN h_dbutiker,
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  DYNAMIC-FUNCTION('findRowWhere':U IN h_dbutiker,
  ...
  RUN dataAvailable IN h_dbutiker
