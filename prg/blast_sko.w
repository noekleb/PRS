...
&Scoped-define FIELDS-IN-QUERY-br_table LastBeskr Last-Id 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table LastBeskr Last-Id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LastBeskr FORMAT "x(30)":U WIDTH 53.6
      Last-Id FORMAT "zz9":U WIDTH 7.2
  ENABLE
      LastBeskr
      Last-Id
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       rowObject.LastBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.Last-Id:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.LastBeskr
"LastBeskr" ? ? "character" ? ? ? ? ? ? yes ? no no "53.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Last-Id
"Last-Id" ? ? "integer" ? ? ? ? ? ? yes ? no no "7.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
