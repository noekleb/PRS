...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.VPIFilTypeNr ~
rowObject.VPIFilTypeKNavn rowObject.VPIFilTypeBeskrivelse 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table rowObject.VPIFilTypeNr ~
rowObject.VPIFilTypeKNavn rowObject.VPIFilTypeBeskrivelse 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.VPIFilTypeNr FORMAT ">9":U
      rowObject.VPIFilTypeKNavn FORMAT "X(12)":U
      rowObject.VPIFilTypeBeskrivelse FORMAT "X(30)":U WIDTH 31
  ENABLE
      rowObject.VPIFilTypeNr
      rowObject.VPIFilTypeKNavn
      rowObject.VPIFilTypeBeskrivelse
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 58 BY 6.67 EXPANDABLE.
...
ASSIGN 
       rowObject.VPIFilTypeNr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.VPIFilTypeKNavn:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.VPIFilTypeBeskrivelse:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.VPIFilTypeNr
"rowObject.VPIFilTypeNr" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.VPIFilTypeKNavn
"rowObject.VPIFilTypeKNavn" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.VPIFilTypeBeskrivelse
"rowObject.VPIFilTypeBeskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no "31" yes no yes "U" "" ""
