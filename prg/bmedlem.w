...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.MedlemsNr ~
rowObject.ForNavn rowObject.EtterNavn 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ForNavn FORMAT "X(40)":U
      EtterNavn FORMAT "X(40)":U WIDTH 43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.MedlemsNr
     _FldNameList[2]   = _<SDO>.rowObject.ForNavn
     _FldNameList[3]   > _<SDO>.rowObject.EtterNavn
"EtterNavn" ? ? "character" ? ? ? ? ? ? no ? no no "43" yes no no "U" "" ""
