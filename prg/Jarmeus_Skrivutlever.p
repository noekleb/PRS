...
/*                                   cKundRad_4 = "".                                                                       */
DO:
    cLevRad_1  = "Hamburgsunds Skor AB".
    cLevRad_2  = "Skolvägen 1".
    cLevRad_3  = "457 45 Hamburgsund".
    cLevRad_4  = "".
    ...
    cRightFtxt3 = "Hamburgsunds Skor AB, Skolvägen 1, 457 45 Hamburgsund - Org.nr: 556247-7751".
...
RUN pdf_text_xy_dec ("Spdf","kundtjanst@hamburgsundskor.se",740,dY - 45).
RUN pdf_text_xy_dec ("Spdf","0525 - 645 00",740,dY - 65).
