...
&Scoped-define FIELDS-IN-QUERY-br_table Beskrivelse HandKode 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table Beskrivelse HandKode 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Beskrivelse FORMAT "X(40)":U WIDTH 41.6
      HandKode FORMAT ">9":U WIDTH 4.2
  ENABLE
      Beskrivelse
      HandKode
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 51 BY 6.67 ROW-HEIGHT-CHARS .63 FIT-LAST-COLUMN.
...
ASSIGN 
       ...
       rowObject.HandKode:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
"Beskrivelse" ? ? "character" ? ? ? ? ? ? yes ? no no "41.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.HandKode
"HandKode" ? ? "integer" ? ? ? ? ? ? yes ? no no "4.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
