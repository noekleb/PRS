...
DEFINE VARIABLE FI-Tekst AS CHARACTER FORMAT "X(256)":U INITIAL "Generering av Falck eksport i angitt periode" 
      VIEW-AS TEXT 
     SIZE 78 BY .62
     FONT 6 NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Generering av Falck eksport"
         HEIGHT             = 15.62
         WIDTH              = 80.4
         MAX-HEIGHT         = 25.33
         MAX-WIDTH          = 116.4
...
ON END-ERROR OF C-Win /* Generering av Falck eksport */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Generering av Falck eksport */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE genererFalck C-Win 
PROCEDURE genererFalck :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  RUN genererfalckeksport.p (DATE(FraDato:SCREEN-VALUE),
  ...
  IF cMsgS <> '' THEN
  DO:
      MESSAGE 'Generering av eksportdatasett er avbrutt med følgende melding:' SKIP(1)
              cMsgs
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
  END.
  ELSE MESSAGE 'Generering av eksportdatasett til Falck ferdig.' SKIP(1)
