...
DEFINE BUTTON BtnCancel AUTO-END-KEY DEFAULT 
     LABEL "Registrer ny størrelsestype..." 
     SIZE 36 BY 1.14
     BGCOLOR 8 .

DEFINE BUTTON BtnCancel2 AUTO-END-KEY DEFAULT 
     LABEL "Endre størrelsestype..." 
     SIZE 36 BY 1.14
     BGCOLOR 8 .
...
ON GO OF FRAME gDialog /* Søkeliste størrelsestyper */
DO:
      ASSIGN    
          cReturn-Value = "OK"    
          .
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL gDialog gDialog
ON WINDOW-CLOSE OF FRAME gDialog /* Søkeliste størrelsestyper */
DO:  
...
ON CHOOSE OF BtnCancel IN FRAME gDialog /* Registrer ny størrelsestype... */
DO:
...
ON CHOOSE OF BtnCancel2 IN FRAME gDialog /* Endre størrelsestype... */
DO:
    ASSIGN
