...
&Scoped-Define ENABLED-OBJECTS rsAlle fiAnbefaltPris B-SokLev Btn_OK ~
Btn_Cancel fi-cMessage fi-cNumTotal fi-cNumSelected 
&Scoped-Define DISPLAYED-OBJECTS rsAlle fiAnbefaltPris fi-cMessage ~
...
DEFINE VARIABLE fiAnbefaltPris AS DECIMAL FORMAT "->>>,>>9.99" INITIAL 0 
     LABEL "Prispunkt" 
     VIEW-AS FILL-IN 
     SIZE 16.6 BY 1.
...
DEFINE FRAME Dialog-Frame
     ...
     fiAnbefaltPris AT ROW 3.86 COL 63 COLON-ALIGNED HELP
          "'varegruppenummer"
...
DO:
  ...
  IF cLookupValue NE "" THEN DO: 
    fiAnbefaltPris:SCREEN-VALUE = cLookupValue.
    APPLY "return" TO fiAnbefaltPris.
  END.
END.
...
DO:
  ASSIGN fiAnbefaltPris rsAlle.
  ASSIGN cValues = (IF fiAnbefaltPris <> ?
                      THEN STRING(fiAnbefaltPris)
                      ELSE "?")
         oiReturn = rsAlle
         .
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fiAnbefaltPris fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle fiAnbefaltPris B-SokLev Btn_OK Btn_Cancel fi-cMessage 
         fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
