...
/*                                   cKundRad_4 = "".                                                                       */
DO:
    cLevRad_1  = "Skovaruhuset SkoDej".
    cLevRad_2  = "Karlsgatan 15".
    cLevRad_3  = "Vilans Köpcentrum".
    cLevRad_4  = "Långebro".
    ...
    cRightFtxt3 = "Långebro Skovaruhus AB, Karlsgatan 15, 291 59 Kristianstad - Org.nr: 556057-4062".
END.
...
/*     IF KOrdreHode.butikknr = 24 THEN */
        RUN pdf_text_xy_dec ("Spdf","@skodej",iLMp2 + 102,70).
/*     ELSE                                                        */
...
/*                                      pdf_ImageDim ("Spdf","HEADERLOGO","HEIGHT") * .20). */
    ...
    RUN pdf_set_font ("Spdf", "GantModern-Bold",8).
    RUN pdf_text_xy_dec ("Spdf","skodej",iLMp2 + dDim + 165,69).
...
/*   IF KOrdreHode.butikknr = 24 THEN */
      RUN pdf_text_xy_dec ("Spdf","kundtjanst@skodej.se",iRMarginPos - bredd("kundtjanst@skodej.se"),dY - 45).
/*   ELSE                                                                                               */
