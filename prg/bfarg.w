...
&Scoped-define DATA-FIELD-DEFS "dfarg.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table FarBeskr KFarge Farg 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table FarBeskr KFarge Farg 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      FarBeskr FORMAT "x(30)":U WIDTH 30.6
      KFarge FORMAT "X(5)":U WIDTH 10.2
      Farg FORMAT "zzzz9":U WIDTH 9.6
  ENABLE
      FarBeskr HELP "?"
      KFarge
      Farg
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 54 BY 6.67 FIT-LAST-COLUMN.
...
ASSIGN 
       rowObject.FarBeskr:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
       rowObject.KFarge:COLUMN-READ-ONLY IN BROWSE br_table = TRUE
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.FarBeskr
"FarBeskr" ? ? "character" ? ? ? ? ? ? yes "?" no no "30.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.KFarge
"KFarge" ? ? "character" ? ? ? ? ? ? yes ? no no "10.2" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.Farg
"Farg" ? ? "integer" ? ? ? ? ? ? yes ? no no "9.6" yes no yes "U" "" "" "" "" "" "" 0 no 0 no no
