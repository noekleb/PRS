...
rowObject.fuGraderingFillogg rowObject.Tekst 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      LinjeNr FORMAT "->,>>>,>>9":U
      fuGraderingFillogg FORMAT "x(15)":U
      Tekst FORMAT "X(180)":U
  ENABLE
      LinjeNr
      Tekst
/* _UIB-CODE-BLOCK-END */
...
ASSIGN 
       ...
       rowObject.Tekst:COLUMN-READ-ONLY IN BROWSE br_table = TRUE.
...
"Tekst" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no yes "U" "" ""
