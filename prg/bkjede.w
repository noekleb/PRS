...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.KjedeNr ~
rowObject.KjedeKNavn rowObject.KjedeNavn 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      KjedeNr FORMAT ">9":U
      KjedeKNavn FORMAT "X(8)":U
      KjedeNavn FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.KjedeNr
     _FldNameList[2]   = _<SDO>.rowObject.KjedeKNavn
     _FldNameList[3]   = _<SDO>.rowObject.KjedeNavn
