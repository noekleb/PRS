...
DEFINE VARIABLE FILL-IN-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Venter på sendingsnummer..." 
      VIEW-AS TEXT 
     SIZE 39 BY .62
     FONT 6 NO-UNDO.
...
DEFINE FRAME DEFAULT-FRAME
     BtnCancel AT ROW 4.33 COL 35
     FILL-IN-2 AT ROW 2.57 COL 5 COLON-ALIGNED NO-LABEL
...
ON END-ERROR OF C-Win /* Postpakke etikett */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Postpakke etikett */
DO:
