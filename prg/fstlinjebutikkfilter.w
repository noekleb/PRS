...
ASSIGN cFieldDefs = 
        ...
        /* 20 */ "SvinnAnt;Svinn;;1," +
        /* 21 */ "SvinnVerdi;Svinn kr;;1," +
        /* 22 */ "GjenkjopAnt;Returer;3;1," +
        /* 23 */ "GjenkjopVerdi;Returer kr;2;1," +
        /* 24 */ "AntTilbSolgt;Tilbud;;1," +
        /* 25 */ "VerdiTilbSolgt;Tilbud kr;2;1," +
        /* 26 */ "BrekkAnt;Brekkasje;;1," +
        /* 27 */ "BrekkVerdi;Brekkasje kr;;1".
...
&Scoped-Define ENABLED-OBJECTS Tg-VisPeriode B-Aktiver 
&Scoped-Define DISPLAYED-OBJECTS Tg-VisPeriode 
...
DO:
  ...
  RUN StLinjeToTT IN h_dstlinje
    ( OUTPUT TTH,cStTypeId,ENTRY(1,cKriterier,CHR(1)),"","",Tg-VisPeriode:CHECKED).
  CREATE QUERY qh.
  qh:SET-BUFFERS(TTH).
...
------------------------------------------------------------------------------*/
  DISPLAY Tg-VisPeriode 
      WITH FRAME fMain.
  ENABLE Tg-VisPeriode B-Aktiver 
      WITH FRAME fMain.
