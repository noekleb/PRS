...
&Scoped-Define ENABLED-FIELDS RowObject.GKTBeskrivelse 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define ENABLED-OBJECTS RECT-2 
&Scoped-Define DISPLAYED-FIELDS RowObject.IdentType ~
RowObject.GKTBeskrivelse 
...
DEFINE FRAME F-Main
     RowObject.IdentType AT ROW 1.71 COL 14 COLON-ALIGNED
          LABEL "Gavekorttype"
          VIEW-AS FILL-IN NATIVE 
          SIZE 4.8 BY 1
     RowObject.GKTBeskrivelse AT ROW 2.71 COL 14 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 32 BY 1
...
/* SETTINGS FOR FILL-IN RowObject.IdentType IN FRAME F-Main
   NO-ENABLE EXP-LABEL                                                  */
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ASSIGN 
      RowObject.IdentType:SENSITIVE = TRUE
      .
  END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ASSIGN
      RowObject.IdentType:SENSITIVE = FALSE
      .
  END.
  RUN SetFokus. /* Setter fokus i ønsket felt. */
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
  IF RowObject.IdentType:SENSITIVE = TRUE THEN
    RUN ApplyEntry ("IdentType").
  ELSE
    RUN ApplyEntry ("GKTBeskrivelse").
END.
