...
/*------------------------------------------------------------------------
    File        : JBoxHandleFuncToMeth.p
    Purpose     : Wrapper for handle library functions so they can be re-used in classes with same name
...
DEF OUTPUT PARAM ohReturn       AS HANDLE  NO-UNDO.

{JBoxFuncToMeth.i ohReturn}
