...
DEFINE FRAME DEFAULT-FRAME
     rectBrwObjectLink AT ROW 1.24 COL 2
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",
                                   ...
                                   + ";+cFromObject|CHARACTER|x(50)||From object"
                                   ...
                                   ,
                                   "where false",
                                   "sort|cFromObjectType").
  DYNAMIC-FUNCTION("NewMenuBand",hBrowse,"Filter,Excel,MultiSortBrowse","").

  DYNAMIC-FUNCTION("FillObjectTable" IN hParent,"ttObjectLink",hBrowse:QUERY:GET-BUFFER-HANDLE(1)).
END.
...
THIS-PROCEDURE:CURRENT-WINDOW:TITLE = "Object links [" + hWindow:TITLE + " - " + ichWindow + "]".
