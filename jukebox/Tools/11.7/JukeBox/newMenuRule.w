...
&Scoped-Define ENABLED-OBJECTS cmbParent cmbInsertAfter Btn_Cancel Btn_OK 
...
DEFINE FRAME Dialog-Frame
     cmbParent AT ROW 2 COL 14.8 COLON-ALIGNED WIDGET-ID 10
     cmbInsertAfter AT ROW 3.19 COL 14.6 COLON-ALIGNED WIDGET-ID 12
     Btn_Cancel AT ROW 4.86 COL 31
     Btn_OK AT ROW 4.86 COL 46.6
     SPACE(1.59) SKIP(0.37)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Add new menu rule"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Add new menu rule */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  IF icMenuList = "" THEN 
    ASSIGN cmbParent:HIDDEN = YES
           ...
           .
  ELSE DO:
    ASSIGN cmbParent:LIST-ITEMS = icMenuList
...
------------------------------------------------------------------------------*/
  ...
  ENABLE cmbParent cmbInsertAfter Btn_Cancel Btn_OK 
      WITH FRAME Dialog-Frame.
