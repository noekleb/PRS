...
Date Created: 11/20/92   
              01/21/14 Brynjar: Added call cancel to prevent JukeBox browse rebuild                   
...
END. /* IF NOT pCancelButton */
    ...
    /* JukeBox, Brynjar */
ELSE DYNAMIC-FUNCTION("setCancelQueryRebuild",YES) NO-ERROR.
