...
/*------------------------------------------------------------------------
  ...
  Mod june 2015 for JukeBox by Brynjar.
      To be able to pick up initial value programmatically it has to be added to private data 
       ...
       TRIGGERS:
          ON LEAVE DO:
            ...
            IF SELF:MODIFIED THEN DO:
              ...
              /* Mod june 2015 for JukeBox by Brynjar.
                 To be able to pick up initial value programmatically it has to be added to private data */
              _U._PRIVATE-DATA:SCREEN-VALUE IN FRAME adv-dial = SELF:SCREEN-VALUE.
              /* End mod for JukeBox */
