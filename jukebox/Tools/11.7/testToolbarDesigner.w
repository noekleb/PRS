...
DEFINE FRAME DEFAULT-FRAME
     BUTTON-1 AT ROW 4.81 COL 10 WIDGET-ID 2
...
DO:
  DEF VAR cName AS CHAR INIT "tbTest".

  cmenu = "new|File;Ny,edit|File;Edit,undo|File;Angre,save|File;Lagre,delete|File;Slett,sub-menu|File;Send to,close|File;Close,help|File;Help,word|File;Word,www|File;www,email|File;Email,activate|File;Activate,accum|File;Accumulate,moveup|File;Move Up,movedown|File;Move Down,|Navigate,first|Navigate;First,prev|Navigate;Prev,next|Navigate;Next,last|Navigate;LastFilemaxborder".
