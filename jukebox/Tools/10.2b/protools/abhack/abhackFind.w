...
&Scoped-Define ENABLED-OBJECTS btnNext gcToFind gcScope btnPrev 
&Scoped-Define DISPLAYED-OBJECTS gcToFind gcScope 
...
iWinX = ghWinToStick:X + 10.
/* 16-NOV-2007 sla: avoid flashings when the window is too far on the bottom */
iWinY = MINIMUM(ghWinToStick:Y + ghWinToStick:HEIGHT-PIXELS + 32
...
------------------------------------------------------------------------------*/
  RUN control_load.
  DISPLAY gcToFind gcScope 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btnNext gcToFind gcScope btnPrev 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
