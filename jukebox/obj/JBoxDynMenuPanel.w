...
&Scoped-Define ENABLED-OBJECTS IMAGE-1 btnExit 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD setRefresh C-Win 
FUNCTION setRefresh RETURNS LOGICAL
  ( INPUT ibRefresh AS LOG )  FORWARD.
...
ON CHOOSE OF btnExit IN FRAME DEFAULT-FRAME /* Button 1 */
DO:
  PUBLISH "ApplyMenu" (hParent,"","Exit"). /* Program name (here blank) or menu label */
END.
...
/*   APPLY "choose" TO btnJournal IN FRAME {&FRAME-NAME}. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION setRefresh C-Win 
FUNCTION setRefresh RETURNS LOGICAL
  ( INPUT ibRefresh AS LOG ) :
/*------------------------------------------------------------------------------
  Purpose:  
    Notes:  
------------------------------------------------------------------------------*/
