...
&Scoped-Define ENABLED-OBJECTS rsAlle 
...
DEFINE FRAME frmSelectorPanel
     fi-cNumTotal AT ROW 1.38 COL 13 COLON-ALIGNED
     rsAlle AT ROW 1.67 COL 26.2 NO-LABEL
     fi-cNumSelected AT ROW 2.43 COL 13 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 49.6 BY 2.81.
...
/* SETTINGS FOR FRAME frmSelectorPanel
   FRAME-NAME                                                           */
ASSIGN 
       FRAME frmSelectorPanel:HEIGHT           = 2.81
       FRAME frmSelectorPanel:WIDTH            = 49.6.

/* SETTINGS FOR FILL-IN fi-cNumSelected IN FRAME frmSelectorPanel
   NO-ENABLE                                                            */
ASSIGN 
       fi-cNumSelected:READ-ONLY IN FRAME frmSelectorPanel        = TRUE.

/* SETTINGS FOR FILL-IN fi-cNumTotal IN FRAME frmSelectorPanel
   NO-ENABLE                                                            */
ASSIGN 
       fi-cNumTotal:READ-ONLY IN FRAME frmSelectorPanel        = TRUE.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-cNumTotal rsAlle fi-cNumSelected 
