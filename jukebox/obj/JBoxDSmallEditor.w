...
&Scoped-Define ENABLED-OBJECTS edText Btn_OK Btn_Cancel 
...
DEFINE FRAME Dialog-Frame
     ...
     Btn_OK AT ROW 9.1 COL 89
     Btn_Cancel AT ROW 9.1 COL 104.6
     SPACE(0.59) SKIP(0.08)
...
------------------------------------------------------------------------------*/
  ...
  ENABLE edText Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ELSE 
    ASSIGN Btn_Cancel:LABEL         = "Cancel" 
           FRAME Dialog-Frame:TITLE = (IF icTitle NE "" THEN icTitle ELSE "Set text value")
           .
