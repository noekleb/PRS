...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD getWeekNumChar C-Win 
...
/* SETTINGS FOR COMBO-BOX CB-FORMAT IN FRAME DEFAULT-FRAME
   NO-DISPLAY NO-ENABLE ALIGN-L                                         */
ASSIGN 
       CB-FORMAT:HIDDEN IN FRAME DEFAULT-FRAME           = TRUE.

/* SETTINGS FOR COMBO-BOX CB-MONTH IN FRAME DEFAULT-FRAME
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fiWeek IN FRAME DEFAULT-FRAME
   ALIGN-L                                                              */
ASSIGN 
       fiWeek:READ-ONLY IN FRAME DEFAULT-FRAME        = TRUE.

/* SETTINGS FOR FILL-IN TEXT-1 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN TEXT-2 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN TEXT-3 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN TEXT-4 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN TEXT-5 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN TEXT-6 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN TEXT-7 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-L                                                    */
...
ON END-ERROR OF C-Win /* Kalender */
OR ENDKEY OF {&WINDOW-NAME} ANYWHERE DO:
  /* This case occurs when the user presses the "Esc" key.
     In a persistently run window, just ignore this.  If we did not, the
     application would exit. */
  IF THIS-PROCEDURE:PERSISTENT THEN RETURN NO-APPLY.
  ELSE ihDate:WINDOW:SENSITIVE = YES.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Kalender */
DO:
...
DO:
  IF VALID-HANDLE(ihDate) THEN DO:
    ...
    IF hParent:FILE-NAME = "JBoxUIlib.p" THEN
      APPLY "tab" TO ihDate.
    ELSE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL CB-FORMAT C-Win
ON ENTRY OF CB-FORMAT IN FRAME DEFAULT-FRAME
DO:
  RUN _SetFormat.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL CB-FORMAT C-Win
ON VALUE-CHANGED OF CB-FORMAT IN FRAME DEFAULT-FRAME
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL CB-MONTH C-Win
ON VALUE-CHANGED OF CB-MONTH IN FRAME DEFAULT-FRAME
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ihDate:WINDOW:SENSITIVE = NO.
  RUN enable_UI.
  RUN InitWindow.
  IF VALID-HANDLE(ihDate) THEN DO:
    THIS-PROCEDURE:CURRENT-WINDOW:X = ihDate:WINDOW:X + ihDate:FRAME:X + ihDate:X + 4.

    IF ihDate:WINDOW:Y + ihDate:FRAME:Y + ihDate:Y + 44 + THIS-PROCEDURE:CURRENT-WINDOW:HEIGHT-PIXELS < SESSION:HEIGHT-PIXELS THEN
      THIS-PROCEDURE:CURRENT-WINDOW:Y = ihDate:WINDOW:Y + ihDate:FRAME:Y + ihDate:Y + ihDate:HEIGHT-PIXELS + 44.    
    ELSE
      THIS-PROCEDURE:CURRENT-WINDOW:Y = ihDate:WINDOW:Y + ihDate:FRAME:Y + ihDate:Y + 16 - THIS-PROCEDURE:CURRENT-WINDOW:HEIGHT-PIXELS.    
  END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setFieldHandle C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setNewDate C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE _AssignDay C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE _BuildString C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE _SelectDay C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE _SetDay C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE _SetFormat C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE _SetHandles C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION getWeekNumChar C-Win 
FUNCTION getWeekNumChar RETURNS CHARACTER
...
/*        dStart = dStart + (9 - WEEKDAY(dStart)).                                        */
/*                                                                                        */
/* IF dStart > dSomeDate THEN                                                             */
/*     RETURN " - uke 1".                                                                 */
/* ELSE                                                                                   */
/*     RETURN " - uke " + STRING (2 + INTEGER(TRUNC(INTEGER(dSomeDate - dStart) / 7,0))). */
