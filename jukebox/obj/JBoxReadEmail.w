...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hBrowse = DYNAMIC-FUNCTION("NewBrowse"
     ...
     + ";cDisplayFrom|CHARACTER|x(50)||" + (IF bScand THEN "Fra" ELSE "From")
     + ";cDisplayTo|CHARACTER|x(50)||" + (IF bScand THEN "Til" ELSE "To")
     + ";cDisplayCc|CHARACTER|x(50)||" + (IF bScand THEN "Kopi" ELSE "CC")
     + ";cDisplayBCc|CHARACTER|x(50)||" + (IF bScand THEN "Blind kopi" ELSE "BCC")
...
RUN JBoxJlwSimpleEmailListener.w PERSIST SET hSimpleListener.
DYNAMIC-FUNCTION("setMailServerProperties" IN hSimpleListener,
                 ENTRY(1,cMailServer,"|"),
...
RUN InitializeObject IN hSimpleListener.
RUN getSubjectList IN hSimpleListener (OUTPUT cSubjectList).
APPLY "close" TO hSimpleListener.
