...
DEF VAR oProcedure	    AS JBoxProcedure NO-UNDO.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  oProcedure = NEW JBoxProcedure(FRAME {&FRAME-NAME}:HANDLE).
...
/* Replace with class browse or query handle (<oBrw..>:BROWSE-HANDLE): */
/*{incl/supptrigg.i oBrw<>:BROWSE-HANDLE} */ /* <- To be able to capture keys (insert, delete..) on the browse or frame */
...
oProcedure:setNoResizeY("<toolbar-rectangle>").
