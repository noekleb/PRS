...
DEFINE FRAME DEFAULT-FRAME
     rectViewer AT ROW 1.24 COL 1.4
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Sample container with viewer object"
         HEIGHT             = 18.67
         WIDTH              = 122.8
         MAX-HEIGHT         = 57.14
         MAX-WIDTH          = 320
...
ON END-ERROR OF C-Win /* Sample container with viewer object */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Sample container with viewer object */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hViewer = DYNAMIC-FUNCTION("NewViewer",
                   rectViewer:HANDLE,
                   ?,                 /* Navigation query */
                   "template/JBoxSuppressedWindow.w").
