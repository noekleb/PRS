...
DEF VAR oUltraGantt  AS JBoxUltraGantt NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS Order Toolbar UltraGantt 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     UltraGantt AT ROW 10.67 COL 2 WIDGET-ID 8
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
/*oUltraGantt:UltraGanttView1:Tasks:ClearAndDispose().*/
...
oUltraGantt:ultraGanttView1:CalendarInfo:Projects:Clear().

oUltraGantt:AddProject(hBuffer::Name,hBuffer::OrderDate,STRING(hBuffer::OrderNum)).
oTask = oUltraGantt:AddTask(hBuffer::OrderDate,
                            (IF hBuffer::PromiseDate NE ? THEN 
                               hBuffer::PromiseDate 
                             ELSE hBuffer::OrderDate + 1) - hBuffer::OrderDate,
                            hBuffer::Name,
                            STRING(hBuffer::OrderNum)).

IF hBuffer::PromiseDate NE ? AND hBuffer::ShipDate NE ? AND hBuffer::ShipDate > hBuffer::PromiseDate THEN                            
  oUltraGantt:AddSubTask(oTask,hBuffer::PromiseDate,
                         hBuffer::ShipDate - hBuffer::PromiseDate,
                         hBuffer::RepName,"","").
  
oUltraGantt:ShowProject().
...
------------------------------------------------------------------------------*/
  ENABLE Order Toolbar UltraGantt 
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  oUltraGantt = NEW JBoxUltraGantt(THIS-PROCEDURE,UltraGantt:HANDLE).
/*  oUltraGantt:iDeltaWidth = -40. */ 
  oUltraGantt:iDeltaHeight = -20. 
  oUltraGantt:RegisterWithJukeBox(YES).
/*  oUltraGantt:CreateDisplayLink(hBrowse,"Ordernum,Name,OrderDate,ShipDate").*/
/*  oUltraGantt:setColumns("Customer|Name;Duration|Duration;Order date|Start;Ship date|Finish"). */

/*    AddProject("Testprosjekt",today,"test").       */
/*    AddTask(TODAY,5,"Testaktivitet","test").       */
/*    AddSubTask(TODAY,2,"Test sub-aktivitet","","").*/

/*  oUltraGantt:AddProject("Testprosjekt",today,"test").             */
/*  oTask = oUltraGantt:AddTask(TODAY,5,"Testaktivitet","test").     */
/*  oUltraGantt:AddSubTask(oTask,TODAY,2,"Test sub-aktivitet","","").*/
/*                                                                   */
/*  oUltraGantt:ShowProject().                                       */
