...
&Scoped-define FIELDS-IN-QUERY-BrwCustomer Name CustNum   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BrwCustomer Name ~
CustNum   
...
&Scoped-Define ENABLED-OBJECTS BrwCustomer popupCustomer 
&Scoped-Define DISPLAYED-OBJECTS popupCustomer 
...
DEFINE VARIABLE popupCustomer AS CHARACTER FORMAT "X(256)":U INITIAL "popupCustomer" 
      VIEW-AS TEXT 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BrwCustomer C-Win _FREEFORM
  QUERY BrwCustomer NO-LOCK DISPLAY
      Name COLUMN-LABEL "Name" FORMAT "x(30)":U
      CustNum COLUMN-LABEL "Cust Num" FORMAT ">>>>9":U
  ENABLE
      Name
      CustNum
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 104 BY 12.38 FIT-LAST-COLUMN.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     popupCustomer AT ROW 1.71 COL 84 COLON-ALIGNED NO-LABEL WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 106.2 BY 15.43 WIDGET-ID 100.
...
ASSIGN 
       FRAME DEFAULT-FRAME:HEIGHT           = 15.43
       FRAME DEFAULT-FRAME:WIDTH            = 106.2.

ASSIGN 
       BrwCustomer:PRIVATE-DATA IN FRAME DEFAULT-FRAME           = 
                "new;Ny,copy;Kopier,undo;Angre,delete;Slett,save;Lagre,excel;Eksporter til E&xcel,sub-menu|;Send to,excel;Eksporter til E&xcel".

ASSIGN 
       popupCustomer:PRIVATE-DATA IN FRAME DEFAULT-FRAME     = 
                "popupCustomer".
...
"Name" "Name" "x(30)" "character" ? ? ? ? ? ? yes "" no no "30" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > "_<CALC>"
"CustNum" "Cust Num" ">>>>9" "integer" ? ? ? ? ? ? yes "" no no "68.6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  DISPLAY popupCustomer 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE BrwCustomer popupCustomer 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  opopupCustomer:AddToolGroup('new;Ny,copy;Kopier,undo;Angre,delete;Slett,save;Lagre,excel;Eksporter til E&xcel,sub-menu|;Send to,excel;Eksporter til E&xcel').
