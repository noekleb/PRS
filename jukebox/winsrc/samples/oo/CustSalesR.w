...
Customer.SalesRep Customer.RepName 
...
&Scoped-define QUERY-STRING-BrwCustomer FOR EACH Customer NO-LOCK, ~
    EACH Salesrep OF Customer NO-LOCK INDEXED-REPOSITION
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 58 BY 8.81 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     filter_tbCustomer AT ROW 1.33 COL 2.2 WIDGET-ID 4
...
"Customer.RepName" "Rep Name" "x(30)" "character" ? ? ? ? ? ? no "Please enter the Name of the Salesperson." no no "2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  oBrwCustomer:altPrimaryBufferList = "Salesrep".
