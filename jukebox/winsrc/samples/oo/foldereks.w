...
FUNCTION getQueryJoinBrwCustomer RETURNS CHARACTER():
  RETURN 'FIRST Salesrep OF Customer NO-LOCK,LAST Order OF Customer NO-LOCK,FIRST buf1_Salesrep  WHERE buf1_Salesrep.SalesRep = Order.SalesRep OUTER-JOIN NO-LOCK'.
END FUNCTION.
...
Customer.RepName Customer.Ordernum Customer.OrderDate Customer.SalesRep ~
Customer.RepName4 
...
&Scoped-Define ENABLED-OBJECTS TabCustomer BrwCustomer 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 110 BY 8.1 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     BrwCustomer AT ROW 3.14 COL 4 WIDGET-ID 200
     TabCustomer AT ROW 11.71 COL 3 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 116.2 BY 19.62 WIDGET-ID 100.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
/* BROWSE-TAB BrwCustomer TabCustomer DEFAULT-FRAME */
ASSIGN 
       FRAME DEFAULT-FRAME:HEIGHT           = 19.62
       FRAME DEFAULT-FRAME:WIDTH            = 116.2.
...
/* Query rebuild information for BROWSE BrwCustomer
     ...
     _TblOptList       = ", FIRST, LAST, FIRST OUTER"
...
"Customer.RepName4" "Rep Name" "x(30)" "character" ? ? ? ? ? ? no "Please enter the Name of the Salesperson." no no "2.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ENABLE TabCustomer BrwCustomer 
...
oContainer:addStatusBar("550,50,70").
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  oTabCustomer:setLinkFields("SalesRep",2).
  oTabCustomer:AddPage("Ordre","oo\CustOrderGoo.w","bmp\bullet_ball_green.bmp").
  oTabCustomer:AddPage("Alle ordre for selger","oo\CustOrderGoo.w","bmp\bullet_ball_red.bmp").
