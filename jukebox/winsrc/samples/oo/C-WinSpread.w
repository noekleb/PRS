...
FUNCTION getQueryJoinQryCustomer RETURNS CHARACTER().
  RETURN 'EACH Order OF Customer NO-LOCK,EACH OrderLine OF Order NO-LOCK'.
END FUNCTION.
...
&Scoped-Define ENABLED-OBJECTS JBoxFpSpread 
...
DEFINE FRAME DEFAULT-FRAME
     JBoxFpSpread AT ROW 3.38 COL 3 WIDGET-ID 2
...
OPEN QUERY {&SELF-NAME} FOR EACH Customer NO-LOCK
     ...
     _Design-Parent    is FRAME DEFAULT-FRAME @ ( 1.71 , 4 )
*/  /* QUERY QUERY-2 */
&ANALYZE-RESUME
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  oQryCustomer:RowsToBatch = 100000.
  ...
  oJBoxFpSpread:InitializeSpreadSheetFromHandle(oQryCustomer:BUFFER-HANDLE,YES).
END.
