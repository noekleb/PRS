...
DEF TEMP-TABLE Customer
    ...
    .
FUNCTION getTableFieldListBrwCustomer RETURNS CHARACTER().
  RETURN 
      'Customer'
      + ';Address'
      + ';Address2'
...
&Scoped-define FIELDS-IN-QUERY-brwCustomer Customer.Address Customer.Address2 Customer.Balance Customer.City Customer.Comments   
&Scoped-define ENABLED-FIELDS-IN-QUERY-brwCustomer Customer.Address   
...
&Scoped-Define ENABLED-OBJECTS brwCustomer CustNum Name Phone 
&Scoped-Define DISPLAYED-OBJECTS CustNum Name Phone 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 30 BY 4.52 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     brwCustomer AT ROW 2.67 COL 14 WIDGET-ID 200
     CustNum AT ROW 9.1 COL 13 COLON-ALIGNED
     Name AT ROW 10.1 COL 13 COLON-ALIGNED
     Phone AT ROW 11.1 COL 13 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 73 BY 13.29 WIDGET-ID 100.
...
ASSIGN 
       FRAME DEFAULT-FRAME:HEIGHT           = 13.29
       FRAME DEFAULT-FRAME:WIDTH            = 73.
...
------------------------------------------------------------------------------*/
  DISPLAY CustNum Name Phone 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE brwCustomer CustNum Name Phone 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
