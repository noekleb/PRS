...
&Scoped-Define ENABLED-OBJECTS BrwItem 
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
/* BROWSE-TAB BrwItem TEXT-1 DEFAULT-FRAME */
ASSIGN 
...
oDynDataBrowse:TotalFields = "fSaldo,avgift-pr-ar".
oDynDataBrowse:userSettingContext = THIS-PROCEDURE:FILE-NAME.
oDynDataBrowse:calcFieldProc = "customer_browsecalc.p".
*/
oDynDataBrowse:InitializeQuery(
  ...
  + ',Order'
     ...
     + ';CustNum'
     + ';Ordernum'
     ,',EACH OrderLine OF Item NO-LOCK,EACH Order OF OrderLine NO-LOCK'
     ,"Itemnum"  /* Initial sort column */
