...
DEFINE VARIABLE FILL-IN-1 AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Fill 1" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     FILL-IN-1 AT ROW 3.86 COL 9 COLON-ALIGNED WIDGET-ID 2
...
DO WITH FRAME {&FRAME-NAME}:
    oDatePickShipDate = NEW JBoxDevExDateEdit(THIS-PROCEDURE,FILL-IN-1:HANDLE).
