...
DEFINE FRAME DEFAULT-FRAME
     brwCustomer AT ROW 1.24 COL 1.2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 68.2 BY 12.48.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
ASSIGN 
       FRAME DEFAULT-FRAME:HEIGHT           = 12.48
       FRAME DEFAULT-FRAME:WIDTH            = 68.2.
...
IF DYNAMIC-FUNCTION("getCurrentObject") = hSalesRepOverlay THEN DO:
  ...
  IF bOk AND cReturnValues NE "" THEN DO:
    ASSIGN hSalesRepOverlay:SCREEN-VALUE = ENTRY(1,cReturnValues,"|")
           .
    APPLY "tab" TO hSalesRepOverlay.
  END.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hSalesRepOverlay = DYNAMIC-FUNCTION("NewBrowseFillIn",hBrowse,"Salesrep","Salesrep"
                    ,"Salesrep;Salesrep;RepName","WHERE true","Salesrep"
                    ,"").
