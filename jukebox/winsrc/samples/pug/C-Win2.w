...
&Scoped-Define ENABLED-OBJECTS oJBoxFpSpread-1 
...
DEFINE RECTANGLE oJBoxFpSpread-1
...
DEFINE FRAME DEFAULT-FRAME
     oJBoxFpSpread-1 AT ROW 2.91 COL 4 WIDGET-ID 2
...
OPEN QUERY {&SELF-NAME} FOR EACH Order NO-LOCK INDEXED-REPOSITION.
     ...
     _Design-Parent    is FRAME DEFAULT-FRAME @ ( 1.24 , 54 )
*/  /* QUERY QUERY-2 */
&ANALYZE-RESUME
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  oJBoxFpSpread = NEW JBoxFpSpread(THIS-PROCEDURE,oJBoxFpSpread-1:HANDLE).
  oJBoxFpSpread:RegisterWithJukeBox(YES).
  oQryOrder:OpenQuery("where ordernum < 500").
  oJBoxFpSpread:InitializeSpreadSheetFromHandle(oQryOrder:BUFFER-HANDLE,YES).
END.
