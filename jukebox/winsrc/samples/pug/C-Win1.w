...
&Scoped-define OPEN-QUERY-QUERY-2 OPEN QUERY QUERY-2 FOR EACH Order NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-QUERY-2 Order
&Scoped-define FIRST-TABLE-IN-QUERY-QUERY-2 Order


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS oJBoxFpSpread 
...
DEFINE RECTANGLE oJBoxFpSpread
...
DEFINE FRAME DEFAULT-FRAME
     oJBoxFpSpread AT ROW 2.91 COL 2 WIDGET-ID 2
...
/* Query rebuild information for QUERY QUERY-2
     ...
     _Design-Parent    is FRAME DEFAULT-FRAME @ ( 1.48 , 56 )
*/  /* QUERY QUERY-2 */
&ANALYZE-RESUME
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  oJBoxFpSpread = NEW JBoxFpSpread(THIS-PROCEDURE,oJBoxFpSpread:HANDLE).
