...
&Scoped-Define ENABLED-OBJECTS btnWarehouse Ordernum OrderStatus SalesRep ~
edWarehouse OrderDate PromiseDate ShipDate Creditcard Terms Carrier ~
Instructions 
...
DEFINE VARIABLE OrderDate AS DATE FORMAT "99/99/9999" INITIAL 10/07/05 
     LABEL "Ordered" 
     VIEW-AS FILL-IN 
     SIZE 16.2 BY 1 TOOLTIP "Please enter the date of order.".
...
DEFINE VARIABLE PromiseDate AS DATE FORMAT "99/99/9999" 
     LABEL "Promised" 
     VIEW-AS FILL-IN 
     SIZE 16.2 BY 1.
...
DEFINE FRAME frmOrderView
     ...
     ShipDate AT ROW 3.29 COL 61.8 COLON-ALIGNED HELP
          "Please enter the ship date."
     Creditcard AT ROW 4.43 COL 61.8 COLON-ALIGNED HELP
          "Please enter the credit card."
     Terms AT ROW 5.57 COL 61.8 COLON-ALIGNED HELP
          "Please enter the terms."
     Carrier AT ROW 6.62 COL 61.8 COLON-ALIGNED HELP
          "Please enter the carrier."
     Instructions AT ROW 7.67 COL 61.8 COLON-ALIGNED HELP
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btnWarehouse Ordernum OrderStatus SalesRep edWarehouse OrderDate 
...
DO WITH FRAME frmOrderView:
  ...
  &IF DEFINED(AdvGuiWin) &THEN
    ...
    oDatePickOrderDate:RegisterWithJukeBox(NO).
    ...
    oDatePickPromiseDate:RegisterWithJukeBox(NO).
    ...
    oDatePickShipDate:RegisterWithJukeBox(NO).
