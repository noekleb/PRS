...
&Scoped-Define ENABLED-OBJECTS sFunction Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS sFunction 
...
DEFINE VARIABLE sFunction AS CHARACTER 
     VIEW-AS SELECTION-LIST SINGLE SCROLLBAR-VERTICAL 
     SIZE 60 BY 6.91 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     sFunction AT ROW 1.48 COL 3 NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  ENABLE sFunction Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
