...
&Scoped-Define ENABLED-OBJECTS ContactView rectToolBar rectWinToolbar 
...
DEFINE FRAME DEFAULT-FRAME
     ContactView AT ROW 2.62 COL 2
     rectToolBar AT ROW 1.14 COL 1.8
     rectWinToolbar AT ROW 1.14 COL 50.2
...
------------------------------------------------------------------------------*/
  ENABLE ContactView rectToolBar rectWinToolbar 
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hToolbar = DYNAMIC-FUNCTION("NewToolBar",
                    rectToolBar:HANDLE,             
                    "Fil",                          
                    "new;Ny,copy;Kopier,undo;Angre,delete;Slett,save;Lagre"
                  + ",-,www;Gule sider¤enable"
                    ,"maxborder").    
  ...
  hViewer = DYNAMIC-FUNCTION("NewViewer",
                   ContactView:HANDLE,
                   ?,
                   "JBoxSmallContactView.w").

  hFieldMap = DYNAMIC-FUNCTION("getFieldMapHandle" IN hViewer).

  /* Link objects: */

  DYNAMIC-FUNCTION("CreateObjectLink",hToolbar,DYNAMIC-FUNCTION("getQueryHandle" IN hViewer)).
  DYNAMIC-FUNCTION("CreateOneToOneLink",DYNAMIC-FUNCTION("getQueryHandle" IN hViewer),hParentQuery,"iJBoxContactId").
...
DYNAMIC-FUNCTION("setOrgWinSize", THIS-PROCEDURE:CURRENT-WINDOW,200,600,0,0).
