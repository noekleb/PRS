...
EventCategoryName 
&Scoped-Define DISPLAYED-OBJECTS EventCategoryName 
...
DEFINE VARIABLE EventCategoryName AS CHARACTER FORMAT "X(50)" 
     LABEL "Kategori" 
...
DEFINE FRAME DEFAULT-FRAME
     EventCategoryName AT ROW 2.43 COL 50 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY EventCategoryName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar EventCategoryName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    + ";EventCategoryName"
                   ,"WHERE true"
                    ,"sort|EventCategoryName").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "EventCategoryName",   /* Update columns in buffer */
