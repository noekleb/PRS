...
EventGroupName 
&Scoped-Define DISPLAYED-OBJECTS EventGroupName 
...
DEFINE VARIABLE EventGroupName AS CHARACTER FORMAT "X(50)" 
     LABEL "Group" 
...
DEFINE FRAME DEFAULT-FRAME
     EventGroupName AT ROW 2.57 COL 50 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY EventGroupName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar EventGroupName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    + ";EventGroupName"
                   ,"WHERE true"
                    ,"sort|EventGroupName").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "EventGroupName",   /* Update columns in buffer */
