...
EventSourceName 
&Scoped-Define DISPLAYED-OBJECTS EventSourceName 
...
DEFINE VARIABLE EventSourceName AS CHARACTER FORMAT "X(50)" 
     LABEL "Kilde" 
...
DEFINE FRAME DEFAULT-FRAME
     EventSourceName AT ROW 2.43 COL 50 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rectBrowse rectToolBar rectWinToolbar EventSourceName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    + ";EventSourceName"
                   ,"WHERE true"
                    ,"sort|EventSourceName").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "EventSourceName",   /* Update columns in buffer */
