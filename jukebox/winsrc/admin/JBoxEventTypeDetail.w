...
EventTypeName 
&Scoped-Define DISPLAYED-OBJECTS EventTypeName 
...
DEFINE VARIABLE EventTypeName AS CHARACTER FORMAT "X(50)" 
     LABEL "Type" 
...
DEFINE FRAME DEFAULT-FRAME
     EventTypeName AT ROW 2.57 COL 50 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY EventTypeName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar EventTypeName 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    + ";EventTypeName"
                   ,"WHERE true"
                    ,"sort|EventTypeName").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "EventTypeName",   /* Update columns in buffer */
