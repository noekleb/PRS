...
hTempTable:CREATE-LIKE(IF icBufferName = "_file" THEN "tt_file" ELSE "tt_field"). 
hTempTable:TEMP-TABLE-PREPARE("tt" + icBufferName).

CREATE BUFFER hBuffer FOR TABLE IF icBufferName = "_file" THEN "tt_file" ELSE "tt_field".
