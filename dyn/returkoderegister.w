...
RECT-64 ReturKodeId ReturKodeTekst VisIKasse 
&Scoped-Define DISPLAYED-OBJECTS ReturKodeId ReturKodeTekst VisIKasse 
...
DEFINE VARIABLE ReturKodeId AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "Returkode" 
     VIEW-AS FILL-IN 
     SIZE 6.2 BY 1.

DEFINE VARIABLE ReturKodeTekst AS CHARACTER FORMAT "X(30)" 
     LABEL "Tekst" 
     VIEW-AS FILL-IN 
     SIZE 47 BY 1.
...
DEFINE VARIABLE VisIKasse AS LOGICAL INITIAL no 
     LABEL "Vis i kasse" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME DEFAULT-FRAME
     ReturKodeId AT ROW 2.67 COL 87 COLON-ALIGNED HELP
          "Bilagsart"
     ReturKodeTekst AT ROW 3.76 COL 87 COLON-ALIGNED HELP
          "Kort beskrivlelse av bilagsart."
     VisIKasse AT ROW 4.86 COL 89 WIDGET-ID 4
...
RUN SUPER.
ASSIGN 
    ReturKodeId:SENSITIVE IN FRAME {&FRAME-NAME} = FALSE.
...
------------------------------------------------------------------------------*/
  DISPLAY ReturKodeId ReturKodeTekst VisIKasse 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar RECT-64 ReturKodeId 
         ReturKodeTekst VisIKasse 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          
                    ...
                    100,                           
                    "",                            
                    "ReturKodeRegister;ReturKodeId;ReturKodeTekst;VisIKasse|Vis i kasse|*/",        
                    "WHERE true", 
                    "").                    
  hBrowse:NAME = "brwReturKodeRegister". 

  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",    
                                                 
                    hBrowse:QUERY,
                    FRAME {&FRAME-NAME}:HANDLE,  
                    "ReturKodeId,ReturKodeTekst,VisIKasse",              
                    "",              
                    "","",                       
                    "").                         
...
RUN SUPER.
  ...
  ReturKodeId:SENSITIVE IN FRAME {&FRAME-NAME} = TRUE.

  APPLY "entry" TO ReturKodeId.
...
------------------------------------------------------------------------------*/
    DO WITH FRAME {&FRAME-NAME}:
        IF ReturKodeId:SCREEN-VALUE = "0" THEN DO:
            MESSAGE "Ugyldig verdi: '0'"
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
            APPLY "ENTRY" TO ReturKodeId.
            RETURN.
        END.
        IF TRIM(ReturKodeTekst:SCREEN-VALUE) = "" THEN DO:
            MESSAGE "Ugyldig verdi"
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
            APPLY "ENTRY" TO ReturKodeTekst.
            RETURN.
        END.
    END.
    RUN SUPER.
