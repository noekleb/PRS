...
RECT-64 BTTekst Bruk 
&Scoped-Define DISPLAYED-OBJECTS BilagsType BTTekst Bruk 
...
DEFINE VARIABLE Bruk AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "Bilagstype" 
     VIEW-AS COMBO-BOX INNER-LINES 25
     LIST-ITEM-PAIRS "Faktura",1,
                     "Kundereskontro",2,
                     "Faktura og kundereskontro",3
     DROP-DOWN-LIST
     SIZE 32 BY 1 NO-UNDO.

DEFINE VARIABLE BilagsType AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "Bilagstype" 
     VIEW-AS FILL-IN 
     SIZE 4.8 BY 1.

DEFINE VARIABLE BTTekst AS CHARACTER FORMAT "X(30)" 
     LABEL "Tekst" 
     VIEW-AS FILL-IN 
     SIZE 32 BY 1.
...
DEFINE FRAME DEFAULT-FRAME
     BilagsType AT ROW 2.71 COL 83 COLON-ALIGNED HELP
          "Bilagstype"
     BTTekst AT ROW 3.71 COL 83 COLON-ALIGNED HELP
          "Bilagstypetekst"
     Bruk AT ROW 4.81 COL 83 COLON-ALIGNED HELP
          "Bilagstype"
...
/* SETTINGS FOR FILL-IN BilagsType IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
...
ON END-ERROR OF C-Win /* Vedlikehold bilagstype */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Vedlikehold bilagstype */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Vedlikehold bilagstype */
DO:
...
ASSIGN 
    BilagsType:SENSITIVE IN FRAME {&FRAME-NAME} = FALSE.
...
------------------------------------------------------------------------------*/
  DISPLAY BilagsType BTTekst Bruk 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar RECT-64 BTTekst Bruk 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          
                    ...
                    100,                           
                    "",                            
                    "BilagsType;BilagsType;BTTekst;Bruk"        
                    + ";+bIBruk|CHARACTER|x(5)|bilagstype_i_bruk.p(BilagsType)|BTiB"         ,
                    "WHERE true", 
                    "").                    
  hBrowse:NAME = "brwBilagstype". 

  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",    
                                                 
                    hBrowse:QUERY,
                    FRAME {&FRAME-NAME}:HANDLE,  
                    "BilagsType,BTTekst,Bruk",              
                    "",              
                    "","",                       
                    "").                         
...
RUN SUPER.
  ...
  BilagsType:SENSITIVE IN FRAME {&FRAME-NAME} = TRUE.

  APPLY "entry" TO BilagsType.
...
------------------------------------------------------------------------------*/
    DO WITH FRAME {&FRAME-NAME}:
        IF BilagsType:SCREEN-VALUE = "0" THEN DO:
            MESSAGE "Ugyldig verdi: '0'"
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
            APPLY "ENTRY" TO BilagsType.
            RETURN.
        END.
        IF TRIM(BTTekst:SCREEN-VALUE) = "" THEN DO:
            MESSAGE "Ugyldig verdi"
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
            APPLY "ENTRY" TO BTTekst.
            RETURN.
        END.
    END.
    RUN SUPER.
