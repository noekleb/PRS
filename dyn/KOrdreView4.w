...
&Scoped-Define ENABLED-OBJECTS InternMerknad 
&Scoped-Define DISPLAYED-OBJECTS InternMerknad 
...
DEFINE VARIABLE InternMerknad AS CHARACTER 
     ...
     SIZE 136 BY 8.1 TOOLTIP "Internmerknad" NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME frmFaktLinje
     InternMerknad AT ROW 1.24 COL 1 HELP
          "Internmerknad" NO-LABEL 
...
------------------------------------------------------------------------------*/
  DISPLAY InternMerknad 
      WITH FRAME frmFaktLinje.
  ENABLE InternMerknad 
      WITH FRAME frmFaktLinje.
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
  ASSIGN InternMerknad:SCREEN-VALUE = ENTRY(2,icKunde,"|")
         .
END.
