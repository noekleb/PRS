...
&Scoped-Define ENABLED-OBJECTS rectFolder 
...
DEFINE FRAME DEFAULT-FRAME
     rectFolder AT ROW 1.24 COL 1.2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Søk artikkel eller produktfamilie"
         HEIGHT             = 23.52
         WIDTH              = 197.2
         MAX-HEIGHT         = 23.52
         MAX-WIDTH          = 197.2
...
ON END-ERROR OF C-Win /* Søk artikkel eller produktfamilie */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Søk artikkel eller produktfamilie */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  DYNAMIC-FUNCTION("InitPages" IN hTabFolder,"Artikkel|ArtBasSokSup.w",?).
