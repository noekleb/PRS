...
&Scoped-Define DISPLAYED-OBJECTS rsAlle fi-cMessage fi-cNumTotal ~
fi-cNumSelected 
...
DEFINE FRAME Dialog-Frame
     ...
     Btn_OK AT ROW 5.33 COL 63.2
     Btn_Cancel AT ROW 5.33 COL 78.8
     ...
     SPACE(64.39) SKIP(1.75)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Behandla poster"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Behandla poster */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY rsAlle fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
  ENABLE rsAlle Btn_OK Btn_Cancel fi-cMessage fi-cNumTotal fi-cNumSelected 
      WITH FRAME Dialog-Frame.
