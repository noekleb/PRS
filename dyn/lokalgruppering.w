...
&Scoped-Define ENABLED-OBJECTS rectBrowse rectToolBar rectSearchField LGId ~
LGBeskrivelse RegistrertDato RegistrertAv EDato BrukerID 
&Scoped-Define DISPLAYED-OBJECTS LGId LGBeskrivelse RegistrertDato ~
...
DEFINE VARIABLE LGBeskrivelse AS CHARACTER FORMAT "X(30)" 
     LABEL "Beskrivelse" 
     VIEW-AS FILL-IN 
     SIZE 40 BY 1.

DEFINE VARIABLE LGId AS INTEGER FORMAT ">>>>>9" INITIAL 0 
     LABEL "Lokal gruppering" 
     VIEW-AS FILL-IN 
     SIZE 6.8 BY 1.
...
DEFINE FRAME DEFAULT-FRAME
     LGId AT ROW 2.52 COL 51 COLON-ALIGNED HELP
          "Lokal gruppering."
     LGBeskrivelse AT ROW 3.57 COL 51 COLON-ALIGNED HELP
          "Beskrivelse"
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Vedlikehold lokale grupperinger"
         HEIGHT             = 16
         WIDTH              = 93
         MAX-HEIGHT         = 57.14
         MAX-WIDTH          = 320
...
ON END-ERROR OF C-Win /* Vedlikehold lokale grupperinger */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Vedlikehold lokale grupperinger */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Vedlikehold lokale grupperinger */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY LGId LGBeskrivelse RegistrertDato RegistrertAv EDato BrukerID 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectSearchField LGId LGBeskrivelse 
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "LokalGruppering;LgId;LGBeskrivelse;!RegistrertAv;!RegistrertDato;!BrukerID;!EDato",    /* Buffers and fields: <buffer1>;<field1>;<field2>..,<buffer2>;.. No fields gives all*/
                    "WHERE true", 
                    "sort|LgId").                   /* Misc - for something I might need in next version.. */
  hBrowse:NAME = "brwLokalGruppering". /* This name is neccessary because the browser is due to special treatment during resize */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "LGBeskrivelse",          /* Update columns in buffer */
                    "",                             /* Corresponding input fields (fill-in..)*/
                    "RegistrertAv,RegistrertDato,BrukerID,EDato,LgId",
                    "",                             /* Additional buffer and displ.fields - not updateable*/
                    "").                            /* Misc - for something I might need in next version.. */
  DYNAMIC-FUNCTION("setAttribute",hFieldMap,"customCreateProc","create_LokalGruppering.p").
