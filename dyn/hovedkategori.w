...
HovedKatNr HovedKatTekst 
&Scoped-Define DISPLAYED-OBJECTS HovedKatNr HovedKatTekst 
...
DEFINE VARIABLE HovedKatTekst AS CHARACTER FORMAT "X(256)":U 
     LABEL "Hovedkat.navn" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     HovedKatNr AT ROW 2.67 COL 78.8 COLON-ALIGNED
     HovedKatTekst AT ROW 3.71 COL 78.8 COLON-ALIGNED
...
ON END-ERROR OF C-Win /* Hovedkategori register */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Hovedkategori register */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Hovedkategori register */
DO:
...
------------------------------------------------------------------------------*/
  ...
  RUN SUPER.
  HovedKatNr:SENSITIVE IN FRAME {&FRAME-NAME} =  DYNAMIC-FUNCTION('getToolbarState',hToolbar) = 'New'.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  DISPLAY HovedKatNr HovedKatTekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar HovedKatNr HovedKatTekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "HovedKatNr,HovedKatTekst",   /* Update columns in buffer */
