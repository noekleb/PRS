...
&Scoped-Define ENABLED-OBJECTS cOpt1 
&Scoped-Define DISPLAYED-OBJECTS cOpt1 
...
------------------------------------------------------------------------------*/
DO WITH FRAME {&FRAME-NAME}:
    IF NUM-ENTRIES(icKunde,'|') >= 3 THEN 
        ASSIGN cOpt1:SCREEN-VALUE = ENTRY(3,icKunde,"|").
END.
