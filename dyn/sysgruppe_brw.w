...
SysHId SysGr Beskrivelse Hjelpetekst 
&Scoped-Define DISPLAYED-OBJECTS SysHId SysGr Beskrivelse Hjelpetekst 
...
DEFINE VARIABLE Beskrivelse AS CHARACTER FORMAT "X(30)" 
     LABEL "Beskrivelse" 
     VIEW-AS FILL-IN 
     SIZE 32 BY 1 TOOLTIP "Kort beskrivelse".

DEFINE VARIABLE Hjelpetekst AS CHARACTER FORMAT "X(50)" 
     LABEL "Hjelpetekst" 
     VIEW-AS FILL-IN 
     SIZE 44.2 BY 1 TOOLTIP "Hjelpetekst".
...
DEFINE FRAME DEFAULT-FRAME
     SysHId AT ROW 3.38 COL 67 COLON-ALIGNED
     SysGr AT ROW 4.33 COL 67 COLON-ALIGNED
     Beskrivelse AT ROW 5.33 COL 67 COLON-ALIGNED
     Hjelpetekst AT ROW 6.38 COL 67 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY SysHId SysGr Beskrivelse Hjelpetekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectToolbar rectBrowse rectSearchField SysHId SysGr Beskrivelse 
         Hjelpetekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",
                             ...
                             ,"WHERE false",
                             "SysGr").
  DYNAMIC-FUNCTION("setSortString",hBrowse,"SysGr"). 
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "SysHId,SysGr,Beskrivelse,Hjelpetekst",   /* Update columns in buffer */
  ...
  hToolbar = DYNAMIC-FUNCTION("NewToolbar",
                              rectToolbar:HANDLE,
                              "File",
                              "New,undo,Save,Delete,excel,filter"
                             ,"maxborder").
