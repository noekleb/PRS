...
ELSE DO:  
  rKundeordreBehandling:LeverTilKunde(DEC(hFieldMap:BUFFER-FIELD("KOrdre_id"):BUFFER-VALUE),USERID('Skotex'),OUTPUT cTekst,OUTPUT bOk).
  IF cTekst <> '' THEN 
    DYNAMIC-FUNCTION("DoMessage",0,0,cTekst,"","").
END. /* FULL_LEVERING */
