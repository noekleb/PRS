...
&Scoped-Define ENABLED-OBJECTS cbRAvdNr LevNr btnSaSong SaSong ~
...
&Scoped-Define DISPLAYED-OBJECTS cbRAvdNr LevNr SaSong tbAvvikVPIinfo ~
...
------------------------------------------------------------------------------*/
  DISPLAY cbRAvdNr LevNr SaSong tbAvvikVPIinfo tbAvvikArtBas tbAvvikStrekKode 
          tbAvvikPris tbAvvikArtInfo VareTekst Levkod fraVPIDato tilVPIDato 
          Utvidetsok Strekkode behStatus tbAnonseArtikkel cbcKontroll Vg 
          cbGrunnsortiment fraOpprettet tilOpprettet 
      WITH FRAME DEFAULT-FRAME.
  ENABLE cbRAvdNr LevNr btnSaSong SaSong tbAvvikVPIinfo tbAvvikArtBas 
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",
                             ...
                             + ",VPIArtPris;!Profilnr;AktivFraDato|Aktiveres@23"
                             + ";!+InnkjopsPris#1|decimal|>>>><>>9.99|Innkjopspris%#1|Innkj.pris"
                             + ";!+Varekost#1|decimal|>>>><>>9.99|Varekost%#1|Varekost"
                             + ",SaSong;SaSong;SasBeskr"
                             + ",LevBas;LevNr@25;LevNamn@26"
  ...
  ASSIGN 
    ...
    hBrowse:GET-BROWSE-COLUMN(2):WIDTH-PIXELS  = 80
    hBrowse:GET-BROWSE-COLUMN(3):WIDTH-PIXELS  = 80
    hBrowse:GET-BROWSE-COLUMN(4):WIDTH-PIXELS  = 150
    hBrowse:GET-BROWSE-COLUMN(5):WIDTH-PIXELS  = 100
    hBrowse:GET-BROWSE-COLUMN(6):WIDTH-PIXELS  = 50
    hBrowse:GET-BROWSE-COLUMN(7):WIDTH-PIXELS  = 20
    hBrowse:GET-BROWSE-COLUMN(8):WIDTH-PIXELS  = 20
    hBrowse:GET-BROWSE-COLUMN(9):WIDTH-PIXELS  = 20
    hBrowse:GET-BROWSE-COLUMN(10):WIDTH-PIXELS = 20
    hBrowse:GET-BROWSE-COLUMN(11):WIDTH-PIXELS = 20
    hBrowse:GET-BROWSE-COLUMN(12):WIDTH-PIXELS = 20
    hBrowse:GET-BROWSE-COLUMN(13):WIDTH-PIXELS = 20
    .
  ...
  ELSE 
      hToolbar = DYNAMIC-FUNCTION("NewToolBar",
                        rectToolBar:HANDLE,             /* Rectangle to define coordinates for toolbar */
                        "Fil",                         /* Corresponding menu label - no menu if blank */
                        "excel;Eksporter til E&xcel,Edit;&Endre,Print;S&kriv,rule,ArtikkelKort;&Artikkel kort,clearFilter;Blank &filter¤ENABLE"
                        + ",RowsToBatch;Antall &rader i resultatsett¤enable"
                        ,"maxborder").                  /* Misc - enable, maxborder.. */
...
DEF VAR cPrescanProfil    AS CHAR NO-UNDO.
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF cbGrunnsortiment:SCREEN-VALUE <> ? THEN 
