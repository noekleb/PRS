...
&Scoped-Define ENABLED-OBJECTS fiBelopKredit edNotat Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS fiBelopKredit edNotat fiNotatTekst 
...
DEFINE VARIABLE edNotat AS CHARACTER 
     ...
     SIZE 58 BY 3.1 TOOLTIP "Notatet blir skrevet up på kreditnota" NO-UNDO.
...
DEFINE FRAME Dialog-Frame
     fiBelopKredit AT ROW 1.67 COL 23.2 COLON-ALIGNED
     edNotat AT ROW 4 COL 2 NO-LABEL
     Btn_OK AT ROW 7.38 COL 29.2
     Btn_Cancel AT ROW 7.38 COL 45.2
     fiNotatTekst AT ROW 3.19 COL 2.4
     SPACE(47.99) SKIP(5.32)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Registrer kreditnota"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Registrer kreditnota */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fiBelopKredit edNotat fiNotatTekst 
      WITH FRAME Dialog-Frame.
  ENABLE fiBelopKredit edNotat Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
