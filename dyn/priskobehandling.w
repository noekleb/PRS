...
mva%_ArtPris Pris_ArtPris LevNr Vg 
...
DEFINE FRAME DEFAULT-FRAME
     lblHeader AT ROW 6.95 COL 132 COLON-ALIGNED NO-LABEL
     behStatus AT ROW 2.43 COL 8 COLON-ALIGNED
     behType AT ROW 3.43 COL 8 COLON-ALIGNED
     btnCalFraDato AT ROW 2.43 COL 148
     tbAvvikPris AT ROW 4.57 COL 83
     tbAvvikArtInfo AT ROW 5.29 COL 83
     btnCalTilDato AT ROW 2.43 COL 166
     VareTekst AT ROW 2.43 COL 81 COLON-ALIGNED
     Levkod AT ROW 3.38 COL 81 COLON-ALIGNED
     fraAktiveresDato AT ROW 2.43 COL 132 COLON-ALIGNED
     tilAktiveresDato AT ROW 2.43 COL 150 COLON-ALIGNED NO-LABEL
     SaSong AT ROW 4.38 COL 51 COLON-ALIGNED
     OrgPris AT ROW 7.91 COL 149 COLON-ALIGNED
     OrgGyldigTilDato AT ROW 8.86 COL 149 COLON-ALIGNED
     OrgDB% AT ROW 9.81 COL 149 COLON-ALIGNED
     btnSaSong AT ROW 4.48 COL 65 NO-TAB-STOP 
     OrgAktiveresDato AT ROW 10.76 COL 149 COLON-ALIGNED
     btnStartUtvalg AT ROW 5.05 COL 157 NO-TAB-STOP 
     lblHeader-2 AT ROW 13.62 COL 132 COLON-ALIGNED NO-LABEL
     Innkjopspris_ArtPris AT ROW 14.33 COL 149 COLON-ALIGNED
     DB%_ArtPris AT ROW 17.24 COL 149 COLON-ALIGNED
     Rab1%_ArtPris AT ROW 15.29 COL 149 COLON-ALIGNED
     varekost_ArtPris AT ROW 16.24 COL 149 COLON-ALIGNED
     mva%_ArtPris AT ROW 18.19 COL 149 COLON-ALIGNED
     Pris_ArtPris AT ROW 19.19 COL 149 COLON-ALIGNED
     LevNr AT ROW 2.43 COL 51 COLON-ALIGNED
     btnLevNr AT ROW 2.43 COL 65 NO-TAB-STOP 
     Vg AT ROW 3.43 COL 51 COLON-ALIGNED
     btnVg AT ROW 3.43 COL 65 NO-TAB-STOP 
     rectBrowse AT ROW 7.19 COL 2.2
     rectToolBar AT ROW 1.24 COL 2
     searchField AT ROW 6.24 COL 2
     rectView AT ROW 7.19 COL 132
     rectWinToolbar AT ROW 1.24 COL 169.2
     rectView-2 AT ROW 13.86 COL 132
...
ON END-ERROR OF C-Win /* Priskøbehandling */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Priskøbehandling */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE behStatus behType btnCalFraDato tbAvvikPris tbAvvikArtInfo 
         ...
         rectToolBar searchField rectView rectWinToolbar rectView-2 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
