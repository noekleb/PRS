...
DEFINE VARIABLE UnderKatTekst AS CHARACTER FORMAT "X(256)":U 
     LABEL "Underkat.navn" 
     VIEW-AS FILL-IN 
     SIZE 40 BY 1 NO-UNDO.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "Underkategori"
                    + ";UnderKatNr;UnderKatTekst;RegistrertTid;!RegistrertDato;!RegistrertAv;!ETid;!EDato;!BrukerID"
                   ,"WHERE true"
                    ,"sort|UnderKatNr").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "UnderKatNr,UnderKatTekst",   /* Update columns in buffer */
