...
&Scoped-Define DISPLAYED-OBJECTS fi-cPassord 
...
DEFINE FRAME Dialog-Frame
     ...
     "artikler fra en varebok som er generert" VIEW-AS TEXT
          SIZE 46 BY .95 AT ROW 4.57 COL 11
          FONT 6
     "for ordreregistrering" VIEW-AS TEXT
          SIZE 25 BY .95 AT ROW 5.57 COL 11
          FONT 6
     "Du har valgt å slette" VIEW-AS TEXT
          SIZE 44 BY 1.19 AT ROW 2.43 COL 11
          FONT 8
     SPACE(10.19) SKIP(9.66)
