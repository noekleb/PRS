...
SysHId Beskrivelse Hjelpetekst 
&Scoped-Define DISPLAYED-OBJECTS SysHId Beskrivelse Hjelpetekst 
...
DEFINE VARIABLE Hjelpetekst AS CHARACTER FORMAT "X(50)" 
     LABEL "Hjelpetekst" 
     VIEW-AS FILL-IN 
     SIZE 43 BY 1 TOOLTIP "Hjelpetekst".
...
DEFINE FRAME DEFAULT-FRAME
     SysHId AT ROW 3.14 COL 67 COLON-ALIGNED
     Beskrivelse AT ROW 4.14 COL 67 COLON-ALIGNED
     Hjelpetekst AT ROW 5.14 COL 67 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY SysHId Beskrivelse Hjelpetekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectToolbar rectBrowse rectSearchField SysHId Beskrivelse Hjelpetekst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",
                             ...
                             ,"WHERE false",
                             "SysHid").
  DYNAMIC-FUNCTION("setSortString",hBrowse,"SysHid"). 
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "SysHId,Beskrivelse,Hjelpetekst",   /* Update columns in buffer */
