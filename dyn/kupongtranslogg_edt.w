...
&Scoped-Define ENABLED-OBJECTS btnAvregnet rectToolBar rectWinToolbar ~
KTLoggId b_id Salgsdato avregnet btnSalgsdato 
&Scoped-Define DISPLAYED-OBJECTS KTLoggId b_id Salgsdato avregnet 
...
DEFINE BUTTON btnAvregnet 
     IMAGE-UP FILE "gif/calendar.gif":U NO-FOCUS FLAT-BUTTON
     LABEL "..." 
     SIZE 4.4 BY 1.

DEFINE BUTTON btnSalgsdato 
     IMAGE-UP FILE "gif/calendar.gif":U NO-FOCUS FLAT-BUTTON
     LABEL "..." 
     SIZE 4.4 BY 1.

DEFINE VARIABLE avregnet AS DATE FORMAT "99/99/9999":U 
     LABEL "Avregnet" 
     VIEW-AS FILL-IN 
     SIZE 16 BY 1 NO-UNDO.

DEFINE VARIABLE b_id AS DECIMAL FORMAT "->>,>>9.99":U INITIAL 0 
     LABEL "Bilagsid" 
     VIEW-AS FILL-IN 
     SIZE 23 BY 1 NO-UNDO.

DEFINE VARIABLE KTLoggId AS DECIMAL FORMAT "->>,>>9.99":U INITIAL 0 
     LABEL "Trans.logg Id" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE Salgsdato AS DATE FORMAT "99/99/9999":U 
     LABEL "Salgsdato" 
     VIEW-AS FILL-IN 
     SIZE 16 BY 1 NO-UNDO.
...
DEFINE FRAME DEFAULT-FRAME
     btnAvregnet AT ROW 6.24 COL 44 NO-TAB-STOP 
     KTLoggId AT ROW 2.91 COL 26 COLON-ALIGNED
     b_id AT ROW 4.33 COL 26 COLON-ALIGNED
     Salgsdato AT ROW 5.29 COL 26 COLON-ALIGNED
     avregnet AT ROW 6.24 COL 26 COLON-ALIGNED
     btnSalgsdato AT ROW 5.29 COL 44 NO-TAB-STOP 
...
&Scoped-define SELF-NAME btnAvregnet
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnAvregnet C-Win
ON CHOOSE OF btnAvregnet IN FRAME DEFAULT-FRAME /* ... */
OR "F10" OF btnAvregnet
DO:
  RUN Cal.w (Avregnet:HANDLE).
END.
...
&Scoped-define SELF-NAME btnSalgsdato
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnSalgsdato C-Win
ON CHOOSE OF btnSalgsdato IN FRAME DEFAULT-FRAME /* ... */
OR "F10" OF btnSalgsdato
DO:
  RUN Cal.w (SalgsDato:HANDLE).
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  IF SOURCE-PROCEDURE:FILE-NAME MATCHES "*kupongtranslogg*" THEN 
...
------------------------------------------------------------------------------*/
  DISPLAY KTLoggId b_id Salgsdato avregnet 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btnAvregnet rectToolBar rectWinToolbar KTLoggId b_id Salgsdato 
         avregnet btnSalgsdato 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
/*                                                        Any number of properties accepted (one ok - if predef. action) */      */
  ...
  DYNAMIC-FUNCTION("setToolbar",DYNAMIC-FUNCTION("getLinkedObject",hParentBrowse,"toolbar","from"),"disable").
  
  DYNAMIC-FUNCTION("CreateObjectLink",hFieldMap,hToolbar).
  DYNAMIC-FUNCTION("CreateObjectLink",hParentBrowse,hToolbar).
  ...
  APPLY "value-changed" TO hParentBrowse.
...
APPLY "entry" TO b_id IN FRAME {&FRAME-NAME}.
END PROCEDURE.
