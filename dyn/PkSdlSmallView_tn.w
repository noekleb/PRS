...
&Scoped-Define ENABLED-OBJECTS PkSdlNr SendtDato EkstId SumFrakt ~
fiMerknadLabel CL ButNamn levnr levnamn cRegTid Merknad MeldingFraLev ~
cOrdreNrList RegistrertAv RegistrertDato fiMeldingLabel PkSdlId btnlevnr ~
TBPkSdlHode 
&Scoped-Define DISPLAYED-OBJECTS PkSdlNr SendtDato PkSdlStatus EkstId ~
...
DEFINE FRAME DEFAULT-FRAME
     ...
     fiMerknadLabel AT ROW 10.91 COL 5.4 COLON-ALIGNED NO-LABEL
     ...
     cRegTid AT ROW 17.48 COL 31.4 COLON-ALIGNED NO-LABEL
     Merknad AT ROW 10.86 COL 17 NO-LABEL
     MeldingFraLev AT ROW 13.33 COL 17 NO-LABEL
     cOrdreNrList AT ROW 8.43 COL 15 COLON-ALIGNED
     RegistrertAv AT ROW 17.48 COL 44 COLON-ALIGNED HELP
          "Brukerid på den som registrerte posten"
     RegistrertDato AT ROW 17.48 COL 15 COLON-ALIGNED HELP
          "Dato da posten ble registrert i registeret"
     fiMeldingLabel AT ROW 13.43 COL 2 NO-LABEL
...
------------------------------------------------------------------------------*/
  DISPLAY PkSdlNr SendtDato PkSdlStatus EkstId SumFrakt fiMerknadLabel CL 
  ...
  ENABLE PkSdlNr SendtDato EkstId SumFrakt fiMerknadLabel CL ButNamn levnr 
         levnamn cRegTid Merknad MeldingFraLev cOrdreNrList RegistrertAv 
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",
                            ...
                            "",
                            "PkSdlId,RegistrertAv,RegistrertDato,ButNamn,cOrdreNrList,cRegTid",
                            "",
                            ""
                            ).
