...
&Scoped-Define ENABLED-OBJECTS btnFilOmr fiKatalog tbFormat selUtvalg ~
fiUtvalgLabel 
&Scoped-Define DISPLAYED-OBJECTS fiKatalog tbFormat selUtvalg fiUtvalgLabel 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD getUtvalg C-Win 
FUNCTION getUtvalg RETURNS CHARACTER
  ( /* parameter-definitions */ )  FORWARD.
...
DEFINE VARIABLE fiUtvalgLabel AS CHARACTER FORMAT "X(256)":U INITIAL "Utvalg:" 
      VIEW-AS TEXT 
     SIZE 6.8 BY .62 NO-UNDO.

DEFINE VARIABLE selUtvalg AS CHARACTER 
     VIEW-AS SELECTION-LIST SINGLE SCROLLBAR-VERTICAL 
     SIZE 71.6 BY 3.48 NO-UNDO.
...
DEFINE FRAME frmUtvalg
     ...
     selUtvalg AT ROW 3.1 COL 14.2 NO-LABEL
     fiUtvalgLabel AT ROW 3.1 COL 7 NO-LABEL
...
/* SETTINGS FOR FRAME frmUtvalg
   FRAME-NAME                                                           */
/* SETTINGS FOR FILL-IN fiUtvalgLabel IN FRAME frmUtvalg
   ALIGN-L                                                              */
...
------------------------------------------------------------------------------*/
  DISPLAY fiKatalog tbFormat selUtvalg fiUtvalgLabel 
      WITH FRAME frmUtvalg.
  ENABLE btnFilOmr fiKatalog tbFormat selUtvalg fiUtvalgLabel 
      WITH FRAME frmUtvalg.
...
ASSIGN hBrowse     = ihBrowse
       ...
       selUtvalg:DELIMITER IN FRAME frmUtvalg = "|"
       selUtvalg:LIST-ITEM-PAIRS = "Alle leveringsmåter|0|Lagerførte varer (kjeldevarer)|1|Gjennomfaktureres|2|Lagerført eller gj.fakt (kontroll mot alle lev.måter)|3"
       .

DYNAMIC-FUNCTION("setNoResizeX",THIS-PROCEDURE:CURRENT-WINDOW,FRAME frmUtvalg:HANDLE,"selUtvalg").
DYNAMIC-FUNCTION("setNoResizeY",THIS-PROCEDURE:CURRENT-WINDOW,FRAME frmUtvalg:HANDLE,"selUtvalg,frmUtvalg").
DYNAMIC-FUNCTION("setNoMoveY",THIS-PROCEDURE:CURRENT-WINDOW,FRAME frmUtvalg:HANDLE,"selUtvalg,fiKatalog,btnFilOmr,fiUtvalgLabel").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION getUtvalg C-Win 
FUNCTION getUtvalg RETURNS CHARACTER
  ( /* parameter-definitions */ ) :
/*------------------------------------------------------------------------------
  Purpose:  
...
RETURN selUtvalg:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
