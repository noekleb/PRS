...
DO:
  RUN KampanjeMixMatch.w PERSISTENT SET hChild.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "KampanjeTilbud"
                    + ";!KampId;KampTilbId;!HapHourId"
                    + ";KampTilbNavn"
                   + ",KampanjeMixMatch"
                    + ";KampId;KampNavn"
                   ,"WHERE FALSE" 
                   + " ,FIRST KampanjeMixMatch OF KampanjeTilbud NO-LOCK"
  ...
  hToolbar = DYNAMIC-FUNCTION("NewToolBar",
                    ...
                    ""
                    + "excel;Eksporter til E&xcel,flatview,BrowseConfig" /* Buttons / Menu items: action;label;tooltip;Method;image,action;label.. 
