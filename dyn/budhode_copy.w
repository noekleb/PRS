...
DEF VAR ipSBudId     AS INT    NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS Aar SBudId SBudBeskrivelse ButikkNr ~
SBudNotat BtnOK BtnCancel AarFra ButikkNrFra RECT-57 RECT-58 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-2 Aar SBudId SBudBeskrivelse ~
ButikkNr SBudNotat AarFra ButikkNrFra FILL-IN-3 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     SBudId AT ROW 1.57 COL 13 COLON-ALIGNED
     SBudBeskrivelse AT ROW 1.57 COL 27 COLON-ALIGNED NO-LABEL
     ButikkNr AT ROW 3.81 COL 60.8 COLON-ALIGNED
     SBudNotat AT ROW 6.95 COL 2 NO-LABEL
...
ON END-ERROR OF C-Win /* Kopier budsjett */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Kopier budsjett */
DO:
...
/*        VIEW-AS ALERT-BOX INFO BUTTONS OK.             */
  ...
  END.
  ELSE DO:
      bOK = DYNAMIC-FUNCTION("RunProc","sbudhode_copy.p",
                             hFieldMap:BUFFER-FIELD('SBudId'):BUFFER-VALUE + '|' + STRING(ipSBudId),
                             ?).
  END.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-2 Aar SBudId SBudBeskrivelse ButikkNr SBudNotat AarFra 
          ButikkNrFra FILL-IN-3 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE Aar SBudId SBudBeskrivelse ButikkNr SBudNotat BtnOK BtnCancel AarFra 
...
/*     iDefaultButikkNr = IF iDefaultButikkNr = 0 THEN 1 ELSE iDefaultButikkNr                                                                      */
  ...
  .
  ASSIGN
  cButikkLst = DYNAMIC-FUNCTION("getFieldList","butiker;butik|butnamn;butik,butikktilgang"
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",
                             ...
                             "SBudId,SBudBeskrivelse,ButikkNr,Aar,SBudNotat",""
                             ,"",""
                             ,"").
...
DO WITH FRAME {&FRAME-NAME}:
    ASSIGN
        SBudBeskrivelse:SCREEN-VALUE = ENTRY(4,cPara,'|')
        ...
        ipSBudId                     = INT(ENTRY(1,cPara,'|'))
        SBudNotat:SCREEN-VALUE       = 'Kopi av budsjett ' + STRING(ipSBudId) + ' ' + 
