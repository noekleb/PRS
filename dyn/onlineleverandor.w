...
OnLineLevNr OnLineLevBeskr 
&Scoped-Define DISPLAYED-OBJECTS OnLineLevNr OnLineLevBeskr 
...
DEFINE VARIABLE OnLineLevBeskr AS CHARACTER FORMAT "X(256)":U 
     LABEL "Beskrivelse" 
     VIEW-AS FILL-IN 
     SIZE 40 BY 1 NO-UNDO.

DEFINE VARIABLE OnLineLevNr AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "OnLine levnr" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     OnLineLevNr AT ROW 2.67 COL 52.2 COLON-ALIGNED
     OnLineLevBeskr AT ROW 3.71 COL 52.2 COLON-ALIGNED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "OnLinje leverandør register"
         HEIGHT             = 16.1
         WIDTH              = 94.8
         MAX-HEIGHT         = 57.14
         MAX-WIDTH          = 320
...
ON END-ERROR OF C-Win /* OnLinje leverandør register */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* OnLinje leverandør register */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* OnLinje leverandør register */
DO:
...
------------------------------------------------------------------------------*/
  ...
  RUN SUPER.
  OnLineLevNr:SENSITIVE IN FRAME {&FRAME-NAME} =  DYNAMIC-FUNCTION('getToolbarState',hToolbar) = 'New'.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  DISPLAY OnLineLevNr OnLineLevBeskr 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar OnLineLevNr OnLineLevBeskr 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "OnLineLeverandor"
                    + ";OnLineLevNr;OnLineLevBeskr;RegistrertDato|Registrert;!RegistrertTid;!RegistrertAv;EDato|Endret;!ETid;BrukerID|Endret av"
                   ,"WHERE true"
                    ,"sort|OnLineLevNr").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "OnLineLevBeskr",   /* Update columns in buffer */
                      "",                           /* Corresponding input fields (fill-in..). blank if equal to update columns */
                    "OnLineLevNr",        /* Additional buffer and displ.fields - not updateable*/
