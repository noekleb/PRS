...
DEF VAR hfiVareKode     AS HANDLE NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS btnGyldigFra rectBrowse rectToolBar ~
rectWinToolbar rectToolBar-2 rectBrowse-2 kupongid KTypeNr Aktiv IdKrav ~
TaVarePaKupong EANKode InterleaveKode KupBeskrivelse GyldigFra GyldigTil ~
SisteInnlDato Belop MinBelop btnSisteInnlDato MaksBelop RabattVerdi ~
btnGyldigTil 
&Scoped-Define DISPLAYED-OBJECTS kupongid KTypeNr Aktiv IdKrav ~
TaVarePaKupong EANKode InterleaveKode KupBeskrivelse GyldigFra GyldigTil ~
SisteInnlDato Belop MinBelop MaksBelop RabattVerdi 
...
DEFINE VARIABLE kupongid AS DECIMAL FORMAT "->>,>>9.99":U INITIAL 0 
     LABEL "Kupong id" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     kupongid AT ROW 2.43 COL 63 COLON-ALIGNED
     ...
     rectWinToolbar AT ROW 1.14 COL 102.6
     rectToolBar-2 AT ROW 16.95 COL 49
     rectBrowse-2 AT ROW 18.14 COL 49
...
------------------------------------------------------------------------------*/
  DISPLAY kupongid KTypeNr Aktiv IdKrav TaVarePaKupong EANKode InterleaveKode 
          ...
          MaksBelop RabattVerdi 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btnGyldigFra rectBrowse rectToolBar rectWinToolbar rectToolBar-2 
         rectBrowse-2 kupongid KTypeNr Aktiv IdKrav TaVarePaKupong EANKode 
         InterleaveKode KupBeskrivelse GyldigFra GyldigTil SisteInnlDato Belop 
         MinBelop btnSisteInnlDato MaksBelop RabattVerdi btnGyldigTil 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
/*                                                                                                                                          */
  hfiVareKode = DYNAMIC-FUNCTION("NewBrowseFillIn",
                    hBrowse2,          
                    "KupVareKode",     
                    "KupVareKode",     
                    "","","","").                

  DYNAMIC-FUNCTION("CreateOverlayLink",hBrowse2,hfiVareKode,"kupVareKode").
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    hBrowse:QUERY,
                    FRAME {&FRAME-NAME}:HANDLE,     /* Frame for the input/display fields (might not be the same frame as the browse) */
                      "KTypeNr,Aktiv,IdKrav,TaVarePaKupong,EANKode,InterleaveKode,KupBeskrivelse,GyldigFra,GyldigTil,SisteInnlDato,Belop,MinBelop,MaksBelop,RabattVerdi",
                      "",                           /* Corresponding input fields (fill-in..). blank if equal to update columns */
...
------------------------------------------------------------------------------*/
  DO WITH FRAME {&FRAME-NAME}:      
    ...
    DYNAMIC-FUNCTION("setNoResizeX", THIS-PROCEDURE:CURRENT-WINDOW, FRAME {&FRAME-NAME}:HANDLE, "brwKVK").
