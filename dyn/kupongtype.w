...
KTypeNr KTypeNavn KTypeKode KTypeBeskrivelse 
&Scoped-Define DISPLAYED-OBJECTS KTypeNr KTypeNavn KTypeKode ~
KTypeBeskrivelse lblBeskrivelse 
...
DEFINE VARIABLE KTypeBeskrivelse AS CHARACTER 
     VIEW-AS EDITOR SCROLLBAR-VERTICAL
     SIZE 40 BY 13.33 NO-UNDO.

DEFINE VARIABLE KTypeKode AS CHARACTER FORMAT "X(2)" 
     LABEL "KType kode" 
     VIEW-AS FILL-IN 
     SIZE 6.4 BY 1.

DEFINE VARIABLE KTypeNavn AS CHARACTER FORMAT "X(256)":U 
     LABEL "Navn" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE lblBeskrivelse AS CHARACTER FORMAT "X(256)":U INITIAL "Beskrivelse:" 
      VIEW-AS TEXT 
...
DEFINE FRAME DEFAULT-FRAME
     KTypeNr AT ROW 2.67 COL 65 COLON-ALIGNED
     KTypeNavn AT ROW 3.76 COL 65 COLON-ALIGNED
     KTypeKode AT ROW 4.81 COL 65 COLON-ALIGNED HELP
          "Kupong type kode"
     KTypeBeskrivelse AT ROW 6 COL 67 NO-LABEL
     lblBeskrivelse AT ROW 5.95 COL 53 COLON-ALIGNED NO-LABEL
     rectBrowse AT ROW 2.43 COL 2
     rectToolBar AT ROW 1.14 COL 1.8
     rectWinToolbar AT ROW 1.14 COL 96.2
     RECT-1 AT ROW 2.43 COL 53
...
/* SETTINGS FOR FILL-IN lblBeskrivelse IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
ASSIGN 
       lblBeskrivelse:READ-ONLY IN FRAME DEFAULT-FRAME        = TRUE.
...
ON END-ERROR OF C-Win /* Kupongtype register */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Kupongtype register */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Kupongtype register */
DO:
...
&Scoped-define SELF-NAME KTypeKode
&UNDEFINE SELF-NAME
...
------------------------------------------------------------------------------*/
  DISPLAY KTypeNr KTypeNavn KTypeKode KTypeBeskrivelse lblBeskrivelse 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar RECT-1 KTypeNr KTypeNavn 
         KTypeKode KTypeBeskrivelse 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "KupongType"
                    + ";KTypeNr;KTypeKode|KtK;KTypeNavn;KTypeBeskrivelse;RegistrertTid;!RegistrertDato;!RegistrertAv;!ETid;!EDato;!BrukerID"
                   ,"WHERE true"
                    ,"sort|KTypeNr").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "KTypeNavn,KTypeKode,KTypeBeskrivelse",   /* Update columns in buffer */
                      "",                           /* Corresponding input fields (fill-in..). blank if equal to update columns */
                      "KTypeNr",        /* Additional buffer and displ.fields - not updateable*/
