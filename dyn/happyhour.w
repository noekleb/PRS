...
&Scoped-Define ENABLED-OBJECTS HapHourId HapHourNavn HapHourNotat ~
rectBrowse rectWinToolbar rectFolder rectFieldMap rectToolbar searchField 
&Scoped-Define DISPLAYED-OBJECTS lblNotat HapHourId HapHourNavn ~
HapHourNotat 
...
DEFINE VARIABLE HapHourNotat AS CHARACTER 
     VIEW-AS EDITOR SCROLLBAR-VERTICAL
     SIZE 56 BY 4.48 NO-UNDO.

DEFINE VARIABLE HapHourId AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Id" 
     VIEW-AS FILL-IN 
     SIZE 18 BY 1 NO-UNDO.

DEFINE VARIABLE HapHourNavn AS CHARACTER FORMAT "X(256)":U 
     LABEL "Navn" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     lblNotat AT ROW 4.57 COL 43.6 COLON-ALIGNED NO-LABEL 
     HapHourId AT ROW 2.67 COL 50 COLON-ALIGNED
     HapHourNavn AT ROW 3.62 COL 50 COLON-ALIGNED
     HapHourNotat AT ROW 4.62 COL 52 NO-LABEL
     rectBrowse AT ROW 2.43 COL 1
     rectWinToolbar AT ROW 1.14 COL 98.6
     rectFolder AT ROW 9.33 COL 42
     rectFieldMap AT ROW 2.43 COL 42
...
DEFINE FRAME frSplitBarX
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 29.2 ROW 2.67
         SCROLLABLE SIZE 23 BY 22.38.
...
/* SETTINGS FOR FRAME frSplitBarX
                                                                        */
ASSIGN 
       FRAME frSplitBarX:HEIGHT           = 22.38
       FRAME frSplitBarX:WIDTH            = 23.
...
ON END-ERROR OF C-Win /* Happy hour register */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Happy hour register */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Happy hour register */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY lblNotat HapHourId HapHourNavn HapHourNotat 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE HapHourId HapHourNavn HapHourNotat rectBrowse rectWinToolbar 
         rectFolder rectFieldMap rectToolbar searchField 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
  DO WITH FRAME {&FRAME-NAME}:
    ...
    hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                      ...
                      "HappyHourHode"
                      + ";HapHourId;HapHourNavn;!HapHourNotat" 
                      + ";!RegistrertTid;!RegistrertDato;!RegistrertAv;!ETid;!EDato;!BrukerID"
                     ,"WHERE true"
                      ,"sort|HapHourId").             /* Initial sort column */
/*     hBrowse:GET-BROWSE-COLUM(1):FORMAT = '>>>>>>>9'. */
    ...
    hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                      ...
                      "HapHourNavn,HapHourNotat",   /* Update columns in buffer */
                        "",                           /* Corresponding input fields (fill-in..). blank if equal to update columns */
                        "HapHourId",        /* Additional buffer and displ.fields - not updateable*/
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  DYNAMIC-FUNCTION("InitPages" IN hTabFolder,"Perioder|HappyHourPeriodeBrw.w|Kampanjer|HappyHourKampanjerBrw.w",hBrowse). 
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  DYNAMIC-FUNCTION("setNoResizeY", THIS-PROCEDURE:CURRENT-WINDOW, FRAME {&FRAME-NAME}:HANDLE, "rectToolbar,HapHourNotat").
...
DYNAMIC-FUNCTION("CreateParentLink",hCurrTabQuery,hBrowse,"HapHourId").
