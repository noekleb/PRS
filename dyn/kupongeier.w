...
KEierNr KENavn 
&Scoped-Define DISPLAYED-OBJECTS KEierNr KENavn 
...
DEFINE VARIABLE KEierNr AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Eier nr" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE KENavn AS CHARACTER FORMAT "X(256)":U 
     LABEL "Navn" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     KEierNr AT ROW 2.67 COL 50 COLON-ALIGNED
     KENavn AT ROW 3.76 COL 50 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  RUN SUPER.
  KEierNr:SENSITIVE IN FRAME {&FRAME-NAME} =  DYNAMIC-FUNCTION('getToolbarState',hToolbar) = 'New'.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  DISPLAY KEierNr KENavn 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar KEierNr KENavn 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "KupongEier"
                    + ";KEierNr;KENavn;RegistrertTid;!RegistrertDato;!RegistrertAv;!ETid;!EDato;!BrukerID"
                   ,"WHERE true"
                    ,"sort|KEierNr").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "KEierNr,KENavn",   /* Update columns in buffer */
