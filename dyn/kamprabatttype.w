...
KampRabattTypeId KampRabattTypeNavn 
&Scoped-Define DISPLAYED-OBJECTS KampRabattTypeId KampRabattTypeNavn 
...
DEFINE VARIABLE KampRabattTypeId AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Id" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE KampRabattTypeNavn AS CHARACTER FORMAT "X(256)":U 
     LABEL "Navn" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     KampRabattTypeId AT ROW 2.67 COL 50 COLON-ALIGNED 
     KampRabattTypeNavn AT ROW 3.76 COL 50 COLON-ALIGNED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Kampanje rabatttype register"
         HEIGHT             = 16
         WIDTH              = 93
         MAX-HEIGHT         = 57.14
         MAX-WIDTH          = 320
...
ON END-ERROR OF C-Win /* Kampanje rabatttype register */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Kampanje rabatttype register */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Kampanje rabatttype register */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY KampRabattTypeId KampRabattTypeNavn 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectWinToolbar KampRabattTypeId 
         KampRabattTypeNavn 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "KampRabattType"
                    + ";KampRabattTypeId;KampRabattTypeNavn;!RegistrertTid;!RegistrertDato;!RegistrertAv;!ETid;!EDato;!BrukerID"
                   ,"WHERE true"
                    ,"sort|KampRabattTypeId").             /* Initial sort column */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "KampRabattTypeNavn",   /* Update columns in buffer */
                    "",     /* Corresponding input fields (fill-in..). blank if equal to update columns */
                      "KampRabattTypeId",        /* Additional buffer and displ.fields - not updateable*/
