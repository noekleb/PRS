...
DEFINE FRAME DEFAULT-FRAME
     ...
     rectWinToolbar AT ROW 1.14 COL 98.4
...
ON END-ERROR OF C-Win /* Nekade plock */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Nekade plock */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Nekade plock */
DO:
...
/* cWhere = "WHERE KOrdre_Id = " + STRING(dKOrdre_Id) + " AND KOrdreLinjeNr = " + STRING(iKOrdreLinjeNr) +  " BY plockdatetime". */
/* MESSAGE cWhere SKIP                                                                                                           */
    cWhere = "WHERE KOrdre_Id = 1150000019 AND KOrdreLinjeNr = 10 BY plockdatetime".
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          
                    ...
                    100,                           
                    "",                            
                    "KOrdreLinjeRejectPlock;KOrdreLinjeNr;KOrdre_Id;plockdatetime; plockstatus;PlukkButikk;Storl",        
                             
                    cWhere, 
/*                     "WHERE KOrdre_Id = 1150000019 AND KOrdreLinjeNr = 10 BY plockdatetime", */
/*                     "WHERE KOrdre_Id = '" + STRING(dKOrdre_Id) + "'AND KOrdreLinjeNr = '" + STRING(iKOrdreLinjeNr) + "' BY plockdatetime", */
                    "").                    
  hBrowse:NAME = "brwKOrdreLinjeRejectPlock". 
