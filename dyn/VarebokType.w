...
VarebokType BeskrivelseVarebokType RegistrertDato RegistrertAv EDato ~
BrukerID 
&Scoped-Define DISPLAYED-OBJECTS VarebokType BeskrivelseVarebokType ~
...
DEFINE FRAME DEFAULT-FRAME
     VarebokType AT ROW 3.57 COL 53.2 COLON-ALIGNED HELP
          "VarebokType"
     BeskrivelseVarebokType AT ROW 4.62 COL 53.2 COLON-ALIGNED HELP
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Vedlikehold Vareboktyper"
         HEIGHT             = 16
         WIDTH              = 93
         MAX-HEIGHT         = 57.14
         MAX-WIDTH          = 320
...
ON END-ERROR OF C-Win /* Vedlikehold Vareboktyper */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Vedlikehold Vareboktyper */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Vedlikehold Vareboktyper */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY VarebokType BeskrivelseVarebokType RegistrertDato RegistrertAv EDato 
          BrukerID 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rectBrowse rectToolBar rectSearchField VarebokType 
         BeskrivelseVarebokType RegistrertDato RegistrertAv EDato BrukerID 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
DO WITH FRAME {&FRAME-NAME}:
  hBrowse = DYNAMIC-FUNCTION("NewBrowse",          /* Create a browse object */
                    ...
                    "VarebokType;VarebokType|Type;BeskrivelseVarebokType;!RegistrertAv;!RegistrertDato;!BrukerID;!EDato",    /* Buffers and fields: <buffer1>;<field1>;<field2>..,<buffer2>;.. No fields gives all*/
                    "WHERE true", 
                    "sort|VarebokType").                   /* Misc - for something I might need in next version.. */
  hBrowse:NAME = "brwVarebokType". /* This name is neccessary because the browser is due to special treatment during resize */
  ...
  hFieldMap = DYNAMIC-FUNCTION("NewFieldMap",      /* A fieldmap object holds extra info for display and input fields (fill-ins) 
                    ...
                    "BeskrivelseVarebokType",          /* Update columns in buffer */
                    "",                             /* Corresponding input fields (fill-in..)*/
                    "RegistrertAv,RegistrertDato,BrukerID,EDato,VarebokType",
                    "",                             /* Additional buffer and displ.fields - not updateable*/
                    "").                            /* Misc - for something I might need in next version.. */
  DYNAMIC-FUNCTION("setAttribute",hFieldMap,"customCreateProc","create_vareboktype.p").
