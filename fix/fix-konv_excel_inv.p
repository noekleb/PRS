...
ASSIGN
    iButNr     = 4
    cOrgRecord = ";@ArtikkelNr;@Antall;'2016-11-29 13:34:05.001';@ButNr;@EAN;System;86,24;are;@ButNr;7"
    cFil       = 'konv\Varetelling_Dame_2017_Des.csv'
    cUtFil     = 'konv\INV' + REPLACE(STRING(TODAY,"99/99/9999"),'/','')  + '.' + STRING(iButNr)
    .
