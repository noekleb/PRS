...
FOR EACH VareBehLinjeTHode EXCLUSIVE-LOCK WHERE
    VareBehLinjeTHode.VareBehNr = 9000008 AND
    VareBehLinjeTHode.ButikkNr = 603:
    ...
    FOR EACH VareBehLinjeTrans OF VareBehLinjeTHode EXCLUSIVE-LOCK WHERE
        (VareBehLinjeTrans.Bestilt1 + 
             ...
             VareBehLinjeTrans.Bestilt4) > 0 AND
        CAN-FIND(VarebokLinje WHERE
                 VareBokLinje.VareBokNr = 9000013 AND
                 VareBokLinje.ArtikkelNr = VareBehLinjeTrans.ArtikkelNr):

        FIND bufVareBehLinjeTrans EXCLUSIVE-LOCK WHERE
            bufVareBehLinjeTrans.VareBehNr  = 9000009 AND
        ...
        ASSIGN
            VareBehLinjeTrans.VareBehNr = 9000009 NO-ERROR.
        
    END.
    /*
    ASSIGN
        VarebehLinjeTHode.VareBehNr = 9000009 NO-ERROR.
    */
END.
