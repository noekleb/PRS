...
/*                ant        = int(ENTRY(12,cString,";")) */
               levpris    = deci(ENTRY(14,cString,";"))
               veilpris    = deci(REPLACE(ENTRY(18,cString,";")," ",""))
                vg         = int(ENTRY(24,cString,";"))
               ntoforh    = deci(ENTRY(26,cString,";"))
               ntoforh    = IF ntoforh = 0 THEN levpris ELSE ntoforh
               utpris     = deci(REPLACE(ENTRY(32,cString,";")," ",""))
               mva        = 24
               levkod     = TRIM(levkod)
