...
DEFINE FRAME DEFAULT-FRAME
     ...
     "" VIEW-AS TEXT
          ...
          BGCOLOR 10 FONT 6
     " Lev VPI Ellte, creation, Kjell" VIEW-AS TEXT
...
/*            FI-AntallE:SCREEN-VALUE = STRING(iAnt).                */
    ...
    END.
    FOR EACH TT_Pricat:
        IF NOT CAN-FIND(strtype WHERE strtype.strtypeid = TT_Pricat.strtype) THEN
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN StrekKode.Kode       = STRING(DECI(TT_Pricat.Ean),"9999999999999")
           ...
           StrekKode.StrKode    = INT(TT_Pricat.Storl)
           StrekKode.KodeType   = 1
           StrekKode.VareId     = TT_Pricat.Modell
           StrekKode.HovedNr    = TT_Pricat.strtype = 2.
