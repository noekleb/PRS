...
ASSIGN
    lVareHNr   = 9000006
    cSep       = CHR(9)
    cFilNavn   = "C:\Appdir\Sport1HK\BergansOrdre27082008\Sport1OrdreBok.txt"
...
REPEAT:
    ...
    ASSIGN
        cTekst    = trim(replace(ENTRY(1,cLinje,cSep),',',' '))
        cTekst2   = entry(1,trim(replace(ENTRY(7,cLinje,cSep),',',' ')),' ')
    ...
    DO TRANSACTION:
        ...
        DO:
            ...
            ASSIGN
                ...
                VareBehLinjeTrans.Kode       = string(Strekkode.StrKode) 
