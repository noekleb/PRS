...
DEFINE VAR ocRetur AS CHARACTER   NO-UNDO.
...
DEF TEMP-TABLE ttt_eksport
    ...
    FIELD cLevAdresse2 AS CHAR FORMAT "x(30)"         
    ...
    FIELD cNotat2 LIKE BestHode.Merknad 
    ...
    FIELD Storl LIKE BestStr.Storl
    FIELD Bestilt LIKE BestStr.Bestilt               
    /* Strekkode */
    FIELD Kode LIKE Strekkode.Kode
    FIELD Bestillingsnummer LIKE Strekkode.Bestillingsnummer
    FIELD VareKost LIKE BestPris.Varekost
    /* VPI informasjon */
    FIELD LopNr LIKE Artbas.LopNr             
    FIELD ABeskr LIKE Artbas.Beskr
    FIELD BongTekst LIKE Artbas.BongTekst
    /* Leverandørinformasjon */
    FIELD ALevNr LIKE Artbas.LevNr             
    FIELD LevNamn LIKE LevBas.LevNamn
    FIELD ALevKod LIKE Artbas.LevKod            
