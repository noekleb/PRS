...
&Scoped-Define ENABLED-OBJECTS RECT-48 RECT-47 T-Batch B-TellOpp B-Start 
...
DEFINE VARIABLE FI-Tittel AS CHARACTER FORMAT "X(256)":U INITIAL "           Fix av Rabatt i statistikkene" 
      VIEW-AS TEXT 
     SIZE 77 BY 1.38
     BGCOLOR 14 FGCOLOR 12 FONT 8 NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Korrigerer rabatt i lager og statistikker"
         HEIGHT             = 16.19
         WIDTH              = 80
         MAX-HEIGHT         = 16.19
         MAX-WIDTH          = 80
...
ON END-ERROR OF C-Win /* Korrigerer rabatt i lager og statistikker */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Korrigerer rabatt i lager og statistikker */
DO:
...
DO:
  ...
  if B-Start:private-data = "OPPDAT" then
    do:
      ...
      run x-fixrab.w persistent set wProgram-Handle (this-procedure:handle, wBatchNr).      
    end.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-48 RECT-47 T-Batch B-TellOpp B-Start 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
