...
FOR EACH BongHode WHERE
    ...
    /* Spesialfix for Lilly Eliasson */
    IF BongHode.KundeKort = '300040' THEN
    DO:
        ASSIGN
            BongHode.KundeKort = '300025'
            BongHode.KundeNr   = 98300025
            BongHode.Medlemskort = '983300025' 
            BongHode.MedlemsNr = 98300046
            .
    END.
