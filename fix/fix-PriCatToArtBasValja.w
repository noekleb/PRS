...
DEFINE FRAME DEFAULT-FRAME
     ...
     " Lev VPI VALJA inga ean" VIEW-AS TEXT
...
DO:
    ...
    REPEAT:
        ...
        ASSIGN modell     = 0
               ...
               veilpris   = deci(REPLACE(ENTRY(14,cString,";")," ",""))
/*                varemerke  = ENTRY(10,cString,";")      */
/*                enh        = ENTRY(11,cString,";")      */
/*                ant        = int(ENTRY(12,cString,";")) */
               levpris    = deci(ENTRY(10,cString,";"))
               vg         = int(ENTRY(20,cString,";"))
               ntoforh    = deci(ENTRY(22,cString,";"))
               utpris     = deci(REPLACE(ENTRY(28,cString,";")," ",""))
               mva        = 24.
    END.
    INPUT CLOSE.
    OUTPUT TO "CLIPBOARD".
    FOR EACH TT_Pricat BREAK BY levkod BY fargekode:
        IF FIRST-OF(TT_Pricat.fargekode) THEN DO:
            PUT UNFORMATTED levkod " " fargekode.
            iAntE = iAntE + 1.
        END.
        PUT UNFORMATTED "-- " levkod " " fargekode SKIP.
    END.
...
/*             ArtBas.ArtikkelNr     = TT_Pricat.modell */
         ...
         ArtBas.AnbefaltPris   = IF TT_Pricat.veilpris = 0 THEN 
                  TT_Pricat.utpris ELSE TT_Pricat.veilpris.
