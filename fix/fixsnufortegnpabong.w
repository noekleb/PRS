...
DEFINE FRAME fMain
     ...
     "  Korriger fortegn på bong" VIEW-AS TEXT
          SIZE 49 BY 1.43 AT ROW 1.71 COL 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Snu/korriger fortegn p bongene."
         HEIGHT             = 8.48
         WIDTH              = 73.4
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF wWin /* Snu/korriger fortegn p bongene. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Snu/korriger fortegn p bongene. */
DO:
...
------------------------------------------------------------------------------*/
  DO WITH FRAME {&FRAME-NAME}:
      ...
      ASSIGN
          FI-Status:SCREEN-VALUE = "Snur fortegn på bong."
          .
      PAUSE 1 NO-MESSAGE.
      FOR EACH BongHode NO-LOCK WHERE
          BongHode.Dato >= FI-FraDato AND
          BongHode.Dato <= FI-TilDato:
