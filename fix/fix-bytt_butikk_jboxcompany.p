for each jboxcompany:
display jboxcompany.
  assign
  jboxcompany.iJBoxCompanyId = 456.
  for each jboxcompanyuser of jboxcompany:
    jboxcompanyuser.iJBoxCompanyId = jboxcompany.iJBoxCompanyId.
    display jboxcompanyuser.
  end.
end.

for each jboxcompanyuser where jboxcompany.iJBoxCompanyId <> jboxcompany.iJBoxCompanyId:
  jboxcompanyuser.iJBoxCompanyId = jboxcompany.iJBoxCompanyId.      
end.
