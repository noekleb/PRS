...
DEFINE INPUT PARAMETER plMedlemsNr LIKE Medlem.MedlemsNr NO-UNDO.
...
FOR EACH stLinje EXCLUSIVE where
         StLinje.DataObjekt = STRING(Medlem.MedlemsNr,"9999999999999") AND 
...
MEDTRANS:
FOR EACH Translogg OF Medlem NO-LOCK WHERE 
  TransLogg.Dato >= DATE(1,1,iAar):
