...
ASSIGN
    cFilNavn   = 'C:\ArkivDokument\Kunder\Stensland\Vareeksport 406.csv'
    cUtFilNavn = 'C:\ArkivDokument\Kunder\Stensland\Vareeksport_406_2_vasket.csv'
    cPricatFil = 'C:\ArkivDokument\Kunder\Stensland\VPI010EAN550_2.csv'
    .
...
/*  1 */ ttPriKat.R1              = "R1"
/*  2 */ ttPriKat.LevNr           = '966' 
/*  3 */ ttPriKat.LevModellNr     = TRIM(ENTRY(1,cLinje,';'),'"')
/*  4 */ ttPriKat.EANnr           = pcEAN
/*  5 */ ttPriKat.VareTekst       = TRIM(ENTRY(3,cLinje,';'),'"')
         ttPriKat.Varetekst       = REPLACE(ttPriKat.VareTekst,';',',')
/*  6 */ ttPriKat.FargeKode       = "" /* Farge er ikke i bruk */
/*  7 */ ttPriKat.FargeTekst      = "" /* Settes blank */
/*  8 */ ttPriKat.Str             = ' 1' /*TRIM(ENTRY(6,cLinje,';'),'"')*/
/*  9 */ ttPriKat.StrTab          = "2" /* Størrelsestype 2 */
/* 10 */ ttPriKat.Varemerke       = TRIM(ENTRY(4,cLinje,';'),'"')
/* 11 */ ttPriKat.Enh             = 'Stk'
/* 12 */ ttPriKat.AntIEnh         = '1'
/* 13 */ ttPriKat.LevPrisEngros   = REPLACE(TRIM(ENTRY(9,cLinje,';'),'"'),' ','')
/* 14 */ ttPriKat.ValKod          = "NOK" 
/* 15 */ ttPriKat.forhRab%        = "" 
/* 16 */ ttPriKat.suppRab%        = "" 
/* 17 */ ttPriKat.VeilPris        = REPLACE(TRIM(ENTRY(11,cLinje,';'),'"'),' ','')
/* 18 */ ttPriKat.PAKstru         = "" 
/* 19 */ ttPriKat.LevUke1         = "" 
/* 20 */ ttPriKat.LevUke2         = "" 
/* 21 */ ttPriKat.LevUke3         = "" 
/* 22 */ ttPriKat.LevUke4         = "" 
/* 23 */ ttPriKat.VareGruppe      = '1750' /*TRIM(ENTRY(7,cLinje,';'),'"') */
/* 24 */ ttPriKat.LevNavn         = "" 
/* 25 */ ttPriKat.LevKod          = ""
...
/* 31 */ ttPriKat.BFsupp          = "" 
/* 32 */ ttPriKat.MarkedsPris     = REPLACE(TRIM(ENTRY(11,cLinje,';'),'"'),' ','') 
