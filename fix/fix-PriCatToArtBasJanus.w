...
/*                ant        = int(ENTRY(12,cString,";")) */
               ...
               veilpris    = deci(REPLACE(ENTRY(31,cString,";")," ",""))
...
DO:
    ...
    FOR EACH TT_Pricat BREAK BY levkod BY fargekode BY utpris.
        IF FIRST-OF(utpris) THEN DO:
...
DO:
    ...
    FOR EACH TT_Pricat WHERE utpris = veilpris:
        EXPORT TT_Pricat.
    END.
END.
OUTPUT CLOSE.
