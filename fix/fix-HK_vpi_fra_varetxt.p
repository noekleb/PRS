...
/*   OUTPUT TO C:\DB\AlbertBoe\vareISO_M_LevU.txt. */
  DO WITH FRAME {&FRAME-NAME}:
/*       INPUT FROM VALUE(FI-Varefil:SCREEN-VALUE) CONVERT SOURCE "IBM850" . */
      INPUT FROM VALUE(FI-Varefil:SCREEN-VALUE).
      REPEAT:
          CREATE TT_Vare2.
          IMPORT TT_Vare2 NO-ERROR.
          IF TT_Vare2.LevNr <> 0 THEN DO:
              FIND TT_Vare WHERE TT_Vare.modell = TT_Vare2.modell AND
                  TT_Vare.ean = TT_Vare2.ean.
              IF TT_Vare.LevNr = 0 THEN
                 TT_Vare.LevNr = TT_Vare2.LevNr.
          END.
          DELETE TT_Vare2.
      END.
      INPUT CLOSE.
