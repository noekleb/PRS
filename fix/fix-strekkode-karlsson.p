...
ASSIGN
    cFilNavn = "C:\Appdir\Sykkelpricat komplett 010607.csv"
    cLoggFil = "C:\Appdir\Sykkelpricat komplett 010607.log"
    .
...
REPEAT:
    ...
    */
    ...
    /* Oppretter priskorrigeringspost */
    IF LKorriger AND AVAILABLE ArtBas THEN
    PRISPOST:
    DO:
        ...
        /* Taster valutapris */
        ASSIGN
          dcValPris  = lKatalogpris
          dcInnPris  = lKatalogpris
          dcUtpris   = DEC(replace(trim(trim(ENTRY(32,cLinje,";"),'"'),"%"),' ',''))
          dcRabatt   = ((dcValPris * lSuppRab%) / 100)
          NO-ERROR.
        ...
        DO TRANSACTION:
            ...
            ASSIGN
                ...
                ArtPris.ValPris[piTilbud]      = dec(ENTRY(1,pcSkjerm,";"))
                ArtPris.InnKjopsPris[piTilbud] = dec(ENTRY(2,pcSkjerm,";"))
                ArtPris.Rab1Kr[piTilbud]       = dec(ENTRY(3,pcSkjerm,";"))
                ArtPris.Rab1%[piTilbud]        = dec(ENTRY(4,pcSkjerm,";"))
                ArtPris.Rab2Kr[piTilbud]       = dec(ENTRY(5,pcSkjerm,";"))
                ArtPris.Rab2%[piTilbud]        = dec(ENTRY(6,pcSkjerm,";"))
                ArtPris.Frakt[piTilbud]        = dec(ENTRY(7,pcSkjerm,";"))
                ArtPris.Frakt%[piTilbud]       = dec(ENTRY(8,pcSkjerm,";"))
                ArtPris.DivKostKr[piTilbud]    = dec(ENTRY(9,pcSkjerm,";"))
                ArtPris.DivKost%[piTilbud]     = dec(ENTRY(10,pcSkjerm,";"))
                ArtPris.Rab3Kr[piTilbud]       = dec(ENTRY(11,pcSkjerm,";"))
                ArtPris.Rab3%[piTilbud]        = dec(ENTRY(12,pcSkjerm,";"))
                ArtPris.VareKost[piTilbud]     = dec(ENTRY(13,pcSkjerm,";"))
                ArtPris.MvaKr[piTilbud]        = dec(ENTRY(14,pcSkjerm,";"))
                ArtPris.Mva%[piTilbud]         = dec(ENTRY(15,pcSkjerm,";"))
                ArtPris.DbKr[piTilbud]         = dec(ENTRY(16,pcSkjerm,";"))
                ArtPris.Db%[piTilbud]          = dec(ENTRY(17,pcSkjerm,";"))
                ArtPris.Pris[piTilbud]         = dec(ENTRY(18,pcSkjerm,";"))
                ArtPris.EuroPris[piTilbud]     = dec(ENTRY(19,pcSkjerm,";"))
                ArtPris.EuroManuel             = FALSE
                ArtPris.AktivFraDato           = DATE(ENTRY(21,pcSkjerm,";"))
                ArtPris.AktivFraTid            = INT(ENTRY(22,pcSkjerm,";"))
                .
