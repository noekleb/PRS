...
/* FÖR ATT KÖRA SKARPT --> ÄNDRA lDebug = TRUE TILL lDebug = FALSE */
/* I annat fall visas alla artiklar som har OS strekkoder som skall tas bort */
/* REGLER FÖR BORTTAG                           */
/*
- Størrelsen på strekkoden skal ikke finnes i størrelsestypen.
- Størrelsen skal være ”OS” på strekkoden.
- Det skal ligge en annen strekkode på samme artikkelen som ikke er 02 kode, og som har en størrelse som finnes i størrelsestypen.
*/
