...
ASSIGN
    cFilNavn = "C:\Appdir\Art nr med OS 210307 (2).csv"
    cLoggFil = "C:\Appdir\Art nr med OS 210307 (2).log"
    .
...
REPEAT:
    ...
    DO TRANSACTION:
        ...
        PUT STREAM LoggFil UNFORMATTED
            ...
            "     Strekkode 'OS'(" STRING(iStrKode) + "): " (IF AVAILABLE buf1Strekkode 
                                                               THEN " Funnet " + buf1Strekkode.Kode + " " + STRING(buf1Strekkode.StrKode) + " " + Buf1Strekkode.Bestillingsnummer 
                                                               ELSE " Finnes ikke") SKIP
            .

        /* Lister opp andre strekkoder på artikkelen. */
        FOR EACH buf2Strekkode OF ArtBas EXCLUSIVE-LOCK WHERE
            buf2Strekkode.Kode > "0299999999999":
            /* Henter 02 koder og sjekker om den skal slettes */
            FIND FIRST buf1Strekkode OF ArtBas EXCLUSIVE-LOCK WHERE
                buf1Strekkode.StrKode = buf2Strekkode.StrKode AND
                buf1Strekkode.Kode BEGINS "02" NO-ERROR.

            PUT STREAM LoggFil UNFORMATTED
            "     Strekkode  (" buf2Strekkode.Kode "):" (IF AVAILABLE buf2Strekkode 
                                       THEN " StrKode: " + STRING(buf2Strekkode.StrKode) + " Bestillingsnr: " + Buf2Strekkode.Bestillingsnummer 
                                       ELSE " Finnes ikke") SKIP
            .
            /* 02 kode som skal slettes */
            IF AVAILABLE buf1Strekkode AND buf1Strekkode.Kode BEGINS "02" THEN
            DO:
                PUT STREAM LoggFil UNFORMATTED
                "     ** Slettes (" buf1Strekkode.Kode "):" " StrKode: " STRING(buf1Strekkode.StrKode) + " Bestillingsnr: " + Buf1Strekkode.Bestillingsnummer SKIP
                .
                /* Døden !!! */
                DELETE buf1Strekkode.
            END.
        END.
