...
DEFINE FRAME Dialog-Frame
     ...
     "Oppdaterer ArtLag.Netpris fra Lager.VVareKost" VIEW-AS TEXT
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Korreksjon av vektet kostpris"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Korreksjon av vektet kostpris */
DO:
...
------------------------------------------------------------------------------*/
  ...
  for each ArtBas no-lock where
    ...
    /* Oppdaterer NetPris i ArtLag for denne butikken. */
    LES_LAGER:
    for each Lager where
      Lager.ArtikkelNr = ArtBas.ArtikkelNr no-lock:
      ...
      for each ArtLag exclusive-lock where
        ...
        ArtLag.NetPris = Lager.VVareKost.            
      end. /* LES_ARTLAG */        
    end. /* LES_LAGER */
