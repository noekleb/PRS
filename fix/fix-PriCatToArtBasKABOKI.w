...
DO:
    ...
    REPEAT:
        ...
        IF cString = "" THEN
            NEXT.
        iAnt = iAnt + 1.
        CASE TRIM(ENTRY(9,cString,";")):
            WHEN "A" THEN
                ASSIGN ENTRY(9,cString,";") = "21".
            WHEN "B" THEN
                ASSIGN ENTRY(9,cString,";") = "22".
            WHEN "C" THEN
                ASSIGN ENTRY(9,cString,";") = "23".
            WHEN "E" THEN
                ASSIGN ENTRY(9,cString,";") = "24".
            WHEN "H" THEN
                ASSIGN ENTRY(9,cString,";") = "25".
            WHEN "I" THEN
                ASSIGN ENTRY(9,cString,";") = "26".
            WHEN "O" THEN
                ASSIGN ENTRY(9,cString,";") = "27".
        END CASE.
        CREATE TT_Pricat.
        ASSIGN modell     = 0 /*deci(ENTRY(1,cString,";")) */
               ...
               storl      = IF TRIM(storl) = "ONE" THEN "1" ELSE TRIM(storl)
...
/*                ant        = int(ENTRY(12,cString,";")) */
               ...
               mva        = 24
               levkod     = TRIM(levkod) + "-" + TRIM(levfarkode)
                   .
...
DO:
    ...
    FOR EACH TT_Pricat BREAK BY levkod.
        IF FIRST-OF(levkod) THEN DO:
