...
FOR EACH PkSdlHode EXCLUSIVE-LOCK WHERE
    ...
    TRIM(ENTRY(1,PkSdlHode.MeldingFraLev,CHR(10))) = 'Ordretype: 12',
    ...
    IF PkSdlHode.Merknad = 'Via fakturamodul' THEN
        NEXT.
    IF PkSdlHode.MeldingFraLev = '' THEN
        NEXT.
    ...
    DO:
        ...
        ASSIGN
            ...
            lVareKost = PkSdlPris.NyInnkjopsPris /*ROUND((PkSdlPris.NyInnkjopsPris * lRab1%) / 100,2)*/
        ...
        */
        ...
        DISPLAY
                ...
                pkSdlHode.SendtDato
                TRIM(ENTRY(1,PkSdlHode.MeldingFraLev,CHR(10))) FORMAT "x(20)"
