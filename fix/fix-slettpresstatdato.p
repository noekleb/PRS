...
DO piLoop= 1 TO NUM-ENTRIES(cButLst):
    ...
    FOR EACH Butiker NO-LOCK WHERE
        ...
        DATO:
        DO dDato = 01/01/2004 TO 01/01/2004:
            pause 0. Display "pfTenderRevenue Flipp 1" butiker.butik ddato SKIP.
            pi = 0.
            ...
            pause 0. Display "pfStatisticsRevenue Flipp 2"  butiker.butik ddato SKIP.
            pi = 0.
            ...
            pause 0. Display "pfDaySales_HourExt Flipp 8"  butiker.butik ddato SKIP.
            pi = 0.
            AVDELING:
            FOR EACH Avdeling:
            ...
            pause 0. Display "pfDaySales Flipp 9"  butiker.butik ddato SKIP.
            pi = 0.
