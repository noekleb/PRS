...
ASSIGN
    cFilNavn   = 'c:\appdir\EANListe190912_160949.csv'
    cUtFilNavn = 'c:\appdir\EANListe170912_131613_vasket.csv'
    cPricatFil = 'c:\appdir\VPI010EAN.csv'
    .
...
/*  4 */ ttPriKat.EANnr           = TRIM(ENTRY(1,cLinje,';'),'"')
/*  5 */ ttPriKat.VareTekst       = TRIM(ENTRY(2,cLinje,';'),'"')
...
/* 13 */ ttPriKat.LevPrisEngros   = TRIM(ENTRY(9,cLinje,';'),'"')
/* 14 */ ttPriKat.ValKod          = "NOK" 
/* 15 */ ttPriKat.forhRab%        = "" 
/* 16 */ ttPriKat.suppRab%        = "" 
/* 17 */ ttPriKat.VeilPris        = TRIM(ENTRY(6,cLinje,';'),'"')
/* 18 */ ttPriKat.PAKstru         = "" 
/* 19 */ ttPriKat.LevUke1         = "" 
/* 20 */ ttPriKat.LevUke2         = "" 
/* 21 */ ttPriKat.LevUke3         = "" 
/* 22 */ ttPriKat.LevUke4         = "" 
/* 23 */ ttPriKat.VareGruppe      = TRIM(ENTRY(7,cLinje,';'),'"') 
/* 24 */ ttPriKat.LevNavn         = "" 
/* 25 */ ttPriKat.LevKod          = ""
...
/* 31 */ ttPriKat.BFsupp          = "" 
/* 32 */ ttPriKat.MarkedsPris     = TRIM(ENTRY(6,cLinje,';'),'"') 
