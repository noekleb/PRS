...
c:
cd c:\polygon\prs
C:\Progress\OpenEdge\bin\prowin -ininame skotex.ini -pf pf\clskotex.pf -p cls\UNI2\setBruksOgHovedkategori_fra_UniversalDB.p -assemblies c:\polygon\assemblies -b