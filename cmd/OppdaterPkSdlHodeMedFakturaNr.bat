...
c:
cd c:\polygon\prs
C:\Progress\OpenEdge\bin\prowin -ininame skotex.ini -pf pf\clskotex.pf -p cls\Pakkseddel\run_asOppdaterPkSdlHodeMedFakturaNr.p -assemblies c:\polygon\assemblies -b