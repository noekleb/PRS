...
/* Load Bar Code Font */
RUN pdf_load_font  ("Spdf","Code 39","\gord\pdfinclude2\samples\support\code39.ttf","\gord\pdfinclude2\samples\support\code39.afm","").

/* Load PRO-SYS Logo File */
RUN pdf_load_image ("Spdf","ProSysLogo","\gord\pdfinclude2\samples\support\prosyslogo.jpg").
