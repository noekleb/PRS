...
/* Load Bar Code Font */
RUN pdf_load_font  ("Spdf","Code39","\gord\PDFinclude2\samples\support\code39.ttf","\gord\PDFinclude2\samples\support\code39.afm",""). 

/* Load and Image that we will use to show how to place onto the page */
RUN pdf_load_image ("Spdf","Product","\gord\PDFinclude2\samples\support\product.jpg"). 
