...
RUN pdf_load_template("Spdf","Temp1","\gord\PDFinclude2\samples\super\Temp1.cfg").
RUN pdf_load_template("Spdf","Temp2","\gord\PDFinclude2\samples\super\Temp2.cfg").
RUN pdf_load_template("Spdf","Portrait","\gord\PDFinclude2\samples\super\Portrait.cfg").
