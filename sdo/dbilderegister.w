...
&Scoped-define INTERNAL-TABLES Bilderegister

/* Definitions for QUERY Query-Main                                     */
&Scoped-Define ENABLED-FIELDS  BildNr BrukerID Bytes Dato DokumentNr EDato EksterntID ETid FilNavn~
 LevArtNr LevNr Merknad Notat RegistrertAv RegistrertDato RegistrertTid Sted~
 Tekst Tid
&Scoped-define ENABLED-FIELDS-IN-Bilderegister BildNr BrukerID Bytes Dato ~
DokumentNr EDato EksterntID ETid FilNavn LevArtNr LevNr Merknad Notat ~
RegistrertAv RegistrertDato RegistrertTid Sted Tekst Tid 
&Scoped-Define DATA-FIELDS  BildNr BrukerID Bytes Dato DokumentNr EDato EksterntID ETid FilNavn~
 LevArtNr LevNr Merknad Notat RegistrertAv RegistrertDato RegistrertTid~
 Bildefil Sted Tekst Tid
&Scoped-define DATA-FIELDS-IN-Bilderegister BildNr BrukerID Bytes Dato ~
DokumentNr EDato EksterntID ETid FilNavn LevArtNr LevNr Merknad Notat ~
RegistrertAv RegistrertDato RegistrertTid Sted Tekst Tid 
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "dbilderegister.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH Bilderegister NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Bilderegister NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main Bilderegister
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Bilderegister
...
------------------------------------------------------------------------------*/
  RETURN IF RowObject.BildNr = 0 THEN "" ELSE cKatalog + "\" + 
      (IF CAN-FIND(FIRST bildedata OF bilderegister WHERE bildedata.teller >= 200) THEN 
