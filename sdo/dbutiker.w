...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Butiker NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Butiker NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main Butiker
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Butiker
