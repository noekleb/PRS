...
&Scoped-Define ENABLED-FIELDS  FilId LinjeNr Gradering Tekst
&Scoped-define ENABLED-FIELDS-IN-VPIFilLogg FilId LinjeNr Gradering Tekst 
&Scoped-Define DATA-FIELDS  FilId LinjeNr Gradering fuGraderingFillogg Tekst
&Scoped-define DATA-FIELDS-IN-VPIFilLogg FilId LinjeNr Gradering Tekst 
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "dvpifillogg.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH VPIFilLogg NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD GraderingFilLogg dTables  _DB-REQUIRED
...
"FilId" "FilId" ? ? "decimal" ? ? ? ? ? ? yes ? no 15.6 yes ""
     _FldNameList[2]   > Data.VPIFilLogg.LinjeNr
"LinjeNr" "LinjeNr" ? ? "integer" ? ? ? ? ? ? yes ? no 10.2 yes ""
     _FldNameList[3]   > Data.VPIFilLogg.Gradering
...
"GraderingFilLogg(RowObject.Gradering)" "fuGraderingFillogg" "Gradering" "x(15)" "character" ? ? ? ? ? ? no ? no 15 no ?
     _FldNameList[5]   > Data.VPIFilLogg.Tekst
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION GraderingFilLogg dTables  _DB-REQUIRED
FUNCTION GraderingFilLogg RETURNS CHARACTER
