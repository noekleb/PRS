...
RUN pdf_new ("Spdf","\gord\PDFinclude\samples\super\template-sample.pdf").

RUN pdf_load_template("Spdf","Template","\gord\PDFinclude\samples\super\template-sample.cfg").
...
INPUT FROM "\gord\PDFinclude\samples\super\template-sample.txt" NO-ECHO.
  REPEAT:
